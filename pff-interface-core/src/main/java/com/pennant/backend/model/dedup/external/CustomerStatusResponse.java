...
public class CustomerStatusResponse {
	...
	public String toString() {
		return "CustomerStatusResponse [dealId=" + dealId + ", areaStatus=" + areaStatus + ", customerStatus="
				+ customerStatus + ", customerID=" + customerID + ", applicationID=" + applicationID
				+ ", dedupeLANMatches=" + dedupeLANMatches + ", applicationNumberDisburse=" + applicationNumberDisburse
				+ ", elcFlag=" + elcFlag + ", elcLimit=" + elcLimit + ", rejectLANMatches=" + rejectLANMatches
				+ ", fraudLANMatches=" + fraudLANMatches + ", cobrandLimit=" + cobrandLimit + ", cobrandAvailLimit="
				+ cobrandAvailLimit + ", cobrandCount=" + cobrandCount + ", wipLANMatches=" + wipLANMatches
				+ ", rblLanMatches=" + rblLanMatches + "]";
	}
