...
public class CustomerDataProcessImpl extends GenericProcess implements CustomerDataProcess {
		...
		try {
			...
			if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD"))) {
				...
				customer.setCustSalutationCode(
						(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspSalu").toString());
				...
				customer.setCustPassportExpiry(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPPE").toString()));
				...
				customer.setCustTradeLicenceExpiry(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspTle").toString()));
				customer.setCustVisaNum(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspVisaN").toString());
				customer.setCustVisaExpiry(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspVisaE").toString()));
				...
				customer.setCustShrtNameLclLng(
						(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspLSNam").toString());
				...
				customer.setCustIsTradeFinCust(
						getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspYTRI").toString()));
				...
				customer.setCustClosedOn(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspDCC").toString()));
				customer.setCustStmtFrq((String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCFRQ").toString());
				customer.setCustStmtLastDate(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPSTM").toString()));
				customer.setCustStmtNextDate(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNSTM").toString()));
				customer.setCustFirstBusinessDate(
						formatCYMDDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCOD").toString()));
				...
				for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
					...
					customerRating.setCustRatingType(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustRatings.CustRatingType", indices));
					customerRating.setCustLongRate(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustRatings.CustLongRate", indices));
					customerRating.setCustShortRate(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustRatings.CustShortRate", indices));
				...
				for (indices1[0] = 0; indices1[0] < custIdCount; indices1[0]++) {
					...
					customerIdentity
							.setIdType((String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustIdentity.CustIdType", indices1));
					customerIdentity
							.setIdRef((String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustIdentity.CustIdNum", indices1));
					customerIdentity.setIdIssueCountry(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.CustIdentity.CustIdCna", indices1));
					customerIdentity.setIdIssuedOn(formatCYMDDate(
							pcmlDoc.getValue(pcml + ".@RSPDTA.CustIdentity.CustIdIssuDt", indices1).toString()));
					customerIdentity.setIdExpiresOn(formatCYMDDate(
							pcmlDoc.getValue(pcml + ".@RSPDTA.CustIdentity.CustIdExpDt", indices1).toString()));
				...
				try {
					custShareHolderCount = Integer
							.parseInt(pcmlDoc.getValue(pcml + ".@RSPDTA.ShareHolderIDCount").toString());
				} catch (Exception e) {
				...
				for (shareholderCount[0] = 0; shareholderCount[0] < custShareHolderCount; shareholderCount[0]++) {
					...
					shareHolder.setShareHolderIDType(
							pcmlDoc.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderIDType", shareholderCount)
									.toString());
					shareHolder.setShareHolderIDRef((String) pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderIDRef", shareholderCount));
					shareHolder.setShareHolderPerc(pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderPerc", shareholderCount).toString());
					shareHolder.setShareHolderRole((String) pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderRole", shareholderCount));
					shareHolder.setShareHolderName((String) pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderName", shareholderCount));
					shareHolder.setShareHolderNation((String) pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderNation", shareholderCount));
					shareHolder.setShareHolderRisk((String) pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderRisk", shareholderCount));
					shareHolder.setShareHolderDOB(formatCYMDDate(pcmlDoc
							.getValue(pcml + ".@RSPDTA.CustShareHolder.ShareHolderDOB", shareholderCount).toString()));
		...
		try {
			...
			if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD"))) {
				...
				for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
					...
					customerCollateral.setCollReference(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCLR", indices));
					customerCollateral
							.setCollType((String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCLP", indices));
					customerCollateral.setCollTypeDesc(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCPD", indices));
					customerCollateral.setCollComplete(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCCM", indices));
					customerCollateral
							.setCollCcy((String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCCY", indices));
					customerCollateral
							.setCollExpDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCXD", indices));
					customerCollateral
							.setColllastRvwDate(pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspLRD", indices));
					customerCollateral.setCollValue(pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCLV", indices));
					customerCollateral
							.setCollBankVal(pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspBKV", indices));
					customerCollateral
							.setCollBankValMar(pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspBVM", indices));
					customerCollateral.setColllocation(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCLO", indices));
					customerCollateral.setColllocationDesc(
							(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DSRspDetails.dsRspCLS", indices));
	...
	public CoreBankAvailCustomer fetchAvailInformation(CoreBankAvailCustomer coreCust) throws InterfaceException {
		...
		try {
			...
			if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
				...
				coreCust.setCollateralCount(
						Integer.parseInt(pcmlDoc.getValue(pcml + ".@RSPDTA.CollateralCount").toString())); //Collateral Count
				...
				if (StringUtils.isNotEmpty(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtCcy").toString())) {
					...
					custLimit.setLimitCcyEdit(
							Integer.parseInt(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtCcyEdit").toString()));
					...
					if ("-".equals(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtRiskSign").toString())) {
						custLimit.setRiskAmount(
								new BigDecimal(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtRisk").toString()).negate());
					} else {
					...
					if ("-".equals(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtAvlSign").toString())) {
						custLimit.setAvailAmount(
								new BigDecimal(pcmlDoc.getValue(pcml + ".@RSPDTA.LmtAvl").toString()).negate());
					} else {
	...
	/**
	 * This method fetches the Customer information for the given CustomerID(CIF) by calling Equation Program PTKAS13PR.
	 * 
	 * @Param Customer
	 * @Return Customer-- unused
	 */
	...
	public CoreBankingCustomer fetchInformation(CoreBankingCustomer coreCust) throws InterfaceException {
		...
		try {
			...
			if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
				 ...
				 * coreCust.setDefaultAccountShortName(getString(pcmlDoc, pcml, ".@RSPDTA.DSRSPDAS")); //Default Account
				 * Short name coreCust.setCustomerType(getString(pcmlDoc, pcml, ".@RSPDTA.DSRSPCTP")); //Customer Type
				 ...
				 * //coreCust.setClosedDate(DateUtility.getUtilDate(getEquationDate(pcmlDoc, pcml,
				 * "").toString(),"ddMMyyyy")); //Close Date coreCust.setCustomerBranchMnemonic(getString(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPBRNM")); //Customer Branch mnemonic //coreCust.setGroupStatus(getString(pcmlDoc, pcml,
				 * ".@RSPDTA.dsRspGrp")); //Group Status coreCust.setGroupName(getString(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPGRP")); //Group name //coreCust.setSegmentIdentifier(getString(pcmlDoc, pcml,
				 * ".@RSPDTA.dsRspGrp")); //Segment Identifier coreCust.setSalutation(getString(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPSALU")); //Salutation if(!getEquationDate(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPDOB").toString().equals("0")){
				 * coreCust.setCustDOB(DateUtility.getUtilDate(getEquationDate(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPDOB").toString(),"ddMMyyyy")); //Date Of Birth }else{ coreCust.setCustDOB(null); }
				 ...
				 * coreCust.setCustPassportExpiry(DateUtility.getUtilDate(getEquationDate(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPPPE").toString(),"ddMMyyyy")); //Passport Expiry Date }else{
				 * coreCust.setCustDOB(null); } coreCust.setMinor(getString(pcmlDoc, pcml, ".@RSPDTA.DSRSPMINOR")); //Is
				 * Minor coreCust.setTradeLicNumber(getString(pcmlDoc, pcml, ".@RSPDTA.DSRSPTLN")); //Trade License
				 * number if(!getEquationDate(pcmlDoc, pcml, ".@RSPDTA.DSRSPTLE").toString().equals("0")){
				 * coreCust.setTradeLicExpiry(DateUtility.getUtilDate(getEquationDate(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPTLE").toString(),"ddMMyyyy")); // Trade License Expiry Date }else{
				 * coreCust.setCustDOB(null); } coreCust.setVisaNumber(getString(pcmlDoc, pcml, ".@RSPDTA.DSRSPVISAN"));
				 * //Visa Number if(!getEquationDate(pcmlDoc, pcml, ".@RSPDTA.DSRSPVISAE").toString().equals("0")){
				 * coreCust.setVisaExpiry(DateUtility.getUtilDate(getEquationDate(pcmlDoc, pcml,
				 * ".@RSPDTA.DSRSPVISAE").toString(),"ddMMyyyy")); //Visa Expiry date }else{ coreCust.setCustDOB(null);
