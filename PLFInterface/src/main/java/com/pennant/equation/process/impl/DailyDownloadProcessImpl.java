...
public class DailyDownloadProcessImpl extends GenericProcess implements DailyDownloadProcess {
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						currency.setCcySwiftCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSCY", indices).toString());
						currency.setCcyEditField(Double
								.parseDouble(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCED", indices).toString()));
						...
						currency.setCcyMinorCcyUnits(Double
								.parseDouble(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPPWD", indices).toString()));
						currency.setCcySpotRate(Double
								.parseDouble(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSPT", indices).toString()));
						currency.setCcyIsReceprocal(
								"1".equals(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSEI", indices).toString())
										? true : false);
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						relationshipOfficer.setROfficerCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPACO", indices).toString());
						relationshipOfficer.setROfficerDesc(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPRNM", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						customerType.setCustTypeCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCTP", indices).toString());
						customerType.setCustTypeCtg(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCTG", indices).toString());
						customerType.setCustTypeDesc(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCTD", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						customerGroup.setCustGrpID(Long
								.parseLong(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPGRP", indices).toString()));
						customerGroup.setCustGrpCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPGRP", indices).toString());
						customerGroup.setCustGrpDesc(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPGRD", indices).toString());
						customerGroup
								.setCustGrpRO1(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPACO", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						accountType
								.setAcTypeDesc(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATD", indices).toString());
						accountType
								.setAcPurpose(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPACP", indices).toString());

						accountType.setInternalAc("Y".equalsIgnoreCase(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSC47", indices).toString()) ? true
										: false);
						accountType.setCustSysAc("Y".equalsIgnoreCase(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSYSAC", indices).toString()) ? true
										: false);
						accountType.setAcTypeIsActive("Y".equalsIgnoreCase(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPACTIVE", indices).toString()) ? true
										: false);

						accountType.setAcTypeNature1(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT1", indices).toString());
						accountType.setAcTypeNature2(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT2", indices).toString());
						accountType.setAcTypeNature3(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT3", indices).toString());
						accountType.setAcTypeNature4(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT4", indices).toString());
						accountType.setAcTypeNature5(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT5", indices).toString());
						accountType.setAcTypeNature6(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT6", indices).toString());
						accountType.setAcTypeNature7(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT7", indices).toString());
						accountType.setAcTypeNature8(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT8", indices).toString());
						accountType.setAcTypeNature9(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT9", indices).toString());
						accountType.setAcTypeNature10(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATPNAT10", indices).toString());
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						for (indices[1] = 0; indices[1] < 10; indices[1]++) {
							if (StringUtils.isBlank(pcmlDoc
									.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCRat.DSRSPRTyp", indices).toString())) {
								break;
							}
							customerRating = new EquationCustomerRating();
							customerRating.setCustID(custID);
							customerRating.setCustRatingType(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCRat.DSRSPRTyp", indices).toString());
							customerRating.setCustRatingCode(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCRat.DSRSPRCod", indices).toString());
							customerRating.setCustRating(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCRat.DSRSPRVal", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						custStsCode.setCustStsCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPLSC", indices).toString());
						custStsCode.setCustStsDescription(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPLSD", indices).toString());
						custStsCode.setDueDays(Integer
								.parseInt(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPPRDE", indices).toString()));
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						industryCode.setIndustryCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPACD", indices).toString());
						industryCode.setIndustryDesc(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPANN", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						branchCode
								.setBranchCode(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPBBN", indices).toString());
						branchCode
								.setBranchDesc(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPBRN", indices).toString());
						branchCode.setBranchAddrLine1(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPBAD1", indices).toString());
						branchCode.setBranchAddrLine2(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPBAD2", indices).toString());
						branchCode
								.setBranchFax(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPTLY", indices).toString());
						branchCode
								.setBranchTel(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPTPH", indices).toString());
						branchCode.setBranchSwiftBankCde(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSWB", indices).toString());
						branchCode.setBranchSwiftCountry(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCNAS", indices).toString());
						branchCode.setBranchSwiftLocCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSWL", indices).toString());
						branchCode.setBranchSwiftBrnCde(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSWBR", indices).toString());
						branchCode.setBranchSortCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPSORT", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						internalAccCode
								.setsIACode(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPANMD", indices).toString());
						internalAccCode
								.setsIAName(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPADES", indices).toString());
						internalAccCode.setsIAShortName(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPDIA", indices).toString());
						internalAccCode
								.setsIAAcType(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPATP", indices).toString());
						internalAccCode
								.setsIANumber(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPBNOC", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						abuser.setAbuserIDType(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspIDType", indices).toString());
						abuser.setAbuserIDNumber(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspIDNumber", indices).toString());
						abuser.setAbuserExpDate(DateUtility.convertDateFromAS400(new BigDecimal(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspExpDate", indices).toString())));
	...
	public void processCustomerNumbers(List<String> existingCustomers) throws InterfaceException {
		...
		try {
			...
			for (indices[0] = 0; indices[0] < existingCustomers.size(); indices[0]++) {
				pcmlDoc.setValue(pcml + ".@REQDTA.DEFDTA.DSReqCPNC", indices,
						StringUtils.leftPad(existingCustomers.get(indices[0]), 6, "0"));// Account Number
			}
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						customer.setCustFName(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCun", indices).toString());
						customer.setCustTypeCode(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCtp", indices).toString());
						customer.setCustIsClosed(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCuc", indices).toString()));
						customer.setCustIsActive(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCuZ", indices).toString()));
						customer.setCustDftBranch(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspBrnm", indices).toString());
						customer.setCustGroupID(
								getLong(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspGrp", indices).toString()));
						customer.setCustParentCountry(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCnap", indices).toString());
						customer.setCustRiskCountry(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCnar", indices).toString());
						customer.setCustDOB(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspDob", indices).toString()));
						customer.setCustSalutationCode(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspSalu", indices).toString());
						customer.setCustGenderCode(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspGend", indices).toString());
						...
						customer.setCustPOB(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPob", indices).toString());
						customer.setCustPassportNo(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPPN", indices).toString());
						customer.setCustPassportExpiry(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPPE", indices).toString()));
						customer.setCustIsMinor(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspMinor", indices).toString()));
						customer.setCustTradeLicenceNum(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspTln", indices).toString());
						customer.setCustTradeLicenceExpiry(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspTle", indices).toString()));
						customer.setCustVisaNum(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspVisaN", indices).toString());
						customer.setCustVisaExpiry(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspVisaE", indices).toString()));
						customer.setCustCoreBank(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCCId", indices).toString());
						customer.setCustCtgCode(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCCod", indices).toString());
						...
						customer.setCustShrtName(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCShn", indices).toString());
						customer.setCustFNameLclLng(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspLFNam", indices).toString());
						customer.setCustShrtNameLclLng(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspLSNam", indices).toString());
						customer.setCustCOB(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCOB", indices).toString());
						customer.setCustRO1(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspACO", indices).toString());
						customer.setCustIsBlocked(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCUB", indices).toString()));
						customer.setCustIsDecease(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCUD", indices).toString()));
						customer.setCustIsTradeFinCust(
								getBoolean(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspYTRI", indices).toString()));
						customer.setCustSector(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCA2", indices).toString());
						customer.setCustSubSector(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspSAC", indices).toString());
						customer.setCustProfession(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspProf", indices).toString());
						customer.setCustTotalIncome(
								getAmount(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspTInc", indices).toString()));
						customer.setCustMaritalSts(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspMSta", indices).toString());
						customer.setCustEmpSts(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspESta", indices).toString());
						customer.setCustBaseCcy(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCCcy", indices).toString());
						customer.setCustResdCountry(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNat", indices).toString());
						customer.setCustClosedOn(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspDCC", indices).toString()));
						customer.setCustStmtFrq(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCFRQ", indices).toString());
						customer.setCustStmtLastDate(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPSTM", indices).toString()));
						customer.setCustStmtNextDate(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNSTM", indices).toString()));
						customer.setCustFirstBusinessDate(formatCYMDDate(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCOD", indices).toString()));
						customer.setCustRelation(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspRltn", indices).toString());
						...
						address.setCustAddrType(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPRIM", indices).toString());
						address.setCustAddrHNbr(
								(String) pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspHNbr", indices).toString());
						address.setCustFlatNbr(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspFNbr", indices).toString());
						address.setCustAddrStreet(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNA3", indices).toString());
						address.setCustAddrLine1(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNA4", indices).toString());
						address.setCustAddrLine2(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspNA5", indices).toString());
						address.setCustPOBox(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPBOX", indices).toString());
						address.setCustAddrCity(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCity", indices).toString());
						address.setCustAddrProvince(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspProv", indices).toString());
						address.setCustAddrCountry(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspCnty", indices).toString());
						address.setCustAddrZIP(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspZIP", indices).toString());
						address.setCustAddrPhone(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPHN", indices).toString());
						...
						if (StringUtils
								.isNotBlank(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspOPHN", indices).toString())) {
							...
							phone.setPhoneNumber(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspOPHN", indices).toString());
							phonelist.add(phone);
						}

						if (StringUtils
								.isNotBlank(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspMob", indices).toString())) {
							phone = new InterfaceCustomerPhoneNumber();
							phone.setRecordType("ADD");
							...
							phone.setPhoneAreaCode(PHONE_AREACODE);
							phone.setPhoneNumber(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspMob", indices).toString());
							phonelist.add(phone);
						}

						if (StringUtils
								.isNotBlank(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspRPHN", indices).toString())) {
							...
							phone.setPhoneAreaCode(PHONE_AREACODE);
							phone.setPhoneNumber(
									pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspRPHN", indices).toString());
							phonelist.add(phone);
						}

						if (StringUtils
								.isNotBlank(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspAPHN", indices).toString())) {
						...
						email.setCustEMailTypeCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspEC01", indices).toString());
						...
						email.setCustEMailTypeCode(
								pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspEC02", indices).toString());
						...
						/*
						 * //<!-- Employee Details--> customerInterfaceData.setCustEmpName(pcmlDoc.getValue(pcml +
						 * ".@RSPDTA.DETDTA.dsRspEName",indices).toString());
						 * customerInterfaceData.setCustEmpFrom(pcmlDoc.getValue(pcml +
						 * ".@RSPDTA.DETDTA.dsRspEDOJ",indices).toString());
						 * customerInterfaceData.setCustEmpDesg(pcmlDoc.getValue(pcml +
						 * ".@RSPDTA.DETDTA.dsRspEDesg",indices).toString());
						 */
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						transactionCode
								.setTranCode(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPTCD", indices).toString());
						transactionCode
								.setTranDesc(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPTCN", indices).toString());
						transactionCode
								.setTranType(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPDCI", indices).toString());
			...
			do {
				...
				if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
					...
					for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
						...
						String idType = StringUtils
								.trimToEmpty(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPCVAL", indices).toString());
						identityType.setIdentityType(idType.length() > 8 ? idType.substring(0, 8) : idType);
						identityType.setIdentityDesc(StringUtils
								.trimToEmpty(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.DSRSPDSC", indices).toString()));
	...
	private ProgramCallDocument PTPFFGFR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
	...
	private ProgramCallDocument PTPFFABUR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFDHR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFCAR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTIPSC7R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFT9R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTIPSC8R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFC2R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFC4R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFGKR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFTAR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFC5R(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFRTR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFCTR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	private ProgramCallDocument PTPFFBHR(String requestStart, int reqTotal, int recordsTillNow,
			ProgramCallDocument pcmlDoc, String pcml) throws PcmlException, Exception {
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQSTART", requestStart);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTOTAL", reqTotal);
		pcmlDoc.setValue(pcml + ".@REQDTA.DSREQTILLNOW", recordsTillNow);
	...
	public List<IncomeAccountTransaction> importIncomeAccTransactions(List<IncomeAccountTransaction> finIncomeAccounts)
		...
		try {
			...
			pcmlDoc.setValue(pcml + ".@REQDTA.@dsReqStartDt",
					DateUtility.formatDate(finIncomeAccounts.get(0).getLastMntOn(), "dd/MM/yyyy").replace("/", ""));// Account Number
			...
			if ("0000".equals(pcmlDoc.getValue(pcml + ".@ERCOD").toString())) {
				...
				for (indices[0] = 0; indices[0] < dsRspCount; indices[0]++) {
					...
					account.setIncomeAccount(
							pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspAccNum", indices).toString()); //Income Account
					account.setProfitAmount(
							new BigDecimal(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPftAma", indices).toString())); //Profit Amount
					account.setManualAmount(
							new BigDecimal(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspManAma", indices).toString())); //Manual Amount
					account.setPffPostingAmount(
							new BigDecimal(pcmlDoc.getValue(pcml + ".@RSPDTA.DETDTA.dsRspPffAma", indices).toString())); //Pff Posting Amount
