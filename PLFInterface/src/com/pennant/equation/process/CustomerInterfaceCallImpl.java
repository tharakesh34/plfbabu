...
import com.pennant.coreinterface.vo.CustomerInterfaceData.ShareHolder;
import com.pennant.equation.util.HostConnection;

public class CustomerInterfaceCallImpl  implements CustomerInterfaceCall {
	private static Logger logger = Logger.getLogger(CustomerInterfaceCallImpl.class);
