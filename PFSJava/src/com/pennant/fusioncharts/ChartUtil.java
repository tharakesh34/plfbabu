...
public class ChartUtil {
		...
		if(setElements.size()>0){
			...
			for (int i = 0; i <   setElements.size(); i++) {
				...
				if(i==0){
					...
					setElement.append("seriesName='"+setElements.get(i).getSeries()+"' "+StringUtils.trimToEmpty(renderAs) +" >");
					setElement.append("\n");
				} else {
	...
	private static String getStyleDefinition(Map<String, ChartStyleDefinition> definitionMap){
		...
		while (iterator.hasNext()){ 
			...
			if(styleDefinition.getType().equalsIgnoreCase("font")){
				definition.append(styleDefinition.getFontStyle());
			}else if(styleDefinition.getType().equalsIgnoreCase("ANIMATION")){
				definition.append(styleDefinition.getAnimationStyle());
			}else if(styleDefinition.getType().equalsIgnoreCase("Shadow")){
				definition.append(styleDefinition.getShadowStyle());
			}else if(styleDefinition.getType().equalsIgnoreCase("Glow")){
				definition.append(styleDefinition.getGlowStyle());
			}else if(styleDefinition.getType().equalsIgnoreCase("Bevel")){
				definition.append(styleDefinition.getBevelStyle());
			}else if(styleDefinition.getType().equalsIgnoreCase("Blur")){
	...
	public static String getStyles(Map<String, ChartStyleDefinition> definitionMap,Map<String, ChartStyleApplication> applicationMap){
		...
		if(!StringUtils.trimToEmpty(definition).equals("")){
		...
		if(!StringUtils.trimToEmpty(application).equals("")){
