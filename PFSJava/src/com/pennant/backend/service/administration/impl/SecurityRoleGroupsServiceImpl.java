...
public class SecurityRoleGroupsServiceImpl extends GenericService<SecurityRoleGroups> implements  SecurityRoleGroupsService{
	...
	public SecurityRoleGroupsDAO   securityRoleGroupsDAO; 
	public SecurityGroupRightsDAO securityGroupRightsDAO;
	...
	private AuditDetail  validation(AuditDetail auditDetail, String usrLanguage,
		...
		errPrmRecordExisted[0]=String.valueOf(rolesGroups.getLovDescRoleCode());
	...
	/**
	 * This method fetches  List<SecurityGroup> by calling SecurityRoleGroupsDAO's 
	...
	/**
	 * This method fetches List<SecurityGroupRights> by GrpId by calling SecurityGroupRightsDAO's
