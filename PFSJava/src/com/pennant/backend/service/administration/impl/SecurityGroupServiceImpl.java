...
public class SecurityGroupServiceImpl extends GenericService<SecurityGroup>implements SecurityGroupService {
	...
	public SecurityGroup getSecurityGroup() {
		...
		return getSecurityGroupDAO().getSecurityGroup();
	}

	/**
	 * @return the securityGroup for New Record
	 */
	@Override
	public SecurityGroup getNewSecurityGroup() {
		logger.debug("Entering ");
		return getSecurityGroupDAO().getNewSecurityGroup();
	}
	 ...
	 */
	@Override
	public SecurityGroup refresh(SecurityGroup securityGroup) {
		logger.debug("Entering ");
		getSecurityGroupDAO().refresh(securityGroup);
		getSecurityGroupDAO().initialize(securityGroup);
		logger.debug("Leaving ");
		return securityGroup;
	}
	...
	public AuditHeader doApprove(AuditHeader auditHeader) {
		...
		BeanUtils.copyProperties((SecurityGroup) auditHeader.getModelData(), securityGroup);
	...
	public AuditHeader  doReject(AuditHeader auditHeader) {
		logger.debug("Entering ");
		SecurityGroup securityGroup= (SecurityGroup) auditHeader.getModelData();
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage
		...
		parmGrpCodeExisted[1]=String.valueOf(securityGroup.getGrpCode());
