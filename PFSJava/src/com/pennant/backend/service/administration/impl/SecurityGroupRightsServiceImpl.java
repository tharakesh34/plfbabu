...
public class SecurityGroupRightsServiceImpl extends GenericService<SecurityGroupRights> implements SecurityGroupRightsService{
	...
	private AuditDetail  validation(AuditDetail auditDetail, String usrLanguage,
		...
		errPrmRecordExisted[0]=String.valueOf(asecGrouprights.getLovDescGrpCode());
	...
	/**
	 * This method fetches List<SecRight> records by calling SecurityGroupRightsDAO's getRightsByGroupId()
	 * @param grpID(long)
	 * @param isAssigned(boolean)
	 * @return  List<SecRight>
	 */
