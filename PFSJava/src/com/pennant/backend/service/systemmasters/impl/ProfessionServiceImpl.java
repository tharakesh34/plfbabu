...
public class ProfessionServiceImpl extends GenericService<Profession> implements ProfessionService {
	...
	public Profession getProfession() {
		return getProfessionDAO().getProfession();
	}

	public Profession getNewProfession() {
		return getProfessionDAO().getNewProfession();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (profession.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(profession.getProfessionCode()));
		} else {
	 ...
	 */
	@Override
	public Profession refresh(Profession profession) {
		logger.debug("Entering");
		getProfessionDAO().refresh(profession);
		getProfessionDAO().initialize(profession);
		logger.debug("Leaving");
		return profession;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,String method) {
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !profession.isWorkflow()) {
