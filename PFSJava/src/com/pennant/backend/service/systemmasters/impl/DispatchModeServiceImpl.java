...
public class DispatchModeServiceImpl extends GenericService<DispatchMode>
	...
	public DispatchMode getDispatchMode() {
		return getDispatchModeDAO().getDispatchMode();
	}

	public DispatchMode getNewDispatchMode() {
		return getDispatchModeDAO().getNewDispatchMode();
	}
	 ...
	 */
	@Override
	public DispatchMode refresh(DispatchMode dispatchMode) {
		logger.debug("Entering");
		getDispatchModeDAO().refresh(dispatchMode);
		getDispatchModeDAO().initialize(dispatchMode);
		logger.debug("Leaving");
		return dispatchMode;
	}
