...
public class IdentityDetailsServiceImpl extends GenericService<IdentityDetails> implements IdentityDetailsService {
	...
	public IdentityDetails getIdentityDetails() {
		return getIdentityDetailsDAO().getIdentityDetails();
	}

	public IdentityDetails getNewIdentityDetails() {
		return getIdentityDetailsDAO().getNewIdentityDetails();
	}
	 ...
	 */
	@Override
	public IdentityDetails refresh(IdentityDetails identityDetails) {
		logger.debug("Entering");
		getIdentityDetailsDAO().refresh(identityDetails);
		getIdentityDetailsDAO().initialize(identityDetails);
		logger.debug("Leaving");
		return identityDetails;
	}
