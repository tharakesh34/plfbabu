...
public class SubSegmentServiceImpl extends GenericService<SubSegment> implements	SubSegmentService {
	...
	public SubSegment getSubSegment() {
		return getSubSegmentDAO().getSubSegment();
	}

	public SubSegment getNewSubSegment() {
		return getSubSegmentDAO().getNewSubSegment();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (subSegment.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(subSegment.getSubSegmentCode())
	 ...
	 */
	@Override
	public SubSegment refresh(SubSegment subSegment) {
		logger.debug("Entering");
		getSubSegmentDAO().refresh(subSegment);
		getSubSegmentDAO().initialize(subSegment);
		logger.debug("Leaving");
		return subSegment;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !subSegment.isWorkflow()) {
