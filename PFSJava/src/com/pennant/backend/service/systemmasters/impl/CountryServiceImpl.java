...
public class CountryServiceImpl extends GenericService<Country> implements
	...
	public Country getCountry() {
		return getCountryDAO().getCountry();
	}

	public Country getNewCountry() {
		return getCountryDAO().getNewCountry();
	}
	 ...
	 */
	@Override
	public Country refresh(Country country) {
		logger.debug("Entering");
		getCountryDAO().refresh(country);
		getCountryDAO().initialize(country);
		logger.debug("Leaving");
		return country;
	}
