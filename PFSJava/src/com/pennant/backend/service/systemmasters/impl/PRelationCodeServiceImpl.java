...
public class PRelationCodeServiceImpl extends GenericService<PRelationCode> implements PRelationCodeService {
	...
	public PRelationCode getPRelationCode() {
		return getPRelationCodeDAO().getPRelationCode();
	}

	public PRelationCode getNewPRelationCode() {
		return getPRelationCodeDAO().getNewPRelationCode();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (pRelationCode.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(pRelationCode.getPRelationCode()));
		} else {
	 ...
	 */
	@Override
	public PRelationCode refresh(PRelationCode pRelationCode) {
		logger.debug("Entering");
		getPRelationCodeDAO().refresh(pRelationCode);
		getPRelationCodeDAO().initialize(pRelationCode);
		logger.debug("Leaving");
		return pRelationCode;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !pRelationCode.isWorkflow()) {
