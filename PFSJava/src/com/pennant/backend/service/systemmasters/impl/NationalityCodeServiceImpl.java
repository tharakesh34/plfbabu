...
public class NationalityCodeServiceImpl extends GenericService<NationalityCode> implements NationalityCodeService {
	...
	public NationalityCode getNationalityCode() {
		return getNationalityCodeDAO().getNationalityCode();
	}

	public NationalityCode getNewNationalityCode() {
		return getNationalityCodeDAO().getNewNationalityCode();
	}
	 ...
	 */
	@Override
	public NationalityCode refresh(NationalityCode nationalityCode) {
		logger.debug("Entering");
		getNationalityCodeDAO().refresh(nationalityCode);
		getNationalityCodeDAO().initialize(nationalityCode);
		logger.debug("Leaving");
		return nationalityCode;
	}
