 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  RepaymentMethodService.java                                                   * 	  
 *                                                                    						*
...
public interface RepaymentMethodService {
	...
	RepaymentMethod getRepaymentMethodById(String id);
	RepaymentMethod getApprovedRepaymentMethodById(String id);
	RepaymentMethod refresh(RepaymentMethod repaymentMethod);
