...
public class ScheduleMethodServiceImpl extends GenericService<ScheduleMethod> implements ScheduleMethodService {
	...
	public ScheduleMethod getScheduleMethod() {
		return getScheduleMethodDAO().getScheduleMethod();
	}

	@Override
	public ScheduleMethod getNewScheduleMethod() {
		return getScheduleMethodDAO().getNewScheduleMethod();
	}
	 ...
	 */
	@Override
	public ScheduleMethod refresh(ScheduleMethod scheduleMethod) {
		logger.debug("Entering");
		getScheduleMethodDAO().refresh(scheduleMethod);
		getScheduleMethodDAO().initialize(scheduleMethod);
		logger.debug("Leaving");
		return scheduleMethod;
	}
