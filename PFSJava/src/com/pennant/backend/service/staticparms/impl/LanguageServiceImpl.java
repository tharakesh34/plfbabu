...
public class LanguageServiceImpl extends GenericService<Language> implements LanguageService {
	...
	public Language getLanguage() {
		return getLanguageDAO().getLanguage();
	}

	public Language getNewLanguage() {
		return getLanguageDAO().getNewLanguage();
	}
	 ...
	 */
	@Override
	public Language refresh(Language language) {

		logger.debug("Entering");
		getLanguageDAO().refresh(language);
		getLanguageDAO().initialize(language);
		logger.debug("Leaving");
		return language;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !language.isWorkflow()) {
