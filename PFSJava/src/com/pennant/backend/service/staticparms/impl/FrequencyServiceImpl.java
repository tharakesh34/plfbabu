...
public class FrequencyServiceImpl extends GenericService<Frequency> implements
	...
	public Frequency getFrequency() {
		return getFrequencyDAO().getFrequency();
	}

	public Frequency getNewFrequency() {
		return getFrequencyDAO().getNewFrequency();
	}
	 ...
	 */
	@Override
	public Frequency refresh(Frequency frequency) {
		logger.debug("Entering");
		getFrequencyDAO().refresh(frequency);
		getFrequencyDAO().initialize(frequency);
		logger.debug("Leaving");
		return frequency;
	}
