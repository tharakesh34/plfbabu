 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  LovFieldCodeService.java                                                   * 	  
 *                                                                    						*
...
public interface LovFieldCodeService {
	
	LovFieldCode getLovFieldCode();
	LovFieldCode getNewLovFieldCode();
	AuditHeader saveOrUpdate(AuditHeader auditHeader);
	LovFieldCode getLovFieldCodeById(String id);
	LovFieldCode getApprovedLovFieldCodeById(String id);
	LovFieldCode refresh(LovFieldCode lovFieldCode);
