...
public class ContractorAssetDetailServiceImpl extends GenericService<ContractorAssetDetail> implements ContractorAssetDetailService {
	...
	/**
	 * @return the contractorAssetDetail
	 */
	@Override
	public ContractorAssetDetail getContractorAssetDetail() {
		return getContractorAssetDetailDAO().getContractorAssetDetail();
	}
	/**
	 * @return the contractorAssetDetail for New Record
	 */
	@Override
	public ContractorAssetDetail getNewContractorAssetDetail() {
		return getContractorAssetDetailDAO().getNewContractorAssetDetail();
	}
	 ...
	 * 		a)	Add new Record for the new record in the DB table FinContractorAssetDetails/FinContractorAssetDetails_Temp 
	 * 			by using ContractorAssetDetailDAO's save method 
	 * 		b)  Update the Record in the table. based on the module workFlow Configuration.
	 * 			by using ContractorAssetDetailDAO's update method
	 * 3)	Audit the record in to AuditHeader and AdtFinContractorAssetDetails by using auditHeaderDAO.addAudit(auditHeader)
	 ...
	 * 1)	Do the Business validation by using businessValidation(auditHeader) method
	 * 		if there is any error or warning message then return the auditHeader.
	 * 2)	delete Record for the DB table FinContractorAssetDetails by using ContractorAssetDetailDAO's delete method with type as Blank 
	 * 3)	Audit the record in to AuditHeader and AdtFinContractorAssetDetails by using auditHeaderDAO.addAudit(auditHeader)    
	 * @param AuditHeader (auditHeader)    
	 * @return auditHeader
	 */
	 ...
	 * with parameter id and type as blank. it fetches the approved records from the FinContractorAssetDetails.
	 * @param id (String)
	 * @return ContractorAssetDetail
	 */
	 ...
	 */
	@Override
	public ContractorAssetDetail refresh(ContractorAssetDetail contractorAssetDetail) {
		logger.debug("Entering");
		getContractorAssetDetailDAO().refresh(contractorAssetDetail);
		getContractorAssetDetailDAO().initialize(contractorAssetDetail);
		logger.debug("Leaving");
		return contractorAssetDetail;
	}
	 ...
	 * 4)	Audit the record in to AuditHeader and AdtFinContractorAssetDetails by using auditHeaderDAO.addAudit(auditHeader) for Work flow
	 * 5)  	Audit the record in to AuditHeader and AdtFinContractorAssetDetails by using auditHeaderDAO.addAudit(auditHeader) based on the transaction Type.
	 * @param AuditHeader (auditHeader)    
	 * @return auditHeader
	 */
	 ...
	 * 3)	Audit the record in to AuditHeader and AdtFinContractorAssetDetails by using auditHeaderDAO.addAudit(auditHeader) for Work flow
	 * @param AuditHeader (auditHeader)    
	 * @return auditHeader
	 */
	...
	public List<AuditDetail> getAuditDetail(List<ContractorAssetDetail> contractorAssetDetails, FinanceMain financeMain, String auditTranType, String method) {
		...
		for (int i = 0; i < contractorAssetDetails.size(); i++) {
			...
			if (!contractorAssetDetail.getRecordType().equals("")) {
