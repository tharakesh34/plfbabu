...
public class CommodityDetailServiceImpl extends GenericService<CommodityDetail> implements CommodityDetailService {
	...
	public CommodityDetail getCommodityDetail() {
		return getCommodityDetailDAO().getCommodityDetail();
	}
	@Override
	public CommodityDetail getNewCommodityDetail() {
		return getCommodityDetailDAO().getNewCommodityDetail();
	}
	...
	@Override
	public CommodityDetail getCommodityDetailById(CommodityDetail commodityDetail) {
		return getCommodityDetailDAO().getCommodityDetailById(commodityDetail,"_View");
	}
	/**
	...
	public CommodityDetail getApprovedCommodityDetailById(CommodityDetail commodityDetail) {
		return getCommodityDetailDAO().getCommodityDetailById(commodityDetail,"_AView");
	}
	 ...
	 */
	@Override
	public CommodityDetail refresh(CommodityDetail commodityDetail) {
		logger.debug("Entering");
		getCommodityDetailDAO().refresh(commodityDetail);
		getCommodityDetailDAO().initialize(commodityDetail);
		logger.debug("Leaving");
		return commodityDetail;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if (commodityDetail.isWorkflow()){
			tempCommodityDetail = getCommodityDetailDAO().getCommodityDetailById(commodityDetail, "_Temp");
		}
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !commodityDetail.isWorkflow()){
