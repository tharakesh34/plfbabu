...
public class WIFFinanceMainServiceImpl extends GenericService<FinanceMain> implements WIFFinanceMainService {
	...
	/**
	 * @return the wIFFinanceMain
	 */
	@Override
	public FinanceMain getWIFFinanceMain() {
		return getWIFFinanceMainDAO().getWIFFinanceMain();
	}
	/**
	 * @return the wIFFinanceMain for New Record
	 */
	@Override
	public FinanceMain getNewWIFFinanceMain() {
		return getWIFFinanceMainDAO().getNewWIFFinanceMain();
	}
	 ...
	 */
	@Override
	public FinanceMain refresh(FinanceMain wIFFinanceMain) {
		logger.debug("Entering");
		getWIFFinanceMainDAO().refresh(wIFFinanceMain);
		getWIFFinanceMainDAO().initialize(wIFFinanceMain);
		logger.debug("Leaving");
		return wIFFinanceMain;
	}
	 ...
	 * 		a)  DELETE	Delete the record from the main table by using getWIFFinanceMainDAO().delete with parameters wIFFinanceMain,""
	 * 		b)  NEW		Add new record in to main table by using getWIFFinanceMainDAO().save with parameters wIFFinanceMain,""
	 * 		c)  EDIT	Update record in the main table by using getWIFFinanceMainDAO().update with parameters wIFFinanceMain,""
	 * 3)	Delete the record from the workFlow table by using getWIFFinanceMainDAO().delete with parameters wIFFinanceMain,"_Temp"
	 * 4)	Audit the record in to AuditHeader and AdtWIFFinanceMain by using auditHeaderDAO.addAudit(auditHeader) for Work flow
	 * 5)  	Audit the record in to AuditHeader and AdtWIFFinanceMain by using auditHeaderDAO.addAudit(auditHeader) based on the transaction Type.
	 * @param AuditHeader (auditHeader)    
	 * @return auditHeader
	 */
	 ...
	 */
		...
		private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
			...
			if(StringUtils.trimToEmpty(method).equals("doApprove") || !wIFFinanceMain.isWorkflow()){
