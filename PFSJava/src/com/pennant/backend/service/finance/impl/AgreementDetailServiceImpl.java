...
public class AgreementDetailServiceImpl extends GenericService<AgreementDetail> implements AgreementDetailService{
	 ...
	 */
	@Override
	public List<FinanceReferenceDetail> getAggrementDetailList(String finType, String nextRoleCode) {
		return getFinanceReferenceDetailDAO().getFinanceReferenceDetail(finType, nextRoleCode, "_AAView");
	}
	...
	private AuditDetail validate(AuditDetail auditDetail, String method, String  usrLanguage){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !agreementDetail.isWorkflow()){
