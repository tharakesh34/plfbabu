...
public class ApprovalStatusEnquiryServiceImpl implements ApprovalStatusEnquiryService{
	...
	public CustomerFinanceDetail getApprovedCustomerFinanceById(String finReference){
		...
		customerFinanceDetail.setAuditTransactionsList(getApprovalStatusEnquiryDAO().getFinTransactionsList(finReference, true,false));
	...
	public CustomerFinanceDetail getCustomerFinanceById(String finReference) {
		...
		customerFinanceDetail.setAuditTransactionsList(getApprovalStatusEnquiryDAO().getFinTransactionsList(finReference, false,false));
		customerFinanceDetail.setNotesList(getNotesDAO().getNotesListAsc(getNotes(finReference, MODULE_FINANCEMAIN)));
		return customerFinanceDetail;
	}
    ...
    public CustomerFinanceDetail getApprovedCustomerFacilityById(String facilityReference) {
		...
		customerFinanceDetail.setAuditTransactionsList(getApprovalStatusEnquiryDAO().getFinTransactionsList(facilityReference, true,true));
    ...
    public CustomerFinanceDetail getCustomerFacilityById(String facilityReference) {
		...
		customerFinanceDetail.setAuditTransactionsList(getApprovalStatusEnquiryDAO().getFinTransactionsList(facilityReference, false,true));
		customerFinanceDetail.setNotesList(getNotesDAO().getNotesListAsc(getNotes(facilityReference, MODULE_FACILITY)));
		return customerFinanceDetail;
    }
