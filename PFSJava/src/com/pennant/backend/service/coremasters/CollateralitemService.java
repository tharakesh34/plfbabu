 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CollateralitemService.java                                                   * 	  
 *                                                                    						*
...
public interface CollateralitemService {
	...
	Collateralitem getCollateralitemById(String id);
	Collateralitem getApprovedCollateralitemById(String id);
	Collateralitem refresh(Collateralitem collateralitem);
