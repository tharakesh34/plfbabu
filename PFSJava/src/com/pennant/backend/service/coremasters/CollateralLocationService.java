 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CollateralLocationService.java                                                   * 	  
 *                                                                    						*
...
public interface CollateralLocationService {
	
	CollateralLocation getCollateralLocation();
	CollateralLocation getNewCollateralLocation();
	AuditHeader saveOrUpdate(AuditHeader auditHeader);
	CollateralLocation getCollateralLocationById(String id);
	CollateralLocation getApprovedCollateralLocationById(String id);
	CollateralLocation refresh(CollateralLocation collateralLocation);
