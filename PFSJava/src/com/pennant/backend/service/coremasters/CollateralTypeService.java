 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CollateralTypeService.java                                                   * 	  
 *                                                                    						*
...
public interface CollateralTypeService {
	...
	CollateralType getCollateralTypeById(String id);
	CollateralType getApprovedCollateralTypeById(String id);
	CollateralType refresh(CollateralType collateralType);
