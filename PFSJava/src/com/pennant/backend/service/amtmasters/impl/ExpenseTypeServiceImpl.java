...
public class ExpenseTypeServiceImpl extends GenericService<ExpenseType> implements ExpenseTypeService {
	...
	public ExpenseType getExpenseType() {
		return getExpenseTypeDAO().getExpenseType();
	}
	public ExpenseType getNewExpenseType() {
		return getExpenseTypeDAO().getNewExpenseType();
	}
	 ...
	 */
	@Override
	public ExpenseType refresh(ExpenseType expenseType) {
		logger.debug("Entering");
		getExpenseTypeDAO().refresh(expenseType);
		getExpenseTypeDAO().initialize(expenseType);
		logger.debug("Leaving");
		return expenseType;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !expenseType.isWorkflow()){
