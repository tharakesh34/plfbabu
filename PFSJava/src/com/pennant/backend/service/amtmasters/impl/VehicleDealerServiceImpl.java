...
public class VehicleDealerServiceImpl extends GenericService<VehicleDealer> implements VehicleDealerService {
	...
	public VehicleDealer getVehicleDealer() {
		return getVehicleDealerDAO().getVehicleDealer();
	}
	public VehicleDealer getNewVehicleDealer() {
		return getVehicleDealerDAO().getNewVehicleDealer();
	}
	 ...
	 */
	@Override
	public VehicleDealer refresh(VehicleDealer vehicleDealer) {
		logger.debug("Entering");
		getVehicleDealerDAO().refresh(vehicleDealer);
		getVehicleDealerDAO().initialize(vehicleDealer);
		logger.debug("Leaving");
		return vehicleDealer;
	}
