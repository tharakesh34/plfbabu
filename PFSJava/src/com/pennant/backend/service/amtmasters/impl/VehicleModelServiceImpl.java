...
public class VehicleModelServiceImpl extends GenericService<VehicleModel> implements VehicleModelService {
	...
	public VehicleModel getVehicleModel() {
		return getVehicleModelDAO().getVehicleModel();
	}
	public VehicleModel getNewVehicleModel() {
		return getVehicleModelDAO().getNewVehicleModel();
	}
	...
	public VehicleModel getVehicleModelById(long id) {
		return getVehicleModelDAO().getVehicleModelById(id,"_View");
	}
	/**
	...
	public VehicleModel getApprovedVehicleModelById(long id) {
		return getVehicleModelDAO().getVehicleModelById(id,"_AView");
	}	
	 ...
	 */
	@Override
	public VehicleModel refresh(VehicleModel vehicleModel) {
		logger.debug("Entering");
		getVehicleModelDAO().refresh(vehicleModel);
		getVehicleModelDAO().initialize(vehicleModel);
		logger.debug("Leaving");
		return vehicleModel;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if (vehicleModel.isWorkflow()){
			tempVehicleModel = getVehicleModelDAO().getVehicleModelById(vehicleModel.getId(), "_Temp");
		}
		...
		valueParm[0]=String.valueOf(vehicleModel.getId());
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !vehicleModel.isWorkflow()){
