...
public class VehicleVersionServiceImpl extends GenericService<VehicleVersion> implements VehicleVersionService {
	...
	public VehicleVersion getVehicleVersion() {
		return getVehicleVersionDAO().getVehicleVersion();
	}
	public VehicleVersion getNewVehicleVersion() {
		return getVehicleVersionDAO().getNewVehicleVersion();
	}
	 ...
	 */
	@Override
	public VehicleVersion refresh(VehicleVersion vehicleVersion) {
		logger.debug("Entering");
		getVehicleVersionDAO().refresh(vehicleVersion);
		getVehicleVersionDAO().initialize(vehicleVersion);
		logger.debug("Leaving");
		return vehicleVersion;
	}
