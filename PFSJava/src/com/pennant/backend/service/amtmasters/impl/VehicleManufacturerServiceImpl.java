...
public class VehicleManufacturerServiceImpl extends GenericService<VehicleManufacturer> implements VehicleManufacturerService {
	...
	public VehicleManufacturer getVehicleManufacturer() {
		return getVehicleManufacturerDAO().getVehicleManufacturer();
	}
	public VehicleManufacturer getNewVehicleManufacturer() {
		return getVehicleManufacturerDAO().getNewVehicleManufacturer();
	}
	...
	@Override
	public VehicleManufacturer getVehicleManufacturerById(long id) {
		return getVehicleManufacturerDAO().getVehicleManufacturerById(id,"_View");
	}
	/**
	...
	public VehicleManufacturer getApprovedVehicleManufacturerById(long id) {
		return getVehicleManufacturerDAO().getVehicleManufacturerById(id,"_AView");
	}	
	 ...
	 */
	@Override
	public VehicleManufacturer refresh(VehicleManufacturer vehicleManufacturer) {
		logger.debug("Entering");
		getVehicleManufacturerDAO().refresh(vehicleManufacturer);
		getVehicleManufacturerDAO().initialize(vehicleManufacturer);
		logger.debug("Leaving");
		return vehicleManufacturer;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if (vehicleManufacturer.isWorkflow()){
			tempVehicleManufacturer = getVehicleManufacturerDAO().getVehicleManufacturerById(vehicleManufacturer.getId(), "_Temp");
		}
		VehicleManufacturer befVehicleManufacturer= getVehicleManufacturerDAO().getVehicleManufacturerById(vehicleManufacturer.getId(), "");

		VehicleManufacturer old_VehicleManufacturer= vehicleManufacturer.getBefImage();


		String[] errParm= new String[1];
		String[] valueParm= new String[1];
		valueParm[0]=String.valueOf(vehicleManufacturer.getId());
		...
		if (vehicleManufacturer.isNew()){ // for New record or new record into work flow
			...
			if (!vehicleManufacturer.isWorkflow()){	// With out Work flow for update and delete
				...
				if (befVehicleManufacturer ==null){ // if records not exists in the main table
					...
					if (old_VehicleManufacturer!=null && !old_VehicleManufacturer.getLastMntOn().equals(befVehicleManufacturer.getLastMntOn())){
				...
				if (old_VehicleManufacturer!=null && !old_VehicleManufacturer.getLastMntOn().equals(tempVehicleManufacturer.getLastMntOn())){ 
					auditDetail.setErrorDetail(ErrorUtil.getErrorDetail(new ErrorDetails(PennantConstants.KEY_FIELD, "41005", errParm,valueParm), usrLanguage));
				}
			}
		}
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !vehicleManufacturer.isWorkflow()){
