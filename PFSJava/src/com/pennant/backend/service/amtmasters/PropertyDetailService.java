 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  PropertyDetailService.java                                                   * 	  
 *                                                                    						*
...
public interface PropertyDetailService {
	...
	PropertyDetail getPropertyDetailById(long id);
	PropertyDetail getApprovedPropertyDetailById(long id);
	PropertyDetail refresh(PropertyDetail propertyDetail);
