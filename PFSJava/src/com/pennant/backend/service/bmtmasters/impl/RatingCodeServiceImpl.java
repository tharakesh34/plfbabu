...
public class RatingCodeServiceImpl extends GenericService<RatingCode> implements RatingCodeService {
	...
	public RatingCode getRatingCode() {
		return getRatingCodeDAO().getRatingCode();
	}

	public RatingCode getNewRatingCode() {
		return getRatingCodeDAO().getNewRatingCode();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (ratingCode.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(ratingCode.getRatingCode()));
		} else {
	 ...
	 */
	@Override
	public RatingCode refresh(RatingCode ratingCode) {
		logger.debug("Entering");
		getRatingCodeDAO().refresh(ratingCode);
		getRatingCodeDAO().initialize(ratingCode);
		logger.debug("Leaving");
		return ratingCode;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !ratingCode.isWorkflow()) {
