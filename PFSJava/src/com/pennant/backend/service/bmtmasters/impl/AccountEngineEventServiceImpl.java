...
public class AccountEngineEventServiceImpl extends
	 ...
	 */
	@Override
	public AccountEngineEvent refresh(AccountEngineEvent accountEngineEvent) {
		logger.debug("Entering");
		getAccountEngineEventDAO().refresh(accountEngineEvent);
		getAccountEngineEventDAO().initialize(accountEngineEvent);
		logger.debug("Leaving");
		return accountEngineEvent;
	}
