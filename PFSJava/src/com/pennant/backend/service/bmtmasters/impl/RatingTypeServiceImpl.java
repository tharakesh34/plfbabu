...
public class RatingTypeServiceImpl extends GenericService<RatingType> implements RatingTypeService {
	...
	public RatingType getRatingType() {
		return getRatingTypeDAO().getRatingType();
	}

	public RatingType getNewRatingType() {
		return getRatingTypeDAO().getNewRatingType();
	}
	 ...
	 */
	@Override
	public RatingType refresh(RatingType ratingType) {
		logger.debug("Entering");
		getRatingTypeDAO().refresh(ratingType);
		getRatingTypeDAO().initialize(ratingType);
		logger.debug("Leaving");
		return ratingType;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove")|| !ratingType.isWorkflow()) {
