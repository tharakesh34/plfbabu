...
public interface HolidayMasterService {
	...
	HolidayMaster getHolidayMaster();
	HolidayMaster getNewHolidayMaster();
	AuditHeader saveOrUpdate(AuditHeader auditHeader);
	HolidayMaster getHolidayMasterById(String id,BigDecimal year,String holidayType);
	HolidayMaster getApprovedHolidayMasterById(String id,BigDecimal year,String holidayType);
	HolidayMaster refresh(HolidayMaster holidayMaster);
