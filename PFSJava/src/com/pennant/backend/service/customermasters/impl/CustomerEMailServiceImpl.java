...
public class CustomerEMailServiceImpl extends GenericService<CustomerEMail> implements CustomerEMailService {
	...
	public CustomerEMail getCustomerEMail() {
		return getCustomerEMailDAO().getCustomerEMail();
	}

	public CustomerEMail getNewCustomerEMail() {
		return getCustomerEMailDAO().getNewCustomerEMail();
	}
	 ...
	 */
	@Override
	public CustomerEMail refresh(CustomerEMail customerEMail) {
		logger.debug("Entering");
		getCustomerEMailDAO().refresh(customerEMail);
		getCustomerEMailDAO().initialize(customerEMail);
		logger.debug("Leaving");
		return customerEMail;
	}
