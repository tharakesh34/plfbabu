...
public class CustomerIdentityServiceImpl extends GenericService<CustomerIdentity> implements CustomerIdentityService {
	...
	public CustomerIdentity getCustomerIdentity() {
		return getCustomerIdentityDAO().getCustomerIdentity();
	}
	public CustomerIdentity getNewCustomerIdentity() {
		return getCustomerIdentityDAO().getNewCustomerIdentity();
	}
	 ...
	 */
	@Override
	public CustomerIdentity refresh(CustomerIdentity customerIdentity) {
		logger.debug("Entering");
		getCustomerIdentityDAO().refresh(customerIdentity);
		getCustomerIdentityDAO().initialize(customerIdentity);
		logger.debug("Leaving");
		return customerIdentity;
	}
