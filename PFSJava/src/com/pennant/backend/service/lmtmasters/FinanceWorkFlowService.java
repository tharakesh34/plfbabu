...
public interface FinanceWorkFlowService {
	...
	FinanceWorkFlow getFinanceWorkFlowById(String id);
	FinanceWorkFlow getApprovedFinanceWorkFlowById(String id);
	FinanceWorkFlow refresh(FinanceWorkFlow financeWorkFlow);
