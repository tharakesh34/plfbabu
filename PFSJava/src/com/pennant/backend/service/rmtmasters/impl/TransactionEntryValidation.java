...
public class TransactionEntryValidation {
	...
	private AuditDetail validate(AuditDetail auditDetail, String method,String  usrLanguage){
		...
		valueParm[0] = String.valueOf(transactionEntry.getLovDescEventCodeName());
		valueParm[1] = String.valueOf(transactionEntry.getLovDescAccSetCodeName());
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !transactionEntry.isWorkflow()){
