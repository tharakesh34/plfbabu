 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  ProductFinanceTypeService.java                                                   * 	  
 *                                                                    						*
...
public interface ProductFinanceTypeService {

	ProductFinanceType getProductFinanceType();
	ProductFinanceType getNewProductFinanceType();
	AuditHeader saveOrUpdate(AuditHeader auditHeader);
	ProductFinanceType getProductFinanceTypeById(long id);
	ProductFinanceType getApprovedProductFinanceTypeById(long id);
	ProductFinanceType refresh(ProductFinanceType productFinanceType);
