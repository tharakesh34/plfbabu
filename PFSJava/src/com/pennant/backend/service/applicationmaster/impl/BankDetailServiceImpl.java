...
public class BankDetailServiceImpl extends
	...
	public BankDetail getBankDetail() {
		return getBankDetailDAO().getBankDetail();
	}

	public BankDetail getNewBankDetail() {
		return getBankDetailDAO().getNewBankDetail();
	}
	 ...
	 */
	@Override
	public BankDetail refresh(BankDetail bankDetail) {

		logger.debug("Entering");
		getBankDetailDAO().refresh(bankDetail);
		getBankDetailDAO().initialize(bankDetail);
		logger.debug("Leaving");
		return bankDetail;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,	String method) {
		...
		if (StringUtils.trimToEmpty(method).equals("doApprove") || !bankDetail.isWorkflow()) {
