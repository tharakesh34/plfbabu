...
public class InterestRateTypeServiceImpl extends GenericService<InterestRateType> implements InterestRateTypeService {
	...
	public InterestRateType getInterestRateType() {
		return getInterestRateTypeDAO().getInterestRateType();
	}

	public InterestRateType getNewInterestRateType() {
		return getInterestRateTypeDAO().getNewInterestRateType();
	}
	 ...
	 */
	@Override
	public InterestRateType refresh(InterestRateType interestRateType) {
		logger.debug("Entering");
		getInterestRateTypeDAO().refresh(interestRateType);
		getInterestRateTypeDAO().initialize(interestRateType);
		logger.debug("Leaving");
		return interestRateType;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage,
		...
		valueParm[0] = interestRateType.getIntRateTypeCode();
