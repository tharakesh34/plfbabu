...
public class SplRateCodeServiceImpl extends GenericService<SplRateCode> implements SplRateCodeService {
	...
	public SplRateCode getSplRateCode() {
		return getSplRateCodeDAO().getSplRateCode();
	}
	public SplRateCode getNewSplRateCode() {
		return getSplRateCodeDAO().getNewSplRateCode();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (splRateCode.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(splRateCode
					.getSRType()));
		} else {
	 ...
	 */
	@Override
	public SplRateCode refresh(SplRateCode splRateCode) {
		logger.debug("Entering");
		getSplRateCodeDAO().refresh(splRateCode);
		getSplRateCodeDAO().initialize(splRateCode);
		logger.debug("Leaving");
		return splRateCode;
	}
