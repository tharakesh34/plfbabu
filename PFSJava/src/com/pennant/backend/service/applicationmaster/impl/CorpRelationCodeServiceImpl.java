...
public class CorpRelationCodeServiceImpl extends GenericService<CorpRelationCode> implements CorpRelationCodeService {
	...
	public CorpRelationCode getCorpRelationCode() {
		return getCorpRelationCodeDAO().getCorpRelationCode();
	}

	public CorpRelationCode getNewCorpRelationCode() {
		return getCorpRelationCodeDAO().getNewCorpRelationCode();
	}
	 ...
	 */
	@Override
	public CorpRelationCode refresh(CorpRelationCode corpRelationCode) {
		logger.debug("Entering");
		getCorpRelationCodeDAO().refresh(corpRelationCode);
		getCorpRelationCodeDAO().initialize(corpRelationCode);
		logger.debug("Leaving");
		return corpRelationCode;
	}
