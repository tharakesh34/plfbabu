...
public class FinanceApplicationCodeServiceImpl extends
	...
	public FinanceApplicationCode getFinanceApplicationCode() {
		return getFinanceApplicationCodeDAO().getFinanceApplicationCode();
	}

	public FinanceApplicationCode getNewFinanceApplicationCode() {
		return getFinanceApplicationCodeDAO().getNewFinanceApplicationCode();
	}
	 ...
	 * BMTFinanceApplicaitonCodes/BMTFinanceApplicaitonCodes_Temp by using
	 ...
	 * AuditHeader and AdtBMTFinanceApplicaitonCodes by using
	 ...
	 * table BMTFinanceApplicaitonCodes by using FinanceApplicationCodeDAO's
	 * delete method with type as Blank 3) Audit the record in to AuditHeader
	 * and AdtBMTFinanceApplicaitonCodes by using
	 * auditHeaderDAO.addAudit(auditHeader)
	 * 
	 * @param AuditHeader
	 *            (auditHeader)
	 ...
	 */
	@Override
	public FinanceApplicationCode refresh(
			FinanceApplicationCode financeApplicationCode) {

		logger.debug("Entering");
		getFinanceApplicationCodeDAO().refresh(financeApplicationCode);
		getFinanceApplicationCodeDAO().initialize(financeApplicationCode);
		logger.debug("Leaving");
		return financeApplicationCode;
	}
	 ...
	 * AdtBMTFinanceApplicaitonCodes by using
	 * auditHeaderDAO.addAudit(auditHeader) for Work flow 5) Audit the record in
	 * to AuditHeader and AdtBMTFinanceApplicaitonCodes by using
