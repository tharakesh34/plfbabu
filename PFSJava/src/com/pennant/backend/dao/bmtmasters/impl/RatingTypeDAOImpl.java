...
public class RatingTypeDAOImpl extends BasisCodeDAO<RatingType> implements RatingTypeDAO {
	...
	public RatingType getRatingType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("RatingType");
		RatingType ratingType = new RatingType();
		if (workFlowDetails != null) {
			ratingType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getRatingType() and set the new
	 * record flag as true and return RatingType()
	 * 
	 * @return RatingType
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(RatingType ratingType) {
	...
	public void update(RatingType ratingType, String type) {
		...
		updateSql.append(" Set RatingType = :RatingType, RatingTypeDesc = :RatingTypeDesc, ValueType = :ValueType,");
