...
public class ProductDAOImpl extends BasisCodeDAO<Product> implements ProductDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new Product
	 * 
	 * @return Product
	 */
	@Override
	public Product getProduct() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Product");
		Product product = new Product();
		if (workFlowDetails != null) {
			product.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getProduct() and set the new record flag as true and
	 * return Product()
	 * 
	 * @return Product
	 */
	...
	public Product getProductByID(final String id, String code, String type) {
		...
		selectSql.append("Select ProductCode, ProductDesc,");
	...
	public String save(Product product, String type) {
		...
		insertSql.append(" (ProductCode, ProductDesc,");
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(" Values(:ProductCode, :ProductDesc, :Version , :LastMntBy, :LastMntOn,");
	...
	public void update(Product product, String type) {
		...
		updateSql.append(" Set ProductCode = :ProductCode, ProductDesc = :ProductDesc,");
