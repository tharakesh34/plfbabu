...
public class FinanceRepayPriorityDAOImpl extends BasisCodeDAO<FinanceRepayPriority> implements FinanceRepayPriorityDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new FinanceRepayPriority 
	...
	public FinanceRepayPriority getFinanceRepayPriority() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("FinanceRepayPriority");
		FinanceRepayPriority financeRepayPriority= new FinanceRepayPriority();
		if (workFlowDetails!=null){
			financeRepayPriority.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getFinanceRepayPriority() and set the new record flag as true and return FinanceRepayPriority()   
	 * @return FinanceRepayPriority
	 */
	...
	public FinanceRepayPriority getNewFinanceRepayPriority() {
		...
		financeRepayPriority.setNewRecord(true);
		logger.debug("Leaving");
		return financeRepayPriority;
	}
	...
	public List<FinanceRepayPriority> getFinanceRpyPriorByPriority(final int priority, String type) {
		...
		selectSql.append(" From FinRpyPriority");
		selectSql.append(StringUtils.trimToEmpty(type));
		selectSql.append(" Where FinPriority =:FinPriority");
	...
	public void initialize(FinanceRepayPriority financeRepayPriority) {
		super.initialize(financeRepayPriority);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(FinanceRepayPriority financeRepayPriority) {
