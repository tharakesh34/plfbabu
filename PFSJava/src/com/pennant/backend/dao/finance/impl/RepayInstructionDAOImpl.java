...
public class RepayInstructionDAOImpl extends BasisCodeDAO<RepayInstruction> implements RepayInstructionDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new RepayInstruction 
	...
	public RepayInstruction getRepayInstruction(boolean isWIF) {
		...
		if(isWIF){
			wifName = "WIFFinRepayInstruction";	
		}else{
			wifName = "RepayInstruction";
		}
		...
		if (workFlowDetails!=null){
			repayInstruction.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getRepayInstruction() and set the new record flag as true and return RepayInstruction()   
	 * @return RepayInstruction
	 */
	...
	public RepayInstruction getNewRepayInstruction(boolean isWIF) {
		...
		repayInstruction.setNewRecord(true);
		logger.debug("Leaving");
		return repayInstruction;
	}
	...
	public void initialize(RepayInstruction repayInstruction) {
		super.initialize(repayInstruction);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(RepayInstruction repayInstruction) {
