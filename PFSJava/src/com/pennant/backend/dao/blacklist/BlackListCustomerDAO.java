...
package com.pennant.backend.dao.blacklist;
...
public interface BlackListCustomerDAO {
	...
	void saveList(List<BlackListCustomers> blackListCustomers);
	List<BlackListCustomers> fetchOverrideBlackListData(String finReference, String queryCode);
