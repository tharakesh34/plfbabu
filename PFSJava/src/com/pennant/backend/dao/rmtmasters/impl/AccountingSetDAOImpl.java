...
public class AccountingSetDAOImpl extends BasisNextidDaoImpl<AccountingSet> implements
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new AccountingSet
	 * 
	...
	public AccountingSet getAccountingSet() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("AccountingSet");
		AccountingSet accountingSet = new AccountingSet();
		if (workFlowDetails != null) {
			accountingSet.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getAccountingSet() and set the new record flag as true and return
	 * AccountingSet()
	 * 
	 * @return AccountingSet
	 */
	...
	public AccountingSet getNewAccountingSet() {
		...
		accountingSet.setNewRecord(true);
		logger.debug("Leaving");
		return accountingSet;
	}
	...
	public void initialize(AccountingSet accountingSet) {
		super.initialize(accountingSet);
	}
	 ...
	 */
	@Override
	public void refresh(AccountingSet accountingSet) {
	...
	public Long getAccountingSetId(final String eventCode, final String accSetCode) {
		...
		try {
			accSetId =  this.namedParameterJdbcTemplate.queryForLong(selectSql.toString(),
		        beanParameters);
		} catch (EmptyResultDataAccessException e) {
