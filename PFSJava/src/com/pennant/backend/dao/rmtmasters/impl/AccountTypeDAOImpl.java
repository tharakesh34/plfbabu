...
public class AccountTypeDAOImpl extends BasisCodeDAO<AccountType> implements
	...
	public AccountType getAccountType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("AccountType");
		AccountType accountType = new AccountType();
		if (workFlowDetails != null) {
			accountType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getAccountType() and set the new
	 * record flag as true and return AccountType()
	 * 
	 * @return AccountType
	 */
	@Override
	...
	public AccountType getAccountTypeById(final String id, String type) {
		...
		selectSql.append(" InternalAc, CustSysAc, AcTypeIsActive ,");
	 ...
	 */
	@Override
	public void refresh(AccountType accountType) {
