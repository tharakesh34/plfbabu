...
public interface AccountingSetDAO {
	 ...
	 AccountingSet getAccountingSet();
	 AccountingSet getNewAccountingSet();
	 ...
	 void initialize(AccountingSet accountingSet);
	 void refresh(AccountingSet entity);
	 List<AccountingSet> getListAERuleBySysDflt(String type);
