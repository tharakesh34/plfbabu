...
implements FinanceCheckListReferenceDAO {
	 ...
	 * @param FinanceCheckListReference (financeCheckListReference)
	 * @return FinanceCheckListReference
	 */
	@Override
	public void initialize(FinanceCheckListReference financeCheckListReference) {
		super.initialize(financeCheckListReference);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(FinanceCheckListReference financeCheckListReference) {
