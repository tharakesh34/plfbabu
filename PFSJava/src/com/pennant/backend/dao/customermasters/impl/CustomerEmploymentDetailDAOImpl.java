 ...
 * 
 */
public class CustomerEmploymentDetailDAOImpl extends BasisCodeDAO<CustomerEmploymentDetail>
	...
	public CustomerEmploymentDetail getCustomerEmploymentDetail() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil
		        .getWorkFlowDetails("CustomerEmploymentDetail");
	...
	/**
	 * This method get the module from method getCustomerEmploymentDetail() and set the new record flag as true and
	 * return CustomerEmploymentDetail()
	 * 
	 * @return CustomerEmploymentDetail
	 */
	...
	public void delete(CustomerEmploymentDetail customerEmploymentDetail, String type) {
		...
		deleteSql.append(" Where CustID =:CustID and CustEmpName=:CustEmpName ");
	...
	public long save(CustomerEmploymentDetail customerEmploymentDetail, String type) {
		...
		insertSql.append(" (CustID, CustEmpName, CustEmpFrom, CustEmpTo, CustEmpDesg,");
		insertSql.append(" CustEmpDept, CustEmpType,CurrentEmployer,");
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode,");
		insertSql.append(" TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(" Values(:CustID, :CustEmpName, :CustEmpFrom, :CustEmpTo, :CustEmpDesg,");
		insertSql.append("	:CustEmpDept, :CustEmpType, :CurrentEmployer,");
		insertSql
	...
	public void update(CustomerEmploymentDetail customerEmploymentDetail, String type) {
		...
		updateSql.append(" Set CustID = :CustID, CustEmpName = :CustEmpName, ");
