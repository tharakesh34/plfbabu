...
public class CustomerBalanceSheetDAOImpl extends BasisCodeDAO<CustomerBalanceSheet> 
	...
	public CustomerBalanceSheet getCustomerBalanceSheet() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("CustomerBalanceSheet");
		CustomerBalanceSheet customerBalanceSheet= new CustomerBalanceSheet();
		if (workFlowDetails!=null){
			customerBalanceSheet.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getCustomerBalanceSheet() and set
	 * the new record flag as true and return CustomerBalanceSheet()
	 * 
	 * @return CustomerBalanceSheet
	 */
	@Override
	...
	public void initialize(CustomerBalanceSheet customerBalanceSheet) {
		super.initialize(customerBalanceSheet);
	}
	 ...
	 */
	@Override
	public void refresh(CustomerBalanceSheet customerBalanceSheet) {
