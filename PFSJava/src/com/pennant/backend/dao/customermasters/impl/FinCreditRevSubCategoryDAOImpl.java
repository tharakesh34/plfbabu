...
public class FinCreditRevSubCategoryDAOImpl extends BasisCodeDAO<FinCreditRevSubCategory> implements FinCreditRevSubCategoryDAO {
	...
	public FinCreditRevSubCategory getFinCreditRevSubCategoryById(final String id, String type) {
		...
		if(StringUtils.trimToEmpty(type).contains("View")){
			//selectSql.append(",lovDescCategoryIdName");
		}
	 ...
	 * @param FinCreditRevSubCategory (finCreditRevSubCategory)
 	 * @return FinCreditRevSubCategory
	 */
	@Override
	public void initialize(FinCreditRevSubCategory finCreditRevSubCategory) {
		super.initialize(finCreditRevSubCategory);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(FinCreditRevSubCategory finCreditRevSubCategory) {
