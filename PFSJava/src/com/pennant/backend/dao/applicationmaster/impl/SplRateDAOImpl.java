...
public class SplRateDAOImpl extends BasisCodeDAO<SplRate> implements SplRateDAO {
	...
	public SplRate getSplRate() {
		...
		if (workFlowDetails != null) {
			splRate.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getSplRate() and set the new
	 * record flag as true and return SplRate()
	 * 
	 * @return SplRate
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(SplRate splRate) {
