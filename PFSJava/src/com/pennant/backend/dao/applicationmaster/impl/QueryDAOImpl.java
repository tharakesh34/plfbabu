...
public class QueryDAOImpl extends BasisCodeDAO<Query> implements QueryDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new Query 
	 * @return Query
	 */
	...
	public Query getQuery() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Query");
	...
	/**
	 * This method get the module from method getQuery() and set the new record flag as true and return Query()   
	 * @return Query
	 */
	 ...
	 */
	@Override
	public Query getQueryById(Query query, String type) {
		logger.debug("Entering");
	...
	public void delete(Query query,String type) {
		...
		try{
			...
			if (recordCount <= 0) {
				ErrorDetails errorDetails= getError("41003",query.getId() ,query.getUserDetails().getUsrLanguage());
				throw new DataAccessException(errorDetails.getError()) {};
			}
		}catch(DataAccessException e){
			logger.error(e);
			ErrorDetails errorDetails= getError("41006",query.getId() ,query.getUserDetails().getUsrLanguage());
			throw new DataAccessException(errorDetails.getError()) {};
		}
		logger.debug("Leaving");
	}
	...
	public void update(Query query,String type) {
		...
		if (recordCount <= 0) {
			...
			ErrorDetails errorDetails= getError("41004",query.getId() ,query.getUserDetails().getUsrLanguage());
			throw new DataAccessException(errorDetails.getError()) {};
		}
		logger.debug("Leaving");
	}
