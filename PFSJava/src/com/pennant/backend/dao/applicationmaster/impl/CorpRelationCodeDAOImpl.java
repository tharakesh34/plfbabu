...
public class CorpRelationCodeDAOImpl extends BasisCodeDAO<CorpRelationCode>	implements CorpRelationCodeDAO {
	...
	public CorpRelationCode getCorpRelationCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("CorpRelationCode");
		CorpRelationCode corpRelationCode = new CorpRelationCode();
		if (workFlowDetails != null) {
			corpRelationCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getCorpRelationCode() and set the
	 * new record flag as true and return CorpRelationCode()
	 * 
	 * @return CorpRelationCode
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(CorpRelationCode corpRelationCode) {
