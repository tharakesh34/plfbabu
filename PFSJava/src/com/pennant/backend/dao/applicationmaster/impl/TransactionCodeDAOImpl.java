...
public class TransactionCodeDAOImpl extends BasisCodeDAO<TransactionCode>  implements TransactionCodeDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new TransactionCode 
	 * @return TransactionCode
	 */
	@Override
	public TransactionCode getTransactionCode() {
		logger.debug("Entering");
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("TransactionCode");
		TransactionCode transactionCode= new TransactionCode();
		if (workFlowDetails!=null){
			transactionCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getTransactionCode() and set the
	 * new record flag as true and return TransactionCode()
	 * 
	 * @return TransactionCode
	 */
	@Override
	...
	public void initialize(TransactionCode transactionCode) {
		super.initialize(transactionCode);
	}
	 ...
	 */
	@Override
	public void refresh(TransactionCode transactionCode) {
	...
	public void delete(TransactionCode transactionCode,String type) {
		...
		try{
			...
			logger.error(e);
			ErrorDetails errorDetails= getError("41006",transactionCode.getId() ,
					transactionCode.getUserDetails().getUsrLanguage());
			throw new DataAccessException(errorDetails.getError()) {};
		}
		logger.debug("Leaving");
