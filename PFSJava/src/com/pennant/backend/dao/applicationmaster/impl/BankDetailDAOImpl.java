...
public class BankDetailDAOImpl extends BasisCodeDAO<BankDetail> implements BankDetailDAO {
	...
	public BankDetail getBankDetail() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("BankDetail");
		BankDetail bankDetail = new BankDetail();
		if (workFlowDetails != null) {
			bankDetail.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getBankDetail() and
	 * set the new record flag as true and return BankDetail()
	 * 
	 * @return BankDetail
	 */
	@Override
	public BankDetail getNewBankDetail() {
		logger.debug("Entering");
	...
	public BankDetail getBankDetailById(final String id, String type) {
		...
		StringBuilder selectSql = new StringBuilder(" SELECT BankCode, BankName, Active," );
	 ...
	 */
	@Override
	public void initialize(BankDetail bankDetail) {
		super.initialize(bankDetail);
	}
	 ...
	 */
	@Override
	public void refresh(BankDetail bankDetail) {
	...
	public String save(BankDetail bankDetail,String type) {
		...
		insertSql.append(" (BankCode, BankName, Active," );
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)" );
		insertSql.append(" Values(:BankCode, :BankName, :Active, " );
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(BankDetail bankDetail,String type) {
		...
		updateSql.append(" Set BankCode = :BankCode, BankName = :BankName, Active = :Active," );
