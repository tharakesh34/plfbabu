...
public class CheckListDAOImpl extends BasisNextidDaoImpl<CheckList> implements CheckListDAO {
	...
	public CheckList getCheckList() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("CheckList");
		CheckList checkList= new CheckList();
		if (workFlowDetails!=null){
			checkList.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	 ...
	 */
	@Override
	public void refresh(CheckList checkList) {
