...
public class InterestRateTypeDAOImpl extends BasisCodeDAO<InterestRateType> implements InterestRateTypeDAO {
	...
	public InterestRateType getInterestRateType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("InterestRateType");
		InterestRateType interestRateType = new InterestRateType();
		if (workFlowDetails != null) {
			interestRateType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getInterestRateType() and set the
	 * new record flag as true and return InterestRateType()
	 * 
	 * @return InterestRateType
	 */
	@Override
	...
	public void initialize(InterestRateType interestRateType) {
		super.initialize(interestRateType);
	}
	 ...
	 */
	@Override
	public void refresh(InterestRateType interestRateType) {
