...
public class FacilityDetailDAOImpl extends BasisCodeDAO<FacilityDetail> implements
	...
	public FacilityDetail getFacilityDetailById(final String facref, String type) {
		...
		if (StringUtils.trimToEmpty(type).contains("View")) {
			selectSql.append(" ,Revolving,CCYformat,FacilityTypeDesc,FacilityCCYName ");
			selectSql.append(" ,TotalFacilityFormatter, UnderWritingFormatter, PropFinalTakeFormatter ");
			selectSql.append(" ,TotalFacilityCcyName, UnderWritingCcyName, PropFinalTakeCcyName ");
		}
	...
	public void initialize(FacilityDetail facilityDetail) {
		super.initialize(facilityDetail);
	}
	 ...
	 */
	@Override
	public void refresh(FacilityDetail facilityDetail) {
