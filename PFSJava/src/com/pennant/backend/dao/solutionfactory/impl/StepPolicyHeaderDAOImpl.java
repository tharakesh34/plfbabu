...
public class StepPolicyHeaderDAOImpl extends BasisCodeDAO<StepPolicyHeader> implements StepPolicyHeaderDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new StepPolicyHeader
	 * 
	...
	/**
	 * This method get the module from method getStepPolicyHeader() and set the new record flag as true and
	 * return StepPolicyHeader()
	 * 
	 * @return StepPolicyHeader
	 */
	...
	public StepPolicyHeader getNewStepPolicyHeader() {
		logger.debug("Entering");
		StepPolicyHeader stepPolicyHeader = getStepPolicyHeader();
	...
	public StepPolicyHeader getStepPolicyHeaderByID(final String id, String type) {
		...
		StringBuilder selectSql = new StringBuilder("SELECT PolicyCode,PolicyDesc,");
	...
	public void initialize(StepPolicyHeader stepPolicyHeader) {
		super.initialize(stepPolicyHeader);
	}
	 ...
	 */
	@Override
	public void refresh(StepPolicyHeader stepPolicyHeader) {
	...
	public String save(StepPolicyHeader stepPolicyHeader, String type) {
		...
		insertSql.append("(PolicyCode, PolicyDesc,Version , LastMntBy, LastMntOn, RecordStatus,"); 
		insertSql.append(" RoleCode, NextRoleCode, TaskId, NextTaskId,RecordType, WorkflowId)");
		insertSql.append(" Values(:PolicyCode, :PolicyDesc, :Version , :LastMntBy, :LastMntOn, :RecordStatus, ");
		insertSql.append(" :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(StepPolicyHeader stepPolicyHeader, String type) {
		...
		updateSql.append(" Set PolicyCode = :PolicyCode, PolicyDesc = :PolicyDesc,");
