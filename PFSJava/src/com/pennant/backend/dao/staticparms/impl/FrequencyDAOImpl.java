...
public class FrequencyDAOImpl extends BasisCodeDAO<Frequency> implements FrequencyDAO {
	...
	public Frequency getFrequency() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Frequency");
		Frequency frequency = new Frequency();
		if (workFlowDetails != null) {
			frequency.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getFrequency() and set the new
	 * record flag as true and return Frequency()
	 * 
	 * @return Frequency
	 */
	...
	public Frequency getNewFrequency() {
		...
		logger.debug("Leaving getNewFrequency()");
		return frequency;
	}
	 ...
	 */
	@Override
	public void refresh(Frequency frequency) {
