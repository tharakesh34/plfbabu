...
public class ScheduleMethodDAOImpl extends BasisCodeDAO<ScheduleMethod> implements ScheduleMethodDAO {
	...
	public ScheduleMethod getScheduleMethod() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("ScheduleMethod");
		ScheduleMethod scheduleMethod = new ScheduleMethod();
		if (workFlowDetails != null) {
			scheduleMethod.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getScheduleMethod() and set the
	 * new record flag as true and return ScheduleMethod()
	 * 
	 * @return ScheduleMethod
	 */
	...
	public void initialize(ScheduleMethod scheduleMethod) {
		super.initialize(scheduleMethod);
	}
	 ...
	 */
	@Override
	public void refresh(ScheduleMethod scheduleMethod) {
	...
	private ErrorDetails  getError(String errorId, String schdMethodCode, String userLanguage){
		...
		parms[1][0] = String.valueOf(schdMethodCode);
