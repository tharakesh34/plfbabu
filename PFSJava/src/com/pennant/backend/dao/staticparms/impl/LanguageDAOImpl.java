...
public class LanguageDAOImpl extends BasisCodeDAO<Language> implements LanguageDAO {
	...
	public Language getLanguage() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Language");
		Language language = new Language();
		if (workFlowDetails != null) {
			language.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getLanguage() and set the new
	 * record flag as true and return Language()
	 * 
	 * @return Language
	 */
	@Override
