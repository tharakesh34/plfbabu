...
public class InterestRateBasisCodeDAOImpl extends BasisCodeDAO<InterestRateBasisCode> implements InterestRateBasisCodeDAO {
	...
	public InterestRateBasisCode getInterestRateBasisCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("InterestRateBasisCode");
		InterestRateBasisCode interestRateBasisCode = new InterestRateBasisCode();
		if (workFlowDetails != null) {
			interestRateBasisCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getInterestRateBasisCode() and set
	 * the new record flag as true and return InterestRateBasisCode()
	 * 
	 * @return InterestRateBasisCode
	 */
	@Override
	...
	public void initialize(InterestRateBasisCode interestRateBasisCode) {
		super.initialize(interestRateBasisCode);
	}
	 ...
	 */
	@Override
	public void refresh(InterestRateBasisCode interestRateBasisCode) {
