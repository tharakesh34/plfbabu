...
public class EmpStsCodeDAOImpl extends BasisCodeDAO<EmpStsCode> implements EmpStsCodeDAO {
	...
	public EmpStsCode getEmpStsCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("EmpStsCode");
		EmpStsCode empStsCode = new EmpStsCode();
		if (workFlowDetails != null) {
			empStsCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getEmpStsCode() and set the new
	 * record flag as true and return EmpStsCode()
	 * 
	 * @return EmpStsCode
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(EmpStsCode empStsCode) {
