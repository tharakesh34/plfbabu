...
public class NationalityCodeDAOImpl extends BasisCodeDAO<NationalityCode> implements NationalityCodeDAO {
	...
	public NationalityCode getNationalityCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("NationalityCode");
		NationalityCode nationalityCodes = new NationalityCode();
		if (workFlowDetails != null) {
			nationalityCodes.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getNationalityCode() and set the
	 * new record flag as true and return NationalityCode()
	 * 
	 * @return NationalityCode
	 */
	@Override
	public NationalityCode getNewNationalityCode() {
		...
		nationalityCodes.setNewRecord(true);
		logger.debug("Leaving");
		return nationalityCodes;
	}
	...
	public void initialize(NationalityCode nationalityCodes) {
		super.initialize(nationalityCodes);
	}
	 ...
	 */
	@Override
	public void refresh(NationalityCode nationalityCodes) {
