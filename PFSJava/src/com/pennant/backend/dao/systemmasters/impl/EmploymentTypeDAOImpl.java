...
public class EmploymentTypeDAOImpl extends BasisCodeDAO<EmploymentType>
	...
	public EmploymentType getEmploymentType() {
		...
		if (workFlowDetails != null) {
			employmentType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getEmploymentType() and set the
	 * new record flag as true and return EmploymentType()
	 * 
	 * @return EmploymentType
	 */
	@Override
	...
	public void initialize(EmploymentType employmentType) {
		super.initialize(employmentType);
	}
	 ...
	 */
	@Override
	public void refresh(EmploymentType employmentType) {
