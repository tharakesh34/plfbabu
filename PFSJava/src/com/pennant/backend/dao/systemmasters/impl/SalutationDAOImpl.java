...
public class SalutationDAOImpl extends BasisCodeDAO<Salutation> implements SalutationDAO {
	...
	public Salutation getSalutation() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Salutation");
		Salutation salutation = new Salutation();
		if (workFlowDetails != null) {
			salutation.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getSalutation() and set the new
	 * record flag as true and return Salutation()
	 * 
	 * @return Salutation
	 */
	@Override
	...
	public Salutation getSalutationById(final String id, String type) {
		...
		selectSql.append("Select SalutationCode, SaluationDesc, SalutationIsActive,SalutationGenderCode,");
	 ...
	 */
	@Override
	public void refresh(Salutation salutation) {
	...
	public String save(Salutation salutation, String type) {
		...
		insertSql.append(" (SalutationCode, SaluationDesc, SalutationIsActive,SalutationGenderCode,");
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId,");
		insertSql.append(" RecordType, WorkflowId)");
		insertSql.append(" Values(:SalutationCode, :SaluationDesc, :SalutationIsActive, :SalutationGenderCode,");
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId,");
		insertSql.append(" :RecordType, :WorkflowId)");
	...
	public void update(Salutation salutation, String type) {
		...
		updateSql.append(" SalutationIsActive = :SalutationIsActive, SalutationGenderCode = :SalutationGenderCode,");
	...
	private ErrorDetails  getError(String errorId, String salutationCode, String userLanguage){
		...
		parms[1][0] = String.valueOf(salutationCode);
