...
public class GeneralDesignationDAOImpl extends BasisCodeDAO<GeneralDesignation>
	...
	public GeneralDesignation getGeneralDesignation() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("GeneralDesignation");
		GeneralDesignation generalDesignation= new GeneralDesignation();
		if (workFlowDetails!=null){
			generalDesignation.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getGeneralDesignation() 
	 * and set the new record flag as true and return GeneralDesignation()
	 *    
	 * @return GeneralDesignation
	 */
	@Override
	 ...
	 * @param GeneralDesignation (generalDesignation)
 	 * @return GeneralDesignation
	 */
	@Override
	public void initialize(GeneralDesignation generalDesignation) {
		super.initialize(generalDesignation);
	}
	 ...
	 */
	@Override
	public void refresh(GeneralDesignation generalDesignation) {
	...
	public void update(GeneralDesignation generalDesignation,String type) {
		...
		updateSql.append(" Set GenDesignation = :GenDesignation, GenDesgDesc = :GenDesgDesc," );
