...
public class DispatchModeDAOImpl extends BasisCodeDAO<DispatchMode> implements DispatchModeDAO {
	...
	public DispatchMode getDispatchMode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("DispatchMode");
		DispatchMode dispatchMode = new DispatchMode();
		if (workFlowDetails != null) {
			dispatchMode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getDispatchMode() and set the new
	 * record flag as true and return DispatchMode()
	 * 
	 * @return DispatchMode
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(DispatchMode dispatchMode) {
