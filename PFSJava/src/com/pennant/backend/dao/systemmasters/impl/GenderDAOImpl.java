...
public class GenderDAOImpl extends BasisCodeDAO<Gender> implements GenderDAO {
	...
	public Gender getGender() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Gender");
		Gender gender = new Gender();
		if (workFlowDetails != null) {
			gender.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getGender() and set the new record
	 * flag as true and return Gender()
	 * 
	 * @return Gender
	 */
	@Override
	...
	public Gender getGenderById(final String id, String type) {
		...
		selectSql.append("SELECT GenderCode, GenderDesc, GenderIsActive," );
	 ...
	 */
	@Override
	public void refresh(Gender gender) {
	...
	public String save(Gender gender, String type) {
		...
		insertSql.append(" (GenderCode, GenderDesc, GenderIsActive," );
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId,");
		insertSql.append(" RecordType, WorkflowId)");
		insertSql.append(" Values(:GenderCode, :GenderDesc, :GenderIsActive, " );
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId,");
		insertSql.append(" :RecordType, :WorkflowId)");
	...
	public void update(Gender gender, String type) {
		...
		updateSql.append(" Set GenderCode = :GenderCode, GenderDesc = :GenderDesc, GenderIsActive = :GenderIsActive," );
