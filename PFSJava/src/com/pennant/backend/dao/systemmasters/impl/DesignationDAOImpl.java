...
public class DesignationDAOImpl extends BasisCodeDAO<Designation> implements DesignationDAO {
	...
	public Designation getDesignation() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Designation");
		Designation designation = new Designation();
		if (workFlowDetails != null) {
			designation.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getDesignation() and set the new
	 * record flag as true and return Designation()
	 * 
	 * @return Designation
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(Designation designation) {
