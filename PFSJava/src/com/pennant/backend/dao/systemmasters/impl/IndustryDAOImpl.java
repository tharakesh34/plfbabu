...
public class IndustryDAOImpl extends BasisCodeDAO<Industry> implements IndustryDAO {
	...
	public Industry getIndustry() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Industry");
		Industry industry = new Industry();
		if (workFlowDetails != null) {
			industry.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getIndustry() and set the new
	 * record flag as true and return Industry()
	 * 
	 * @return Industry
	 */
	@Override
	...
	public Industry getIndustryById(final String id, String type) {
		...
		selectSql.append("Select IndustryCode, SubSectorCode, IndustryDesc, IndustryLimit, IndustryIsActive,");
	 ...
	 */
	@Override
	public void refresh(Industry industry) {
	...
	public void update(Industry industry, String type) {
		...
		updateSql.append(" IndustryLimit = :IndustryLimit, IndustryIsActive = :IndustryIsActive,");
