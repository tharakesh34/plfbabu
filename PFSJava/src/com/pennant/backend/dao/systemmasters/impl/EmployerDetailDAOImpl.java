...
public class EmployerDetailDAOImpl extends BasisNextidDaoImpl<EmployerDetail> implements EmployerDetailDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new EmployerDetail 
	...
	public EmployerDetail getEmployerDetail() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("EmployerDetail");
	...
	/**
	 * This method get the module from method getEmployerDetail() and set the new record flag as true and return EmployerDetail()   
	 * @return EmployerDetail
	 */
	...
	public EmployerDetail getNewEmployerDetail() {
		logger.debug("Entering");
		EmployerDetail employerDetail = getEmployerDetail();
	...
	public EmployerDetail getEmployerDetailById(final long id, String type) {
		...
		StringBuilder selectSql = new StringBuilder("Select EmployerId, EmpIndustry, EmpName, EstablishDate, EmpAddrHNbr, EmpFlatNbr, EmpAddrStreet, EmpAddrLine1, EmpAddrLine2, EmpPOBox, EmpCountry, EmpProvince, EmpCity, EmpPhone, EmpFax, EmpTelexNo, EmpEmailId, EmpWebSite, ContactPersonName, ContactPersonNo, EmpAlocationType");
	 ...
	 * @param EmployerDetail (employerDetail)
 	 * @return EmployerDetail
	 */
	@Override
	public void initialize(EmployerDetail employerDetail) {
		super.initialize(employerDetail);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(EmployerDetail employerDetail) {
	...
	public long save(EmployerDetail employerDetail,String type) {
		...
		insertSql.append(" (EmployerId, EmpIndustry, EmpName, EstablishDate, EmpAddrHNbr, EmpFlatNbr, EmpAddrStreet, EmpAddrLine1, EmpAddrLine2, EmpPOBox, EmpCountry, EmpProvince, EmpCity, EmpPhone, EmpFax, EmpTelexNo, EmpEmailId, EmpWebSite, ContactPersonName, ContactPersonNo, EmpAlocationType");
		insertSql.append(", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(" Values(:EmployerId, :EmpIndustry, :EmpName, :EstablishDate, :EmpAddrHNbr, :EmpFlatNbr, :EmpAddrStreet, :EmpAddrLine1, :EmpAddrLine2, :EmpPOBox, :EmpCountry, :EmpProvince, :EmpCity, :EmpPhone, :EmpFax, :EmpTelexNo, :EmpEmailId, :EmpWebSite, :ContactPersonName, :ContactPersonNo, :EmpAlocationType");
		insertSql.append(", :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(EmployerDetail employerDetail,String type) {
		...
		updateSql.append(" Set EmployerId = :EmployerId, EmpIndustry = :EmpIndustry, EmpName = :EmpName, EstablishDate = :EstablishDate, EmpAddrHNbr = :EmpAddrHNbr, EmpFlatNbr = :EmpFlatNbr, EmpAddrStreet = :EmpAddrStreet, EmpAddrLine1 = :EmpAddrLine1, EmpAddrLine2 = :EmpAddrLine2, EmpPOBox = :EmpPOBox, EmpCountry = :EmpCountry, EmpProvince = :EmpProvince, EmpCity = :EmpCity, EmpPhone = :EmpPhone, EmpFax = :EmpFax, EmpTelexNo = :EmpTelexNo, EmpEmailId = :EmpEmailId, EmpWebSite = :EmpWebSite, ContactPersonName = :ContactPersonName, ContactPersonNo = :ContactPersonNo, EmpAlocationType = :EmpAlocationType");
