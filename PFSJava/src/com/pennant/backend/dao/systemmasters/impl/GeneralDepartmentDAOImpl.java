...
public class GeneralDepartmentDAOImpl extends BasisCodeDAO<GeneralDepartment>
	...
	public GeneralDepartment getGeneralDepartment() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("GeneralDepartment");
		GeneralDepartment generalDepartment= new GeneralDepartment();
		if (workFlowDetails!=null){
			generalDepartment.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getGeneralDepartment() and set the
	 * new record flag as true and return GeneralDepartment()
	 * 
	 * @return GeneralDepartment
	 */
	@Override
	...
	public void initialize(GeneralDepartment generalDepartment) {
		super.initialize(generalDepartment);
	}
	 ...
	 */
	@Override
	public void refresh(GeneralDepartment generalDepartment) {
