...
public class DivisionDetailDAOImpl extends BasisCodeDAO<DivisionDetail> implements DivisionDetailDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new DivisionDetail 
	...
	public DivisionDetail getDivisionDetail() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("DivisionDetail");
	...
	/**
	 * This method get the module from method getDivisionDetail() and set the new record flag as true and return DivisionDetail()   
	 * @return DivisionDetail
	 */
	...
	public DivisionDetail getNewDivisionDetail() {
		logger.debug("Entering");
		DivisionDetail divisionDetail = getDivisionDetail();
	...
	public DivisionDetail getDivisionDetailById(final String id, String type) {
		...
		StringBuilder selectSql = new StringBuilder("Select DivisionCode, DivisionCodeDesc, Active");
	...
	public void initialize(DivisionDetail divisionDetail) {
		super.initialize(divisionDetail);
	}
	/**
	 ...
	 */
	@Override
	public void refresh(DivisionDetail divisionDetail) {
	...
	public String save(DivisionDetail divisionDetail,String type) {
		...
		insertSql.append(" (DivisionCode, DivisionCodeDesc, Active");
		insertSql.append(", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(" Values(:DivisionCode, :DivisionCodeDesc, :Active");
		insertSql.append(", :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(DivisionDetail divisionDetail,String type) {
		...
		updateSql.append(" Set DivisionCode = :DivisionCode, DivisionCodeDesc = :DivisionCodeDesc, Active = :Active");
