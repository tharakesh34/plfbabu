...
public interface VehicleManufacturerDAO {
	...
	VehicleManufacturer getVehicleManufacturerById(long id, String type);
	...
	void initialize(VehicleManufacturer vehicleManufacturer);
	void refresh(VehicleManufacturer entity);
}