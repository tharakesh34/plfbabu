...
public class VehicleVersionDAOImpl extends BasisNextidDaoImpl<VehicleVersion>
	...
	public VehicleVersion getVehicleVersion() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("VehicleVersion");
		VehicleVersion vehicleVersion= new VehicleVersion();
		if (workFlowDetails!=null){
			vehicleVersion.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getVehicleVersion() and set the
	 * new record flag as true and return VehicleVersion()
	 * 
	 * @return VehicleVersion
	 */
	@Override
	...
	public VehicleVersion getVehicleVersionById(final long id, String type) {
		...
		selectSql.append(" VehicleVersionCode, ");
	...
	public void initialize(VehicleVersion vehicleVersion) {
		super.initialize(vehicleVersion);
	}
	 ...
	 */
	@Override
	public void refresh(VehicleVersion vehicleVersion) {
	...
	public long save(VehicleVersion vehicleVersion,String type) {
		...
		insertSql.append("(VehicleVersionId, VehicleModelId, VehicleVersionCode, " );
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode,");
		insertSql.append(" TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(" Values(:VehicleVersionId, :VehicleModelId, :VehicleVersionCode,");
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode,");
		insertSql.append(" :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(VehicleVersion vehicleVersion,String type) {
		...
		updateSql.append(" VehicleVersionCode = :VehicleVersionCode,");
