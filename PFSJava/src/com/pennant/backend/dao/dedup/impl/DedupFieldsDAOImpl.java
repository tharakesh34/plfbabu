...
public class DedupFieldsDAOImpl extends BasisCodeDAO<DedupFields> implements DedupFieldsDAO {
	 ...
	 */
	@Override
	public void refresh(DedupFields dedupFields) {
	...
	try{
		dedupFields = this.namedParameterJdbcTemplate.queryForObject(selectListSql, beanParameters, typeRowMapper);	
	}catch (EmptyResultDataAccessException e) {
		dedupFields = null;
	}*/
