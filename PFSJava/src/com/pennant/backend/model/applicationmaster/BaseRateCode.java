 ...
 *
 */
public class BaseRateCode implements java.io.Serializable {
	...
	public BaseRateCode() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("BaseRateCode");
	}
	...
	public boolean equals(BaseRateCode baseRateCode) {
		return getId() == baseRateCode.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BaseRateCode) {
			BaseRateCode baseRateCode = (BaseRateCode) obj;
			return equals(baseRateCode);
		}
		return false;
	}
}
