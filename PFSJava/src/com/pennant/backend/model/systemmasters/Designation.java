...
public class Designation implements java.io.Serializable {
	...
	public Designation() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("Designation");
	}
	...
	public boolean equals(Designation designation) {
		return getId() == designation.getId();
	}
