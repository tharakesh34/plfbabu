...
public class Province implements java.io.Serializable {
	...
	public Province() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("Province");
	}
	...
	public boolean equals(Province province) {
		if(getCPProvince()==province.getCPProvince() && getCPCountry()==province.getCPCountry()){
			return true;
		}
		return false;
	}
