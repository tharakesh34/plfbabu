...
public class Industry implements java.io.Serializable {
	...
	private String subSectorCode = null;
	...
	public Industry() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("Industry");
	}
	...
	public boolean equals(Industry industry) {
		if(getIndustryCode()==industry.getIndustryCode() && getSubSectorCode()==industry.getSubSectorCode()){
			return true;
		}
		return false;
	}
