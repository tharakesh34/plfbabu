...
public class AddressType implements java.io.Serializable {
	...
	private String addrTypeCode = null;
	...
	public AddressType() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("AddressType");
	}
	...
	public boolean equals(AddressType addressType) {
		return getId() == addressType.getId();
	}
