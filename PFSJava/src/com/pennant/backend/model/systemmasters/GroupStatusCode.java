 ...
 * 
 */
public class GroupStatusCode implements java.io.Serializable {
	
	private static final long serialVersionUID = -5087295833493236885L;

	private String grpStsCode = null;
	...
	public GroupStatusCode() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("GroupStatusCode");
	}
	...
	public boolean equals(GroupStatusCode groupStatusCode) {
		return getId() == groupStatusCode.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof GroupStatusCode) {
			GroupStatusCode groupStatusCode = (GroupStatusCode) obj;
			return equals(groupStatusCode);
		}
		return false;
	}
}
