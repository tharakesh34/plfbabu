 ...
 *
 */
public class OverdueCharge implements java.io.Serializable {
	...
	public OverdueCharge() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("OverdueCharge");
	}
	...
	public boolean equals(OverdueCharge overdueCharge) {
		return getId() == overdueCharge.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof OverdueCharge) {
			OverdueCharge overdueCharge = (OverdueCharge) obj;
			return equals(overdueCharge);
		}
		return false;
	}
}
