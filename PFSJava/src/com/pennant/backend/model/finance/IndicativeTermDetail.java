...
public class IndicativeTermDetail implements Serializable { 
	...
	private int lovDescTotalFacilityFormatter = 0;
	private int lovDescUnderWritingFormatter = 0;
	private int lovDescPropFinalTakeFormatter = 0;
	private String lovDescTotalFacilityCCYName;
	private String lovDescUnderWritingCCYName;
	private String lovDescPropFinalTakeCCYName;
	...
	public boolean equals(IndicativeTermDetail detail) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IndicativeTermDetail) {
			IndicativeTermDetail detail = (IndicativeTermDetail) obj;
	...
	public String getLovDescPropFinalTakeCCYName() {
	    return lovDescPropFinalTakeCCYName;
    }

	public void setLovDescPropFinalTakeCCYName(String lovDescPropFinalTakeCCYName) {
	    this.lovDescPropFinalTakeCCYName = lovDescPropFinalTakeCCYName;
    }

	public String getLovDescUnderWritingCCYName() {
	    return lovDescUnderWritingCCYName;
    }

	public void setLovDescUnderWritingCCYName(String lovDescUnderWritingCCYName) {
	    this.lovDescUnderWritingCCYName = lovDescUnderWritingCCYName;
    }

	public String getLovDescTotalFacilityCCYName() {
	    return lovDescTotalFacilityCCYName;
    }

	public void setLovDescTotalFacilityCCYName(String lovDescTotalFacilityCCYName) {
	    this.lovDescTotalFacilityCCYName = lovDescTotalFacilityCCYName;
    }

	public int getLovDescTotalFacilityFormatter() {
	    return lovDescTotalFacilityFormatter;
    }

	public void setLovDescTotalFacilityFormatter(int lovDescTotalFacilityFormatter) {
	    this.lovDescTotalFacilityFormatter = lovDescTotalFacilityFormatter;
    }

	public int getLovDescUnderWritingFormatter() {
    	return lovDescUnderWritingFormatter;
    }

	public void setLovDescUnderWritingFormatter(int lovDescUnderWritingFormatter) {
    	this.lovDescUnderWritingFormatter = lovDescUnderWritingFormatter;
    }

	public int getLovDescPropFinalTakeFormatter() {
	    return lovDescPropFinalTakeFormatter;
    }

	public void setLovDescPropFinalTakeFormatter(int lovDescPropFinalTakeFormatter) {
	    this.lovDescPropFinalTakeFormatter = lovDescPropFinalTakeFormatter;
    }
