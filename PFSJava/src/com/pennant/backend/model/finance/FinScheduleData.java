...
public class FinScheduleData {
	...
	private List<DefermentHeader> defermentHeaders = new ArrayList<DefermentHeader>(1);
	private List<DefermentDetail> defermentDetails = new ArrayList<DefermentDetail>(1);
