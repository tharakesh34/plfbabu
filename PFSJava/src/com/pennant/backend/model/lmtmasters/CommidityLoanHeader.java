 ...
 *
 */
public class CommidityLoanHeader implements java.io.Serializable {
	...
	@XmlTransient
	private CommidityLoanHeader befImage;
	@XmlTransient
	...
	public CommidityLoanHeader() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("CommidityLoanHeader");
	}

	public CommidityLoanHeader(String id) {
		this.setId(id);
	}

	public Set<String> getExcludeFields(){
		Set<String> excludeFields=new HashSet<String>();
		excludeFields.add("commidityLoanDetails");
	...
	@XmlTransient
	public CommidityLoanHeader getBefImage(){
		return this.befImage;
	}
	
	public void setBefImage(CommidityLoanHeader beforeImage){
	...
	public boolean equals(CommidityLoanHeader loanHeader) {
		return getId() == loanHeader.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof CommidityLoanHeader) {
			CommidityLoanHeader loanHeader = (CommidityLoanHeader) obj;
			return equals(loanHeader);
		}
		return false;
	}
