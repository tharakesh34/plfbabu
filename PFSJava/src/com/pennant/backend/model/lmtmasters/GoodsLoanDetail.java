 ...
 *
 */
public class GoodsLoanDetail implements java.io.Serializable {
	...
	@XmlTransient
	private GoodsLoanDetail befImage;
	@XmlTransient
	...
	private List<GoodsLoanDetail> goodsLoanDetailList=new ArrayList<GoodsLoanDetail>();

	public boolean isNew() {
		return isNewRecord();
	}

	public GoodsLoanDetail() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("GoodsLoanDetail");
	}

	public GoodsLoanDetail(String id) {
		this.setId(id);
	}
	...
	@XmlTransient
	public GoodsLoanDetail getBefImage(){
		return this.befImage;
	}
	
	public void setBefImage(GoodsLoanDetail beforeImage){
	...
	public boolean equals(GoodsLoanDetail goodsLoanDetail) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof GoodsLoanDetail) {
			GoodsLoanDetail goodsLoanDetail = (GoodsLoanDetail) obj;
			return equals(goodsLoanDetail);
		}
		return false;
	}

	public void setGoodsLoanDetailList(List<GoodsLoanDetail> goodsLoanDetailList) {
	    this.goodsLoanDetailList = goodsLoanDetailList;
    }

	public List<GoodsLoanDetail> getGoodsLoanDetailList() {
