 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CustomerQDE.java                                                   * 	  
 *                                                                    						*
 * Author      		:  PENNANT TECHONOLOGIES              									*
 *                                                                  						*
 * Creation Date    :  29-07-2011    														*
 *                                                                  						*
 * Modified Date    :  29-07-2011    														*
 *                                                                  						*
 * Description 		:                                             							*
 *                                                                                          *
 ********************************************************************************************
...
public class CustomerQDE {
	...
	public CustomerQDE(String custCIF,String custCoreBank,String custCtgCode,String lovDescCustCtgCodeName,String custTypeCode,String lovDescCustTypeCodeName,
			String custSalutationCode,String lovDescCustSalutationCodeName,String custFName,String custMName,String custLName,
			String custShrtName,Date custDOB,String custPassportNo,String custTradeLicenceNum,String custVisaNum, String custParentCountry,
