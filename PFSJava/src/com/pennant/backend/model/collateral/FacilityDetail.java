 ...
 *
 */
public class FacilityDetail implements java.io.Serializable {
	...
	private String facilityCCYName;
	...
	private int totalFacilityFormatter = 0;
	private int underWritingFormatter = 0;
	private int propFinalTakeFormatter = 0;
	
	private String totalFacilityCcyName = "";
	private String underWritingCcyName = "";
	private String propFinalTakeCcyName = "";
	...
	public FacilityDetail() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("FacilityDetail");
	}
	...
	public String getFacilityCCYName() {
    	return facilityCCYName;
    }

	public void setFacilityCCYName(String facilityCCYName) {
    	this.facilityCCYName = facilityCCYName;
    }
	...
	public boolean equals(FacilityDetail facilityDetail) {
		return getId() == facilityDetail.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof FacilityDetail) {
			FacilityDetail facilityDetail = (FacilityDetail) obj;
			return equals(facilityDetail);
		}
		return false;
	}
	...
	public int getTotalFacilityFormatter() {
    	return totalFacilityFormatter;
    }

	public void setTotalFacilityFormatter(int totalFacilityFormatter) {
    	this.totalFacilityFormatter = totalFacilityFormatter;
    }

	public int getUnderWritingFormatter() {
    	return underWritingFormatter;
    }

	public void setUnderWritingFormatter(int underWritingFormatter) {
    	this.underWritingFormatter = underWritingFormatter;
    }

	public int getPropFinalTakeFormatter() {
    	return propFinalTakeFormatter;
    }

	public void setPropFinalTakeFormatter(int propFinalTakeFormatter) {
    	this.propFinalTakeFormatter = propFinalTakeFormatter;
    }

	public String getTotalFacilityCcyName() {
    	return totalFacilityCcyName;
    }

	public void setTotalFacilityCcyName(String totalFacilityCcyName) {
    	this.totalFacilityCcyName = totalFacilityCcyName;
    }

	public String getUnderWritingCcyName() {
    	return underWritingCcyName;
    }

	public void setUnderWritingCcyName(String underWritingCcyName) {
    	this.underWritingCcyName = underWritingCcyName;
    }

	public String getPropFinalTakeCcyName() {
    	return propFinalTakeCcyName;
    }

	public void setPropFinalTakeCcyName(String propFinalTakeCcyName) {
    	this.propFinalTakeCcyName = propFinalTakeCcyName;
    }
