...
import com.pennant.equation.process.UploadAccrualDetailsProcess;

public class AccrualPostinServiceEquationImpl implements AccrualPostingService{

	private static Logger logger = Logger.getLogger(AccrualPostinServiceEquationImpl.class);

	protected Map<String,String> descMap = null;
	private UploadAccrualDetailsProcess uploadAccrualDetailsProcess;
	...
	public List<ReturnDataSet> doAccrualPosting(List<ReturnDataSet> setDetails, Date valueDate, String postBranch, 
		...
		try {
			coreBankPostingDetails = getUploadAccrualDetailsProcess().doUploadAccruals(coreBankPostingDetails, valueDate, postBranch, isDummy);
		}catch (Exception e) {
			throw e;
		}
	...
	public UploadAccrualDetailsProcess getUploadAccrualDetailsProcess() {
		return uploadAccrualDetailsProcess;
	}

	public void setUploadAccrualDetailsProcess(UploadAccrualDetailsProcess uploadAccrualDetailsProcess) {
		this.uploadAccrualDetailsProcess = uploadAccrualDetailsProcess;
	}
