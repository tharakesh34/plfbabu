...
public class CERSAIDownloadProcess {
	...
	public void generateAddReport() throws IOException {
		...
		try {
			...
			List<String> collateralList = cersaiService.getotalRecords(CersaiConstants.ADD);

			totalRecords = collateralList.size();

			CersaiHeader ch = cersaiService.processFileHeader(totalRecords, CersaiConstants.ADD);
			...
			fileInfo.setDownloadType(CersaiConstants.ADD);
	...
	public void generateModifyReport() throws IOException {
		...
		try {
			...
			CersaiHeader ch = cersaiService.processFileHeader(totalRecords, CersaiConstants.MODIFY);
			...
			fileInfo.setRemarks(updateRemarks());
			fileInfo.setFileLocation(filePath);
			fileInfo.setDownloadType(CersaiConstants.MODIFY);
	...
	public void generateSatisfactionReport() throws IOException {
		...
		try {
			...
			List<String> collateralList = cersaiService.getSatisfyingRecords(CersaiConstants.SATISFY);

			totalRecords = collateralList.size();

			CersaiHeader ch = cersaiService.processFileHeader(totalRecords, CersaiConstants.SATISFY);
			...
			fileInfo.setFileLocation(filePath);
			fileInfo.setRemarks(updateRemarks());
			fileInfo.setDownloadType(CersaiConstants.SATISFY);
