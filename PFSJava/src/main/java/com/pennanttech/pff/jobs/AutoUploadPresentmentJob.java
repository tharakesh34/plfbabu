...
public class AutoUploadPresentmentJob implements Job, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5686556217810115247L;
	private static final Logger logger = LogManager.getLogger(AutoUploadPresentmentJob.class);

	public static final String JOB_ENABLED = SMTParameterConstants.PRESENTMENT_NACH_AUTO_UPLOAD_JOB_ENABLED;
	public static final String JOB_KEY = "PRESENTMENT_NACH_AUTO_UPLOAD_JOB_ENABLED";
	public static final String JOB_KEY_DESCRIPTION = "Presentment NACH Auto Upload Job Enabled";
	public static final String JOB_TRIGGER = "PRESENTMENT_NACH_AUTO_UPLOAD_JOB_TRIGGER";
	private static final String DEFAULT_JOB_FREQUENCY = "0 0/5 * 1/1 * ? *";
	public static final String JOB_FREQUENCY = SMTParameterConstants.PRESENTMENT_NACH_AUTO_UPLOAD_JOB_FREQUENCY;
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		if (SysParamUtil.isAllowed(JOB_ENABLED)) {
			...
			logger.warn("{} Presentment NACH Auto Upload job is disabled", JOB_ENABLED);
		}
