...
public class DisbursementRequestsQueries {
	...
	public static String getSelectAllQuery(DisbursementRequest requestData) {
		...
		sql.append(", PARTNERBANK_ID PARTNER_BANK_ID, PARTNERBANK_CODE PARTNER_BANK_CODE");
		sql.append(", ALWFILEDOWNLOAD ALW_FILE_DOWNLOAD");
	...
	public static String getInsertQuery() {
		...
		sql.append(", CHANNEL, BATCH_ID, AUTO_DOWNLOAD, HEADER_ID, PARTNERBANK_ID)");
		sql.append(" Values (");
		...
		sql.append(", :Channel, :HeaderId, :AutoDownload, :HeaderId, :PartnerBankId)");
