package com.pennant.pff.courierdetailupload.dao.impl;
...
public class CourierDetailUploadDAOImpl extends SequenceDao<CourierDetailUpload> implements CourierDetailUploadDAO {
	...
	public List<CourierDetailUpload> getDetails(long headerID) {
		...
		sql.append(" From Courier_Detail_Upload");
	...
	public void update(List<CourierDetailUpload> detailsList) {
		StringBuilder sql = new StringBuilder("Update Courier_Detail_Upload Set");
	...
	public void update(List<Long> headerIds, String errorCode, String errorDesc, int progress) {
		String sql = "Update Courier_Detail_Upload Set Progress = ?, Status = ?, ErrorCode = ?, ErrorDesc = ? Where HeaderId = ?";
	...
	public String getSqlQuery() {
		...
		sql.append(" From Courier_Detail_Upload lcd");
	...
	public Long isFileExist(String reference, String letterType, Date letterDate) {
		String sql = "Select HeaderID From Courier_Detail_Upload  Where FinReference = ? And LetterType = ? And LetterDate = ?";
