...
public class WriteOffUploadDAOImpl extends SequenceDao<WriteOffUploadDetail> implements WriteOffUploadDAO {
	...
	public List<WriteOffUploadDetail> getDetails(long headerID) {
		String sql = "Select HeaderId, Id, FinID, FinReference, Remarks, Progress, ErrorCode, ErrorDesc, Status From WRITEOFF_UPLOAD Where HeaderId = ?";
	...
	public List<String> isDuplicateExists(String reference, long headerID) {
		...
		sql.append(" Select HeaderId From WRITEOFF_UPLOAD");
	...
	public void update(List<WriteOffUploadDetail> detailsList) {
		String sql = "Update WRITEOFF_UPLOAD set FinID = ?, Progress = ?, Status = ?, ErrorCode = ?, ErrorDesc = ? Where ID = ?";
	...
	public void update(List<Long> headerIds, String errorCode, String errorDesc, int progress) {
		String sql = "Update WRITEOFF_UPLOAD set Progress = ?, Status = ?, ErrorCode = ?, ErrorDesc = ? Where HeaderID = ?";
	...
	public void update(WriteOffUploadDetail detail) {
		String sql = "Update WRITEOFF_UPLOAD set Progress = ?, Status = ?, ErrorCode = ?, ErrorDesc = ? Where ID = ?";
	...
	public String getSqlQuery() {
		...
		sql.append(" From WRITEOFF_UPLOAD hu");
	...
	public long saveLog(WriteOffUploadDetail detail, FileUploadHeader header) {
		StringBuilder sql = new StringBuilder("Insert into WRITEOFF_UPLOAD_LOG");
	...
	public String getStatus(String finReference) {
		String sql = "Select Status From WRITEOFF_UPLOAD Where FinReference = ? and Status is null";
	...
	public boolean isInProgress(String finReference, long headerID) {
		...
		sql.append(" From WRITEOFF_UPLOAD wu");
