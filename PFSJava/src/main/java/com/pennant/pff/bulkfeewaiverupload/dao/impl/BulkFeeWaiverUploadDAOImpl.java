...
public class BulkFeeWaiverUploadDAOImpl extends SequenceDao<BulkFeeWaiverUpload> implements BulkFeeWaiverUploadDAO {
	...
	@Override
	public long save(BulkFeeWaiverUpload bfw) {
		StringBuilder sql = new StringBuilder("Insert into FEE_WAIVER_UPLOAD");
		sql.append(" (HeaderId, FinReference, FinTypeCode, WaivedAmount, Remarks)");
		sql.append(" Values(?, ?, ?, ?, ?, ?, ?)");
		...
		try {
			...
			this.jdbcOperations.update(new PreparedStatementCreator() {
				...
				public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
					...
					ps.setLong(++index, bfw.getHeaderId());
					ps.setString(++index, bfw.getReference());
					ps.setString(++index, bfw.getFeeTypeCode());
					ps.setBigDecimal(++index, bfw.getWaivedAmount());
					ps.setString(++index, bfw.getRemarks());
