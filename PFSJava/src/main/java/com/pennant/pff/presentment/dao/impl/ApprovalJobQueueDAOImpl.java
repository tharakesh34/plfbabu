...
public class ApprovalJobQueueDAOImpl extends SequenceDao<BatchJobQueue> implements BatchJobQueueDAO {
	private static final String SEQUENCE_NAME = "SEQ_PRESENTMENT_EXTX_QUEUE";

	public ApprovalJobQueueDAOImpl(DataSource dataSource) {
