package com.pennant.pff.receipt.loanclosureerror;
...
public enum LoanClosureUploadError {
	...
	LCU_01("Fin Reference should not be empty."),

	LCU_02("Fin Reference is not valid."),

	LCU_03("Fin Reference is not in active."),
