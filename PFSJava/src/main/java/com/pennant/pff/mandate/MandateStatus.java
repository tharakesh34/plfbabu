...
public enum MandateStatus {
	...
	public static final String FIN = _FINANCE.code;
	public static final String NEW = _NEW.code;
	public static final String AWAITCON = _AC.code;
	public static final String APPROVED = _APPROVED.code;
	public static final String REJECTED = _REJECTED.code;
	public static final String HOLD = _HOLD.code;
	public static final String RELEASE = _RELEASE.code;
	public static final String CANCEL = _CANCEL.code;
	public static final String INPROCESS = _INPROCESS.code;
	public static final String ACKNOWLEDGE = _ACK.code;
	public static final String ACCEPTED = _ACCEPTED.code;
