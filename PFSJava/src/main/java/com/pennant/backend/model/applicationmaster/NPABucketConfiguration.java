 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NPABucketConfiguration.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-04-2017 * *
...
public class NPABucketConfiguration extends AbstractWorkflowEntity {
	...
	public NPABucketConfiguration() {
		super();
	}

	public NPABucketConfiguration(long id) {
		super();
		this.setId(id);
	}
