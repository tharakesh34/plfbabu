 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScheduleMethod.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * * Modified Date
 * : 12-09-2011 * * Description : * *
 ********************************************************************************************
...
/**
 * Model class for the <b>ScheduleMethod table</b>.<br>
 *
 */
public class ScheduleMethod extends AbstractWorkflowEntity {
	...
	public ScheduleMethod(String id) {
		super();
		this.setId(id);
	}
