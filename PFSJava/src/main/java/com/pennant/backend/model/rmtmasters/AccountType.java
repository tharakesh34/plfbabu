 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AccountType.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified Date :
...
public class AccountType extends AbstractWorkflowEntity {
	...
	public Integer getAcctTypeLevel() {
		return acctTypeLevel;
	}

	public void setAcctTypeLevel(Integer acctTypeLevel) {
