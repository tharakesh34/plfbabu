...
public class PennantJavaUtil {
	...
	public void init() {
		...
		ModuleUtil.register("Academic", new ModuleMapping("Academic", Academic.class, new String[] { "BMTAcademics",
				"BMTAcademics_AView" }, masterWF,
				new String[] { "AcademicLevel", "AcademicDecipline", "AcademicDesc" }, null, 600));

		ModuleUtil.register("LoanPurpose", new ModuleMapping("LoanPurpose", LoanPurpose.class, new String[] {
				"LoanPurposes", "LoanPurposes_AView" }, masterWF,
				new String[] { "LoanPurposeCode", "LoanPurposeDesc" },
				new Object[][] { { "LoanPurposeIsActive", "0", 1 } }, 350));

		ModuleUtil.register("AddressType",
				new ModuleMapping("AddressType", AddressType.class, new String[] { "BMTAddressTypes",
		...
		ModuleUtil.register("BuilderCompany", new ModuleMapping("BuilderCompany", BuilderCompany.class, new String[] {
				"BuilderCompany", "BuilderCompany_AView" }, masterWF, new String[] { "Name", "Segmentation",
				"GroupIdName" }, null, 350));
		...
		ModuleUtil.register("BuilderProjcet", new ModuleMapping("BuilderProjcet", BuilderProjcet.class, new String[] {
				"BuilderProjcet", "BuilderProjcet_AView" }, masterWF,
		...
		ModuleUtil.register("DocumentType", new ModuleMapping("DocumentType", DocumentType.class, new String[] {
				"BMTDocumentTypes", "BMTDocumentTypes_AView" }, masterWF,
		...
		ModuleUtil.register("CustDocumentType", new ModuleMapping("DocumentType", DocumentType.class, new String[] {
				...
				new String[] { "DocTypeCode", "DocTypeDesc" }, new Object[][] { { "DocTypeIsActive", "0", 1 },
						{ "CategoryCode", "0", DocumentCategories.CUSTOMER.getKey() } }, 350));
		...
		ModuleUtil.register("GeneralDepartment", new ModuleMapping("GeneralDepartment", GeneralDepartment.class,
				new String[] { "RMTGenDepartments", "RMTGenDepartments_AView" }, masterWF, new String[] {
						"GenDepartment", "GenDeptDesc" }, new Object[][] { { "GenDeptIsActive", "0", 1 } }, 300));
		...
		ModuleUtil.register("GeneralDesignation", new ModuleMapping("GeneralDesignation", GeneralDesignation.class,
				new String[] { "RMTGenDesignations", "RMTGenDesignations_AView" }, masterWF, new String[] {
						"GenDesignation", "GenDesgDesc" }, new Object[][] { { "GenDesgIsActive", "0", 1 } }, 350));
		...
		ModuleUtil.register("IncomeType", new ModuleMapping("IncomeType", IncomeType.class, new String[] {
				"BMTIncomeTypes", "BMTIncomeTypes_AView" }, masterWF, new String[] { "IncomeTypeCode",
				"IncomeTypeDesc", "lovDescCategoryName", "IncomeExpense" }, new Object[][] { { "IncomeTypeIsActive",
				"0", 1 } }, 500));
		...
		ModuleUtil.register("LovFieldDetail", new ModuleMapping("LovFieldDetail", LovFieldDetail.class, new String[] {
				"RMTLovFieldDetail", "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCode",
				"FieldCodeValue", "ValueDesc" }, null, 300));

		ModuleUtil
				.register("MaritalStatusCode", new ModuleMapping("MaritalStatusCode", MaritalStatusCode.class,
						new String[] { "BMTMaritalStatusCodes", "BMTMaritalStatusCodes_AView" }, masterWF,
						new String[] { "MaritalStsCode", "MaritalStsDesc" }, new Object[][] { { "MaritalStsIsActive",
								"0", 1 } }, 300));
		...
		ModuleUtil.register("PRelationCode", new ModuleMapping("PRelationCode", PRelationCode.class, new String[] {
				"BMTPRelationCodes", "BMTPRelationCodes_AView" }, masterWF, new String[] { "PRelationCode",
				"PRelationDesc" }, new Object[][] { { "RelationCodeIsActive", "0", 1 } }, 300));

		ModuleUtil.register("Profession", new ModuleMapping("Profession", Profession.class, new String[] {
				"BMTProfessions", "BMTProfessions_AView" }, masterWF,
		...
		ModuleUtil.register("Salutation", new ModuleMapping("Salutation", Salutation.class, new String[] {
				"BMTSalutations", "BMTSalutations_AView" }, masterWF,
		...
		ModuleUtil.register("SubSegment", new ModuleMapping("SubSegment", SubSegment.class, new String[] {
				"BMTSubSegments", "BMTSubSegments_AView" }, masterWF,
				new String[] { "SubSegmentCode", "SubSegmentDesc" },
				new Object[][] { { "SubSegmentIsActive", "0", 1 } }, 500));

		ModuleUtil.register("Caste", new ModuleMapping("Caste", Caste.class, new String[] { "Caste", "Caste_AView" },
				masterWF, new String[] { "CasteCode", "CasteDesc" }, new Object[][] { { "CasteIsActive", "0", 1 } },
				400));

		ModuleUtil.register("Religion", new ModuleMapping("Religion", Religion.class, new String[] { "Religion",
				"Religion_AView" }, masterWF, new String[] { "ReligionCode", "ReligionDesc" }, new Object[][] { {
				"Active", "0", 1 } }, 400));
		...
		ModuleUtil.register("ReasonTypes", new ModuleMapping("ReasonTypes", ReasonTypes.class, new String[] {
				"ReasonTypes", "ReasonTypes_AView" }, masterWF, new String[] { "Code", "Description" }, null, 600));

		ModuleUtil.register("ReasonCategory",
				new ModuleMapping("ReasonCategory", ReasonCategory.class, new String[] { "ReasonCategory",
		...
		ModuleUtil.register("AccountTypeGroup", new ModuleMapping("AccountTypeGroup", AccountTypeGroup.class,
				new String[] { "AccountTypeGroup", "AccountTypeGroup_AView" }, acnTypeGrps_WF, new String[] {
						"GroupCode", "GroupDescription" }, new Object[][] { { "GroupIsActive", "0", 1 } }, 400));

		ModuleUtil.register("Mandate", new ModuleMapping("Mandate", Mandate.class, new String[] { "Mandates",
				"Mandates_AView" }, manadateWF, new String[] { "MandateID", "BankCode", "BankName", "BranchCode",
				"BranchDesc", "MICR", "IFSC" }, null, 750));

		ModuleUtil
				.register("MandateStatus", new ModuleMapping("MandateStatus", MandateStatus.class, new String[] {
						"MandatesStatus", "MandatesStatus_View" }, masterWF, new String[] { "MandateID", "Status" },
						null, 300));

		ModuleUtil.register("PartnerBank", new ModuleMapping("PartnerBank", PartnerBank.class, new String[] {
				"PartnerBanks", "PartnerBanks_AView" }, masterWF,
		...
		ModuleUtil.register("PinCode", new ModuleMapping("PinCode", PinCode.class, new String[] { "PinCodes",
				"PinCodes_AView" }, masterWF, new String[] { "PinCode", "AreaName", "City", "PCCityName", "PCProvince",
				"LovDescPCProvinceName", "Gstin", "LovDescPCCountryName" }, new Object[][] { { "Active", "0", 1 } },
				700));

		ModuleUtil.register("PartnerBankModes", new ModuleMapping("PartnerBankModes", PartnerBankModes.class,
				new String[] { "PartnerBankModes", "PartnerBankModes_AView" }, masterWF, new String[] {
						"PartnerBankCode", "PartnerBankName" }, null, 300));

		ModuleUtil.register("FinTypePartnerBank", new ModuleMapping("FinTypePartnerBank", FinTypePartnerBank.class,
				new String[] { "FinTypePartnerBanks", "FinTypePartnerBanks_AView" }, masterWF, new String[] {
						"FinType", "Purpose", "PaymentMode", "PartnerBankID" }, null, 300));
		...
		ModuleUtil.register("BankBranch", new ModuleMapping("BankBranch", BankBranch.class, new String[] {
				...
				"BankCode", "BankName", "MICR", "IFSC", "city" }, null, 1200));
		...
		ModuleUtil.register("BaseRate", new ModuleMapping("BaseRate", BaseRate.class, new String[] { "RMTBaseRates",
				"RMTBaseRates_AView" }, masterWF, new String[] { "BRType", "Currency", "BREffDate" },
		...
		ModuleUtil.register("Currency", new ModuleMapping("Currency", Currency.class, new String[] { "RMTCurrencies",
				"RMTCurrencies_AView" }, masterWF, new String[] { "CcyCode", "CcyDesc", "CcyNumber" },
		...
		ModuleUtil.register("CustomerCategory", new ModuleMapping("CustomerCategory", CustomerCategory.class,
				new String[] { "BMTCustCategories", "BMTCustCategories_AView" }, masterWF, new String[] {
						"CustCtgCode", "CustCtgDesc" }, new Object[][] { { "CustCtgIsActive", "0", 1 } }, 400));
		...
		ModuleUtil.register("CustomerNotesType", new ModuleMapping("CustomerNotesType", CustomerNotesType.class,
				new String[] { "BMTCustNotesTypes", "BMTCustNotesTypes_AView" }, masterWF, new String[] {
						"CustNotesTypeCode", "CustNotesTypeDesc" },
		...
		ModuleUtil.register("CustomerStatusCode", new ModuleMapping("CustomerStatusCode", CustomerStatusCode.class,
				new String[] { "BMTCustStatusCodes", "BMTCustStatusCodes_AView" }, masterWF, new String[] {
						"CustStsCode", "CustStsDescription" }, new Object[][] { { "CustStsIsActive", "0", 1 } }, 300));

		ModuleUtil.register("FeeType", new ModuleMapping("FeeType", FeeType.class, new String[] { "FeeTypes",
				"FeeTypes_AView" }, masterWF, new String[] { "FeeTypeCode", "FeeTypeDesc" }, new Object[][] { {
				"Active", "0", 1 } }, 300));
		...
		ModuleUtil.register("TransactionCode", new ModuleMapping("TransactionCode", TransactionCode.class,
				new String[] { "BMTTransactionCode", "BMTTransactionCode_AView" }, transactionCodes_WF, new String[] {
						"TranCode", "TranDesc" }, new Object[][] { { "TranIsActive", "0", 1 } }, 300));
		...
		ModuleUtil.register("VesselDetail", new ModuleMapping("VesselDetail", VesselDetail.class, new String[] {
				"VesselDetails", "VesselDetails_AView" }, masterWF, new String[] { "VesselTypeID", "VesselSubType" },
				null, 300));
		...
		ModuleUtil.register("PresentmentReasonCode", new ModuleMapping("PresentmentReasonCode",
				PresentmentReasonCode.class, new String[] { "PresentmentReasonCode", "PresentmentReasonCode_AView" },
				masterWF, new String[] { "Code", "Description" }, null, 300));
		ModuleUtil.register("FinanceStatusCode", new ModuleMapping("FinanceStatusCode", FinanceStatusCode.class,
				new String[] { "FINANCESTATUSCODES", "FINANCESTATUSCODES_AView" }, masterWF, new String[] {
						"StatusCode", "StatusDesc" }, null, 300));
		ModuleUtil.register("NPABucketConfiguration", new ModuleMapping("NPABucketConfiguration",
				NPABucketConfiguration.class, new String[] { "NPABUCKETSCONFIG", "NPABUCKETSCONFIG_AView" }, masterWF,
				new String[] { "ConfigID", "DueDays" }, null, 300));
		ModuleUtil.register("DPDBucketConfiguration", new ModuleMapping("DPDBucketConfiguration",
				DPDBucketConfiguration.class, new String[] { "DPDBUCKETSCONFIG", "DPDBUCKETSCONFIG_AView" }, masterWF,
				new String[] { "ConfigID", "DueDays" }, null, 300));
		ModuleUtil.register("Entities", new ModuleMapping("Entities", Entities.class, new String[] { "Entities",
				"Entities_AView" }, masterWF, new String[] { "EntityCode", "EntityDesc" }, new Object[][] { { "Active",
				0, 1 } }, 300));
		ModuleUtil.register("Entity", new ModuleMapping("Entity", Entity.class,
				new String[] { "Entity", "Entity_AView" }, masterWF, new String[] { "EntityCode", "EntityDesc" },
				new Object[][] { { "Active", "0", 1 } }, 600));

		ModuleUtil.register("MandateCheckDigit", new ModuleMapping("MandateCheckDigit", MandateCheckDigit.class,
				new String[] { "MandateCheckDigits", "MandateCheckDigits_AView" }, masterWF, new String[] {
						"CheckDigitValue", "LookUpValue", "Active" }, null, 600));

		ModuleUtil.register("ManualDeviation", new ModuleMapping("ManualDeviation", ManualDeviation.class,
				new String[] { "ManualDeviations", "ManualDeviations_AView" }, masterWF, new String[] { "Code",
						"Description" }, new Object[][] { { "Active", "0", 1 } }, 500));
		...
		ModuleUtil.register("VASProviderAccDetail", new ModuleMapping("VASProviderAccDetail",
				VASProviderAccDetail.class, new String[] { "VASProviderAccDetail", "VASManufacturerAccDetail_AView" },
				masterWF, new String[] { "EntityCode", "BankCode", "ProviderId", "PaymentMode", "BankBranchID",
						"AccountNumber", "ReceivableAdjustment", "ReconciliationAmount", "Active" }, null, 600));
		ModuleUtil.register("InstrumentwiseLimit", new ModuleMapping("InstrumentwiseLimit", InstrumentwiseLimit.class,
				new String[] { "InstrumentwiseLimit", "InstrumentwiseLimit_AView" }, masterWF, new String[] {
						"InstrumentMode", "PaymentMinAmtperTrans", "PaymentMaxAmtperTran", "PaymentMaxAmtperDay",
						"ReceiptMinAmtperTran", "ReceiptMaxAmtperTran", "ReceiptMaxAmtperDay" }, null, 600));
		...
		ModuleUtil.register("CustomerBankInfo", new ModuleMapping("CustomerBankInfo", CustomerBankInfo.class,
				new String[] { "CustomerBankInfo", "CustomerBankInfo_AView" }, null, new String[] { "CustID",
						"bankName" }, null, 300));
		ModuleUtil.register("CustomerGST", new ModuleMapping("CustomerGST", CustomerGST.class, new String[] {
				"CustomerGST", "CustomerGST_AView" }, null, new String[] { "gstNumber" }, null, 300));
		...
		ModuleUtil.register("CustomerIncome", new ModuleMapping("CustomerIncome", CustomerIncome.class, new String[] {
				"income_details", "income_details_aview" }, null, new String[] { "custId", "income" }, null, 300));
		...
		ModuleUtil.register("Beneficiary", new ModuleMapping("Beneficiary", Beneficiary.class, new String[] {
				"Beneficiary", "Beneficiary_AView" }, benficiaryWF, new String[] { "BeneficiaryId", "CustID" }, null,
				300));
		ModuleUtil.register("BeneficiaryEnquiry", new ModuleMapping("Beneficiary", Beneficiary.class, new String[] {
				"Beneficiary", "Beneficiary_AView" }, masterWF, new String[] { "CustCIF", "BankName", "BranchDesc",
				"City", "AccNumber", "AccHolderName" }, null, 500));

		/************* Rules Factory *************/

		ModuleUtil.register("AccountingSet", new ModuleMapping("AccountingSet", AccountingSet.class, new String[] {
				"RMTAccountingSet", "RMTAccountingSet_AView" }, acntingSet_WF, new String[] { "EventCode",
				"AccountSetCode", "AccountSetCodeName" }, null, 600));
		...
		ModuleUtil.register("FinTypeAccounting", new ModuleMapping("FinTypeAccounting", FinTypeAccounting.class,
				new String[] { "FinTypeAccounting", "FinTypeAccounting_AView" }, masterWF, new String[] { "FinType",
						"Event", "lovDescEventAccountingName" }, null, 600));
		...
		ModuleUtil.register("Rule", new ModuleMapping("Rule", Rule.class, new String[] { "Rules", "Rules_AView" },
				limitconfigWF, new String[] { "RuleCode", "RuleCodeDesc" }, new Object[][] { { "Active", "0", 1 } },
				400));
		...
		ModuleUtil.register("FinTypeExpense", new ModuleMapping("FinTypeExpense", FinTypeExpense.class, new String[] {
				"FinTypeExpenses", "FinTypeExpenses_AView" }, null, new String[] { "FinType", "ExpenseTypeCode" },
				null, 600));

		/************* Solution Factory *************/

		ModuleUtil.register("AccountType", new ModuleMapping("AccountType", AccountType.class, new String[] {
				"RMTAccountTypes", "RMTAccountTypes_AView" }, acnTypes_WF, new String[] { "AcType", "AcTypeDesc" },
				new Object[][] { { "AcTypeIsActive", "0", 1 } }, 400));

		ModuleUtil.register("AssetType", new ModuleMapping("AssetType", AssetType.class, new String[] { "AssetTypes",
				"AssetTypes_AView" }, masterWF, new String[] { "AssetType", "AssetDesc" }, null, 400));

		ModuleUtil
				.register("CustomerType", new ModuleMapping("CustomerType", CustomerType.class, new String[] {
						"RMTCustTypes", "RMTCustTypes_AView" }, masterWF,
						new String[] { "CustTypeCode", "CustTypeDesc" }, new Object[][] {
								{ "CustTypeIsActive", "0", 1 }, { "CustTypeCode", "1", PennantConstants.NONE } }, 500));

		ModuleUtil.register("CustomerGroup", new ModuleMapping("CustomerGroup", CustomerGroup.class, new String[] {
				"CustomerGroups", "CustomerGroups_AView" }, customerWF, new String[] { "CustGrpCode", "CustGrpDesc" },
		...
		ModuleUtil.register("ProcessEditor", new ModuleMapping("ProcessEditorDetail", ProcessEditorDetail.class,
				new String[] { "ProcessEditorDetail" }, masterWF, new String[] { "ModuleName", "ModuleDesc" }, null,
				300));

		ModuleUtil
				.register("LimitCodeDetail", new ModuleMapping("LimitCodeDetail", LimitCodeDetail.class, new String[] {
						"LimitCodeDetail", "" }, masterWF, new String[] { "LimitCode", "LimitDesc" }, null, 300));
		...
		ModuleUtil
				.register("DedupFields", new ModuleMapping("DedupFields", DedupFields.class, new String[] {
						"DedupFields", "DedupFields_View" }, masterWF, new String[] { "FieldName", "FieldControl" },
						null, 300));
		...
		ModuleUtil.register("FinanceWorkFlow", new ModuleMapping("FinanceWorkFlow", FinanceWorkFlow.class,
				new String[] { "LMTFinanceWorkFlowDef", "LMTFinanceWorkFlowDef_FTView" }, masterWF, new String[] {
						"LovDescProductCodeName", "FinType", "LovDescFinTypeName" }, new Object[][] {
						{ "ModuleName", "0", "FINANCE" }, { "FinIsActive", "0", 1 } }, 600));
		...
		ModuleUtil.register("CollateralWorkFlow", new ModuleMapping("FinanceWorkFlow", FinanceWorkFlow.class,
				new String[] { "LMTFinanceWorkFlowDef", "LMTFinanceWorkFlowDef_AView" }, masterWF, new String[] {
						"TypeCode", "CollateralDesc" }, new Object[][] { { "ModuleName", "0", "COLLATERAL" },
						{ "FinIsActive", "0", 1 } }, 300));

		ModuleUtil.register("CommitmentWorkFlow", new ModuleMapping("FinanceWorkFlow", FinanceWorkFlow.class,
				new String[] { "LMTFinanceWorkFlowDef", "LMTFinanceWorkFlowDef_AView" }, masterWF, new String[] {
						"TypeCode", "CommitmentTypeDesc" }, new Object[][] { { "ModuleName", "0", "COMMITMENT" },
						{ "FinIsActive", "0", 1 } }, 300));
		...
		ModuleUtil.register("FinanceType", new ModuleMapping("FinanceType", FinanceType.class, new String[] {
				"RMTFinanceTypes", "RMTFinanceTypes_AView" }, masterWF, new String[] { "FinType", "FinCategory",
				"FinTypeDesc" }, new Object[][] { { "FinIsActive", "0", 1 }, { "Product", "0", "" } }, 600));
		...
		ModuleUtil.register("HolidayMaster", new ModuleMapping("HolidayMaster", HolidayMaster.class, new String[] {
				"SMTHolidayMaster", "SMTHolidayMaster_AView" }, masterWF,
		...
		ModuleUtil.register("WeekendMaster", new ModuleMapping("WeekendMaster", WeekendMaster.class, new String[] {
				"SMTWeekendMaster", "SMTWeekendMaster_AView" }, masterWF,
		...
		ModuleUtil.register("FinanceEnquiry", new ModuleMapping("FinanceEnquiry", FinanceEnquiry.class, new String[] {
				"FinanceEnquiry", "FinanceEnquiry" }, null, new String[] { "FinReference", "FinType" }, null, 300));
		...
		ModuleUtil.register("VASWorkFlow", new ModuleMapping("FinanceWorkFlow", FinanceWorkFlow.class, new String[] {
				"LMTFinanceWorkFlowDef", "LMTFinanceWorkFlowDef_AView" }, masterWF, new String[] { "TypeCode",
				"VasProductDesc" }, new String[][] { { "ModuleName", "0", "VAS" } }, 600));
		...
		ModuleUtil.register("VASProductType", new ModuleMapping("VASProductType", VASProductType.class, new String[] {
				"VASProductType", "VasProductType_AView" }, masterWF,
				new String[] { "ProductType", "ProductTypeDesc" }, null, 300));

		ModuleUtil.register("Promotion", new ModuleMapping("Promotions", Promotion.class, new String[] { "Promotions",
				"Promotions_AView" }, masterWF, new String[] { "PromotionCode", "PromotionDesc" }, null, 300));

		ModuleUtil.register("CDScheme", new ModuleMapping("Promotions", Promotion.class, new String[] { "Promotions",
				"Promotions_AView" }, masterWF, new String[] { "PromotionCode", "PromotionDesc", "ReferenceID" }, null,
				300));

		ModuleUtil.register("ProductDeviation", new ModuleMapping("ProductDeviation", ProductDeviation.class,
				new String[] { "ProductDeviations", "ProductDeviations_AView" }, null, new String[] { "DeviationCode",
						"DeviationDesc" }, null, 300));
		...
		ModuleUtil.register("NOCFinanceMain", new ModuleMapping("FinanceMain", FinanceMain.class, new String[] {
		...
		ModuleUtil.register("FinanceMaintenance",
				new ModuleMapping("FinanceMain", FinanceMain.class, new String[] { "FinanceMain",
						"FinanceMaintenance_View" }, null, new String[] { "FinReference", "FinType" }, null, 350));
		...
		ModuleUtil.register("PreAppeovedFinance", new ModuleMapping("FinanceMain", FinanceMain.class, new String[] {
				"FinanceMain_PA", "FinanceMain_PA" }, masterWF, new String[] { "FinReference", "FinType",
				"FinStartDate" }, null, 700));
		...
		ModuleUtil.register("HoldDisbursement", new ModuleMapping("HoldDisbursement", HoldDisbursement.class,
				new String[] { "HoldDisbursement", "HoldDisbursement_AView" }, masterWF, new String[] { "FinReference",
						"Hold", "TotalLoanAmt", "DisbursedAmount", "HoldLimitAmount" }, null, 600));
		...
		ModuleUtil.register("Commitment", new ModuleMapping("Commitment", Commitment.class, new String[] {
				"Commitments", "Commitments_AView" }, facilityCommitWF, new String[] { "CmtReference", "CustCIF",
				"CustShrtName", "CmtTitle", "CmtAmountExt", "CmtUtilizedAmountExt", "CmtAvailableExt" }, null, 900));
		...
		ModuleUtil.register("CommitmentRate", new ModuleMapping("CommitmentRates", CommitmentRate.class, new String[] {
				"CommitmentRates", "CommitmentRates_AView" }, facilityCommitWF,
				new String[] { "CmtRvwFrq", "CmtRvwFrq" }, null, 300));

		ModuleUtil.register("CommitmentType", new ModuleMapping("CommitmentType", CommitmentType.class, new String[] {
				"CommitmentType", "" }, masterWF, new String[] { "TypeCode", "Description" }, null, 300));

		ModuleUtil.register("CMTLimitLine", new ModuleMapping("LimitDetails", LimitDetails.class, new String[] {
				"LimitDetails", "LimitDetails_AView" }, masterWF, new String[] { "DetailId", "LimitLine" }, null, 400));
		...
		ModuleUtil.register("JVPostingEntry", new ModuleMapping("JVPostingEntry", JVPostingEntry.class, new String[] {
				"JVPostingEntry", "JVPostingEntry_AView" }, "MISC_POST", new String[] { "BatchReference", "Account" },
				null, 300));
		/************* FEE Postings *************/

		ModuleUtil.register("FeePostings", new ModuleMapping("FeePostings", FeePostings.class, new String[] {
				"FeePostings", "FeePostings_AView" }, "FEE_POSTING", new String[] { "PostId", "PostAgainst",
				"Reference" }, null, 300));
		...
		ModuleUtil.register("FinReceiptHeader", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, realizationWF, new String[] { "ReceiptID", "ReceiptPurpose" },
				null, 300));

		ModuleUtil.register("FinReceiptDetail", new ModuleMapping("FinReceiptDetail", FinReceiptDetail.class,
				new String[] { "FinReceiptDetail", "RECEIPTDETAILS_TVIEW" }, ReceiptProcessWF, new String[] {
						"ReceiptID", "ReceiptSeqID", "ReceiptPurpose" }, null, 300));

		ModuleUtil.register("ReceiptRealization", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, realizationWF, new String[] { "ReceiptID", "ReceiptPurpose" },
				null, 300));

		ModuleUtil.register("FeeReceipt", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, feeReceiptWF, new String[] { "ReceiptID", "ReceiptPurpose" },
				null, 300));

		ModuleUtil.register("ReceiptBounce", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, receiptBounceWF, new String[] { "ReceiptID", "ReceiptPurpose" },
				null, 300));

		ModuleUtil.register("ReceiptCancellation", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, receiptCancelWF, new String[] { "ReceiptID", "ReceiptPurpose" },
				null, 300));

		ModuleUtil.register("ReceiptKnockOffCancel", new ModuleMapping("FinReceiptHeader", FinReceiptHeader.class,
				new String[] { "FinReceiptHeader" }, receiptKnockOffCancelWF, new String[] { "ReceiptID",
						"ReceiptPurpose" }, null, 300));
		...
		ModuleUtil.register("FinFlagsDetail", new ModuleMapping("FinFlagsDetail", FinFlagsDetail.class, new String[] {
				"FlagDetails", "FlagDetails_View" }, masterWF, new String[] { "Reference", "FlagCode" }, null, 300));

		ModuleUtil.register("FinTypeVASProducts", new ModuleMapping("FinTypeVASProducts", FinTypeVASProducts.class,
				new String[] { "FinTypeVASProducts", "FinTypeVASProducts_View" }, masterWF, new String[] { "FinType",
						"VasProduct" }, null, 300));
		...
		ModuleUtil.register("FinanceTaxDetail", new ModuleMapping("FinanceTaxDetail", FinanceTaxDetail.class,
				new String[] { "FinTaxDetail", "FinTaxDetail_AView" }, GST_WF, new String[] { "FinReference",
						"ApplicableFor", "TaxExempted", "TaxNumber", "City", "PinCode" }, null, 600));

		ModuleUtil.register("FinTaxUploadHeader", new ModuleMapping("FinTaxUploadHeader", FinTaxUploadHeader.class,
				new String[] { "FinTaxUploadHeader", "FinTaxUploadHeader_AView" }, gstFileUplod, new String[] {
						"batchReference", "taxCode" }, null, 300));

		ModuleUtil.register("FinTaxUploadDetail", new ModuleMapping("FinTaxUploadDetail", FinTaxUploadDetail.class,
				new String[] { "FinTaxUploadDetail", "FinTaxUploadDetail_AView" }, gstFileUplod, new String[] {
						"batchReference", "taxCode" }, null, 300));

		ModuleUtil.register("FinMaintainInstruction", new ModuleMapping("FinMaintainInstruction",
				FinMaintainInstruction.class,
		...
		ModuleUtil.register("FinAgreementDetail", new ModuleMapping("FinAgreementDetail", FinAgreementDetail.class,
				new String[] { "FinAgreementDetail", "FinAgreementDetail_AView" }, masterWF, new String[] {
						"FinReference", "AgrName" }, null, 300));
		...
		ModuleUtil.register("BulkProcessHeader", new ModuleMapping("BulkProcessHeader", BulkProcessHeader.class,
				new String[] { "BulkProcessHeader", "BulkProcessHeader" }, masterWF, new String[] { "BulkProcessID",
						"FromDate" }, null, 300));
		...
		ModuleUtil.register("FinCollaterals", new ModuleMapping("FinCollaterals", FinCollaterals.class, new String[] {
				"FinCollaterals", "FinCollaterals_AView" }, masterWF,
		...
		ModuleUtil.register("MGRCHQFinanceMain", new ModuleMapping("FinanceMain", FinanceMain.class, new String[] {
				"FinanceMain", "FinanceMain_AView" }, null,
				new String[] { "FinReference", "FinType", "LovDescCustCIF" }, null, 400));
		...
		ModuleUtil.register("ExtendedFieldHeader", new ModuleMapping("ExtendedFieldHeader", ExtendedFieldHeader.class,
				new String[] { "ExtendedFieldHeader", "ExtendedFieldHeader_AView" }, masterWF, new String[] {
						"ModuleId", "TabHeading" }, null, 300));
		...
		ModuleUtil.register("ScheduleMethod", new ModuleMapping("ScheduleMethod", ScheduleMethod.class, new String[] {
				"BMTSchdMethod", "BMTSchdMethod_AView" }, masterWF, new String[] { "SchdMethod", "SchdMethodDesc" },
				null, 300));
		...
		ModuleUtil.register("SecurityUserDivBranch", new ModuleMapping("SecurityUserDivBranch",
				...
				null, null, 300));
		ModuleUtil.register("UserDivBranch", new ModuleMapping("UserDivBranch", SecurityUserDivBranch.class,
				new String[] { "SecurityUserDivBranch_view" }, null, new String[] { "UserBranch", "UserBranchDesc" },
				null, 300));
		...
		ModuleUtil.register("PFSParameter", new ModuleMapping("PFSParameter", PFSParameter.class, new String[] {
				"SMTparameters", "SMTparameters_AView" }, masterWF, new String[] { "SysParmCode", "SysParmDesc" },
				null, 300));
		...
		ModuleUtil.register("CourseType", new ModuleMapping("CourseType", CourseType.class, new String[] {
				"AMTCourseType", "AMTCourseType_AView" }, masterWF,
		...
		ModuleUtil.register("ExpenseType", new ModuleMapping("ExpenseType", ExpenseType.class, new String[] {
				"ExpenseTypes", "ExpenseTypes_AView" }, masterWF,
		...
		ModuleUtil.register("VASVehicleDealer", new ModuleMapping("VehicleDealer", VehicleDealer.class, new String[] {
				"AMTVehicleDealer", "AMTVehicleDealer_AView" }, masterWF, new String[] { "DealerId", "DealerName",
				"DealerCity" }, null, 500));

		ModuleUtil.register("DMA", new ModuleMapping("DMA", VehicleDealer.class, new String[] { "AMTVehicleDealer",
				"AMTVehicleDealer_AView" }, masterWF, new String[] { "DealerName", "Code" }, new Object[][] {
				{ "DealerType", "0", "DMA" }, { "Active", "0", 1 } }, 350));
		...
		ModuleUtil.register("DSA", new ModuleMapping("DSA", VehicleDealer.class, new String[] { "AMTVehicleDealer",
				"AMTVehicleDealer_AView" }, masterWF, new String[] { "DealerName", "Code" }, new Object[][] {
				{ "DealerType", "0", "DSA" }, { "Active", "0", 1 } }, 350));
		...
		ModuleUtil.register("VehicleModel", new ModuleMapping("VehicleModel", VehicleModel.class, new String[] {
				"AMTVehicleModel", "AMTVehicleModel_AView" }, masterWF, new String[] {
				"lovDescVehicleManufacturerName", "VehicleModelDesc" }, null, 300));
		...
		ModuleUtil.register("ORG_SCHOOL_PRODUCT_TYPES", new ModuleMapping("ProductType", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCode", "FieldCodeValue",
						"ValueDesc" }, new String[][] { { "FieldCode", "0", "ORG_SCHOOL_SERVICES" } }, 300));

		ModuleUtil.register("Authorization", new ModuleMapping("Authorization", Authorization.class, new String[] {
				"AMTAuthorization", "AMTAuthorization_AView" }, masterWF, new String[] { "AuthUserId", "AuthName" },
				null, 300));

		ModuleUtil.register("FacilityType", new ModuleMapping("FacilityType", FacilityType.class, new String[] {
				"RMTFacilityTypes", "RMTFacilityTypes" }, masterWF, new String[] { "FacilityType", "FacilityDesc" },
				null, 300));
		...
		ModuleUtil.register("RejectFinanceMain", new ModuleMapping("FinanceMain", FinanceMain.class, new String[] {
				"RejectFinanceMain", "RejectFinanceMain" }, masterWF, new String[] { "FinReference", "FinType" }, null,
				300));

		ModuleUtil.register("ReinstateFinance", new ModuleMapping("ReinstateFinance", ReinstateFinance.class,
				new String[] { "ReinstateFinance", "ReinstateFinance_View" }, "REINSTATELOAN", new String[] {
						"FinReference", "CustCIF", "FinType" }, null, 300));
		...
		ModuleUtil.register("DocumentDetails", new ModuleMapping("DocumentDetails", DocumentDetails.class,
				new String[] { "DocumentDetails" }, masterWF, new String[] { "DocModule", "DocCategory", "DocType" },
				null, 300));
		...
		ModuleUtil.register("SecurityUserOperationRoles", new ModuleMapping("SecurityUserOperationRoles",
				SecurityUserOperationRoles.class, new String[] { "SecurityUserOperationRoles",
						"UserOperationRoles_View" }, securityWF,
				new String[] { "UsrID", "LovDescFirstName", "RoleCd" }, null, 400));

		ModuleUtil.register("LegalExpenses", new ModuleMapping("LegalExpenses", LegalExpenses.class, new String[] {
				"FinLegalExpenses", "FinLegalExpenses_AView" }, "MSTGRP1", new String[] { "ExpReference",
				"FinReference", "TransactionType" }, null, 390));
		...
		// LIMIT MODULE START
		ModuleUtil.register("LimitFilterQuery", new ModuleMapping("LimitFilterQuery", LimitFilterQuery.class,
		...
		ModuleUtil.register("LimitHeader", new ModuleMapping("LimitHeader", LimitHeader.class, new String[] {
				"LimitHeader", "LimitHeader_AView" }, limitsetupWF, new String[] { "HeaderId", "ResponsibleBranch" },
				new Object[][] { { "Active", "0", 1 } }, 300));
		...
		ModuleUtil.register("LimitDetails", new ModuleMapping("LimitDetails", LimitDetails.class, new String[] {
				"LimitDetails", "LimitDetails_AView" }, "MSTGRP1", new String[] { "DetailId", "LimitGroup" },
				new Object[][] { { "Active", "0", 1 } }, 300));
		...
		ModuleUtil.register("LimitGroup", new ModuleMapping("LimitGroup", LimitGroup.class, new String[] {
				"LimitGroup", "LimitGroup_AView" }, limitconfigWF, new String[] { "GroupCode", "GroupName" },
				new Object[][] { { "Active", "0", 1 } }, 300));
		...
		ModuleUtil.register("LimitStructureDetail", new ModuleMapping("LimitStructureDetail",
				LimitStructureDetail.class, new String[] { "LimitStructureDetails", "LimitStructureDetails_AView" },
				"MSTGRP1", new String[] { "LimitStructureCode", "StructureName" },
				new Object[][] { { "Active", "0", 1 } }, 300));

		ModuleUtil.register("CustomerRebuild", new ModuleMapping("LimitHeader", LimitHeader.class, new String[] {
				"LimitHeader", "LimitHeader_AView" }, null, new String[] { "CustomerId", "CustCIF",
				"LimitStructureCode" }, new String[][] { { "Active", "0", "1" } }, 500));

		ModuleUtil.register("CustomerGrpRebuild", new ModuleMapping("LimitHeader", LimitHeader.class, new String[] {
				"LimitHeader", "LimitHeader_AView" }, null, new String[] { "CustomerGroup", "CustGrpCode",
				"LimitStructureCode" }, new String[][] { { "Active", "0", "1" } }, 500));
		...
		ModuleUtil.register("FinAssetTypes", new ModuleMapping("FinAssetTypes", FinAssetTypes.class, new String[] {
				"FinAssetTypes", "FinAssetTypes" }, null, new String[] { "Reference", "AssetType" }, null, 300));
		...
		ModuleUtil.register("CollateralStructure", new ModuleMapping("CollateralStructure", CollateralStructure.class,
				new String[] { "CollateralStructure", "CollateralStructure_AView" }, masterWF, new String[] {
						"CollateralType", "CollateralDesc" }, null, 300));

		ModuleUtil.register("BMTRBFldDetails", new ModuleMapping("BMTRBFldDetails", CustomerStatusCode.class,
				new String[] { "BMTRBFldDetails", "BMTRBFldDetails" }, null, new String[] { "RBModule", "RBFldName" },
				null, 300));

		/* Vas Configuration */
		ModuleUtil.register("VASConfiguration", new ModuleMapping("VASConfiguration", VASConfiguration.class,
				new String[] { "VasStructure", "VasStructure_AView" }, masterWF, new String[] { "ProductCode",
						"ProductDesc" }, null, 300));

		ModuleUtil.register("VASRecording",
				new ModuleMapping("VASRecording", VASRecording.class, new String[] { "VASRecording",
						"VASRecording_AView" }, VASWF, new String[] { "ProductCode", "ProductDesc" }, null, 300));

		/* Collateral Setup */
		ModuleUtil.register("CollateralSetup", new ModuleMapping("CollateralSetup", CollateralSetup.class,
				new String[] { "CollateralSetup", "CollateralSetup_AView" }, collsetupWWF, new String[] {
						"CollateralRef", "DepositorCif", "CollateralType" }, null, 400));

		/* Coowner Details */
		ModuleUtil.register("CoOwnerDetail", new ModuleMapping("CollateralCoOwners", CollateralSetup.class,
				new String[] { "CollateralCoOwners", "CollateralCoOwners_View" }, masterWF, new String[] {
						"CollateralRef", "CoOwnerId" }, null, 300));
		...
		ModuleUtil.register("InsuranceType", new ModuleMapping("InsuranceType", InsuranceType.class, new String[] {
				"InsuranceType", "InsuranceType_AView" }, masterWF,
		...
		ModuleUtil.register("FinTypeInsurances", new ModuleMapping("FinTypeInsurances", FinTypeInsurances.class,
				new String[] { "FinTypeInsurances", "FinTypeInsurances_View" }, masterWF, new String[] { "PolicyType",
						"PolicyDesc" }, null, 300));

		ModuleUtil.register("FinInsurances", new ModuleMapping("FinInsurances", FinInsurances.class, new String[] {
				"FinInsurances", "FinInsurances_View" }, masterWF,
				new String[] { "InsuranceType", "InsuranceTypeDesc" }, null, 300));

		ModuleUtil.register("InsurancePolicy", new ModuleMapping("InsurancePolicy", InsurancePolicy.class,
				new String[] { "InsurancePolicy", "InsurancePolicy_View" }, masterWF, new String[] { "PolicyCode",
						"PolicyDesc" }, null, 300));

		ModuleUtil.register("InsuranceTypePolicy", new ModuleMapping("InsuranceTypePolicy", InsurancePolicy.class,
				new String[] { "InsurancePolicy", "InsurancePolicy_View" }, masterWF, new String[] { "InsuranceType",
						"InsuranceTypeDesc" }, null, 300));

		ModuleUtil.register("AmountCode", new ModuleMapping("Amountcode", AmountCode.class, new String[] {
				"BMTAmountCodes", "BMTAmountCodes" }, masterWF, new String[] { "AllowedEvent", "AmountCode",
				"AmountCodeDesc" }, new Object[][] { { "AmountCodeIsActive", "0", 1 } }, 300));
		ModuleUtil.register("DisbursementRegistration", new ModuleMapping("DisbursementRegistration",
				FinAdvancePayments.class, new String[] { "INT_DISBURSEMENT_REQUEST_VIEW",
						" INT_DISBURSEMENT_REQUEST_VIEW" }, null, new String[] { "PAYMENTID", "FINREFERENCE" }, null,
				300));

		ModuleUtil.register("MandateRegistration", new ModuleMapping("Mandate", Mandate.class, new String[] {
				"Mandates", "Mandates_AView" }, null, new String[] { "MandateID", "BankCode", "BankName", "BranchCode",
				"BranchDesc", "MICR", "IFSC" }, null, 700));
		...
		ModuleUtil.register("DPDBucket", new ModuleMapping("DPDBucket", DPDBucket.class, new String[] { "DPDBUCKETS",
				"DPDBUCKETS_AView" }, masterWF, new String[] { "BucketCode", "BucketDesc" }, null, 700));

		ModuleUtil.register("NPABucket", new ModuleMapping("NPABucket", NPABucket.class, new String[] { "NPABUCKETS",
				"NPABUCKETS_AView" }, masterWF, new String[] { "BucketCode", "BucketDesc" }, null, 300));

		ModuleUtil.register("ManualAdvise", new ModuleMapping("ManualAdvise", ManualAdvise.class, new String[] {
				"ManualAdvise", "ManualAdvise_AView" }, "MANUAL_ADVICE", new String[] { "AdviseType", "FinReference",
				"FeeTypeID" }, null, 600));
		...
		ModuleUtil.register("BounceReason", new ModuleMapping("BounceReason", BounceReason.class, new String[] {
				"BounceReasons", "BounceReasons_AView" }, masterWF, new String[] { "BounceCode", "Lovdesccategory",
				"Reason" }, new Object[][] { { "Active", "0", 1 } }, 600));

		ModuleUtil.register("ProfitCenter", new ModuleMapping("ProfitCenter", ProfitCenter.class, new String[] {
				"ProfitCenters", "ProfitCenters_AView" }, profitCenters_WF, new String[] { "ProfitCenterCode",
		...
		ModuleUtil.register("CostCenter", new ModuleMapping("CostCenter", CostCenter.class, new String[] {
				"CostCenters", "CostCenters_AView" }, costCenters_WF,
				new String[] { "CostCenterCode", "CostCenterDesc" }, new Object[][] { { "Active", "0", 1 } }, 400));
		/* PresentmentDetail */
		ModuleUtil.register("PresentmentDetail", new ModuleMapping("PresentmentDetail", PresentmentDetail.class,
		...
		ModuleUtil.register("PresentmentDetailDef", new ModuleMapping("PresentmentDetail", PresentmentDetail.class,
				new String[] { "PresentmentDetails", "PresentmentDetails_AView" }, null, new String[] { "FinReference",
						"PresentmentRef" }, null, 400));
		...
		ModuleUtil.register("PresentmentHeader", new ModuleMapping("PresentmentHeader", PresentmentHeader.class,
				new String[] { "PresentmentHeader", "PresentmentHeader_AView" }, PRESENTMENT_BATCH, new String[] {
						"Reference", "PresentmentDate", "PartnerBankId", "FromDate", "ToDate", "Status", "MandateType",
						"LoanType", "FinBranch", "Schdate" }, null, 600));

		ModuleUtil.register("PresentmentExcludeHeader", new ModuleMapping("PresentmentExcludeHeader",
				PresentmentHeader.class, new String[] { "PresentmentHeader", "presentmentexcludehdr_view" }, masterWF,
				new String[] { "Id", "Reference" }, null, 600));

		ModuleUtil.register("AccountMapping", new ModuleMapping("AccountMapping", AccountMapping.class, new String[] {
				"AccountMapping", "AccountMapping_AView" }, hostGLMapping_WF,
		...
		ModuleUtil.register("FinTypePartner", new ModuleMapping("FinTypePartnerBank", FinTypePartnerBank.class,
				new String[] { "FinTypePartnerBanks", "FinTypePartnerBanks_AView" }, masterWF, new String[] {
						"PartnerBankCode", "PartnerBankName" }, null, 450));

		ModuleUtil.register("Locality", new ModuleMapping("Locality", Locality.class, new String[] { "Locality",
				"Locality_AView" }, masterWF, new String[] { "Id", "Name", "City" }, null, 600));
		...
		ModuleUtil.register("PaymentHeader", new ModuleMapping("PaymentHeader", PaymentHeader.class, new String[] {
				"PaymentHeader", "PaymentHeader_AView" }, PaymentWF, new String[] { "PaymentType", "PaymentAmount",
				"ApprovedOn", "Status" }, null, 600));

		ModuleUtil.register("PaymentDetail", new ModuleMapping("PaymentDetail", PaymentDetail.class, new String[] {
				"PaymentDetails", "PaymentDetails_AView" }, masterWF, new String[] { "AmountType", "ReferenceId" },
				null, 600));

		ModuleUtil.register("PaymentInstruction", new ModuleMapping("PaymentInstruction", PaymentInstruction.class,
				new String[] { "PaymentInstructions", "PaymentInstructions_AView" }, masterWF, new String[] {
						"PaymentType", "PaymentAmount", "BankCode", "PaymentCCy" }, null, 600));

		ModuleUtil.register("TaxDetail", new ModuleMapping("TaxDetail", TaxDetail.class, new String[] { "TAXDETAIL",
				"TAXDETAIL_AView" }, masterWF, new String[] { "PCCity", "PCCityName", "CountryCode", "CountryDesc",
				"EntityCode", "EntityDesc", "CPProvince", "CPProvinceName", "ZipCode" }, null, 600));

		ModuleUtil.register("FileBatchStatus", new ModuleMapping("FileBatchStatus", FileBatchStatus.class,
				new String[] { "FileBatchStatus", "FileBatchStatus_AView" }, null, new String[] { "Id", "FileName" },
				null, 600));
		...
		ModuleUtil.register("DocumentDataMapping", new ModuleMapping("DocumentDataMapping", DocumentDataMapping.class,
				new String[] { "DocumentDataMapping", "DocumentDataMapping" }, masterWF, new String[] { "Type",
						"TypeDescription" }, null, 350));

		ModuleUtil.register("PdfDocumentType", new ModuleMapping("PdfDocumentType", DocumentType.class, new String[] {
				"BMTDocumentTypes", "BMTDocumentTypes_AView" }, masterWF,
				new String[] { "DocTypeCode", "DocTypeDesc" }, new Object[][] { { "DocTypeIsActive", "0", 1 } }, 350));

		ModuleUtil.register("ChequeHeader", new ModuleMapping("ChequeHeader", ChequeHeader.class, new String[] {
				"CHEQUEHEADER", "CHEQUEHEADER_AView" }, CHEQUE_WF, new String[] { "FinReference", "ChequeType",
				"NoOfCheques", "TotalAmount" }, null, 600));

		ModuleUtil.register("ChequeDetail", new ModuleMapping("ChequeDetail", ChequeDetail.class, new String[] {
				"CHEQUEDETAIL", "CHEQUEDETAIL_AView" }, masterWF, new String[] { "HeaderID", "BankBranchID",
				"AccountNo", "ChequeSerialNo", "ChequeDate", "ChequeCcy", "Status" }, null, 600));

		ModuleUtil.register("CacheStats", new ModuleMapping("CacheStats", CacheStats.class, new String[] {
				"CACHE_PARAMETERS", "CACHE_PARAMETERS" }, null, new String[] { "" }, null, 600));

		/* Interface Mapping */

		ModuleUtil.register("InterfaceMapping", new ModuleMapping("InterfaceMapping", InterfaceMapping.class,
				new String[] { "InterfaceMapping", "InterfaceMapping_AView" }, collectionWF, new String[] {
						"InterfaceName", "InterfaceField" }, null, 600));

		ModuleUtil.register("InterfaceFields", new ModuleMapping("InterfaceFields", InterfaceFields.class,
				new String[] { "Interface_Fields", "INTERFACE_FIELDs_AVIEW" }, null, new String[] { "InterfaceName",
						"TableName", "MappingType", "Field" }, null, 600));
		...
		ModuleUtil.register("DataEngineStatus", new ModuleMapping("DataEngineStatus", FileBatchStatus.class,
				new String[] { "DataEngineStatus", "DATAENGINESTATUS_AVIEW" }, null, new String[] { "Id", "FileName" },
				null, 600));

		ModuleUtil.register("FeeWaiverHeader", new ModuleMapping("FeeWaiverHeader", FeeWaiverHeader.class,
				new String[] { "FeeWaiverHeader", "FeeWaiverHeader_View" }, feeWaiverWF, new String[] { "WaiverId",
						"FinReference" }, null, 600));

		ModuleUtil.register("FeeWaiverDetail", new ModuleMapping("FeeWaiverDetail", FeeWaiverDetail.class,
				new String[] { "FeeWaiverDetails", "FeeWaiverDetails" }, null, new String[] { "WaiverId",
						"WaivedAmount" }, null, 600));

		ModuleUtil.register("UploadHeader", new ModuleMapping("UploadHeader", UploadHeader.class, new String[] {
				"uploadheader", "UPLOADHEADER_AVIEW" }, masterWF, new String[] { "UploadId", "FileName" }, null, 600));

		ModuleUtil.register("LoanTypeExpenseUpload", new ModuleMapping("UploadHeader", UploadHeader.class,
				new String[] { "UploadHeader", "UploadHeader_LTView" }, null, new String[] { "UploadId", "FileName" },
				null, 600));

		ModuleUtil.register("LoanLevelExpenseUpload", new ModuleMapping("UploadHeader", UploadHeader.class,
				new String[] { "UploadHeader", "UploadHeader_LLView" }, null, new String[] { "UploadId", "FileName" },
				null, 600));

		ModuleUtil.register("LoanTypeExpenseMasterUpload", new ModuleMapping("UploadHeader", UploadHeader.class,
				new String[] { "UploadHeader", "UploadHeader_FTEView" }, null, new String[] { "UploadId", "FileName" },
				null, 600));

		ModuleUtil.register("FinFeeFactorUpload", new ModuleMapping("UploadHeader", UploadHeader.class, new String[] {
				"UploadHeader", "UploadHeader_FFFView" }, null, new String[] { "UploadId", "FileName" }, null, 600));

		ModuleUtil.register("IRRCode", new ModuleMapping("IRRCode", IRRCode.class, new String[] { "IRRCodes",
				"IRRCodes_AView" }, masterWF, new String[] { "IRRID", "IRRCode", "IRRCodeDesc" }, new Object[][] { {
				"Active", "0", 1 } }, 600));

		ModuleUtil.register("IRRFeeType", new ModuleMapping("IRRFeeType", IRRFeeType.class, new String[] {
				"IRRFeeTypes", "IRRFeeTypes_AView" }, masterWF, new String[] { "IRRID", "FeeTypeID", "FeePercentage" },
				null, 600));
		...
		ModuleUtil.register("CostOfFund", new ModuleMapping("CostOfFund", CostOfFund.class, new String[] {
				"CostOfFunds", "CostOfFunds_AView" }, masterWF, new String[] { "CofCode", "CofRate" },
				new String[][] { { "Active", "0", "1" } }, 300));

		ModuleUtil.register("IRRFinanceType", new ModuleMapping("IRRFinanceTypes", IRRFinanceType.class, new String[] {
				"IRRFinanceTypes", "IRRFinanceTypes_AView" }, masterWF, new String[] { "finType" }, null, 500));

		ModuleUtil.register("Verification", new ModuleMapping("Verification", Verification.class, new String[] {
				"Verifications", "Verifications" }, null, new String[] { "VerificationType", "KeyReference" }, null,
				300));

		ModuleUtil.register("VerificationAgencies", new ModuleMapping("VerificationAgencies", VehicleDealer.class,
				new String[] { "AMTVehicleDealer", "AMTVehicleDealer_AView" }, null, new String[] { "DealerName",
						"DealerCity" }, new Object[][] { { "Active", "0", 1 } }, 450));

		ModuleUtil.register("VerificationWaiverReason", new ModuleMapping("VerificationWaiverReason", ReasonCode.class,
		...
		ModuleUtil.register("LVDocument", new ModuleMapping("LVDocument", LVDocument.class, new String[] {
				"verification_lv_details", "verification_lv_details_view" }, WF_VERIFICATION_LV, null, null, 600));
		...
		ModuleUtil.register("RCUDocument", new ModuleMapping("RCUDocument", RCUDocument.class, new String[] {
				"verification_rcu_details", "verification_rcu_details_view" }, WF_VERIFICATION_RCU, null, null, 600));

		/* Technical Verification */
		ModuleUtil.register("TechnicalVerification", new ModuleMapping("TechnicalVerification",
				TechnicalVerification.class, new String[] { "Verification_Tv", "Verification_Tv_AView" },
				WF_VERIFICATION_TV, null, null, 600));

		ModuleUtil.register("AuthorizationLimit", new ModuleMapping("AuthorizationLimit", AuthorizationLimit.class,
				new String[] { "Auth_Limits", "Auth_Limits_AView" }, masterWF, new String[] { "UserID", "RoleId",
						"LimitAmount", "StartDate", "ExpiryDate", "Active" }, null, 600));

		ModuleUtil.register("FinanceUserAuthorizationLimit", new ModuleMapping("AuthorizationLimit",
				AuthorizationLimit.class, new String[] { "Auth_Limits", "Auth_Limits_AView" }, masterWF, new String[] {
						"UserID", "RoleId", "LimitAmount", "StartDate", "ExpiryDate", "Active" }, null, 600));

		ModuleUtil.register("FinanceRoleAuthorizationLimit", new ModuleMapping("AuthorizationLimit",
				AuthorizationLimit.class, new String[] { "Auth_Limits", "Auth_Limits_AView" }, masterWF, new String[] {
						"UserID", "RoleId", "LimitAmount", "StartDate", "ExpiryDate", "Active" }, null, 600));

		ModuleUtil.register("FinanceUserAuthorizationLimitHold", new ModuleMapping("AuthorizationLimit",
				AuthorizationLimit.class, new String[] { "Auth_Limits", "Auth_Limits_AView" }, masterWF, new String[] {
						"UserID", "RoleId", "LimitAmount", "HoldStartDate", "HoldExpiryDate", "Active" }, null, 600));

		ModuleUtil.register("FinanceRoleAuthorizationLimitHold", new ModuleMapping("AuthorizationLimit",
				AuthorizationLimit.class, new String[] { "Auth_Limits", "Auth_Limits_AView" }, masterWF, new String[] {
						"UserID", "RoleId", "LimitAmount", "HoldStartDate", "HoldExpiryDate", "Active" }, null, 600));

		ModuleUtil.register("AuthorizationLimitDetail", new ModuleMapping("AuthorizationLimitDetail",
				AuthorizationLimitDetail.class, new String[] { "Auth_Limit_Details", "Auth_Limit_Details_AView" },
				masterWF, new String[] { "Code", "LimitAmount" }, null, 600));

		ModuleUtil.register("DocumentCategory", new ModuleMapping("DocumentCategory", DocumentCategory.class,
				new String[] { "DocumentCategory", "DocumentCategory" }, null, new String[] { "Code", "Description" },
				null, 600));
		...
		ModuleUtil.register("EligibilityMethods", new ModuleMapping("EligibilityMethod", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "ELGMETHOD" } },
				400));

		ModuleUtil.register("QueryCategory", new ModuleMapping("QueryCategory", QueryCategory.class, new String[] {
				"BMTQueryCategories", "BMTQueryCategories_AView" }, masterWF, new String[] { "Code", "Description" },
				new Object[][] { { "Active", "0", 1 } }, 600));

		ModuleUtil.register("QueryDetail", new ModuleMapping("QueryDetail", QueryDetail.class, new String[] {
				"QUERYDETAIL", "QUERYDETAIL_AView" }, null, new String[] { "FinReference", "CategoryId", "Status" },
				null, 600));

		ModuleUtil.register("SecurityUserEmails", new ModuleMapping("SecurityUser", SecurityUser.class, new String[] {
				"UserOperationRoles_View", "UserOperationRoles_View" }, securityWF, new String[] { "UsrEmail",
				"LovDescFirstName" }, null, 600));

		ModuleUtil.register("StageTabDetail", new ModuleMapping("StageTabDetail", StageTabDetail.class, new String[] {
				"StageTabDetail", "StageTabDetail" }, null, new String[] { "TabCode", "TabDescription" },
				new Object[][] { { "Active", "0", 1 } }, 600));

		// GST Invoice Report
		ModuleUtil.register("GSTInvoiceReport", new ModuleMapping("GSTInvoiceReport", GSTInvoiceTxn.class,
				new String[] { "GST_Invoice_Txn", "GST_Invoice_Txn_View" }, null, new String[] { "InvoiceNo",
						"LoanAccountNo" }, null, 600));
		...
		/* Legal Details */
		ModuleUtil.register("LegalDetail", new ModuleMapping("LegalDetail", LegalDetail.class, new String[] {
				"LegalDetails", "LegalDetails_AView" }, LEGAL_DETAILS, new String[] { "LegalReference",
				"LoanReference", "CollateralReference" }, null, 600));

		ModuleUtil.register("LegalApplicantDetail", new ModuleMapping("LegalApplicantDetail",
				LegalApplicantDetail.class, new String[] { "LegalApplicantDetails", "LegalApplicantDetails_AView" },
				null, new String[] { "Title" }, null, 600));

		ModuleUtil.register("LegalPropertyDetail", new ModuleMapping("LegalPropertyDetail", LegalPropertyDetail.class,
				new String[] { "LegalPropertyDetails", "LegalPropertyDetails_AView" }, null,
				new String[] { "ScheduleType" }, null, 600));

		ModuleUtil.register("LegalDocument", new ModuleMapping("LegalDocument", LegalDetail.class, new String[] {
				"LegalDocuments", "LegalDocuments_AView" }, null, new String[] { "DocumentDate" }, null, 600));

		ModuleUtil.register("LegalPropertyTitle", new ModuleMapping("LegalPropertyTitle", LegalPropertyTitle.class,
				new String[] { "LegalPropertyTitle", "LegalPropertyTitle_AView" }, null, new String[] { "Title" },
				null, 600));

		ModuleUtil.register("LegalECDetail", new ModuleMapping("LegalECDetail", LegalECDetail.class, new String[] {
				"LegalECDetails", "LegalECDetails_AView" }, null, new String[] { "EcDate" }, null, 600));
		...
		ModuleUtil.register("PSLWeakerSection", new ModuleMapping("PSLWeakerSection", PSLWeakerSection.class,
				new String[] { "PSLWeakerSection", "PSLWeakerSection" }, null, new String[] { "Code", "Description" },
				null, 350));
		...
		// Sampling
		ModuleUtil.register("Sampling", new ModuleMapping("Sampling", Sampling.class, new String[] { "Sampling",
				"Sampling_view" }, sampling_WF, new String[] { "FinReference" }, null, 600));
		ModuleUtil.register("PSLEndUse", new ModuleMapping("PSLEndUse", PSLEndUse.class, new String[] { "PSLEndUse",
				"PSLEndUse" }, null, new String[] { "Code", "Description" }, null, 350));

		ModuleUtil
				.register("PSLDetail", new ModuleMapping("PSLDetail", FinAssetEvaluation.class, new String[] {
						"PSLDetail", "PSLDetail_AView" }, masterWF, new String[] { "FinReference", "CategoryCode" },
						null, 300));

		// Deposit Details
		ModuleUtil.register("DepositDetails", new ModuleMapping("DepositDetails", DepositDetails.class, new String[] {
				"DepositDetails", "DepositDetails_AView" }, masterWF, new String[] { "BranchCode", "DepositType" },
				null, 400));
		// Deposit Movements
		ModuleUtil.register("DepositMovements", new ModuleMapping("DepositMovements", DepositMovements.class,
				new String[] { "DepositMovements", "DepositMovements_AView" }, null, new String[] { "PartnerBankId",
						"TransactionType" }, null, 400));
		// CashDenominations
		ModuleUtil.register("CashDenomination", new ModuleMapping("CashDenominations", CashDenomination.class,
				new String[] { "CashDenominations", "CashDenominations_AView" }, null, new String[] { "ModuleCode" },
				null, 400));
		// DepositCheques
		ModuleUtil.register("DepositCheques", new ModuleMapping("DepositCheques", DepositCheques.class, new String[] {
				"DepositCheques", "DepositCheques_AView" }, null, new String[] { "ReceiptMode" }, null, 400));
		// Organization
		ModuleUtil.register("Organization", new ModuleMapping("Organization", Organization.class, new String[] {
				"Organizations", "organizations_Aview" }, org_School_WF, new String[] { "Cif", "custShrtName" }, null,
				600));
		...
		ModuleUtil.register("MasterDef", new ModuleMapping("MasterDef", MasterDef.class, new String[] { "master_def",
				"master_def" }, null, new String[] { "masterType,keyType,keyCode" }, null, 600));

		// Indemnity Report
		ModuleUtil.register("ClosedFinance", new ModuleMapping("ClosedFinance", FinanceMain.class, new String[] {
				"FinanceMain", "FinanceMain_View" }, null, new String[] { "FinReference", "FinType" }, new Object[][] {
				{ "FinIsActive", "0", 0 }, { "ClosingStatus", "1", "C" } }, 350));

		// Bank Information Detail
		ModuleUtil.register("BankInfoDetail", new ModuleMapping("BankInfoDetail", BankInfoDetail.class, new String[] {
				"BankInfoDetail", "BankInfoDetail_View" }, null, new String[] { "" }, null, 350));
		...
		// Receipt Modes
		ModuleUtil.register("FinTypeReceiptModes", new ModuleMapping("FinTypeReceiptModes", FinTypeReceiptModes.class,
				new String[] { "FinTypeReceiptModes", "FinTypeReceiptModes_View" }, masterWF, new String[] { "FinType",
						"ReceiptMode" }, null, 300));

		// Receipt Upload
		ModuleUtil.register("ReceiptUploadHeader", new ModuleMapping("ReceiptUploadHeader", ReceiptUploadHeader.class,
				new String[] { "ReceiptUploadHeader", "ReceiptUploadHeader_AVIEW" }, WF_RECEIPTUPLOAD, new String[] {
						"uploadHeaderId", "FileName" }, null, 600));
		...
		//VASRebooking
		ModuleUtil.register("VASRebooking", new ModuleMapping("VASRecording", VASRecording.class, new String[] {
				"VASRecording", "VASRecording_AView" }, VASWF, new String[] { "VasReference", "ProductCode" }, null,
				300));
		//FinVASRebooking
		ModuleUtil.register("FinVASRebooking", new ModuleMapping("VASRecording", VASRecording.class, new String[] {
				"VASRecording", "VASRecording_AView" }, VASWF, new String[] { "PrimaryLinkRef", "ProductCode" }, null,
				300));
		//Insurance Details
		ModuleUtil.register("InsuranceDetails", new ModuleMapping("InsuranceDetails", InsuranceDetails.class,
				new String[] { "InsuranceDetails", "InsuranceDetails_AView" }, insuranceDetails, new String[] {
						"Reference", "FinReference", "PolicyNumber" }, null, 600));
		//Insurance Details Inquiry
		ModuleUtil.register("InsuranceDetailsEnq", new ModuleMapping("InsuranceDetails", InsuranceDetails.class,
				new String[] { "InsuranceDetails", "InsuranceDetails_AView" }, null, new String[] { "Reference",
						"FinReference", "PolicyNumber" }, null, 600));
		//Insurance Payment Upload
		ModuleUtil
				.register("InsurancePaymentInstructions", new ModuleMapping("InsurancePaymentInstructions",
						InsurancePaymentInstructions.class, new String[] { "InsurancePaymentInstructions",
								"InsurancePaymentInstructions" }, null, new String[] { "EntityCode", "ProviderId" },
						null, 600));

		ModuleUtil.register("DataEngineStatusInsUpload", new ModuleMapping("DataEngineStatusInsUpload",
				FileBatchStatus.class, new String[] { "DataEngineStatus", "DATAENGINESTATUS_IUVIEW" }, null,
				new String[] { "Id", "FileName" }, null, 600));

		ModuleUtil.register("DataEngineStatusInsPayUpload", new ModuleMapping("DataEngineStatusInsPayUpload",
				FileBatchStatus.class, new String[] { "DataEngineStatus", "DATAENGINESTATUS_IPUVIEW" }, null,
				new String[] { "Id", "FileName" }, null, 600));

		ModuleUtil.register("ClusterHierarchy", new ModuleMapping("ClusterHierarchy", ClusterHierarchy.class,
				new String[] { "Cluster_Hierarchy", "Cluster_Hierarchy" }, CLUSTER_HIERARCHY, new String[] { "Entity",
						"ClusterType" }, null, 600));

		ModuleUtil.register("Cluster", new ModuleMapping("Cluster", Cluster.class, new String[] { "Clusters",
				"Clusters_aview" }, CLUSTERS, new String[] { "Code", "Name", "ClusterType" }, null, 600));

		ModuleUtil.register("BusinessVertical", new ModuleMapping("BusinessVertical", BusinessVertical.class,
				new String[] { "business_vertical", "business_vertical_AView" }, BUSINESS_VERTICAL, new String[] {
						"code", "Description" }, new Object[][] { { "Active", "0", 1 } }, 600));

		ModuleUtil.register("ReportingManager", new ModuleMapping("ReportingManager", ReportingManager.class,
				new String[] { "secusr_reporting_managers", "secuser_reporting_manager_AViw" }, masterWF, new String[] {
						"id", "usrid" }, null, 600));

		ModuleUtil.register("SecurityUserHierarchy", new ModuleMapping("SecurityUserHierarchy",
				SecurityUserHierarchy.class, new String[] { "userhierarchy_view", "userhierarchy_view" }, null,
				new String[] { "UserName", "BusinessVerticalCode", "FinType", "Product", "Branch",
						"ReportingToUserName" }, null, 800));
		// TemplateFields

		ModuleUtil.register("TemplateFields", new ModuleMapping("TemplateFields", TemplateFields.class, new String[] {
				"TemplateFields", "TemplateFields" }, masterWF, new String[] { "module", "event" }, new Object[][] { {
				"Active", "0", 1 } }, 400));

		ModuleUtil.register("CovenantType", new ModuleMapping("CovenantType", CovenantType.class, new String[] {
				"COVENANT_TYPES", "COVENANT_TYPES_AView" }, masterWF, new String[] { "Code", "Description",
				"CovenantType" }, null, 600));

		ModuleUtil.register("Covenant", new ModuleMapping("Covenant", Covenant.class, new String[] { "COVENANTS",
				"COVENANTS_AVIEW" }, masterWF, new String[] { "Id", "CovenantType" }, null, 300));

		ModuleUtil.register("CovenantDocument", new ModuleMapping("CovenantDocument", CovenantDocument.class,
				new String[] { "Covenant_Documents", "Covenant_Documents_Aview" }, masterWF, new String[] { "Id",
						"CovenantType" }, null, 300));

		ModuleUtil.register("FinOptionType", new ModuleMapping("FinOptionType", FinOptionType.class, new String[] {
				"FIN_OPTION_TYPES", "FIN_OPTION_TYPES_AView" }, masterWF, new String[] { "Code", "Description",
				"OptionType", "Frequency" }, null, 600));

		ModuleUtil
				.register("OperationRoles", new ModuleMapping("OperationRoles", SecurityRole.class, new String[] {
						"SecurityRole", "operation_roles_view" }, securityWF, new String[] { "RoleCd", "RoleDesc" },
						null, 600));
		ModuleUtil.register("FinOption", new ModuleMapping("FinOption", FinOption.class, new String[] { "FIN_OPTIONS",
				"FIN_OPTIONS_AView" }, masterWF, new String[] { "Id", "FinOption" }, null, 600));

		ModuleUtil.register("CollectionAgencies", new ModuleMapping("CollectionAgencies", BusinessVertical.class,
				new String[] { "CollectionAgencies", "CollectionAgencies" }, BUSINESS_VERTICAL, new String[] { "id",
						"code" }, null, 600));
		...
		ModuleUtil.register("Excess", new ModuleMapping("ExcessAmount", FinExcessAmount.class,
				new String[] { "FinExcessAmount_LovView" }, null, new String[] { "ExcessID", "Amount", "UtilisedAmt",
						"ReservedAmt", "BalanceAmt" }, new String[][] { { "AmountType", "0", "E" } }, 750));

		ModuleUtil.register("EMIInAdvance", new ModuleMapping("EMIINadvanceAmount", FinExcessAmount.class,
				new String[] { "FinExcessAmount_LovView" }, null, new String[] { "ExcessID", "Amount", "UtilisedAmt",
						"ReservedAmt", "BalanceAmt" }, new String[][] { { "AmountType", "0", "A" } }, 750));

		ModuleUtil.register("CASHCLT", new ModuleMapping("CASHCLT", FinExcessAmount.class,
				new String[] { "FinExcessAmount_LovView" }, null, new String[] { "ExcessID", "Amount", "UtilisedAmt",
						"ReservedAmt", "BalanceAmt" }, new String[][] { { "AmountType", "0",
						RepayConstants.RECEIPTMODE_CASHCLT } }, 750));

		ModuleUtil.register("DSF", new ModuleMapping("DSF", FinExcessAmount.class,
				new String[] { "FinExcessAmount_LovView" }, null, new String[] { "ExcessID", "Amount", "UtilisedAmt",
						"ReservedAmt", "BalanceAmt" }, new String[][] { { "AmountType", "0",
						RepayConstants.RECEIPTMODE_DSF } }, 750));

		ModuleUtil.register("PayableAdvise", new ModuleMapping("ManualAdvise", ManualAdvise.class,
				new String[] { "ManualAdvise_LovView" }, null, new String[] { "AdviseID", "FeeTypeID", "AdviseAmount",
						"ReservedAmt", "BalanceAmt" }, new Object[][] { { "AdviseType", "0", 2 } }, 750));

		ModuleUtil.register("LoanClosureEnquiry", new ModuleMapping("LoanClosureEnquiry", ForeClosure.class, null,
				masterWF, null, null, 400));

		ModuleUtil.register("ReceiptFinanceMain", new ModuleMapping("ReceiptFinanceMain", FinanceMain.class,
				new String[] { "FINANCEMAIN_DATAVIEW", "FINANCEMAIN_DATAVIEW" }, null, new String[] { "FinReference",
						"FinType" }, null, 350));
		...
		ModuleUtil.register("Commodity", new ModuleMapping("Commodities", Commodity.class, new String[] {
				"COMMODITIES", "COMMODITIES_AView" }, masterWF, new String[] { "Id", "CommodityTypeCode", "Code" },
				null, 600));

		ModuleUtil.register("DealerGroup", new ModuleMapping("DealerGroup", DealerGroup.class, new String[] {
				"CD_DealerGroup", "CD_DealerGroup_AVIEW" }, masterWF, new String[] { "DealerGroupId",
				"DealerGroupCode", "" }, null, 600));

		ModuleUtil.register("ProductGroup", new ModuleMapping("ProductGroup", ProductGroup.class, new String[] {
				"CD_DealerGroup", "CD_DealerGroup_AVIEW" }, masterWF, new String[] { "DealerGroupId",
				"DealerGroupCode", "" }, null, 600));

		ModuleUtil.register("DealerMapping", new ModuleMapping("DealerMapping", DealerMapping.class, new String[] {
				"CD_DealerMapping", "CD_DealerMapping_AVIEW" }, masterWF, new String[] { "DealerMapId", "MerchantId",
				"StoreId" }, null, 600));
		...
		ModuleUtil.register("Manufacturer", new ModuleMapping("Manufacturer", Manufacturer.class, new String[] {
				"CD_MANUFACTURERS", "CD_MANUFACTURERS_AView" }, masterWF, new String[] { "ManufacturerId", "Name" },
				null, 600));

		ModuleUtil
				.register("ChannelTypes", new ModuleMapping("ChannelTypes", LovFieldDetail.class,
						new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId",
								"FieldCodeValue", "ValueDesc" }, new Object[][] { { "IsActive", "0", 1 },
								{ "FieldCode", "0", "CHANNEL" } }, 400));

		/* LovFieldDetails Module mappings */

		ModuleUtil.register("AssetCalc", new ModuleMapping("AssetCalc", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "ASSETCALC" } },
				400));

		ModuleUtil.register("BankCode",
				new ModuleMapping("BankCode", LovFieldDetail.class, new String[] { "RMTLovFieldDetail_AView" },
						masterWF, new String[] { "FieldCodeId", "FieldCodeValue", "ValueDesc" }, new Object[][] {
								{ "IsActive", "0", 1 }, { "FieldCode", "0", "BANKCODE" } }, 400));

		ModuleUtil.register("CreditArea",
				new ModuleMapping("CreditArea", LovFieldDetail.class, new String[] { "RMTLovFieldDetail_AView" },
						masterWF, new String[] { "FieldCodeId", "FieldCodeValue", "ValueDesc" }, new Object[][] {
								{ "IsActive", "0", 1 }, { "FieldCode", "0", "CRDTAREA" } }, 400));

		ModuleUtil.register("IndustryCode", new ModuleMapping("IndustryCode", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "INDUSTRYCODE" } },
				400));

		ModuleUtil.register("OtherBank", new ModuleMapping("IndustryCode", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "OTHERBANK" } },
				400));

		ModuleUtil.register("RelationShipArea", new ModuleMapping("IndustryCode", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" },
				new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "RELATIONSHPAREA" } }, 400));
		/* LovFieldDetails Module mappings */

		ModuleUtil.register("OtherBank", new ModuleMapping("OtherBank", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "OTHERBANK" } },
				400));

		ModuleUtil.register("RealationShipArea", new ModuleMapping("RealationShipArea", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" },
				new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "RELATIONSHPAREA" } }, 400));

		ModuleUtil.register("ConsumerProduct", new ModuleMapping("ConsumerProduct", ConsumerProduct.class,
				new String[] { "CD_PRODUCTS", "CD_PRODUCTS_AView" }, masterWF, new String[] { "ProductId", "modelId" },
				null, 600));

		ModuleUtil.register("MerchantDetails", new ModuleMapping("MerchantDetails", MerchantDetails.class,
				new String[] { "CD_MERCHANTS", "CD_MERCHANTS_AView" }, masterWF, new String[] { "MerchantId",
						"MerchantName" }, null, 600));

		ModuleUtil.register("DealerMapping", new ModuleMapping("DealerMapping", DealerMapping.class, new String[] {
				"CD_DealerMapping", "CD_DealerMapping_AVIEW" }, masterWF, new String[] { "DealerMapId", "MerchantId",
				"StoreId" }, null, 600));

		ModuleUtil.register("Stores", new ModuleMapping("MerchantDetails", MerchantDetails.class, new String[] {
				"CD_MERCHANTS", "CD_MERCHANTS_AView" }, masterWF, new String[] { "StoreId", "StoreName" }, null, 600));

		ModuleUtil.register("ProductGroup", new ModuleMapping("ProductGroup", ProductGroup.class, new String[] {
				"ProductGroup", "ProductGroup_AVIEW" }, masterWF, new String[] { "modelId", "productId" }, null, 600));

		ModuleUtil.register("Category", new ModuleMapping("Category", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" },
				new Object[][] { { "IsActive", "0", 1 }, { "FieldCode", "0", "Dealer_Category" } }, 400));

		ModuleUtil.register("ProductCategory", new ModuleMapping("ProductCategory", LovFieldDetail.class,
				new String[] { "RMTLovFieldDetail_AView" }, masterWF, new String[] { "FieldCodeId", "FieldCodeValue",
						"ValueDesc" }, new Object[][] { { "IsActive", "0", 1 },
						{ "FieldCode", "0", "Product_Category" } }, 400));

		ModuleUtil.register("SchemeDealerGroup", new ModuleMapping("SchemeDealerGroup", SchemeDealerGroup.class,
				new String[] { "CD_SCHEME_DEALERGROUP", "CD_SCHEME_DEALERGROUP_AView" }, masterWF, new String[] {
						"SchemeDealerGroupId", "PromotionId", "SchemeId", "DealerGroupCode" }, null, 600));

		ModuleUtil.register("Promotion", new ModuleMapping("Promotions", Promotion.class, new String[] { "Promotions",
				"Promotions_AView" }, masterWF, new String[] { "PromotionCode", "PromotionDesc" }, null, 300));

		ModuleUtil.register("SchemeProductGroup", new ModuleMapping("SchemeProductGroup", SchemeProductGroup.class,
				new String[] { "CD_SCHEME_PRODUCTGROUP", "CD_SCHEME_PRODUCTGROUP_AView" }, masterWF, new String[] {
						"PromotionId", "SchemeId", "DealerGroupCode" }, null, 600));

		ModuleUtil.register("POSId", new ModuleMapping("MerchantDetails", MerchantDetails.class, new String[] {
				"CD_MERCHANTS", "CD_MERCHANTS_AView" }, masterWF, new String[] { "POSId", "StoreName" }, null, 600));

		ModuleUtil.register("DealerCode", new ModuleMapping("DealerMapping", DealerMapping.class, new String[] {
				"CD_DealerMapping", "CD_DealerMapping_AVIEW" }, masterWF, new String[] { "DealerCode", "MerchantId" },
				null, 600));

		ModuleUtil.register("TransactionMapping", new ModuleMapping("TransactionMapping", TransactionMapping.class,
				new String[] { "TransactionMapping", "TransactionMapping_AVIEW" }, masterWF, new String[] { "Mid",
						"Tid" }, null, 600));

		ModuleUtil.register("HSNCodeData", new ModuleMapping("Commodities", Commodity.class, new String[] {
				"COMMODITIES", "COMMODITIES_AView" }, masterWF, new String[] { "HSNCode", "Code" }, null, 600));//"CurrentValue", 

		ModuleUtil.register("HSNCodeData", new ModuleMapping("Commodities", Commodity.class, new String[] {
				"COMMODITIES", "COMMODITIES_AView" }, masterWF, new String[] { "HSNCode", "Code" }, null, 600));//"CurrentValue", 

		ModuleUtil.register("LowerTaxDeduction", new ModuleMapping("LowerTaxDeduction", LowerTaxDeduction.class,
				new String[] { "LowerTaxDeduction", "LowerTaxDeduction" }, masterWF, new String[] { "FinReference",
						"Type" }, null, 600));

		ModuleUtil.register("GSTRate", new ModuleMapping("GSTRate", GSTRate.class, new String[] { "GST_RATES",
				"GST_RATES_AView" }, masterWF, new String[] { "FromState", "ToState", "TaxType", "Amount",
				"Percentage", "CalcOn", "Active" }, null, 600));

		ModuleUtil.register("SettlementProcess", new ModuleMapping("SettlementProcess", SettlementProcess.class,
				new String[] { "SETTLEMENT_REQUEST", "SETTLEMENT_REQUEST" }, masterWF, new String[] { "Id",
		...
		ModuleUtil.register("CustCardSales", new ModuleMapping("CustCardSales", CustCardSales.class, new String[] {
				"CustCardSales", "CustCardSales_AView" }, masterWF, new String[] { "Id, MerchantId" }, null, 600));

		ModuleUtil.register("CustCardSalesDetails", new ModuleMapping("CustCardSalesDetails",
				CustCardSalesDetails.class, new String[] { "CustCardSalesDetails", "CustCardSalesDetails_AView" },
				masterWF, new String[] { "Id", "CardSalesId" }, null, 600));

		ModuleUtil.register("CreditReviewData", new ModuleMapping("CreditReviewData", CreditReviewData.class,
				new String[] { "CreditReviewData", "CreditReviewData" }, null, new String[] { "FinReference" }, null,
				600));

		ModuleUtil.register("PaymentTransaction", new ModuleMapping("PaymentTransaction", PaymentTransaction.class,
				new String[] { "PaymentTransaction_View", " PaymentTransaction_View" }, null, new String[] {
						"FinReference", "TranReference" }, null, 300));

		// MiscPosting Upload
		ModuleUtil.register("MiscPostingUpload", new ModuleMapping("MiscPostingUpload", MiscPostingUpload.class,
				new String[] { "MiscPostingUploads", "MiscPostingUploads_AView" }, null, new String[] { "UploadId",
						"FileName" }, null, 600));

		ModuleUtil
				.register("MiscUploadPostings", new ModuleMapping("UploadHeader", UploadHeader.class, new String[] {
						"UploadHeader", "MiscUploadPostings_Rview" }, null, new String[] { "UploadId", "FileName" },
						null, 600));

		ModuleUtil.register("ExtendedSecurityUser", new ModuleMapping("SecurityUser", SecurityUser.class, new String[] {
				"SecUsers", "SecUsers" }, securityWF, new String[] { "UsrLogin", "UsrFName" }, new Object[][] { {
				"usrdeptcode", "0", "CREDIT" } }, 600));
		ModuleUtil.register("FinOptionReport", new ModuleMapping("FinOptionReport", FinOption.class, new String[] {
				"FIN_OPTIONS", "FIN_OPTIONS_AVIEW" }, masterWF, new String[] { "FinReference" }, null, 600));

		ModuleUtil.register("DMA_LMT", new ModuleMapping("DMA_LMT", VehicleDealer.class, new String[] {
				"AMTVehicleDealer", "AMTVehicleDealer" }, masterWF, new String[] { "DealerId", "Code", "DealerName" },
		...
		ModuleUtil.register("SourceOfficer_LMT", new ModuleMapping("SourceOfficer_LMT", VehicleDealer.class,
				new String[] { "AMTVehicleDealer", "AMTVehicleDealer_AView" }, masterWF, new String[] { "DealerId",
						"Code", "DealerName" }, new Object[][] {
						{ "DealerType", "0", VASConsatnts.VASAGAINST_PARTNER }, { "Active", "0", 1 } }, 350));

		ModuleUtil.register("LimitsCustomer", new ModuleMapping("Customer", Customer.class, new String[] { "Customers",
				"LimitCustomers_View" }, customerWF, new String[] { "CustCIF", "CustShrtName", "CustCtgCode",
				"CustFName", "CustLName" }, null, 700));
		ModuleUtil.register("ManualUploadHeader", new ModuleMapping("UploadHeader", UploadHeader.class, new String[] {
				"uploadheader", "UPLOADHEADER_AVIEW" }, masterWF, new String[] { "UploadId", "FileName" }, null, 600));
		// Manual Advise Upload
		ModuleUtil.register("AdviseUpload", new ModuleMapping("UploadHeader", UploadHeader.class, new String[] {
				"UploadHeader", "UPLOADHEADER_MAUVIEW" }, null, new String[] { "UploadId", "FileName" }, null, 600));
		// Manual Advise Upload
		ModuleUtil.register("UploadManualAdvise", new ModuleMapping("UploadManualAdvise", UploadManualAdvise.class,
				new String[] { "AdviseUploads", "AdviseUploads_AView" }, masterWF, new String[] { "UploadId", "Entity",
						"FileName" }, null, 600));
		...
		ModuleUtil.register("LoanCancelReasons", new ModuleMapping("ReasonCode", ReasonCode.class, new String[] {
				...
				{ "Active", "0", 1 }, { "REASONCATEGORYCODE", "0", "LOANCANCEL" },
				{ "ReasonTypeCode", "0", "LOANCANCEL" } }, 600));
