...
public class FinanceConstants {
	...
	public static final String PENALTYTYPE_PERCONETIME 			= "P";
	public static final String PENALTYTYPE_PERCONDUEDAYS 		= "D";
	public static final String PENALTYTYPE_PERCONDUEMTH 		= "M";
	public static final String PENALTYTYPE_FLATAMTONPASTDUEMTH 	= "A";
	...
	public static final String FINSER_EVENT_ADVRPY 				= "SchdlRepayment";
	public static final String FINSER_EVENT_SCHDRPY 			= "EarlyPayment";
