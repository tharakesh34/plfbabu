...
public interface ContractorAssetDetailService {
	...
	List<AuditDetail> getAuditDetail(List<ContractorAssetDetail> contractorAssetDetails, FinanceMain financeMain,
			String auditTranType, String method);

	List<AuditDetail> validate(FinanceDetail financeDetail, String method, String usrLanguage);

	List<AuditDetail> saveOrUpdate(String finReference, List<ContractorAssetDetail> contractorAssetDetails,
			String tableType, String auditTranType);

	List<AuditDetail> doApprove(List<ContractorAssetDetail> contractorAssetDetails, String tableType,
			String auditTranType);

	List<AuditDetail> delete(List<ContractorAssetDetail> contractorAssetDetails, String tableType,
			String auditTranType);
}