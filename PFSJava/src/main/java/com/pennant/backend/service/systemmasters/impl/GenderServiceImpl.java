 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GenderServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class GenderServiceImpl extends GenericService<Gender> implements GenderService {
	...
	private static Logger logger = LogManager.getLogger(GenderServiceImpl.class);
	...
	public boolean isValidGenderCode(String genderCode) {
		return getGenderDAO().isValidGenderCode(genderCode);
	}
