 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FrequencyServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class FrequencyServiceImpl extends GenericService<Frequency> implements FrequencyService {
	...
	private static Logger logger = LogManager.getLogger(FrequencyServiceImpl.class);
