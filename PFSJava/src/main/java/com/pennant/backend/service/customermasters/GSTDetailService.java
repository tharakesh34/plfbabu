 ...
 * 
 */
public interface GSTDetailService {

	AuditHeader saveOrUpdate(AuditHeader auditHeader);

	GSTDetail getGSTDetailById(long id, String typeCode);

	GSTDetail getApprovedGSTDetailById(long id, String typeCode);
	...
	GSTDetail getDefaultGSTDetailById(long id);
