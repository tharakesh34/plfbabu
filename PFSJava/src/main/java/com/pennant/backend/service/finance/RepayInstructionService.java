 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RepayInstructionService.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 02-12-2011 * *
...
public interface RepayInstructionService {
	...
	RepayInstruction getRepayInstructionById(long finID, boolean isWIF);

	RepayInstruction getApprovedRepayInstructionById(long finID, boolean isWIF);
