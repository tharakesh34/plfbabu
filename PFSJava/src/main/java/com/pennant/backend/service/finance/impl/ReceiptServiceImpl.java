...
public class ReceiptServiceImpl extends GenericService<FinReceiptHeader> implements ReceiptService {
	...
	public void setFinanceData(FinReceiptData rd) {
		...
		FinExcessAmount fea = finExcessAmountDAO.getFinExcessAmount(finID, rch.getReceiptID());
	...
	@Override
	public FinReceiptData doApproveReceipt(FinReceiptData frd) throws Exception {
