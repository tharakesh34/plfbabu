 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LegalNoteServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 19-06-2018 * * Modified
...
public class LegalNoteService extends GenericService<LegalNote> {
	private static final Logger logger = LogManager.getLogger(LegalNoteService.class);
