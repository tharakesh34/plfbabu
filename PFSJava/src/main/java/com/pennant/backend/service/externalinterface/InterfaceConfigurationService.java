 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : InterfaceConfigurationService.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-08-2019 * *
...
public interface InterfaceConfigurationService {
	...
	InterfaceConfiguration getInterfaceConfiguration(long id);

	InterfaceConfiguration getApprovedInterfaceConfiguration(long id);
