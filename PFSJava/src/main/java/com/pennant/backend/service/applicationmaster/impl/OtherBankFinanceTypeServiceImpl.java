 ...
 * 
 */
public class OtherBankFinanceTypeServiceImpl extends GenericService<OtherBankFinanceType>
		implements OtherBankFinanceTypeService {
	private static final Logger logger = LogManager.getLogger(OtherBankFinanceTypeServiceImpl.class);
	 ...
	 * OtherBankFinanceTypes/OtherBankFinanceTypes_Temp by using OtherBankFinanceTypeDAO's save method b) Update the
	...
	/**
	 * getApprovedOtherBankFinanceTypeById fetch the details by using OtherBankFinanceTypeDAO's
	...
	public AuditHeader doApprove(AuditHeader auditHeader) {
		...
		if (!PennantConstants.RECORD_TYPE_NEW.equals(otherBankFinanceType.getRecordType())) {
			auditHeader.getAuditDetail()
					.setBefImage(otherBankFinanceTypeDAO.getOtherBankFinanceTypeById(otherBankFinanceType.getId(), ""));
		}
	 ...
	 * workFlow table by using getOtherBankFinanceTypeDAO().delete with parameters otherBankFinanceType,"_Temp" 3) Audit
