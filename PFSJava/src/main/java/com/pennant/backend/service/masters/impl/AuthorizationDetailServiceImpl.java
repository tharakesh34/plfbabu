 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AuthorizationDetailServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-06-2012 *
...
public class AuthorizationDetailServiceImpl extends GenericService<AuthorizationDetail>
	...
	/**
	 * @param authorizationDetailDAO the authorizationDetailDAO to set
	 */
