...
public class DDAControllerService extends GenericService<FinanceDetail> {
	...
	public boolean validateDDAStatus(String finReference) throws InterfaceException {
		...
		DDAProcessData ddaProcessData = getDdaProcessService().getDDADetailsById(finReference,
				PennantConstants.REQ_TYPE_REG);
	...
	/*	
		*//**
			 ...
			 * @return
			 *//*
			 * public String checkDDAApproval(String finReference) { logger.debug("Entering");
			 * 
			 * DDAProcessData ddaProcessData = getDdaProcessService().getDDADetailsById(finReference,
			 * PennantConstants.REQ_TYPE_REG); if(ddaProcessData != null) { if
			 * (!StringUtils.isBlank(ddaProcessData.getDdaReference()) &&
			 * StringUtils.isBlank(ddaProcessData.getDdaAckStatus())) { return PennantConstants.DDA_ACK; } else if
			 * (!StringUtils.isBlank(ddaProcessData.getDdaAckStatus())) { return PennantConstants.DDA_NAK; } else {
			 * return PennantConstants.DDA_PENDING; } } return null; }
			 */
	 ...
	 * @throws InterfaceException
	 */
	private DDAProcessData prepareDDARegRequest(FinanceMain aFinMain, CustomerDetails customerDetails, String purpose)
			throws InterfaceException {
		logger.debug("Entering");
