 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : InterfaceMappingService.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 01-12-2016 * *
...
package com.pennant.backend.service.interfacemapping;
...
public interface InterfaceMappingService {

	AuditHeader saveOrUpdate(AuditHeader auditHeader);

	InterfaceMapping getInterfaceMappingById(long id);
