 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FlagService.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 14-07-2015 * * Modified Date :
...
public interface FlagService {
	...
	Flag getFlagById(String id);

	Flag getApprovedFlagById(String id);
