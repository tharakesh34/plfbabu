...
public interface BulkDefermentChangeProcessService {
	...
	boolean bulkRateChangeFinances(List<BulkProcessDetails> bulkRateChangeFinances, String recalType, BigDecimal rateChange) throws PFFInterfaceException;
	AuditHeader saveOrUpdate(AuditHeader aAuditHeader, boolean isWIF) throws PFFInterfaceException;
	...
	boolean bulkDefermentChanges(List<BulkProcessDetails> defermentChangeFinances,String recalType, boolean excludeDeferment, 
			String addTermAfter, Date calFromDate, Date calToDate, String cbRecalType) throws PFFInterfaceException, Exception;
