 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  FinAssetEvaluationServiceImpl.java                                                   * 	  
 *                                                                    						*
...
import com.pennant.backend.service.finance.validation.FinAssetEvaluationValidation;
import com.pennant.backend.util.PennantConstants;
import com.pennant.backend.util.PennantJavaUtil;
import com.pennanttech.pennapps.core.model.ErrorDetail;

/**
 * Service implementation for methods that depends on <b>FinAssetEvaluation</b>.<br>
 * 
 */
public class FinAssetEvaluationServiceImpl extends GenericService<FinAssetEvaluation>
		implements FinAssetEvaluationService {

	private static final Logger logger = LogManager.getLogger(FinAssetEvaluationServiceImpl.class);
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		String tableType = "";
		FinAssetEvaluation finAssetEvaluation = (FinAssetEvaluation) auditHeader.getAuditDetail().getModelData();
		...
		if (finAssetEvaluation.isNew()) {
			...
			getFinAssetEvaluationDAO().update(finAssetEvaluation, tableType);
		}
	...
	public AuditHeader delete(AuditHeader auditHeader) {
		...
		FinAssetEvaluation finAssetEvaluation = (FinAssetEvaluation) auditHeader.getAuditDetail().getModelData();
		getFinAssetEvaluationDAO().delete(finAssetEvaluation, "");
	...
	public AuditHeader doApprove(AuditHeader auditHeader) {
		...
		if (finAssetEvaluation.getRecordType().equals(PennantConstants.RECORD_TYPE_DEL)) {
			...
			finAssetEvaluation.setRoleCode("");
			finAssetEvaluation.setNextRoleCode("");
			finAssetEvaluation.setTaskId("");
			finAssetEvaluation.setNextTaskId("");
			finAssetEvaluation.setWorkflowId(0);

			if (finAssetEvaluation.getRecordType().equals(PennantConstants.RECORD_TYPE_NEW)) {
				tranType = PennantConstants.TRAN_ADD;
				finAssetEvaluation.setRecordType("");
				getFinAssetEvaluationDAO().save(finAssetEvaluation, "");
			} else {
				tranType = PennantConstants.TRAN_UPD;
				finAssetEvaluation.setRecordType("");
				getFinAssetEvaluationDAO().update(finAssetEvaluation, "");
			}
		}

		getFinAssetEvaluationDAO().delete(finAssetEvaluation, "_Temp");
	...
	public AuditDetail saveOrUpdate(FinAssetEvaluation finAssetEvaluation, String tableType, String auditTranType) {
		...
		finAssetEvaluation.setWorkflowId(0);
		if (finAssetEvaluation.isNewRecord()) {
