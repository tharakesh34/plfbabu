 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NationalityCodeServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class NationalityCodeServiceImpl extends GenericService<NationalityCode> implements NationalityCodeService {
	...
	private static Logger logger = LogManager.getLogger(NationalityCodeServiceImpl.class);
