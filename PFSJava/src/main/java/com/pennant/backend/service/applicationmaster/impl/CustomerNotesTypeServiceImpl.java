 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerNotesTypeServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class CustomerNotesTypeServiceImpl extends GenericService<CustomerNotesType>
	...
	private static Logger logger = LogManager.getLogger(CustomerNotesTypeServiceImpl.class);
