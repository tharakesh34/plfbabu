 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GSTRateService.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 20-05-2019 * * Modified Date
...
public interface GSTRateService {
	...
	GSTRate getGSTRate(long id);

	GSTRate getApprovedGSTRate(long id);
