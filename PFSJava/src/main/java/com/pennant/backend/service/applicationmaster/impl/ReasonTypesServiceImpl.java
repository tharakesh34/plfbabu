 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ReasonTypesServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 19-12-2017 * *
...
public class ReasonTypesServiceImpl extends GenericService<ReasonTypes> implements ReasonTypesService {
	private static final Logger logger = LogManager.getLogger(ReasonTypesServiceImpl.class);
	 ...
	 * 
	 * @param id id of the ReasonTypes.
	 * @return ReasonTypes
	 */
	@Override
	 ...
	 * 
	 * @param id id of the ReasonTypes. (String)
	 * @return ReasonTypes
	 */
