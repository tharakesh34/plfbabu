 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CorporateCustomerDetailServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 ...
 * 
 */
public class CorporateCustomerDetailServiceImpl extends GenericService<CorporateCustomerDetail>
		implements CorporateCustomerDetailService {
	private static final Logger logger = LogManager.getLogger(CorporateCustomerDetailServiceImpl.class);
	 ...
	 * CustomerCorporateDetail/CustomerCorporateDetail_Temp by using CorporateCustomerDetailDAO's save method b) Update
	 * the Record in the table. based on the module workFlow Configuration. by using CorporateCustomerDetailDAO's update
	 * method 3) Audit the record in to AuditHeader and AdtCustomerCorporateDetail by using
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		String tableType = "";
		CorporateCustomerDetail corporateCustomerDetail = (CorporateCustomerDetail) auditHeader.getAuditDetail()
				.getModelData();
	 ...
	 * CustomerCorporateDetail by using CorporateCustomerDetailDAO's delete method with type as Blank 3) Audit the
	 * record in to AuditHeader and AdtCustomerCorporateDetail by using auditHeaderDAO.addAudit(auditHeader)
	 * 
	 * @param AuditHeader (auditHeader)
	 * @return auditHeader
	 */
	...
	/**
	 * getApprovedCorporateCustomerDetailById fetch the details by using CorporateCustomerDetailDAO's
	 * getCorporateCustomerDetailById method . with parameter id and type as blank. it fetches the approved records from
	 * the CustomerCorporateDetail.
	 * 
	 * @param id (int)
	 * @return CorporateCustomerDetail
	 */
	 ...
	 * following actions a) DELETE Delete the record from the main table by using getCorporateCustomerDetailDAO().delete
	 * with parameters corporateCustomerDetail,"" b) NEW Add new record in to main table by using
	 * getCorporateCustomerDetailDAO().save with parameters corporateCustomerDetail,"" c) EDIT Update record in the main
	 * table by using getCorporateCustomerDetailDAO().update with parameters corporateCustomerDetail,"" 3) Delete the
	 * record from the workFlow table by using getCorporateCustomerDetailDAO().delete with parameters
	 * corporateCustomerDetail,"_Temp" 4) Audit the record in to AuditHeader and AdtCustomerCorporateDetail by using
	 * auditHeaderDAO.addAudit(auditHeader) for Work flow 5) Audit the record in to AuditHeader and
	 * AdtCustomerCorporateDetail by using auditHeaderDAO.addAudit(auditHeader) based on the transaction Type.
	 * 
	 * @param AuditHeader (auditHeader)
	 * @return auditHeader
	 */
	 ...
	 * workFlow table by using getCorporateCustomerDetailDAO().delete with parameters corporateCustomerDetail,"_Temp" 3)
	 * Audit the record in to AuditHeader and AdtCustomerCorporateDetail by using auditHeaderDAO.addAudit(auditHeader)
	 * for Work flow
	 * 
	 * @param AuditHeader (auditHeader)
	 * @return auditHeader
	 ...
	 * for any mismatch conditions Fetch the error details from getCorporateCustomerDetailDAO().getErrorDetail with
