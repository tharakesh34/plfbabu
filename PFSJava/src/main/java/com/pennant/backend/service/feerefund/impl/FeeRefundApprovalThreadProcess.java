...
public class FeeRefundApprovalThreadProcess {
	...
	private void processFeeRefundApproval(FeeRefundHeader frh, List<FeeRefundDetail> feeRefundDetailList,
		...
		long feeRefundId = frh.getFeeRefundId();
		...
		try {
			...
			for (FeeRefundDetail frd : feeRefundDetailList) {
				...
				updatePayableRef(adviseId, frd.getFeeRefundDetailId());
			}

			createPaymentInstruction(frh, feeRefundDetailList, fri);
			this.feeRefundHeaderService.updateApprovalStatus(frh.getFeeRefundId(),
					PennantConstants.FEE_REFUND_APPROVAL_SUCCESS);
			...
			this.feeRefundHeaderService.updateApprovalStatus(frh.getFeeRefundId(),
					PennantConstants.FEE_REFUND_APPROVAL_FAILED);
	...
	public void updatePayableRef(long adviseId, long feeRefundDetailId) {
		feeRefundDetailDAO.updatePayableRef(adviseId, feeRefundDetailId);
	}
