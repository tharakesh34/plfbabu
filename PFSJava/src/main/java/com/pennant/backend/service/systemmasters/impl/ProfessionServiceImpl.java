 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProfessionServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class ProfessionServiceImpl extends GenericService<Profession> implements ProfessionService {
	...
	private AuditDetail validation(AuditDetail auditDetail, String usrLanguage) {
		...
		if (profession.isNewRecord() && PennantConstants.RECORD_TYPE_NEW.equals(profession.getRecordType())
				&& professionDAO.isDuplicateKey(code,
						profession.isWorkflow() ? TableType.BOTH_TAB : TableType.MAIN_TAB)) {
