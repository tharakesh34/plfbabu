 ...
 * 
 */
public interface DealRecommendationMeritsService {
	...
	List<AuditDetail> delete(List<DealRecommendationMerits> dealRecommendationMerits, TableType tableType,
			String auditTranType);

	List<AuditDetail> processDealRecommendationMerits(List<DealRecommendationMerits> dealRecommendationMeritsList,
			TableType tableType, String auditTranType, boolean isApproveRcd);
