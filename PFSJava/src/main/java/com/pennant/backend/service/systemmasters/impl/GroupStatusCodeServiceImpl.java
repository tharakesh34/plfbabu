 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GroupStatusCodeServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class GroupStatusCodeServiceImpl extends GenericService<GroupStatusCode> implements GroupStatusCodeService {
	...
	private static Logger logger = LogManager.getLogger(GroupStatusCodeServiceImpl.class);
