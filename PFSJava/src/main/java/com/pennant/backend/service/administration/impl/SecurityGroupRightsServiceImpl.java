...
public class SecurityGroupRightsServiceImpl extends GenericService<SecurityGroupRights>
	 ...
	 * for each AuditDetail if "AuditTranType" is PennantConstants.TRAN_ADD it saves the record by calling
	 * SecurityGroupRightsDAO's save() method b)if "AuditTranType" is PennantConstants.TRAN_DEL it Deletes the record by
	 * calling SecurityGroupRightsDAO's delete() method
	 * 
	 **/
	...
	/**
	 * This method fetches {@link List} of {@link SecurityRight} records by calling SecurityGroupRightsDAO's
	 * getRightsByGroupId()
	 * 
	 * @param grpID(long)
