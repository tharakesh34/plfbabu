...
public class TransactionEntryValidation {
	...
	public List<AuditDetail> transactionEntryListValidation(List<AuditDetail> auditDetails, String method,
			String usrLanguage) {
	...
	private AuditDetail validate(AuditDetail auditDetail, String method, String usrLanguage) {
		...
		if (transactionEntry.isWorkflow()) {
			tempFeeTier = getFeeTierDAO().getTransactionEntryById(transactionEntry.getId(),
					transactionEntry.getTransOrder(), "_Temp");
		}

		TransactionEntry beftransactionEntry = getFeeTierDAO().getTransactionEntryById(transactionEntry.getId(),
