...
public class FinanceTaxDetailServiceImpl extends GenericService<FinanceTaxDetail> implements FinanceTaxDetailService {
	 ...
	 * Configuration. by using FinTaxDetailDAO's update method 3) Audit the
	 * record in to AuditHeader and AdtFinTaxDetail by using
	...
	/**
	 * getFinTaxDetail fetch the details by using FinTaxDetailDAO's
	 * getFinTaxDetailById method.
	 * 
	 * @param finReference
	 ...
	 * getFinTaxDetailById method . with parameter id and type as blank. it
	 * fetches the approved records from the FinTaxDetail.
	 * 
	 * @param finReference
	 ...
	 * using getFinanceTaxDetailDAO().delete with parameters financeTaxDetail,""
	 * b) NEW Add new record in to main table by using
	 * getFinanceTaxDetailDAO().save with parameters financeTaxDetail,"" c) EDIT
	 * Update record in the main table by using getFinanceTaxDetailDAO().update
	 * with parameters financeTaxDetail,"" 3) Delete the record from the
	 * workFlow table by using getFinanceTaxDetailDAO().delete with parameters
	 ...
	 * the workFlow table by using getFinanceTaxDetailDAO().delete with
	 * parameters financeTaxDetail,"_Temp" 3) Audit the record in to AuditHeader
	 * and AdtFinTaxDetail by using auditHeaderDAO.addAudit(auditHeader) for
	 * Work flow
	 * 
	 * @param AuditHeader
	 *            (auditHeader)
	 ...
	 * getFinanceTaxDetailDAO().getErrorDetail with Error ID and language as
