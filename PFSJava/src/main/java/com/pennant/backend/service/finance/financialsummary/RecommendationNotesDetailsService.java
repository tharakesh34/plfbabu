...
public interface RecommendationNotesDetailsService {
	...
	List<AuditDetail> processDueDiligenceDetails(List<RecommendationNotes> recommendationNotesDetails, TableType tableType,
			String auditTranType, boolean isApproveRcd);

	List<AuditDetail> doApprove(List<RecommendationNotes> recommendationNotesDetails, TableType tableType, String auditTranType);

	List<AuditDetail> delete(List<RecommendationNotes> recommendationNotesDetails, TableType tableType, String auditTranType);
