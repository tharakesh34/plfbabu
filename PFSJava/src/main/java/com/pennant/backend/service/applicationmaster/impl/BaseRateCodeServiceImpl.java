 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BaseRateCodeServiceImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class BaseRateCodeServiceImpl extends GenericService<BaseRateCode> implements BaseRateCodeService {
	 ...
	 * RMTBaseRateCodes/RMTBaseRateCodes_Temp by using BaseRateCodeDAO's save method b) Update the Record in the table.
	 * based on the module workFlow Configuration. by using BaseRateCodeDAO's update method 3) Audit the record in to
	 * AuditHeader and AdtRMTBaseRateCodes by using auditHeaderDAO.addAudit(auditHeader)
	 * 
	 ...
	 * RMTBaseRateCodes by using BaseRateCodeDAO's delete method with type as Blank 3) Audit the record in to
	 * AuditHeader and AdtRMTBaseRateCodes by using auditHeaderDAO.addAudit(auditHeader)
	 * 
	 * @param AuditHeader (auditHeader)
	 * @return auditHeader
	...
	/**
	 * getBaseRateCodeById fetch the details by using BaseRateCodeDAO's getBaseRateCodeById method.
	 * 
	 * @param id   (String)
	 ...
	 * following actions a) DELETE Delete the record from the main table by using getBaseRateCodeDAO().delete with
	 * parameters baseRateCode,"" b) NEW Add new record in to main table by using getBaseRateCodeDAO().save with
	 * parameters baseRateCode,"" c) EDIT Update record in the main table by using getBaseRateCodeDAO().update with
	 * parameters baseRateCode,"" 3) Delete the record from the workFlow table by using getBaseRateCodeDAO().delete with
	 * parameters baseRateCode,"_Temp" 4) Audit the record in to AuditHeader and AdtRMTBaseRateCodes by using
	 * auditHeaderDAO.addAudit(auditHeader) for Work flow 5) Audit the record in to AuditHeader and AdtRMTBaseRateCodes
	 ...
	 * workFlow table by using getBaseRateCodeDAO().delete with parameters baseRateCode,"_Temp" 3) Audit the record in
	 * to AuditHeader and AdtRMTBaseRateCodes by using auditHeaderDAO.addAudit(auditHeader) for Work flow
	 * 
	 * @param AuditHeader (auditHeader)
	 * @return auditHeader
	 */
	 ...
	 * from getBaseRateCodeDAO().getErrorDetail with Error ID and language as parameters. if any error/Warnings then
