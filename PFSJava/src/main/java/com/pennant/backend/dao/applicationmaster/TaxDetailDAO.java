 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : TaxDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 14-06-2017 * * Modified Date :
...
public interface TaxDetailDAO extends BasicCrudDao<TaxDetail> {
	 ...
	 * 
	 * @param id        id of the TaxDetail.
	 * @param taxCode   taxCode of the TaxDetail.
	 * @param tableType The type of the table.
