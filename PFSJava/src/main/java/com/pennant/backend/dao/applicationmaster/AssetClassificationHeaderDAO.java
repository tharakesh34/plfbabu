 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AssetClassificationHeaderDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-05-2020 * *
...
public interface AssetClassificationHeaderDAO extends BasicCrudDao<AssetClassificationHeader> {
	 ...
	 * 
	 * @param id         id of the AssetClassificationHeader.
	 * @param code       code of the AssetClassificationHeader.
	 * @param stageOrder stageOrder of the AssetClassificationHeader.
	 * @param tableType  The type of the table.
