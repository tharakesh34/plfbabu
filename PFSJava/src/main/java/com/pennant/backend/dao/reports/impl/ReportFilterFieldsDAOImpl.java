...
public class ReportFilterFieldsDAOImpl extends SequenceDao<ReportFilterFields> implements ReportFilterFieldsDAO {
	...
	/**
	 * This method get the module from method getReportFilterFields() and set the new record flag as true and return
	 * ReportFilterFields()
	 * 
	 * @return ReportFilterFields
	 */
	...
	public ReportFilterFields getReportFilterFieldsById(final long id, String type) {
		...
		StringBuilder selectSql = new StringBuilder(
				"SELECT ReportID, FieldID, FieldName, FieldType, FieldLabel, FieldDBName,");
		selectSql.append(
				" AppUtilMethodName, ModuleName, LovHiddenFieldMethod, LovTextFieldMethod, MultiSelectSearch, FieldLength,");
	...
	public long save(ReportFilterFields reportFilterFields, String type) {
		...
		insertSql.append(
				" :AppUtilMethodName, :ModuleName, :LovHiddenFieldMethod, :LovTextFieldMethod, :MultiSelectSearch, :FieldLength,");
		insertSql.append(
				" :FieldMaxValue, :FieldMinValue, :SeqOrder, :Mandatory, :FieldConstraint, :FieldErrorMessage,");
		insertSql
				.append(" :WhereCondition, :StaticValue, :FieldWidth, :FilterRequired, :DefaultFilter, :FilterFileds,");
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode,");
		insertSql.append(" :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(ReportFilterFields reportFilterFields, String type) {
		...
		updateSql.append(
				" ,FieldDBName = :FieldDBName, AppUtilMethodName = :AppUtilMethodName, ModuleName = :ModuleName,");
		updateSql.append(" LovHiddenFieldMethod = :LovHiddenFieldMethod, LovTextFieldMethod = :LovTextFieldMethod,");
		updateSql.append(
				" MultiSelectSearch = :MultiSelectSearch, FieldLength = :FieldLength, FieldMaxValue = :FieldMaxValue,");
		...
		updateSql.append(
				" FilterRequired = :FilterRequired, DefaultFilter = :DefaultFilter, FilterFileds =:FilterFileds,");
