 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SegmentDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date
...
public class SegmentDAOImpl extends BasicDao<Segment> implements SegmentDAO {
	...
	public Segment getSegmentById(final String id, String type) {
		...
		RowMapper<Segment> typeRowMapper = BeanPropertyRowMapper.newInstance(Segment.class);
		try {
