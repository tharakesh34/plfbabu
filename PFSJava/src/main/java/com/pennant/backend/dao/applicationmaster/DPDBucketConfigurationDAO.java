 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DPDBucketConfigurationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-04-2017 * *
...
public interface DPDBucketConfigurationDAO extends BasicCrudDao<DPDBucketConfiguration> {
	 ...
	 * 
	 * @param configID  configID of the DPDBucketConfiguration.
	 ...
	 * 
	 * @param configID    configID of the DPDBucketConfiguration.
	 * @param productCode productCode of the DPDBucketConfiguration.
	 * @param bucketID    bucketID of the DPDBucketConfiguration.
	 * @param tableType   The type of the table.
