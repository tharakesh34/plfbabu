 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmpStsCodeDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class EmpStsCodeDAOImpl extends BasicDao<EmpStsCode> implements EmpStsCodeDAO {
	private static Logger logger = LogManager.getLogger(EmpStsCodeDAOImpl.class);
	...
	public EmpStsCode getEmpStsCodeById(final String id, String type) {
		...
		RowMapper<EmpStsCode> typeRowMapper = BeanPropertyRowMapper.newInstance(EmpStsCode.class);
	 ...
	 * 
	 * @param Employee Status Codes (empStsCode)
	 * @param type     (String) ""/_Temp/_View
	 * @return void
