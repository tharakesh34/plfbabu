 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : TransactionCodeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-11-2011 * * Modified
 * Date : 10-11-2011 * * Description : * *
 ********************************************************************************************
...
public interface TransactionCodeDAO extends BasicCrudDao<TransactionCode> {
	 ...
	 * 
	 * @param tranCode  TranCode of the transactionCode.
