 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : TransactionEntryDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 14-12-2011 * * Modified
...
public interface TransactionEntryDAO {
	...
	List<TransactionEntry> getListTransactionEntryByRefType(String finType, String finEvent, int refType,
			String roleCode, String type, boolean postingProcess);
