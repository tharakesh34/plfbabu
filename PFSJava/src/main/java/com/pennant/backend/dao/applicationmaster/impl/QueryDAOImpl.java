...
public class QueryDAOImpl extends BasicDao<Query> implements QueryDAO {
	...
	public Query getQueryById(String queryCode, String queryModule, String type) {
		...
		StringBuilder selectSql = new StringBuilder(
				"Select  QueryCode, QueryModule, QueryDesc, SqlQuery, ActualBlock, SubQuery");
		selectSql.append(
				", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId,Active");
	...
	public void update(Query query, String type) {
		...
		updateSql.append(
				" Set QueryModule = :QueryModule, QueryDesc = :QueryDesc, SqlQuery = :SqlQuery, ActualBlock = :ActualBlock, SubQuery = :SubQuery");
		updateSql.append(
				", Version= :Version , LastMntBy = :LastMntBy, LastMntOn = :LastMntOn, RecordStatus= :RecordStatus, RoleCode = :RoleCode, NextRoleCode = :NextRoleCode, TaskId = :TaskId, NextTaskId = :NextTaskId, RecordType = :RecordType, WorkflowId = :WorkflowId, Active = :Active");
