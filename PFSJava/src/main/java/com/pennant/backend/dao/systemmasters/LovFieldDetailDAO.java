 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LovFieldDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-10-2011 * * Modified
...
public interface LovFieldDetailDAO extends BasicCrudDao<LovFieldDetail> {
	 ...
	 * 
	 * @param fieldCode   of LovFieldDetails
	 * @param fieldDetail of LovFieldDetails
	 * @param tableType   of LovFieldDetails
	 * @return
	 */
	...
	boolean isfieldCodeValueExists(String fieldCodeValue, boolean isActive);
}