...
public class LimitRuleDAOImpl extends SequenceDao<LimitFilterQuery> implements LimitRuleDAO {
	...
	/**
	 * This method will create a new object for Rule and set the Work flow details if available.
	 * 
	 * @return Rule
	 */
	@Override
	...
	/**
	 * This method will get the object from the method getRule() method and set the new Rule flag.
	 * 
	 * @return Rule
	 */
	@Override
	 ...
	 */
	@Override
	public LimitFilterQuery getLimitRuleByID(final String id, String queryModule, String querySubCode, String type) {
		logger.debug("Entering");
		...
		selectSql.append(
				" Select QueryId, QueryCode, QueryModule, QuerySubCode,QueryDesc, SQLQuery, ActualBlock,Active, ");
	...
	public long save(LimitFilterQuery dedupParm, String type) {
		...
		insertSql.append(
				" Values(:QueryId , :QueryCode, :QueryModule,:QueryDesc, :SQLQuery, :ActualBlock, :QuerySubCode,:Active,");
		insertSql.append(" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode,");
		insertSql.append(" :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
