 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NPAProvisionHeaderDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-05-2020 * *
...
public interface NPAProvisionHeaderDAO extends BasicCrudDao<NPAProvisionHeader> {
	 ...
	 * 
	 * @param id        id of the NPAProvisionHeader.
	 * @param entity    entity of the NPAProvisionHeader.
	 * @param finType   finType of the NPAProvisionHeader.
	 * @param tableType The type of the table.
