...
public class InsurancePolicyDAOImpl extends BasicDao<InsurancePolicy> implements InsurancePolicyDAO {
	private static Logger logger = LogManager.getLogger(InsurancePolicyDAOImpl.class);
	...
	public InsurancePolicy getInsurancePolicyById(final String id, String type) {
		...
		RowMapper<InsurancePolicy> typeRowMapper = BeanPropertyRowMapper.newInstance(InsurancePolicy.class);
