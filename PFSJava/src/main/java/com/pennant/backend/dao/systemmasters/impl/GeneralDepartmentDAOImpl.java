 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDepartmentDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class GeneralDepartmentDAOImpl extends BasicDao<GeneralDepartment> implements GeneralDepartmentDAO {
	private static Logger logger = LogManager.getLogger(GeneralDepartmentDAOImpl.class);
	...
	public GeneralDepartment getGeneralDepartmentById(final String id, String type) {
		...
		RowMapper<GeneralDepartment> typeRowMapper = BeanPropertyRowMapper.newInstance(GeneralDepartment.class);
