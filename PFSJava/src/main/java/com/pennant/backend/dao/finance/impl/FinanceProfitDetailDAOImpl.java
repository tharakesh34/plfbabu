...
public class FinanceProfitDetailDAOImpl extends BasicDao<FinanceProfitDetail> implements FinanceProfitDetailDAO {
	...
	private StringBuilder getProfitDetailQuery() {
		...
		sql.append(", PrvMthGapIntAmz, FirstRepayDate, PrvMthAcr , NoInst");
	...
	public BigDecimal getOverDueAmountByLoan(long finID) {
		StringBuilder sql = new StringBuilder("Select ");
		sql.append(" (ODPRINCIPAL + ODPROFIT + COALESCE(OD.LPPDUE,0) + COALESCE(OD.LPIDUE,0)");
