 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NPABucketConfigurationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-04-2017 * *
...
public interface NPABucketConfigurationDAO extends BasicCrudDao<NPABucketConfiguration> {
	 ...
	 * 
	 * @param configID  configID of the NPABucketConfiguration.
	 ...
	 * 
	 * @param configID    configID of the NPABucketConfiguration.
	 * @param productCode productCode of the NPABucketConfiguration.
	 * @param bucketID    bucketID of the NPABucketConfiguration.
	 * @param tableType   The type of the table.
