 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SecurityOperationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-03-2014 * * Modified
 * Date : 10-03-2014 * * Description : * *
 ********************************************************************************************
...
public interface SecurityOperationDAO {
	...
	void delete(SecurityOperation securityOperation, String type);

	long save(SecurityOperation securityOperation, String type);
