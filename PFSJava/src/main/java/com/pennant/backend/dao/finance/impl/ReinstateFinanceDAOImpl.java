...
public class ReinstateFinanceDAOImpl extends BasicDao<ReinstateFinance> implements ReinstateFinanceDAO {
	...
	public FinanceMain getRejectedFinanceById(final String id) {
		...
		selectSql.append(" ClosingStatus, FinApprovedDate, InitiateUser,");
		selectSql.append(
				" AnualizedPercRate , EffectiveRateOfReturn , FinRepayPftOnFrq , GrcProfitDaysBasis, StepFinance , StepPolicy, AlwManualSteps, NoOfSteps, ");
		...
		selectSql.append(
				" Blacklisted, FeeChargeAmt, LimitValid, OverrideLimit, FinPurpose,FinStatus, FinStsReason,Authorization1,Authorization2, NextUserId, Priority, MinDownPayPerc ");
