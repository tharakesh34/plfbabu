 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DirectorDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 01-12-2011 * * Modified
 * Date : 01-12-2011 * * Description : * *
 ********************************************************************************************
...
public interface DirectorDetailDAO {
	...
	DirectorDetail getDirectorDetailByDirectorId(long directorId, long custId, String string);
