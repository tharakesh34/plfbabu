 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : QueryCategoryDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 08-05-2018 * * Modified
 * Date : 08-05-2018 * * Description : * *
 ********************************************************************************************
...
public interface QueryCategoryDAO extends BasicCrudDao<QueryCategory> {
	 ...
	 * 
	 * @param id        id of the QueryCategory.
	 * @param code      code of the QueryCategory.
	 * @param tableType The type of the table.
