 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceRepayPriorityDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-03-2012 * *
...
public class FinanceRepayPriorityDAOImpl extends BasicDao<FinanceRepayPriority> implements FinanceRepayPriorityDAO {
	...
	/**
	 * This method Deletes the Record from the FinRpyPriority or FinRpyPriority_Temp. if Record not deleted then throws
	 * DataAccessException with error 41003. delete Finance Repay Priority Details by key FinType
	 * 
	...
	/**
	 * This method updates the Record FinRpyPriority or FinRpyPriority_Temp. if Record not updated then throws
	 * DataAccessException with error 41004. update Finance Repay Priority Details by key FinType and Version
	 * 
	 * @param Finance Repay Priority Details (financeRepayPriority)
	 * @param type    (String) ""/_Temp/_View
	 * @return void
