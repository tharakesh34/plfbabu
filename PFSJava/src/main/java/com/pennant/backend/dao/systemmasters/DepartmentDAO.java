 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DepartmentDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date :
...
public interface DepartmentDAO extends BasicCrudDao<Department> {
	...
	/**
	 * 
	 * @param departmentCode of department
	 * @param tableType      of department
	 * @return
	 */
