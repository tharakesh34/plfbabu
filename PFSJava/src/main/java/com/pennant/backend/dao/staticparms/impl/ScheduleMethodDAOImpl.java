 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScheduleMethodDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class ScheduleMethodDAOImpl extends BasicDao<ScheduleMethod> implements ScheduleMethodDAO {
	...
	public ScheduleMethod getScheduleMethodById(final String id, String type) {
		...
		RowMapper<ScheduleMethod> typeRowMapper = BeanPropertyRowMapper.newInstance(ScheduleMethod.class);
	 ...
	 * 
	 * @param Schedule Method (scheduleMethod)
	 * @param type     (String) ""/_Temp/_View
	 * @return void
