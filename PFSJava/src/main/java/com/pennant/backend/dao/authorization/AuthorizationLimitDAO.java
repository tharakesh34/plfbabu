 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AuthorizationLimitDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-04-2018 * *
...
public interface AuthorizationLimitDAO extends BasicCrudDao<AuthorizationLimit> {
	 ...
	 * 
	 * @param id        id of the AuthorizationLimit.
	 * @param limitType limitType of the AuthorizationLimit.
	 * @param userID    userID of the AuthorizationLimit.
	 * @param roleId    roleId of the AuthorizationLimit.
	 * @param module    module of the AuthorizationLimit.
	 * @param tableType The type of the table.
