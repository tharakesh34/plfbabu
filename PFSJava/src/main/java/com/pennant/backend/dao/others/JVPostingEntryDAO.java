 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : JVPostingEntryDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-06-2013 * * Modified
...
public interface JVPostingEntryDAO {
	...
	JVPostingEntry getJVPostingEntryById(long id, long txnReference, long acEntryRef, String type);
	...
	List<JVPostingEntry> getDeletedJVPostingEntryListById(long batchRef, String type);
