...
public interface LimitRuleDAO {
	...
	LimitFilterQuery getLimitRuleByID(String id, String queryModule, String querySubCode, String type);

	List<LimitFilterQuery> getLimitRuleByModule(String queryModule, String querySubCode, String type);
