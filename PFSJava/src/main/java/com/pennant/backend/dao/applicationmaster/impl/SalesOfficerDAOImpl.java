...
public class SalesOfficerDAOImpl extends BasicDao<SalesOfficer> implements SalesOfficerDAO {
	...
	public SalesOfficer getSalesOfficerById(final String id, String type) {
		...
		selectSql.append(
				"SELECT T1.SalesOffCode, T1.SalesOffFName, T1.SalesOffMName, T1.SalesOffLName, T1.SalesOffShrtName, T1.SalesOffDept, T1.SalesOffIsActive,T2.DeptDesc lovDescSalesOffDeptName,");
	...
	public String save(SalesOfficer salesOfficer, String type) {
		...
		insertSql.append(
				" (SalesOffCode, SalesOffFName, SalesOffMName, SalesOffLName, SalesOffShrtName, SalesOffDept, SalesOffIsActive,");
		insertSql.append(
				" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(
				" Values(:SalesOffCode, :SalesOffFName, :SalesOffMName, :SalesOffLName, :SalesOffShrtName, :SalesOffDept, :SalesOffIsActive, ");
		insertSql.append(
				" :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId)");
	...
	public void update(SalesOfficer salesOfficer, String type) {
		...
		updateSql.append(
				" Set SalesOffFName = :SalesOffFName, SalesOffMName = :SalesOffMName, SalesOffLName = :SalesOffLName, ");
		updateSql.append(
				" SalesOffShrtName = :SalesOffShrtName, SalesOffDept = :SalesOffDept, SalesOffIsActive = :SalesOffIsActive, ");
