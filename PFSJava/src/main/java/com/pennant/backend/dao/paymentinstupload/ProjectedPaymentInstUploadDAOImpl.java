...
public class ProjectedPaymentInstUploadDAOImpl extends BasicDao<PaymentInstBulkUploadQueuing>
	...
	private static Logger logger = LogManager.getLogger(ProjectedPaymentInstUploadDAOImpl.class);

	private static final String UPDATE_SQL = "UPDATE PaymentInstUploadQueuing set ThreadId = :ThreadId Where ThreadId = :AcThreadId";
