 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CollateralStructureDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 29-11-2016 * *
...
public interface CollateralStructureDAO {
	CollateralStructure getCollateralStructureByType(String collateralType, String type);

	void update(CollateralStructure collateralStructure, String type);
