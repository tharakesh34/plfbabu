 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ReinstateFinanceDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public interface ReinstateFinanceDAO {
	...
	ReinstateFinance getReinstateFinanceById(long finID, String type);
