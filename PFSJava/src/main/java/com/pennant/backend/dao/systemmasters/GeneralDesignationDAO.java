 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDesignationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public interface GeneralDesignationDAO extends BasicCrudDao<GeneralDesignation> {
	 ...
	 * 
	 * @param genDesignation genDesignation of the generalDesignation.
