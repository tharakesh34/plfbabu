 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerTypeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date
...
public interface CustomerTypeDAO extends BasicCrudDao<CustomerType> {
	 ...
	 * 
	 * @param customerTypeCode of CustomerTypeDAO
	 * @param tableType        of CustomerTypeDAO
	 * @return
	 */
