...
public class FinOCRCaptureDAOImpl extends SequenceDao<FinOCRCapture> implements FinOCRCaptureDAO {
	private static final Logger logger = Logger.getLogger(FinOCRCaptureDAOImpl.class);
	...
	public List<FinOCRCapture> getFinOCRCaptureDetailsByRef(String finReference, String type) {
		...
		RowMapper<FinOCRCapture> typeRowMapper = ParameterizedBeanPropertyRowMapper.newInstance(FinOCRCapture.class);
