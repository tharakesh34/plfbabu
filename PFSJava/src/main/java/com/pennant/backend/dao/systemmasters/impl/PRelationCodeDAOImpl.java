 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PRelationCodeDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class PRelationCodeDAOImpl extends BasicDao<PRelationCode> implements PRelationCodeDAO {
	private static Logger logger = LogManager.getLogger(PRelationCodeDAOImpl.class);
	...
	public PRelationCode getPRelationCodeById(final String id, String type) {
		...
		RowMapper<PRelationCode> typeRowMapper = BeanPropertyRowMapper.newInstance(PRelationCode.class);
	 ...
	 * 
	 * @param Persional Relation Codes (pRelationCode)
	 * @param type      (String) ""/_Temp/_View
	 * @return void
