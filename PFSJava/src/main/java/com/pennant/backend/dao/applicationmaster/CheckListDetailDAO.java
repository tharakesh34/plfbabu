 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CheckListDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-12-2011 * * Modified
...
public interface CheckListDetailDAO {
	...
	List<CheckListDetail> getCheckListDetailByChkList(final Set<Long> checkListId, String type);
