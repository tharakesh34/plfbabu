 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmpStsCodeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date :
...
public interface EmpStsCodeDAO extends BasicCrudDao<EmpStsCode> {
	 ...
	 * 
	 * @param empStsCode of EmpStsCode
	 * @param tableType  of EmpStsCode
	 * @return
	 */
