 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SnapShotConditionsDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-02-2018 * *
...
public interface SnapShotConditionsDAO extends BasicCrudDao<SnapShotCondition> {
	 ...
	 * 
	 * @param id             id of the SnapShotConditions.
	 * @param executionOrder executionOrder of the SnapShotConditions.
