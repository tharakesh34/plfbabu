 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SeqAccountNumberDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 01-12-2011 * *
...
public class GenerateAccountNumberDAOImpl extends BasicDao<SeqAccountNumber> implements GenerateAccountNumberDAO {
	...
	public SeqAccountNumber getSeqAccountNumber(SeqAccountNumber seqAccountNumber, boolean isReadOnly) {
		...
		try {
			return this.jdbcTemplate.queryForObject(selectQry.toString(), beanParameters, typeRowMapper);
	 ...
	 * 
	 * @param SeqAccountNumber Details (seqAccountNumber)
	 *
	 * @return void
