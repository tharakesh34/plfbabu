 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : MaritalStatusCodeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public interface MaritalStatusCodeDAO extends BasicCrudDao<MaritalStatusCode> {
	 ...
	 * 
	 * @param maritalStsCode of MaritalStatusCode
	 * @param tableType      of MaritalStatusCode
	 * @return
	 */
