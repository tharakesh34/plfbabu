 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmployerDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 31-07-2013 * * Modified
 * Date : 31-07-2013 * * Description : * *
 ********************************************************************************************
...
public interface EmployerDetailDAO extends BasicCrudDao<EmployerDetail> {
	...
	/**
	 * 
	 * @param employerId of EmployerDetail
	 * @param tableType  of EmployerDetail
	 * @return
	 */
