 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinTypeFeesDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 30-06-2011 * * Modified Date
...
public interface FinTypeFeesDAO {
	...
	List<FinTypeFees> getFinTypeFeesForLMSEvent(String finType, String finEvent);
