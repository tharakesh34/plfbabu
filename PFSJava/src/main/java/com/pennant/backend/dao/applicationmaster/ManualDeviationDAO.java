 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ManualDeviationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-04-2018 * * Modified
 * Date : 03-04-2018 * * Description : * *
 ********************************************************************************************
...
public interface ManualDeviationDAO extends BasicCrudDao<ManualDeviation> {
	 ...
	 * 
	 * @param deviationID deviationID of the ManualDeviation.
	 * @param code        code of the ManualDeviation.
	 * @param tableType   The type of the table.
