...
public class CheckListDAOImpl extends SequenceDao<CheckList> implements CheckListDAO {
	...
	public CheckList getCheckListById(final long id, String type) {
		...
		StringBuilder selectSql = new StringBuilder(
				"Select CheckListId, CheckListDesc, CheckMinCount, CheckMaxCount, CheckRule, Active,");
		selectSql.append(
				" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId, ModuleName");
	...
	/**
	 * This method insert new Records into BMTCheckList or BMTCheckList_Temp. it fetches the available Sequence form
	 * SeqBMTCheckList by using getNextidviewDAO().getNextId() method.
	 *
	 * save Check List
	 * 
	 * @param Check List (checkList)
	...
	public void update(CheckList checkList, String type) {
		...
		updateSql.append(
				" CheckMinCount = :CheckMinCount, CheckMaxCount = :CheckMaxCount,CheckRule=:CheckRule, Active = :Active, ");
		updateSql.append(" Version = :Version , LastMntBy = :LastMntBy, LastMntOn = :LastMntOn,");
		updateSql.append(" RecordStatus= :RecordStatus, RoleCode = :RoleCode, NextRoleCode = :NextRoleCode,");
		updateSql.append(
				" TaskId = :TaskId, NextTaskId = :NextTaskId, RecordType = :RecordType, WorkflowId = :WorkflowId, ModuleName = :ModuleName");
