 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PSLDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 20-06-2018 * * Modified Date :
 * 20-06-2018 * * Description : * *
 ********************************************************************************************
...
public interface SynopsisDetailsDAO extends BasicCrudDao<SynopsisDetails> {
	...
	SynopsisDetails getSynopsisDetails(long finID);
}