...
public interface FinStageAccountingLogDAO {
	...
	long getLinkedTranId(long finID, String finevent, String roleCode);

	void saveStageAccountingLog(FinStageAccountingLog stageAccountingLog);

	void deleteByRefandRole(long finID, String finEvent, String roleCode);

	List<Long> getLinkedTranIdList(long finID, String finEvent);

	void update(long finID, String finEvent, boolean processed);
