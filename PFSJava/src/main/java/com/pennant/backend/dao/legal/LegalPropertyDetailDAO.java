 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LegalPropertyDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-06-2018 * *
...
public interface LegalPropertyDetailDAO extends BasicCrudDao<LegalPropertyDetail> {
	 ...
	 * 
	 * @param legalPropertyId legalPropertyId of the LegalPropertyDetail.
	 * @param legalId
