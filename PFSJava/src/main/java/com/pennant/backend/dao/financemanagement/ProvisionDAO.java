 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProvisionDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 31-05-2012 * * Modified Date :
...
public interface ProvisionDAO {
	...
	Provision getProvisionByFinId(long finID, TableType type, boolean isMovement);
	...
	boolean isProvisionExists(long finID, TableType type);
