 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AuthorizationLimitDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-04-2018 * *
...
public interface AuthorizationLimitDetailDAO extends BasicCrudDao<AuthorizationLimitDetail> {
	 ...
	 * 
	 * @param id        id of the AuthorizationLimitDetail.
	 ...
	 * 
	 * @param id          id of the AuthorizationLimitDetail.
	 * @param authLimitId authLimitId of the AuthorizationLimitDetail.
	 * @param code        code of the AuthorizationLimitDetail.
	 * @param tableType   The type of the table.
