 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProvisionMovementDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 31-05-2012 * * Modified
...
public interface ProvisionMovementDAO {
	...
	ProvisionMovement getProvisionMovementById(long finID, Date movementDate, String type);
