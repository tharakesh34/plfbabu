 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ChequeHeaderDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-11-2017 * * Modified Date
...
public interface ChequeHeaderDAO {
	...
	void deleteByFinRef(long finID, TableType tableType);

	boolean isDuplicateKey(long headerID, long finID, TableType tableType);
