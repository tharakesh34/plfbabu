 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : MaritalStatusCodeDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class MaritalStatusCodeDAOImpl extends BasicDao<MaritalStatusCode> implements MaritalStatusCodeDAO {
	...
	public MaritalStatusCode getMaritalStatusCodeById(final String id, String type) {
		...
		RowMapper<MaritalStatusCode> typeRowMapper = BeanPropertyRowMapper.newInstance(MaritalStatusCode.class);
	 ...
	 * 
	 * @param Marital Status Codes (maritalStatusCode)
	 * @param type    (String) ""/_Temp/_View
	 * @return void
