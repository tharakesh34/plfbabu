 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SnapShotColumnDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-02-2018 * * Modified
 * Date : 16-02-2018 * * Description : * *
 ********************************************************************************************
...
public interface SnapShotColumnDAO extends BasicCrudDao<SnapShotColumn> {
	 ...
	 * 
	 * @param id         id of the SnapShotColumn.
	 * @param columnName columnName of the SnapShotColumn.
