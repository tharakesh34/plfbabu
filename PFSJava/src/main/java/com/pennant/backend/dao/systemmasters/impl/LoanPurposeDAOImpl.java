...
public class LoanPurposeDAOImpl extends BasicDao<LoanPurpose> implements LoanPurposeDAO {
	private static Logger logger = LogManager.getLogger(LoanPurposeDAOImpl.class);
	...
	public LoanPurpose getLoanPurposeById(final String id, String type) {
		...
		RowMapper<LoanPurpose> typeRowMapper = BeanPropertyRowMapper.newInstance(LoanPurpose.class);
