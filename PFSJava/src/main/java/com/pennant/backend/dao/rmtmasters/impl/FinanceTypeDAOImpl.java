...
public class FinanceTypeDAOImpl extends BasisCodeDAO<FinanceType> implements FinanceTypeDAO {
	...
	public FinanceType getFinanceTypeByID(final String id, String type) {
		...
		selectSql.append(" FinIsDwPayRequired,  FinRvwRateApplFor, FinAlwRateChangeAnyDate, FinGrcRvwRateApplFor,FinIsIntCpzAtGrcEnd,");
		...
		selectSql.append(" MaxUnplannedEmi, MaxReAgeHolidays, CalRoundingMode, FrequencyDays,alwMaxDisbCheckReq,quickDisb, ");
		...
		if (type.contains("View")) {
			...
			selectSql.append(" lovDescPftPayAcTypeName,lovDescFinSuspAcTypeName, lovDescFinDivisionName,lovDescPromoFinTypeDesc,");
		}
	...
	public FinanceType getOrgFinanceTypeByID(final String finType, String type) {
		...
		selectSql.append(" MaxReAgeHolidays, CalRoundingMode, FrequencyDays,AlwReage,AlwUnPlanEmiHoliday,alwMaxDisbCheckReq,quickDisb ");
		if(type.contains("ORGView")){
			...
			selectSql.append(" GrcPricingMethodDesc, RpyPricingMethodDesc, DftStepPolicyType, ProductCategory ");
		}
		selectSql.append(" FROM RMTFinanceTypes");
		selectSql.append(StringUtils.trimToEmpty(type));
		selectSql.append(" Where FinType = :FinType");
	...
	public String save(FinanceType financeType, String type) {
		...
		insertSql.append(" FinAlwRateChangeAnyDate, FinGrcRvwRateApplFor, ");
		...
		insertSql.append(" AllowDownpayPgm, Remarks, AlwEarlyPayMethods , ");
		...
		insertSql.append(" PlanEMIHLockPeriod , PlanEMICpz , UnPlanEMIHLockPeriod , UnPlanEMICpz , ReAgeCpz, FddLockPeriod, AlwdRpyMethods,MaxUnplannedEmi, MaxReAgeHolidays, CalRoundingMode, FrequencyDays,alwMaxDisbCheckReq) ");
	...
	public void update(FinanceType financeType, String type) {
		...
		updateSql.append(" Set FinType = :FinType, Product = :Product,  FinTypeDesc = :FinTypeDesc, FinCategory =:FinCategory, FinCcy = :FinCcy,");
		...
		updateSql.append(" FinGrcRvwRateApplFor = :FinGrcRvwRateApplFor, ");
		...
		updateSql.append(" DownPayRule=:DownPayRule, ");
		...
		updateSql.append(" CalRoundingMode=:CalRoundingMode ,FrequencyDays=:FrequencyDays,AlwMaxDisbCheckReq=:AlwMaxDisbCheckReq,QuickDisb=:QuickDisb");
