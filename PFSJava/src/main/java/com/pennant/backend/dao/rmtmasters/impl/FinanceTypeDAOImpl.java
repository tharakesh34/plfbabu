...
public class FinanceTypeDAOImpl extends BasicDao<FinanceType> implements FinanceTypeDAO {
	...
	public FinanceType getFinanceTypeByID(final String id, String type) {
		...
		sql.append(
				", AdvStage, DsfReq, CashCollateralReq  , TdsAllowToModify , TdsApplicableTo, AlwVan, vanAllocationMethod, allowDrawingPower, allowRevolving ");
	...
	public FinanceType getFinanceTypeByFinType(final String finType) {
		...
		selectSql.append(
				" PastduePftCalMthd, PastduePftMargin,alwMultiPartyDisb, alwMaxDisbCheckReq, CostOfFunds, FinLTVCheck, PartiallySecured , AlwVan, vanAllocationMethod ");
	...
	public String save(FinanceType financeType, String type) {
		...
		sql.append(
				", :DsfReq, :CashCollateralReq , :TdsAllowToModify , :TdsApplicableTo, :AlwVan, :VanAllocationMethod , :AllowDrawingPower, :AllowRevolving) ");
	...
	public void update(FinanceType financeType, String type) {
		...
		sql.append(
				", AlwVan =:AlwVan, VanAllocationMethod =:VanAllocationMethod , AllowDrawingPower =:AllowDrawingPower, AllowRevolving =:AllowRevolving");
		sql.append(" Where FinType =:FinType");
