...
public class FinanceTypeDAOImpl extends BasisCodeDAO<FinanceType> implements FinanceTypeDAO {
	...
	public FinanceType getFinanceTypeByID(final String id, String type) {
		...
		selectSql.append(" chequeCaptureReq, FinLTVCheck, PartiallySecured, alwAdvEMI, advEMIMinTerms, advEMIMaxTerms, advEMIDftTerms, advEMISchdMthd, bpiRateBasis, alwHybridRate, fixedRateTenor,");
	...
	public String save(FinanceType financeType, String type) {
		...
		insertSql.append(" alwAdvEMI, advEMIMinTerms, advEMIMaxTerms, advEMIDftTerms, advEMISchdMthd, bpiRateBasis, alwHybridRate, fixedRateTenor)");
	...
	public void update(FinanceType financeType, String type) {
		...
		updateSql.append(" alwAdvEMI = :alwAdvEMI, advEMIMinTerms = :advEMIMinTerms, advEMIMaxTerms = :advEMIMaxTerms, advEMIDftTerms = :advEMIDftTerms, advEMISchdMthd = :advEMISchdMthd, bpiRateBasis = :bpiRateBasis,");
