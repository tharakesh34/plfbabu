 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ExtendedFieldHeaderDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 28-12-2011 * *
...
public interface ExtendedFieldHeaderDAO {
	...
	ExtendedFieldHeader getExtendedFieldHeaderByModuleName(String moduleName, String subModuleName, String event,
			String type);
