...
public class FinanceMainDAOImpl extends BasicDao<FinanceMain> implements FinanceMainDAO {
	...
	public FinanceMain getFinanceMain(final String id, String nextRoleCode, String type) {
		...
		selectSql.append(
				", GrcAdvType, GrcAdvTerms, AdvType, AdvTerms, AdvStage, AllowDrawingPower, AllowRevolving, SanBsdSchdle, PromotionSeqId,SvAmount,CbAmount");
	...
	public FinanceMain getFinanceMainById(final String finReference, String type, boolean isWIF) {
		...
		selectSql.append(
				", GrcAdvType, GrcAdvTerms, AdvType, AdvTerms, AdvStage, SanBsdSchdle, PromotionSeqId, SvAmount, CbAmount ");
		if (!isWIF) {
	...
	public FinanceMain getFinMainsForEODByFinRef(String finReference, boolean isActive) {
		...
		selectSql.append(
				" FinCategory, ProductCategory, ReAgeBucket,TDSApplicable, SanBsdSchdle, PromotionSeqId, SvAmount, CbAmount ");
