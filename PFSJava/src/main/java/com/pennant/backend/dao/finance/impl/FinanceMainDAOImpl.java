...
public class FinanceMainDAOImpl extends BasisCodeDAO<FinanceMain> implements FinanceMainDAO {
	...
	public FinanceMain getFinanceMain(final String id, String nextRoleCode, String type) {
		...
		selectSql
				.append(" ,	AdvanceEMI, AdvEMITerms, BpiRateBasis, FixedTenorRate,FixedRateTenor");
	...
	public String save(FinanceMain financeMain, TableType tableType, boolean wif) {
		...
		sql.append(" FinCategory, ProductCategory, AdvanceEMI, AdvEMITerms, BpiRateBasis, FixedTenorRate,FixedRateTenor,");
	...
	public void update(FinanceMain financeMain, TableType tableType, boolean wif) {
		...
		sql.append(" AdvanceEMI = :AdvanceEMI, AdvEMITerms = :AdvEMITerms, BpiRateBasis = :BpiRateBasis, FixedTenorRate=:FixedTenorRate, FixedRateTenor=:FixedRateTenor,");
	...
	public void listUpdate(ArrayList<FinanceMain> financeMain, String type) {
		...
		updateSql.append(" PromotionCode = :PromotionCode, AdvanceEMI = :AdvanceEMI, AdvEMITerms = :AdvEMITerms, BpiRateBasis= :BpiRateBasis, FixedTenorRate=:FixedTenorRate, FixedRateTenor=:FixedRateTenor");
		updateSql.append(" Where FinReference =:FinReference");
		logger.debug("updateSql: " + updateSql.toString());
	...
	public String saveRejectFinanace(FinanceMain financeMain) {
		...
		insertSql.append(" Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId,");
		insertSql.append(" NextTaskId, RecordType, WorkflowId, RejectStatus, RejectReason, DueBucket, AdvanceEMI , AdvEMITerms, BpiRateBasis, FixedTenorRate,FixedRateTenor)");
