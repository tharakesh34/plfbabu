...
public interface FinFeeChargesDAO {
	...
	FeeRule getFeeChargesByFinRefAndFee(long finID, String feeCode, String tableType);
	...
	List<FeeRule> getFeeChargesByFinRef(long finID, String finEvent, boolean isWIF, String tableType);
}
