 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LiabilityRequestDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 31-12-2015 * * Modified
 * Date : 31-12-2015 * * Description : * *
 ********************************************************************************************
...
public interface LiabilityRequestDAO {
	...
	LiabilityRequest getLiabilityRequestByFinReference(long finID, String type);
	...
	int getFinareferenceCount(long finID, String type);
}