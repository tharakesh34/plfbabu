 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IncomeTypeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date :
...
public interface IncomeTypeDAO extends BasicCrudDao<IncomeType> {
	 ...
	 * 
	 * @param incomeTypeCode IncomeTypeCode of the incomeType.
	 * @param incomeExpense  IncomeExpense of the incomeType.
	 * @param category       Category of the incomeType.
