 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : VASProductTypeDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 09-01-2017 * *
...
public class VASProductTypeDAOImpl extends BasicDao<VASProductType> implements VASProductTypeDAO {
	...
	public VASProductType getVASProductTypeById(final String id, String type) {
		...
		RowMapper<VASProductType> typeRowMapper = BeanPropertyRowMapper.newInstance(VASProductType.class);
	 ...
	 * 
	 * @param VASProductType (vASProductType)
	 * @param type           (String) ""/_Temp/_View
	 * @return void
