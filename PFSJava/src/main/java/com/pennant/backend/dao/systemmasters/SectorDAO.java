 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SectorDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date :
...
public interface SectorDAO extends BasicCrudDao<Sector> {
	 ...
	 * 
	 * @param sectorCode SectorCode of the sector
	 * @param tableType  The type of the table.
	 * @return true if the record exists.
	 */
	boolean isDuplicateKey(String sectorCode, TableType tableType);

	boolean isExistSectorCode(String code);
}