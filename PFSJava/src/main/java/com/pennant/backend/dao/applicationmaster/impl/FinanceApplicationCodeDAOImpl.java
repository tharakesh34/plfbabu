 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceApplicationCodeDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class FinanceApplicationCodeDAOImpl extends BasicDao<FinanceApplicationCode>
	...
	public FinanceApplicationCode getFinanceApplicationCodeById(final String id, String type) {
		...
		RowMapper<FinanceApplicationCode> typeRowMapper = BeanPropertyRowMapper
	 ...
	 * 
	 * @param Finance Application Codes (financeApplicationCode)
	 * @param type    (String) ""/_Temp/_View
	 * @return void
