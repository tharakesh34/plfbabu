...
public class GCDCustomerDAOImpl implements GCDCustomerDAO {
	...
	public void save(GcdCustomer gcdCustomer) {
		...
		try {
			...
			insertSql
					.append(" IncomeSource, YearsOfCurrJob, DOI, MpAkerId, MakerDate, AuthId, AuthDate, AccType, ApCcocatg,");
			insertSql
					.append(" DateLastUpdate, NationalId, PassportNo, Nationality, PanNo, RegionId, BankType, EntityFlag,");
			insertSql
					.append(" ContactPerson, CustSearchId, SectorId, FraudFlag, FraudScore, EmiCardElig, AddressDetail,");
			insertSql.append(" BankDetail, NomineeName, NomineeAddress, NomineeRelationship, Field9, Field10,");
			insertSql
					.append(" InsertUpdateFlag, StatusFromFinnOne, RejectionReason, FinnCustId, SfdcCustomerId, BranchId)");

			insertSql
					.append(" Values(:FinCustId, :SourceSystem, :CustomerName, :ConstId, :IndustryId, :CategoryId, :Spousename,");
			insertSql.append(" :IndvCorpFlag, :FName, :MName, :Lname, :DOB, :Sex,");
			...
			insertSql
					.append(" :EmiCardElig, :AddressDetail, :BankDetail, :NomineeName, :NomineeAddress, :NomineeRelationship,");
			insertSql
					.append(" :Field9, :Field10, :InsertUpdateFlag, :StatusFromFinnOne, :RejectionReason, :FinnCustId, :SfdcCustomerId, :BranchId)");
...
/*
	...
	public void setDataSource(DataSource dataSource) {
		...
		//this.simpleJdbcCall = new SimpleJdbcCall(dataSource).withProcedureName("CREATE_CUSTOMER_IN_FINNONE");
	}
