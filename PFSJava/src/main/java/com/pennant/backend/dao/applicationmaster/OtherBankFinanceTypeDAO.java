 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : OtherBankFinanceTypeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-04-2015 * *
...
public interface OtherBankFinanceTypeDAO extends BasicCrudDao<OtherBankFinanceType> {
	 ...
	 * 
	 * @param finType   of OtherBankFinanceType
	 * @param tableType of OtherBankFinanceType
	 * @return
	 */
