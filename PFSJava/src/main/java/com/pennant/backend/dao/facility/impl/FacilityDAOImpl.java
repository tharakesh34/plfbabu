...
public class FacilityDAOImpl extends BasicDao<Facility> implements FacilityDAO {
	...
	public Facility getFacilityById(final String id, String type) {
		...
		StringBuilder selectSql = new StringBuilder(
				"Select CAFReference,FacilityType, CustID, StartDate, PresentingUnit, CountryOfDomicile, DeadLine, CountryOfRisk, EstablishedDate, NatureOfBusiness, SICCode, CountryManager, CustomerRiskType, RelationshipManager, CustomerGroup, NextReviewDate");
		selectSql.append(
				" ,CountryExposure,CountryLimit,ReviewCenter,CountryLimitAdeq,LevelOfApproval,DedupFound, SkipDedup");
		selectSql.append(
				" ,CustomerBackGround,Strength,Weaknesses,SourceOfRepayment,AdequacyOfCashFlows,TypesOfSecurities,GuaranteeDescription,FinancialSummary,Mitigants");
		selectSql.append(
				", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId");
		selectSql.append(
				",Purpose,Interim,AccountRelation,AntiMoneyLaunderClear,LimitAndAncillary,AntiMoneyLaunderSection,OverriddeCirculation");
		if (StringUtils.trimToEmpty(type).contains("View")) {
			...
			selectSql.append(
					",sICCodeName,CustomerGroupName,CustGrpCodeName,CountryManagerName, CustRelation,CustTypeDesc");
		}
	...
	public String save(Facility facility, String type) {
		...
		insertSql.append(
				" (CAFReference, FacilityType,CustID, StartDate, PresentingUnit, CountryOfDomicile, DeadLine, CountryOfRisk, EstablishedDate, NatureOfBusiness, SICCode, CountryManager, CustomerRiskType, RelationshipManager, CustomerGroup, NextReviewDate");
		insertSql.append(
				" ,CountryExposure,CountryLimit,ReviewCenter,CountryLimitAdeq,LevelOfApproval,OverriddeCirculation,DedupFound, SkipDedup");
		insertSql.append(
				" ,CustomerBackGround,Strength,Weaknesses,SourceOfRepayment,AdequacyOfCashFlows,TypesOfSecurities,GuaranteeDescription,FinancialSummary,Mitigants");
		insertSql.append(
				" ,Purpose,Interim,AccountRelation,AntiMoneyLaunderClear,LimitAndAncillary,AntiMoneyLaunderSection");
		insertSql.append(
				", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId)");
		insertSql.append(
				" Values( :CAFReference, :FacilityType,:CustID, :StartDate, :PresentingUnit, :CountryOfDomicile, :DeadLine, :CountryOfRisk, :EstablishedDate, :NatureOfBusiness, :SICCode, :CountryManager, :CustomerRiskType, :RelationshipManager, :CustomerGroup, :NextReviewDate");
		insertSql.append(
				" ,:CountryExposure,:CountryLimit,:ReviewCenter,:CountryLimitAdeq,:LevelOfApproval,:OverriddeCirculation,:DedupFound, :SkipDedup");
		insertSql.append(
				" ,:CustomerBackGround,:Strength,:Weaknesses,:SourceOfRepayment,:AdequacyOfCashFlows,:TypesOfSecurities,:GuaranteeDescription,:FinancialSummary,:Mitigants");
	...
	public void update(Facility facility, String type) {
		...
		updateSql.append(
				" , CountryExposure=:CountryExposure, CountryLimit=:CountryLimit, ReviewCenter=:ReviewCenter, CountryLimitAdeq=:CountryLimitAdeq, LevelOfApproval=:LevelOfApproval,OverriddeCirculation=:OverriddeCirculation");
		updateSql.append(
				" ,CustomerBackGround=:CustomerBackGround,Strength=:Strength,Weaknesses=:Weaknesses,SourceOfRepayment=:SourceOfRepayment,AdequacyOfCashFlows=:AdequacyOfCashFlows,TypesOfSecurities=:TypesOfSecurities,GuaranteeDescription=:GuaranteeDescription,FinancialSummary=:FinancialSummary,Mitigants=:Mitigants");
		updateSql.append(
				" ,Purpose=:Purpose, Interim=:Interim, AccountRelation=:AccountRelation, AntiMoneyLaunderClear=:AntiMoneyLaunderClear, LimitAndAncillary=:LimitAndAncillary, AntiMoneyLaunderSection=:AntiMoneyLaunderSection ");
	...
	public Facility getLatestFacilityByCustID(final long custID, String type) {
		...
		selectSql.append(
				" Select CAFReference,FacilityType, CustID, StartDate, PresentingUnit, CountryOfDomicile, DeadLine, CountryOfRisk, ");
		selectSql.append(
				" EstablishedDate, NatureOfBusiness, SICCode, CountryManager, CustomerRiskType, RelationshipManager, CustomerGroup, NextReviewDate");
		selectSql.append(
				" ,CountryExposure,CountryLimit,ReviewCenter,CountryLimitAdeq,LevelOfApproval,DedupFound, SkipDedup");
		selectSql.append(
				" ,CustomerBackGround,Strength,Weaknesses,SourceOfRepayment,AdequacyOfCashFlows,TypesOfSecurities,GuaranteeDescription,FinancialSummary,Mitigants ");
