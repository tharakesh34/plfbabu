 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AddressTypeDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date
...
public interface AddressTypeDAO extends BasicCrudDao<AddressType> {
	 ...
	 * 
	 * @param addressTypeCode addressTypeCode of the addressType.
