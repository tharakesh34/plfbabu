 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IdentityDetailsDAOImpl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class IdentityDetailsDAOImpl extends BasicDao<IdentityDetails> implements IdentityDetailsDAO {
	private static Logger logger = LogManager.getLogger(IdentityDetailsDAOImpl.class);
	 ...
	 * 
	 * @param Identity Details (identityDetails)
	 * @param type     (String) ""/_Temp/_View
	 * @return void
