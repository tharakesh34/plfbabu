...
public interface CreditReviewSummaryDAO {
	...
	List<FinCreditReviewSummary> getListCreditReviewSummaryByYearAndCustId2(long id, String year, String category,
			String type);

	List<FinCreditReviewSummary> getListCreditReviewSummaryByYearAndCustId2(long id, String year, String category,
			int auditPeriod, boolean isCurrentYear, String type);
