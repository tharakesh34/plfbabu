...
public class ManagerChequeDAOImpl extends SequenceDao<ManagerCheque> implements ManagerChequeDAO {
	...
	/**
	 * This method get the module from method getManagerCheque() and set the new record flag as true and return
	 * ManagerCheque()
	 * 
	 * @return ManagerCheque
	 */
	...
	public ManagerCheque getManagerChequeById(final long id, String type) {
		...
		StringBuilder selectSql = new StringBuilder(
				"Select ChequeID, ChqPurposeCode, ChequeRef, ChequeNo, BeneficiaryName, CustCIF, DraftCcy, FundingCcy, FundingAccount, NostroAccount, NostroFullName, ChequeAmount, ValueDate, Narration1, Narration2, Reprint, OldChequeID, Cancel");
		selectSql.append(
				", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId, BranchCode, StopOrderRef");
		selectSql.append(
				", IssueDate, ChargeAmount, AddressLine1, AddressLine2, AddressLine3, AddressLine4, AddressLine5");
	...
	/**
	 * This method Deletes the Record from the ManagerCheques or ManagerCheques_Temp. if Record not deleted then throws
	 * DataAccessException with error 41003. delete Manager Cheques by key ChequeID
	 * 
	 * @param Manager
	 *            Cheques (managerCheque)
	 * @param type
	 *            (String) ""/_Temp/_View
	 * @return void
	...
	/**
	 * This method insert new Records into ManagerCheques or ManagerCheques_Temp. it fetches the available Sequence form
	 * SeqManagerCheques by using getNextidviewDAO().getNextId() method.
	 *
	...
	public long save(ManagerCheque managerCheque, String type) {
		...
		insertSql.append(
				" (ChequeID, ChqPurposeCode, ChequeRef, ChequeNo, BeneficiaryName, CustCIF, DraftCcy, FundingCcy, FundingAccount, NostroAccount, NostroFullName, ChequeAmount, ValueDate, Narration1, Narration2, Reprint, OldChequeID, Cancel");
		insertSql.append(
				", Version , LastMntBy, LastMntOn, RecordStatus, RoleCode, NextRoleCode, TaskId, NextTaskId, RecordType, WorkflowId, BranchCode, StopOrderRef");
		insertSql.append(
				", IssueDate, ChargeAmount, AddressLine1, AddressLine2, AddressLine3, AddressLine4, AddressLine5)");
		insertSql.append(
				" Values(:ChequeID, :ChqPurposeCode, :ChequeRef, :ChequeNo, :BeneficiaryName, :CustCIF, :DraftCcy, :FundingCcy, :FundingAccount, :NostroAccount, :NostroFullName, :ChequeAmount, :ValueDate, :Narration1, :Narration2, :Reprint, :OldChequeID, :Cancel");
		insertSql.append(
				", :Version , :LastMntBy, :LastMntOn, :RecordStatus, :RoleCode, :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId, :BranchCode, :StopOrderRef");
		insertSql.append(
				", :IssueDate, :ChargeAmount, :AddressLine1, :AddressLine2, :AddressLine3, :AddressLine4, :AddressLine5)");
	...
	/**
	 * This method updates the Record ManagerCheques or ManagerCheques_Temp. if Record not updated then throws
	 * DataAccessException with error 41004. update Manager Cheques by key ChequeID and Version
	 * 
	 * @param Manager
	 *            Cheques (managerCheque)
	 * @param type
	...
	public void update(ManagerCheque managerCheque, String type) {
		...
		updateSql.append(
				" Set ChqPurposeCode = :ChqPurposeCode, ChequeRef = :ChequeRef, ChequeNo = :ChequeNo, BeneficiaryName = :BeneficiaryName");
		updateSql.append(
				", CustCIF = :CustCIF, DraftCcy = :DraftCcy, FundingCcy = :FundingCcy, FundingAccount = :FundingAccount, NostroAccount = :NostroAccount, NostroFullName = :NostroFullName");
		updateSql.append(
				", ChequeAmount = :ChequeAmount, ValueDate = :ValueDate, Narration1 = :Narration1, Narration2 = :Narration2, Reprint = :Reprint, OldChequeID = :OldChequeID, Cancel = :Cancel");
		updateSql.append(
		...
		updateSql.append(
				", TaskId = :TaskId, NextTaskId = :NextTaskId, RecordType = :RecordType, WorkflowId = :WorkflowId, BranchCode = :BranchCode, StopOrderRef = :StopOrderRef");
		updateSql.append(
				", IssueDate = :IssueDate, ChargeAmount = :ChargeAmount, AddressLine1 = :AddressLine1, AddressLine2 = :AddressLine2, AddressLine3 = :AddressLine3, AddressLine4 = :AddressLine4, AddressLine5 = :AddressLine5");
