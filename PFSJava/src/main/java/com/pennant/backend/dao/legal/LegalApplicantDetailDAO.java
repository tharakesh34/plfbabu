 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LegalApplicantDetailDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-06-2018 * *
...
public interface LegalApplicantDetailDAO extends BasicCrudDao<LegalApplicantDetail> {
	 ...
	 * 
	 * @param legalApplicantId legalApplicantId of the LegalApplicantDetail.
	 * @param legalId
