 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DesignationDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date
...
public interface DesignationDAO extends BasicCrudDao<Designation> {
	...
	/**
	 * 
	 * @param designationCode of Designation
	 * @param tableType       of Designation
	 * @return
	 */
