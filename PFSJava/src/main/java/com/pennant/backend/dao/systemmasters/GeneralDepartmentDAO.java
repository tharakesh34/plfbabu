 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDepartmentDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public interface GeneralDepartmentDAO extends BasicCrudDao<GeneralDepartment> {
	 ...
	 * 
	 * @param genDepartmentCode of GeneralDepartment
	 * @param tableType         of GeneralDepartment
	 * @return
	 */
