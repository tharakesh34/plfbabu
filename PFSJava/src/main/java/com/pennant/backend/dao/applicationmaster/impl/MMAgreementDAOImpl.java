...
public class MMAgreementDAOImpl extends SequenceDao<MMAgreement> implements MMAgreementDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new MMAgreement
	 * 
	 * @return MMAgreement
	 */
	@Override
	...
	/**
	 * This method get the module from method getMMAgreement() and set the new record flag as true and return
	 * MMAgreement()
	 * 
	 * @return MMAgreement
	 */
	...
	public MMAgreement getMMAgreementById(final long id, String type) {
		...
		selectSql.append(
				" ContractAmt ,ContractDate,Rate ,Fax,Purchaddress,Attention,TitleNo,MMAgreeType,Product,AgreeName,");
		selectSql.append(
				" FOLIssueDate,MaturityDate,FacilityLimit,ProfitRate,BaseRateCode,minRate,Margin,ProfitPeriod,");
		selectSql.append(
				" MinAmount,NumberOfTerms,LatePayRate,FOlReference,AvlPerDays,MaxCapProfitRate,PmaryRelOfficer,");
		...
		if (type.contains("_View")) {
			...
			selectSql.append(
					" lovDescCustAddrCityName,lovDescCustAddrProvinceName,lovDescCustAddrCountryName,CustShrtNameLclLng,");
		}
		...
		RowMapper<MMAgreement> typeRowMapper = ParameterizedBeanPropertyRowMapper.newInstance(MMAgreement.class);

		try {
			aMMAgreement = this.jdbcTemplate.queryForObject(selectSql.toString(), beanParameters, typeRowMapper);
	...
	/**
	 * This method Deletes the Record from the MMAgreement or MMAgreement_Temp. if Record not deleted then throws
	...
	/**
	 * This method insert new Records into MMAgreement or MMAgreement_Temp.
	 * 
	 * save MMAgreement
	 * 
	 * @param MMAgreement
	...
	public long save(MMAgreement aMMAgreement, String type) {
		...
		insertSql.append(
				" :NextRoleCode, :TaskId, :NextTaskId, :RecordType, :WorkflowId, :MMAgreeType,:Product,:AgreeName,");
		insertSql.append(
				" :FOLIssueDate, :MaturityDate, :FacilityLimit, :ProfitRate, :BaseRateCode, :minRate, :Margin, :ProfitPeriod,");
		insertSql.append(" :MinAmount, :NumberOfTerms, :LatePayRate ,");
		insertSql.append(" :FOlReference, :AvlPerDays,:MaxCapProfitRate,:PmaryRelOfficer,");
	...
	/**
	 * This method updates the Record MMAgreement or MMAgreement_Temp. if Record not updated then throws
	 * DataAccessException with error 41004. update MMAgreement by key PCCountry and Version
	 * 
	 * @param Ciry
	 *            (aMMAgreement)
	 * @param type
	...
	public void update(MMAgreement aMMAgreement, String type) {
		...
		updateSql.append(
				" ContractAmt = :ContractAmt ,ContractDate = :ContractDate,PurchRegOffice = :PurchRegOffice,Fax = :Fax,");
		...
		updateSql.append(
				" RecordType = :RecordType, WorkflowId = :WorkflowId, MMAgreeType = :MMAgreeType, Product = :Product, AgreeName= :AgreeName,");
		updateSql.append(
				" FOLIssueDate =  :FOLIssueDate, MaturityDate =  :MaturityDate,FacilityLimit  =  :FacilityLimit, ProfitRate =  :ProfitRate,");
		updateSql.append(
				" BaseRateCode =  :BaseRateCode, minRate =  :minRate,Margin  =  :Margin,ProfitPeriod =  :ProfitPeriod,");
		updateSql.append(" MinAmount = :MinAmount,NumberOfTerms  =  :NumberOfTerms, LatePayRate =  :LatePayRate, ");
		updateSql.append(
				" FOlReference = :FOlReference,AvlPerDays= :AvlPerDays,MaxCapProfitRate= :MaxCapProfitRate,PmaryRelOfficer= :PmaryRelOfficer,");
