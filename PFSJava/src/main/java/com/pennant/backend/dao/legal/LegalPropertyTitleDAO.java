 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LegalPropertyTitleDAO.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 18-06-2018 * *
...
public interface LegalPropertyTitleDAO extends BasicCrudDao<LegalPropertyTitle> {
	 ...
	 * 
	 * @param legalPropertyTitleId legalPropertyTitleId of the LegalPropertyTitle.
