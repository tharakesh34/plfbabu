...
public class DeviationHeaderDAOImpl extends SequenceDao<DeviationHeader> implements DeviationHeaderDAO {
	...
	/**
	 * This method get the module from method getDeviationHeader() and set the new record flag as true and return
	 * DeviationHeader()
	 * 
	 * @return DeviationHeader
	 */
	...
	/**
	 * This method insert new Records into DeviationHeader or DeviationHeader_Temp. it fetches the available Sequence
	 * form SeqDeviationHeader by using getNextidviewDAO().getNextId() method.
	 *
