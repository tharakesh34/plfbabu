...
public class DeviationParamDAOImpl extends BasicDao<DeviationParam> implements DeviationParamDAO {
	private static Logger logger = LogManager.getLogger(DeviationParamDAOImpl.class);
