...
public class BatchFileUtil {
	...
	public static String getAutoPayReqFileName() {
		...
		filename.append(DateUtility.format(DateUtility.getAppDate(), BatchFileUtil.DATE_FORMAT_YMd));
	...
	public static String getLimitUtilFileName() {
		...
		filename.append(DateUtility.format(DateUtility.getAppDate(), BatchFileUtil.DATE_FORMAT_DMYT));
		filename.append(FILE_EXT);
		return filename.toString();
	}
	...
	public static String getBatchReference() {
		return DateUtility.format(DateUtility.getAppDate(), BatchFileUtil.DATE_FORMAT_YMd);
	}
