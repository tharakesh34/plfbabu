...
public class SnapshotService {
	...
	private static final String snapshotQuery_FinPftDetails = "INSERT INTO FinPftDetails_SnapShot  ("
			...
			+ " FINWORSTSTATUS , NOINST , NOPAIDINST , NOODINST , FINACCOUNT , FINACTYPE , DISBACCOUNTID , DISBACTCCY , REPAYACCOUNTID ,"
			...
			+ " TOTALADVPFTSCHD , TOTALRBTSCHD , TOTALPRIPAIDINADV , TDSCHDADVPFT , TDSCHDRBT , PFTAMZNORMAL , PFTAMZPD , AMZTILLLBDNORMAL ,"
			...
			+ " GSTLPPTILLLBD, AMZMethod, NOAutoIncGrcEnd) "
			...
			+ " CLOSEDLINKEDFINREF , UPFRONTFEE , BOUNCEAMTDUE , BOUNCEAMTPAID , BOUNCEAMT , RECEIVABLEADVISE , EXCESSAMTBAL ,"
			+ " EMIINADVANCEBAL , RECEIVABLEADVISEBAL , PAYABLEADVISEBAL , ACTUALODDAYS , LPITILLLBD , GSTLPITILLLBD , LPPTILLLBD ,"
			+ " GSTLPPTILLLBD, AMZMethod, NOAutoIncGrcEnd FROM FinPftDetails";
