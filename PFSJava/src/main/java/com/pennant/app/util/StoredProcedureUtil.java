 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : StoredProcedureUtil.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-09-2012 * * Modified
 * Date : 21-09-2012 * * Description : * *
 ********************************************************************************************
...
public class StoredProcedureUtil extends StoredProcedure {
	...
	public StoredProcedureUtil(DataSource dataSource, String sprocName, Map<String, Object> inParameterMap,
			Map<String, Object> outParameterMap) {
