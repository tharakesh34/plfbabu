...
public class ReportUtil implements Serializable {
	...
	public boolean generateExcelReport(String folderPath, String reportName, String reportDesc, boolean bulkReportProc,
		...
		try {
			...
			/*
			 * else{ MessageUtil.showErrorMessage(Labels.getLabel("label_Error_ReportNotImplementedYet.vlaue")); }
			 */

		} catch (Exception e) {
			logger.error("Exception: ", e);
			/*
			 * if(!bulkReportProc){ MessageUtil.showErrorMessage("Error in Configuring the " +reportName+ " report"); }
			 */
			return false;
		} finally {
			reportSrc = null;
