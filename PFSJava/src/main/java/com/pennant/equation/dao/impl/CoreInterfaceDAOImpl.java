...
public class CoreInterfaceDAOImpl extends BasicDao<EquationCurrency> implements CoreInterfaceDAO {
	...
	public void saveAccountTypeNatureDetails(List<EquationAccountType> accountTypes) throws Exception {
		...
		insertSql.append(
				" Values( :AcType, :AcTypeNature1, :AcTypeNature2, :AcTypeNature3, :AcTypeNature4, :AcTypeNature5, ");
		insertSql.append(" :AcTypeNature6 , :AcTypeNature7, :AcTypeNature8, :AcTypeNature9, :AcTypeNature10)");
	...
	public void updateAccountTypeNatureDetails(List<EquationAccountType> accountTypes) throws Exception {
		...
		updateSql.append(
				" Set  AcTypeNature1 = :AcTypeNature1, AcTypeNature2 = :AcTypeNature2, AcTypeNature3 = :AcTypeNature3,");
		updateSql.append(
				" AcTypeNature4 = :AcTypeNature4, AcTypeNature5 = :AcTypeNature5, AcTypeNature6 = :AcTypeNature6,");
		updateSql.append(
				" AcTypeNature7 = :AcTypeNature7, AcTypeNature8 = :AcTypeNature8, AcTypeNature9 = :AcTypeNature9,");
	...
	public void updateCustomerDetails(List<Customer> customerList) {
		...
		updateSql.append(
				" CustIsClosed = :CustIsClosed, CustIsActive = :CustIsActive, CustIsMinor = :CustIsMinor, CustDOB = :CustDOB, ");
		updateSql.append(
				" CustGenderCode = :CustGenderCode, CustPOB = :CustPOB, CustCoreBank = :CustCoreBank, CustTotalIncome = :CustTotalIncome, ");
		updateSql.append(
				" CustPassportNo = :CustPassportNo, CustPassportExpiry = :CustPassportExpiry, CustShrtName = :CustShrtName, ");
		updateSql.append(
				" CustFNameLclLng = :CustFNameLclLng, CustShrtNameLclLng = :CustShrtNameLclLng, CustIsBlocked = :CustIsBlocked,");
		updateSql.append(
				" CustIsDecease = :CustIsDecease, CustIsTradeFinCust = :CustIsTradeFinCust, CustClosedOn = :CustClosedOn,");
		...
		updateSql.append(
				" CustParentCountry = (CASE WHEN :CustParentCountry='' THEN CustParentCountry ELSE :CustParentCountry END),");
		updateSql.append(
				" CustRiskCountry = (CASE WHEN :CustRiskCountry=''  THEN CustRiskCountry ELSE :CustRiskCountry END),");
		updateSql.append(
				" CustSalutationCode = (CASE WHEN :CustSalutationCode=''  THEN CustSalutationCode ELSE :CustSalutationCode END),");
		...
		updateSql.append(
				" CustMaritalSts = (CASE WHEN :CustMaritalSts=''  THEN CustMaritalSts ELSE :CustMaritalSts END),");
		...
		updateSql.append(
				" CustResdCountry = (CASE WHEN :CustResdCountry=''  THEN CustResdCountry ELSE :CustResdCountry END),  ");
		updateSql.append(
				" CustNationality = (CASE WHEN :CustNationality=''  THEN CustNationality ELSE :CustNationality END)  ");
	...
	public void updateAddressDetails(List<CustomerAddres> customerList) throws Exception {
		...
		updateSql
				.append(" CustAddrLine2 = :CustAddrLine2, CustAddrZIP = :CustAddrZIP, CustAddrPhone = :CustAddrPhone ");
