...
public class GenerateAdtChangeSet {
	static final String DB_URL = "jdbc:postgresql://192.168.120.26:5432/plf_core_finid_dev?currentSchema=plfaudit,plf,public";
	...
	public String getChangeSet(String tableName, int id) throws Exception {
		...
		if (!isTableExist("adt" + tableName)) {
			return null;
		}

		boolean finIdExists = isFinIDExist("adt" + tableName);

		if (finIdExists) {
			return null;
		}

		tableName = "adt" + tableName;
