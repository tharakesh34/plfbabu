...
public class ExtInterfaceDaoImpl implements ExtInterfaceDao {
	...
	public List<ExternalConfig> getExternalConfig() {
		...
		queryStr = "SELECT INTERFACE_TYPE,NO_OF_RECORDS,FILE_LOCATION,HOLD_TYPE,FILE_PREPEND,FILE_POSTPEND,FILE_EXTENSION,DATE_FORMAT,SUCCESS_INDICATOR,FAIL_INDICATOR FROM FILE_INTERFACE_CONFIG";
