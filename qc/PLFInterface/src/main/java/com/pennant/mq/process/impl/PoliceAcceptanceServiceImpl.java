...
public class PoliceAcceptanceServiceImpl implements PoliceAcceptanceProcess {
	...
	public InterfaceMortgageDetail getPoliceAcceptance(InterfaceMortgageDetail mortgageDetail)
		...
		return getPoliceAcceptanceUtilProcess().getPoliceAcceptance(mortgageDetail,
				InterfaceMasterConfigUtil.CREATE_MORTGAGE);
	}
	...
	public void setPoliceAcceptanceUtilProcess(PoliceAcceptanceUtilProcess policeAcceptanceUtilProcess) {
