...
public class CoreBankAccountDetail implements Serializable {
	...
	private boolean powerOfAttorneyFlag;
	...
	List<CoreBankAccountDetail> acSummaryList=new ArrayList<CoreBankAccountDetail>();


	public List<CoreBankAccountDetail> getAcSummaryList() {
		return acSummaryList;
	}

	public void setAcSummaryList(List<CoreBankAccountDetail> acSummaryList) {
		this.acSummaryList = acSummaryList;
	}
	...
	public boolean getPowerOfAttorneyFlag() {
		return powerOfAttorneyFlag;
	}

	public void setPowerOfAttorneyFlag(boolean powerOfAttorneyFlag) {
