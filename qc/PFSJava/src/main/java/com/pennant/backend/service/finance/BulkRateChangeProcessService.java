...
public interface BulkRateChangeProcessService {
	...
	List<ScheduleMapDetails> getDeferedDates(List<BulkRateChangeDetails> bulkRateChangeDetails, String cbRecalType,
			Date reCalFromDate, Date reCalToDate);

	boolean processBulkRateChangeDetail(BulkRateChangeHeader bulkRateChangeHeader,
