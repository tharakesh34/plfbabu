...
public interface CreditApplicationReviewService {
	...
	Map<String, List<FinCreditReviewSummary>> getListCreditReviewSummaryByCustId(final long id, int noOfYears, int year,
			String type);

	Map<String, List<FinCreditReviewSummary>> getListCreditReviewSummaryByCustId2(final long id, int noOfYears,
	...
	Map<String, FinCreditReviewDetails> getListCreditReviewDetailsByCustId(long id, int noOfYears, int year);
