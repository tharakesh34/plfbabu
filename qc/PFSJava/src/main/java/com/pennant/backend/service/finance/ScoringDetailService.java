...
public interface ScoringDetailService {
	...
	FinanceDetail fetchFinScoringDetails(FinanceDetail financeDetail, List<FinanceReferenceDetail> scoringGroupList,
			String ctgType);

	FinanceDetail setFinanceScoringDetails(FinanceDetail financeDetail, String finType, String userRole, String ctgType,
			String screenEvent);

	List<ScoringMetrics> executeScoringMetrics(List<ScoringMetrics> scoringMetricsList,
			CustomerEligibilityCheck customerEligibilityCheck);

	List<Object> getFinScoreDetailList(String finReference);

	void validate(FinanceDetail financeDetail, AuditDetail auditDetail, String[] errParm, String[] valueParm,
			String usrLanguage);
