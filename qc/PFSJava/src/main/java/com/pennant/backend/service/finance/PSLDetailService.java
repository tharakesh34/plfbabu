...
public interface PSLDetailService {

	AuditHeader saveOrUpdate(AuditHeader auditHeader);

	PSLDetail getPSLDetail(String finReference);

	PSLDetail getApprovedPSLDetail(String finReference);
	...
	AuditDetail saveOrUpdate(PSLDetail pslDetail, TableType tableType, String auditTranType);

	AuditDetail validate(PSLDetail pslDetail, String method, String auditTranType, String usrLanguage);
