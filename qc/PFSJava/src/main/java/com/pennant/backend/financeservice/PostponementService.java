...
public interface PostponementService {
	...
	FinScheduleData doPostponement(FinScheduleData finscheduleData, FinServiceInstruction serviceInstruction,
	...
	FinScheduleData doReAging(FinScheduleData finscheduleData, FinServiceInstruction serviceInstruction,
			String scheduleMethod);
}
