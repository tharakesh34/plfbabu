...
public class DDAProcessDAOImpl extends SequenceDao<FinanceLimitProcess> implements DDAProcessDAO {
	...
	public long save(DDAProcessData ddaProcessData) {
		...
		insertSql.append(
				" CustomerName , BankName, AccountType, Iban, MobileNum, EmailID, CommenceOn, AllowedInstances, ");
		insertSql
				.append(" MaxAmount, CurrencyCode, PaymentFreq, Validation, Error, ErrorCode, ErrorDesc, ReturnCode, ");
		insertSql.append(" ReturnText, ValueDate, Active)");
		insertSql.append(
				" Values(:SeqNo, :FinRefence, :ReferenceNum, :Purpose, :CustCIF, :CustomerType, :IdType, :IdNum,");
		insertSql.append(
				" :CustomerName , :BankName, :AccountType, :Iban, :MobileNum, :EmailID, :CommenceOn, :AllowedInstances, ");
		insertSql.append(
				" :MaxAmount, :CurrencyCode, :PaymentFreq, :Validation, :Error, :ErrorCode, :ErrorDesc, :ReturnCode, ");
		insertSql.append(" :ReturnText, :ValueDate, :Active)");
	...
	public DDAProcessData getDDADetailsById(String finReference, String reqTypeValidate) {
		...
		selectSql.append(
				" Select SeqNo, FinRefence, ReferenceNum, Purpose, CustCIF, CustomerType, IdType, IdNum, CustomerName,");
		selectSql.append(
				" BankName, AccountType, Iban, MobileNum, EmailID, CommenceOn, AllowedInstances, MaxAmount, CurrencyCode, Active, ");
		selectSql.append(
				" MaxAmount, CurrencyCode, PaymentFreq, Validation, Error, ErrorCode, ErrorDesc, ReturnCode,  ReturnText, ValueDate, ");
