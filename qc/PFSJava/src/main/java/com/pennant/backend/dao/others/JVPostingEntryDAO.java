...
public interface JVPostingEntryDAO {
	...
	List<JVPostingEntry> getDistinctJVPostingEntryListById(JVPostingEntry jVPostingEntry, String type);

	List<JVPostingEntry> getDistinctJVPostingEntryValidationStatusById(JVPostingEntry jVPostingEntry, String type);

	List<JVPostingEntry> getDistinctJVPostingEntryPostingStatusById(JVPostingEntry jVPostingEntry, String type);
