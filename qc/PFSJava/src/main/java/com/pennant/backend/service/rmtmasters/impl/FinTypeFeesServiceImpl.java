...
public class FinTypeFeesServiceImpl extends GenericService<FinTypeFees> implements FinTypeFeesService {
	 ...
	 * Do Add or Update the Record a) Add new Record for the new record in the DB table FinTypeFeess/FinTypeFeess_Temp
	 * by using FinTypeFeessDAO's save method b) Update the Record in the table. based on the module workFlow
	 ...
	 * parameters promotionFee,"_Temp" 4) Audit the record in to AuditHeader and AdtFinTypeFeess by using
	...
	@Override
	public List<AuditDetail> setFinTypeFeesAuditData(List<FinTypeFees> finTypeFeesList, String auditTranType,
			String method) {
		logger.debug("Entering");
	...
	@Override
	public List<AuditDetail> delete(List<FinTypeFees> finTypeFeesList, String tableType, String auditTranType,
