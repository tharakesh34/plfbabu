	...
	public RepeatStatus execute(StepContribution arg0, ChunkContext context) throws Exception {
		...
		try {
			...
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinScheduleDetails", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//2. Finance Disbursement Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinDisbursementDetails", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//5. Finance Repay Instruction Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinRepayInstruction", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();
			...
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinRepayHeader", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//8. Finance Repay Schedule Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinRepayScheduleDetail", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//9. Finance Provision Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinProvisions", "FinReference", false, false));
			sqlStatement.executeUpdate();
			sqlStatement.close();
			...
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinWriteoffDetail", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//12. Finance Document Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("DocumentDetails", "ReferenceId", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();

			//13. Finance Premium Details
			sqlStatement = connection
					.prepareStatement(prepareDeleteQuery("FinancePremiumDetail", "FinReference", true, true));
			sqlStatement.executeUpdate();
			sqlStatement.close();
