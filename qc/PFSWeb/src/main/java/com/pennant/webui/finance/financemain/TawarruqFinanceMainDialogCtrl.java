 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  TawarruqFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
 ...
 */
public class TawarruqFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = Logger.getLogger(TawarruqFinanceMainDialogCtrl.class);

	/*
	 * All the components that are defined here and have a corresponding component with the same 'id' in the ZUL-file
	 * are getting autoWired by our 'extends GFCBaseCtrl' GenericForwardComposer.
	 */
	protected Window window_TawarruqFinanceMainDialog; // autoWired

	/**
	 * default constructor.<br>
	 */
	public TawarruqFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_TawarruqFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_TawarruqFinanceMainDialog);
		...
		setMainWindow(window_TawarruqFinanceMainDialog);
	 ...
	 * @throws Exception
	 */
	public void onClose$window_TawarruqFinanceMainDialog(Event event) throws Exception {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_TawarruqFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
