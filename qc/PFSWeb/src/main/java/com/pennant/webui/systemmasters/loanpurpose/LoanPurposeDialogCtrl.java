 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  LoanPurposeDialogCtrl.java                                                   * 	  
 *                                                                    						*
...
public class LoanPurposeDialogCtrl extends GFCBaseCtrl<LoanPurpose> {
	...
	/**
	 * Deletes a LoanPurpose object from database.<br>
	 * 
	 * @throws InterruptedException
	 */
	private void doDelete() throws InterruptedException {
		...
		if (MessageUtil.confirm(msg) == MessageUtil.YES) {
			if (StringUtils.isBlank(aLoanPurpose.getRecordType())) {
				...
				aLoanPurpose.setRecordType(PennantConstants.RECORD_TYPE_DEL);
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_LoanPurposeDialog, auditHeader);
		} catch (Exception exp) {
