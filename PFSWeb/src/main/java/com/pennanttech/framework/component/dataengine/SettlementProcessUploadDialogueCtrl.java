...
public class SettlementProcessUploadDialogueCtrl extends GFCBaseCtrl<Configuration> {
	...
	public SettlementProcessUploadDialogueCtrl() {
		super();
	}
	...
	public void onCreate$window_SettlementProcessUploadDialogueCtrl(Event event) throws Exception {
		...
		setPageComponents(window_SettlementProcessUploadDialogueCtrl);
	...
	public class ProcessData implements Runnable {
		...
		public void run() {
			try {
				settlementProcessUploadResponce.collateralFileUploadProcessResponseFile(this.userId, status, file, media,
						false);
			} catch (Exception e) {
