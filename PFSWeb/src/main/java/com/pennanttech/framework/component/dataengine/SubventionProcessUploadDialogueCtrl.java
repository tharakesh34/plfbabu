...
public class SubventionProcessUploadDialogueCtrl extends GFCBaseCtrl<Configuration> {
	private static final Logger logger = LogManager.getLogger(SubventionProcessUploadDialogueCtrl.class);
	private static final long serialVersionUID = 1297405999029019920L;

	protected Window window_SubventionProcessUploadDialogueCtrl;
	...
	private SubventionProcessUploadResponce subventionProcessUploadResponce;

	public SubventionProcessUploadDialogueCtrl() {
		super();
	}
	...
	public void onCreate$window_SubventionProcessUploadDialogueCtrl(Event event) throws Exception {
		...
		setPageComponents(window_SubventionProcessUploadDialogueCtrl);
	...
	public class ProcessData implements Runnable {
		...
		public void run() {
			try {
				subventionProcessUploadResponce.subventionFileUploadProcessResponseFile(this.userId, status, file,
						media, false);
			} catch (Exception e) {
	...
	public SubventionProcessUploadResponce getSubventionProcessUploadResponce() {
		return subventionProcessUploadResponce;
	}
