...
public class SubventionProcessUploadDialogCtrl extends GFCBaseCtrl<Configuration> {
	private static final Logger logger = LogManager.getLogger(SubventionProcessUploadDialogCtrl.class);
	private static final long serialVersionUID = 1297405999029019920L;

	protected Window window_subventionProcessUploadDialogCtrl;
	...
	public SubventionProcessUploadDialogCtrl() {
		super();
	}
