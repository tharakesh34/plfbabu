...
public class OverdraftFinanceMainDialogCtrl extends FinanceMainBaseCtrl implements Serializable {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = LogManager.getLogger(OverdraftFinanceMainDialogCtrl.class);

	/*
	 * All the components that are defined here and have a corresponding component with the same 'id' in the ZUL-file
	 * are getting autoWired by our 'extends GFCBaseCtrl' GenericForwardComposer.
	 */
	protected Window window_overdraftFinanceMainDialogCtrl;

	/**
	 * default constructor.<br>
	 */
	public OverdraftFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_overdraftFinanceMainDialogCtrl(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_overdraftFinanceMainDialogCtrl);
		...
		setMainWindow(window_overdraftFinanceMainDialogCtrl);
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_overdraftFinanceMainDialogCtrl);
		logger.debug("Leaving " + event.toString());
	}
