 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CDFinanceMainDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-11-2011 * *
 ...
 */
public class CDFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = LogManager.getLogger(CDFinanceMainDialogCtrl.class);

	/*
	 * All the components that are defined here and have a corresponding component with the same 'id' in the ZUL-file
	 * are getting autoWired by our 'extends GFCBaseCtrl' GenericForwardComposer.
	 */
	protected Window window_CDFinanceMainDialog; // autoWired

	/**
	 * default constructor.<br>
	 */
	public CDFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_CDFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_CDFinanceMainDialog);
		...
		setMainWindow(window_CDFinanceMainDialog);
		setProductCode("CD");
	 ...
	 * @throws Exception
	 */
	public void onClose$window_CDFinanceMainDialog(Event event) throws Exception {
	...
	public void doFillReasons(int reason) {
		...
		try {
			Executions.createComponents("/WEB-INF/pages/ReasonDetail/ReasonDetails.zul", window_CDFinanceMainDialog,
					map);
		} catch (Exception e) {
			MessageUtil.showError(e);
		}
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_CDFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
