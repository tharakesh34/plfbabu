...
public class SimpleLoggingAspect {
	...
	public void logBefore(JoinPoint joinPoint) {
		...
		System.out.println("hijacked : " + joinPoint.getClass().getName() + "." + joinPoint.getSignature().getName());
		System.out.println("******");
	}
	...
	public void logException(JoinPoint joinPoint, Exception exception) {
		...
		System.out
				.println("Method : " + joinPoint.getSignature().getName() + ", Exception : " + exception.getMessage());
