...
public class PennantLOVListUtil {
	...
	private static Map<String, ModuleListcode> moduleMap = new HashMap<String, ModuleListcode>() {
		...
		{
			put("AccountPurpose",
					new ModuleListcode("AccountPurpose", getHeading("Account Purpose"),
							PennantStaticListUtil.getAccountPurpose(),
							getHeadings(new String[] { "PurposeCode", "PurposeDescription" })));
			put("WeekName", new ModuleListcode("WeekName", getHeading("WeekName"), PennantStaticListUtil.getWeekName(),
					getHeadings(new String[] { "WeekCode", "WeekName" })));
			put("EarlyPayMethod",
					new ModuleListcode("EarlyPayMethod", getHeading("Early Payment Method"),
