...
public class AvailmentTicketDialogCtrl extends GFCBaseCtrl<Customer> {
	...
	private static final Logger logger = LogManager.getLogger(AvailmentTicketDialogCtrl.class);
				...
				for (AvailFinance availFinance : availFinances) {
					...
					finCmt.setLastRepay(availFinance.getLastRepay() == null ? ""
							: DateUtility.formatToLongDate(
									DateUtility.parse(availFinance.getLastRepay(), PennantConstants.DBDateTimeFormat)));
