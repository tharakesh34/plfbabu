 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ReportListListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 23-01-2012 *
 * * Modified Date : 23-01-2012 * * Description : * *
 ********************************************************************************************
...
package com.pennant.webui.reports.reportlist.model;
...
public class ReportListListModelItemRenderer implements ListitemRenderer<ReportList>, Serializable {
	...
	public void render(Listitem item, ReportList reportList, int count) {
		...
		lc.setParent(item);
		item.setAttribute("id", reportList.getId());
		ComponentsCtrl.applyForward(item, "onDoubleClick=onReportListItemDoubleClicked");
	}
}