 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ReportListListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 23-01-2012 * * Modified
...
public class ReportListListCtrl extends GFCBaseListCtrl<ReportList> {
	 ...
	 * 
	 * @param aReportList The entity that need to be passed to the dialog.
	 */
