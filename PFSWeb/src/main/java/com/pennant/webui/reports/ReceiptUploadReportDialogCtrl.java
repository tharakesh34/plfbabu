 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CostOfFundsStatusReportDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 18-07-2018
...
public class ReceiptUploadReportDialogCtrl extends GFCBaseCtrl<ReceiptUploadHeader> {
	...
	public void onClick$btnSearch(Event event) throws IOException {
		...
		try {
			ReportsUtil.generateReport(userName, "ReceiptUploadDetails", whereCond, searchCriteria);
		} catch (Exception e) {
			MessageUtil.showError(e);
		}
