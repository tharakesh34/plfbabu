 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  LegalPropertyTitleDialogCtrl.java                                                   * 	  
 *                                                                    						*
...
public class LegalPropertyTitleDialogCtrl extends GFCBaseCtrl<LegalPropertyTitle> {
	...
	private static final Logger logger = Logger.getLogger(LegalPropertyTitleDialogCtrl.class);
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_LegalPropertyTitleDialog(Event event) throws Exception {
	...
	/**
	 * Deletes a LegalPropertyTitle object from database.<br>
	 * 
	 * @throws InterruptedException
	 */
