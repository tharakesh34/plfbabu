 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BeneficiaryListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 01-12-2016 * * Modified
...
public class BeneficiaryListCtrl extends GFCBaseListCtrl<Beneficiary> {
	 ...
	 * 
	 * @param aBeneficiary The entity that need to be passed to the dialog.
	 */
