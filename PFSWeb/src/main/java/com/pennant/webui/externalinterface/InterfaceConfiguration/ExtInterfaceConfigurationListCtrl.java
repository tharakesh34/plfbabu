 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  ExtInterfaceConfigurationListCtrl.java                                                   * 	  
 *                                                                    						*
...
public class ExtInterfaceConfigurationListCtrl extends GFCBaseListCtrl<InterfaceConfiguration> {
	...
	private static final Logger logger = LogManager.getLogger(ExtInterfaceConfigurationListCtrl.class);
	 ...
	 * 
	 * @param Extinterfaceconfiguration
