 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ExtInterfaceConfigurationListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date
 ...
 * 
 */
public class ExtInterfaceConfigurationListModelItemRenderer
		implements ListitemRenderer<InterfaceConfiguration>, Serializable {

	private static final long serialVersionUID = 1L;

	public ExtInterfaceConfigurationListModelItemRenderer() {
		super();
	}
	...
	public void render(Listitem item, InterfaceConfiguration interfaceConfiguration, int count) {
		...
		ComponentsCtrl.applyForward(item, "onDoubleClick=onExtInterfaceConfigurationItemDoubleClicked");
	}
}