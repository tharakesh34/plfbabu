 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FeeTypeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-01-2017 * *
 * Modified Date : 03-01-2017 * * Description : * *
 ********************************************************************************************
...
public class FeeTypeListModelItemRenderer implements ListitemRenderer<FeeType>, Serializable {
	...
	@Override
	public void render(Listitem item, FeeType feeType, int count) {
