 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GenderListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date
...
public class TargetDetailListCtrl extends GFCBaseListCtrl<TargetDetail> {
	...
	private static final Logger logger = LogManager.getLogger(TargetDetailListCtrl.class);
	 ...
	 * 
	 * @param aTargetDetail The entity that need to be passed to the dialog.
	 */
