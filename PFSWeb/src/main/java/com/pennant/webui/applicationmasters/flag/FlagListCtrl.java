 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FlagListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 14-07-2015 * * Modified Date :
...
public class FlagListCtrl extends GFCBaseListCtrl<Flag> {
	 ...
	 * 
	 * @param aFlag The entity that need to be passed to the dialog.
	 */
