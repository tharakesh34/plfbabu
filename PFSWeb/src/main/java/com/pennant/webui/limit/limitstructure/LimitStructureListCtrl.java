 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LimitStructureListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 31-03-2016 * *
...
public class LimitStructureListCtrl extends GFCBaseListCtrl<LimitStructure> {
	...
	private static final Logger logger = LogManager.getLogger(LimitStructureListCtrl.class);
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onClick$button_LimitStructureList_NewLimitStructure(Event event) {
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onLimitStructureItemDoubleClicked(Event event) {
