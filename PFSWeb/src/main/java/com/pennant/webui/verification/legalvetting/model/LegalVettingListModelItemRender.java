package com.pennant.webui.verification.legalvetting.model;
...
public class LegalVettingListModelItemRender implements ListitemRenderer<LegalVetting>, Serializable {
	private static final long serialVersionUID = 1L;

	List<Long> list = new ArrayList<>();

	public LegalVettingListModelItemRender() {
		super();
	}
	...
	public void render(Listitem item, LegalVetting lv, int count) throws Exception {
		...
		ComponentsCtrl.applyForward(item, "onDoubleClick=onLegalVettingItemDoubleClicked");
	}
