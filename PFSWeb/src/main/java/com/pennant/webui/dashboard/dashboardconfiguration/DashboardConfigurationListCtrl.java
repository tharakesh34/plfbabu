 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DashboardConfigurationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 14-06-2011 *
...
public class DashboardConfigurationListCtrl extends GFCBaseListCtrl<DashboardConfiguration> {
	...
	private static final Logger logger = LogManager.getLogger(DashboardConfigurationListCtrl.class);
	 ...
	 * 
	 * @param aDashboardConfiguration The entity that need to be passed to the dialog.
	 */
