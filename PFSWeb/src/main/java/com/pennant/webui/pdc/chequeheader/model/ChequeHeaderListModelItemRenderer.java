 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ChequeHeaderListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-11-2017
...
public class ChequeHeaderListModelItemRenderer implements ListitemRenderer<ChequeHeader>, Serializable {
	...
	public void render(Listitem item, ChequeHeader chequeHeader, int count) {
		...
		lc.setParent(item);
		lc = new Listcell(CurrencyUtil.format(chequeHeader.getTotalAmount(), CurrencyUtil.getFormat("INR")));
		lc.setParent(item);
