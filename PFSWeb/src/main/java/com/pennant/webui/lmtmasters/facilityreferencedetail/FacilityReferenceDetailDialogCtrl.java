...
public class FacilityReferenceDetailDialogCtrl extends GFCBaseCtrl<FacilityReferenceDetail> {
	...
	private static final Logger logger = LogManager.getLogger(FacilityReferenceDetailDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(String.valueOf(aFacilityReferenceDetail.getFinRefDetailId()), aFacilityReferenceDetail);
