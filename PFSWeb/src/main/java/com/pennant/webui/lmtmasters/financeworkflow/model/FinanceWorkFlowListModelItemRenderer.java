 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceWorkFlowListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 * 19-11-2011 * * Modified Date : 19-11-2011 * * Description : * *
 ********************************************************************************************
...
public class FinanceWorkFlowListModelItemRenderer implements ListitemRenderer<FinanceWorkFlow>, Serializable {
	...
	public void render(Listitem item, FinanceWorkFlow financeWorkFlow, int count) {
		...
		lc.setParent(item);
		lc = new Listcell(PennantApplicationUtil.getLabelDesc(financeWorkFlow.getScreenCode(),
				PennantStaticListUtil.getScreenCodes()));
		lc.setParent(item);
		lc = new Listcell(PennantApplicationUtil.getLabelDesc(financeWorkFlow.getFinEvent(), eventList));
		lc.setParent(item);
