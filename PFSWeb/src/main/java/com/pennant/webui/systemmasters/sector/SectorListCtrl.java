 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SectorListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date
...
public class SectorListCtrl extends GFCBaseListCtrl<Sector> {
	...
	private static final Logger logger = LogManager.getLogger(SectorListCtrl.class);
	 ...
	 * 
	 * @param sector The entity that need to be passed to the dialog.
	 */
