 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CasteListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date :
...
public class CasteListCtrl extends GFCBaseListCtrl<Caste> {
	...
	private static final Logger logger = LogManager.getLogger(CasteListCtrl.class);
	 ...
	 * 
	 * @param caste The entity that need to be passed to the dialog.
	 */
