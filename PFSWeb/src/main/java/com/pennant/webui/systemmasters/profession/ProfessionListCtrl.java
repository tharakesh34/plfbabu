 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProfessionListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class ProfessionListCtrl extends GFCBaseListCtrl<Profession> {
	 ...
	 * 
	 * @param profession The entity that need to be passed to the dialog.
	 */
