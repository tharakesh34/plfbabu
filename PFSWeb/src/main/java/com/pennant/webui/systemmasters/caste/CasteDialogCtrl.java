 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CasteDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified Date
...
public class CasteDialogCtrl extends GFCBaseCtrl<Caste> {
	...
	private static final Logger logger = LogManager.getLogger(CasteDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_CasteDialog_CasteCode.value") + " : " + aCaste.getCasteCode();

		doDelete(keyReference, aCaste);
