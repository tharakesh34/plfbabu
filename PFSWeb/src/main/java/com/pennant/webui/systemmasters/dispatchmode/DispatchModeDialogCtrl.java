 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DispatchModeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 18-08-2011 * *
...
public class DispatchModeDialogCtrl extends GFCBaseCtrl<DispatchMode> {
	...
	private static final Logger logger = LogManager.getLogger(DispatchModeDialogCtrl.class);
	 ...
	 * 
	 * @param aDispatchMode DispatchMode
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_DispatchModeDialog_DispatchModeCode.value") + " : "
				+ aDispatchMode.getDispatchModeCode();

		doDelete(keyReference, aDispatchMode);
