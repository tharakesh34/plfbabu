 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmploymentTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class EmploymentTypeListCtrl extends GFCBaseListCtrl<EmploymentType> {
	...
	private static final Logger logger = LogManager.getLogger(EmploymentTypeListCtrl.class);
	 ...
	 * 
	 * @param employmentType The entity that need to be passed to the dialog.
	 */
