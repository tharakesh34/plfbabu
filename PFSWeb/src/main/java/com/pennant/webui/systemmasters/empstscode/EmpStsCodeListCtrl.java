 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmpStsCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class EmpStsCodeListCtrl extends GFCBaseListCtrl<EmpStsCode> {
	...
	private static final Logger logger = LogManager.getLogger(EmpStsCodeListCtrl.class);
	 ...
	 * 
	 * @param empStsCode The entity that need to be passed to the dialog.
	 */
