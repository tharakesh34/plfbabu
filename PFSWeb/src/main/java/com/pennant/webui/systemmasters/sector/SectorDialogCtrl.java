...
public class SectorDialogCtrl extends GFCBaseCtrl<Sector> {
	...
	private static final Logger logger = LogManager.getLogger(SectorDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_SectorDialog(Event event) {
	...
	public void doWriteBeanToComponents(Sector aSector) {
		...
		if (aSector.isNewRecord() || (aSector.getRecordType() != null ? aSector.getRecordType() : "")
	 ...
	 * @param aSector (Sector)
	 */
	public void doShowDialog(Sector aSector) {
		logger.debug("Entering");

		// set ReadOnly mode accordingly if the object is new or not.
		if (aSector.isNewRecord()) {
	 ...
	 * 
	 */
	protected boolean doProcess(Sector aSector, String tranType) {
		logger.debug("Entering");
