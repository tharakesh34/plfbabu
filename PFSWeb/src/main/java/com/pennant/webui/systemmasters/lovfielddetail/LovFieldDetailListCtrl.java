 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LovFieldDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-10-2011 * *
...
public class LovFieldDetailListCtrl extends GFCBaseListCtrl<LovFieldDetail> {
	...
	private static final Logger logger = LogManager.getLogger(LovFieldDetailListCtrl.class);
	 ...
	 * 
	 * @param lovFieldDetail The entity that need to be passed to the dialog.
	 */
