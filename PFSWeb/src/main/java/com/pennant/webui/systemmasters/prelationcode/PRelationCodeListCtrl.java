 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PRelationCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class PRelationCodeListCtrl extends GFCBaseListCtrl<PRelationCode> {
	...
	private static final Logger logger = LogManager.getLogger(PRelationCodeListCtrl.class);
	 ...
	 * 
	 * @param pRelationCode The entity that need to be passed to the dialog.
	 */
