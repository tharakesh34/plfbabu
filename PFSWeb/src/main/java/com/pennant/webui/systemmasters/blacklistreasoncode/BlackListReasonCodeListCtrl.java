 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BlackListReasonCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class BlackListReasonCodeListCtrl extends GFCBaseListCtrl<BlackListReasonCode> {
	...
	private static final Logger logger = LogManager.getLogger(BlackListReasonCodeListCtrl.class);
	 ...
	 * 
	 * @param blackListReasonCode The entity that need to be passed to the dialog.
	 */
