...
public class SubSegmentDialogCtrl extends GFCBaseCtrl<SubSegment> {
	...
	private static final Logger logger = LogManager.getLogger(SubSegmentDialogCtrl.class);
	 ...
	 * 
	 */
	protected boolean doProcess(SubSegment aSubSegment, String tranType) {
		logger.debug("Entering");
