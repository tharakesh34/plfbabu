 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NationalityCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class NationalityCodeListCtrl extends GFCBaseListCtrl<NationalityCode> {
	...
	private static final Logger logger = LogManager.getLogger(NationalityCodeListCtrl.class);
	 ...
	 * 
	 * @param nationalityCode The entity that need to be passed to the dialog.
	 */
