 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SubSectorListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified
...
public class SubSectorListCtrl extends GFCBaseListCtrl<SubSector> {
	...
	private static final Logger logger = LogManager.getLogger(SubSectorListCtrl.class);
	 ...
	 * 
	 * @param subSector The entity that need to be passed to the dialog.
	 */
