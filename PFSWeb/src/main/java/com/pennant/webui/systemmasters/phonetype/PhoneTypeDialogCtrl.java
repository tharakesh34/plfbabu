 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PhoneTypeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * * Modified
...
public class PhoneTypeDialogCtrl extends GFCBaseCtrl<PhoneType> {
	...
	private static final Logger logger = LogManager.getLogger(PhoneTypeDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_PhoneTypeDialog(Event event) {
	 ...
	 * @param aPhoneType
	 */
	public void doShowDialog(PhoneType aPhoneType) {
		logger.debug("Entering");
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_PhoneTypeDialog_PhoneTypeCode.value") + " : " + aPhoneType.getPhoneTypeCode(),
				aPhoneType);
