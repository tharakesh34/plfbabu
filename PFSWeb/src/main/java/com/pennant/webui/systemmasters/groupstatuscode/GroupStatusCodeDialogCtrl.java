 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GroupStatusCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class GroupStatusCodeDialogCtrl extends GFCBaseCtrl<GroupStatusCode> {
	...
	private static final Logger logger = LogManager.getLogger(GroupStatusCodeDialogCtrl.class);
	 ...
	 * 
	 * @param aGroupStatusCode GroupStatusCode
	 */
	public void doWriteBeanToComponents(GroupStatusCode aGroupStatusCode) {
		...
		if (aGroupStatusCode.isNewRecord()
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_GroupStatusCodeDialog_GrpStsCode.value") + " : "
				+ aGroupStatusCode.getGrpStsCode();

		doDelete(keyReference, aGroupStatusCode);
	...
	public void doSave() throws InterruptedException {
		...
		isNew = aGroupStatusCode.isNewRecord();
		String tranType = "";
	 ...
	 * 
	 */
	protected boolean doProcess(GroupStatusCode aGroupStatusCode, String tranType) {
		logger.debug("Entering");
