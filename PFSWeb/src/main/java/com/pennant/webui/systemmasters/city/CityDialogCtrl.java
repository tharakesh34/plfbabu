 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CityDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date
...
public class CityDialogCtrl extends GFCBaseCtrl<City> {
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_CityDialog_PCCountry.value") + " : " + aCity.getPCCountry() + ","
