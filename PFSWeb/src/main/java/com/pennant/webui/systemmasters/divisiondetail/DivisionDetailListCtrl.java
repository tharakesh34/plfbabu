 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DivisionDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 02-08-2013 * *
...
public class DivisionDetailListCtrl extends GFCBaseListCtrl<DivisionDetail> {
	...
	private static final Logger logger = LogManager.getLogger(DivisionDetailListCtrl.class);
	...
	public void onCreate$window_DivisionDetailList(Event event) {
		...
		// registerButton(button_DivisionDetailList_NewDivisionDetail, "button_DivisionDetailList_NewDivisionDetail",
		// true);
	 ...
	 * 
	 * @param divisionDetail The entity that need to be passed to the dialog.
	 */
