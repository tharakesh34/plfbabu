 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DesignationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class DesignationListCtrl extends GFCBaseListCtrl<Designation> {
	...
	private static final Logger logger = LogManager.getLogger(DesignationListCtrl.class);
	 ...
	 * 
	 * @param designation The entity that need to be passed to the dialog.
	 */
