 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmploymentTypeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class EmploymentTypeDialogCtrl extends GFCBaseCtrl<EmploymentType> {
	...
	private static final Logger logger = LogManager.getLogger(EmploymentTypeDialogCtrl.class);
	 ...
	 * 
	 * @param aEmploymentType EmploymentType
	 */
	public void doWriteBeanToComponents(EmploymentType aEmploymentType) {
		...
		if (aEmploymentType.isNewRecord()
				|| (aEmploymentType.getRecordType() != null ? aEmploymentType.getRecordType() : "")
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_EmploymentTypeDialog_EmpType.value") + " : "
				+ aEmploymentType.getEmpType();

		doDelete(keyReference, aEmploymentType);
