 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LoanPurposeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class LoanPurposeListCtrl extends GFCBaseListCtrl<LoanPurpose> {
	...
	private static final Logger logger = LogManager.getLogger(LoanPurposeListCtrl.class);
	 ...
	 * 
	 * @param LoanPurpose The entity that need to be passed to the dialog.
	 */
