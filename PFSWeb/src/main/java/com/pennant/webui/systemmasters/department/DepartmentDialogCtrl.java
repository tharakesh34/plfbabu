 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DepartmentDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class DepartmentDialogCtrl extends GFCBaseCtrl<Department> {
	...
	private static final Logger logger = LogManager.getLogger(DepartmentDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_DepartmentDialog_DeptCode.value") + " : "
				+ aDepartment.getDeptCode();

		doDelete(keyReference, aDepartment);
