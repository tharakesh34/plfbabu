 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDepartmentListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class GeneralDepartmentListCtrl extends GFCBaseListCtrl<GeneralDepartment> {
	...
	private static final Logger logger = LogManager.getLogger(GeneralDepartmentListCtrl.class);
	 ...
	 * 
	 * @param generalDepartment The entity that need to be passed to the dialog.
	 */
