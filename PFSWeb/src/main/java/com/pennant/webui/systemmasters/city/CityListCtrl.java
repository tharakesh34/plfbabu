 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CityListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified Date :
...
public class CityListCtrl extends GFCBaseListCtrl<City> {
	...
	private static final Logger logger = LogManager.getLogger(CityListCtrl.class);
	 ...
	 * 
	 * @param city The entity that need to be passed to the dialog.
	 */
