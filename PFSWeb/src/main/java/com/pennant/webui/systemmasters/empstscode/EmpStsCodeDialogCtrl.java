 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EmpStsCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class EmpStsCodeDialogCtrl extends GFCBaseCtrl<EmpStsCode> {
	...
	private static final Logger logger = LogManager.getLogger(EmpStsCodeDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_EmpStsCodeDialog_EmpStsCode.value") + " : "
				+ aEmpStsCode.getEmpStsCode();

		doDelete(keyReference, aEmpStsCode);
