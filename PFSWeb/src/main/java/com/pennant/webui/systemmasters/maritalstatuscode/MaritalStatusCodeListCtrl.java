 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : MaritalStatusCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class MaritalStatusCodeListCtrl extends GFCBaseListCtrl<MaritalStatusCode> {
	...
	private static final Logger logger = LogManager.getLogger(MaritalStatusCodeListCtrl.class);
	 ...
	 * 
	 * @param maritalStatusCode The entity that need to be passed to the dialog.
	 */
