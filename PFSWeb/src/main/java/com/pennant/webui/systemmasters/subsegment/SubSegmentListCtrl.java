 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SubSegmentListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class SubSegmentListCtrl extends GFCBaseListCtrl<SubSegment> {
	...
	private static final Logger logger = LogManager.getLogger(SubSegmentListCtrl.class);
	 ...
	 * 
	 * @param subSegment The entity that need to be passed to the dialog.
	 */
