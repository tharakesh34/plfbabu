 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IndustryListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class IndustryListCtrl extends GFCBaseListCtrl<Industry> {
	...
	private static final Logger logger = LogManager.getLogger(IndustryListCtrl.class);
	 ...
	 * 
	 * @param industry The entity that need to be passed to the dialog.
	 */
