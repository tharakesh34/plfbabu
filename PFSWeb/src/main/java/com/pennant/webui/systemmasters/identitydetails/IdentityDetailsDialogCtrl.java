 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IdentityDetailsDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class IdentityDetailsDialogCtrl extends GFCBaseCtrl<IdentityDetails> {
	...
	private static final Logger logger = LogManager.getLogger(IdentityDetailsDialogCtrl.class);
	 ...
	 * 
	 * @param aIdentityDetails IdentityDetails
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_IdentityDetailsDialog_IdentityType.value") + " : "
				+ aIdentityDetails.getIdentityType();

		doDelete(keyReference, aIdentityDetails);
