 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AddressTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class AddressTypeListCtrl extends GFCBaseListCtrl<AddressType> {
	...
	private static final Logger logger = LogManager.getLogger(AddressTypeListCtrl.class);
	 ...
	 * 
	 * @param addressType The entity that need to be passed to the dialog.
	 */
