 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IdentityDetailsListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class IdentityDetailsListCtrl extends GFCBaseListCtrl<IdentityDetails> {
	...
	private static final Logger logger = LogManager.getLogger(IdentityDetailsListCtrl.class);
	...
	public void onIdentityDetailsItemDoubleClicked(Event event) {
		...
		String whereCond = " where IdentityType=?";

		if (doCheckAuthority(identityDetails, whereCond, new Object[] { identityDetails.getIdentityType() })) {
