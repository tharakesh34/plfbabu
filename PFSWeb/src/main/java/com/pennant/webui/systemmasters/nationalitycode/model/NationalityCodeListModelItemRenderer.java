 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NationalityCodesListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 ...
 * 
 */
public class NationalityCodeListModelItemRenderer implements ListitemRenderer<NationalityCode>, Serializable {
	...
	@Override
	public void render(Listitem item, NationalityCode nationalityCode, int count) {
		...
		item.setAttribute("id", nationalityCode.getId());
