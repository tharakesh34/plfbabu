 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProvinceListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class ProvinceListCtrl extends GFCBaseListCtrl<Province> {
	...
	private static final Logger logger = LogManager.getLogger(ProvinceListCtrl.class);
	 ...
	 * 
	 * @param province The entity that need to be passed to the dialog.
	 */
