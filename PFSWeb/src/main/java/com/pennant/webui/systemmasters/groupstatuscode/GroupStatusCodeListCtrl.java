 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GroupStatusCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class GroupStatusCodeListCtrl extends GFCBaseListCtrl<GroupStatusCode> {
	...
	private static final Logger logger = LogManager.getLogger(GroupStatusCodeListCtrl.class);
	 ...
	 * 
	 * @param groupStatusCode The entity that need to be passed to the dialog.
	 */
