 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BuilderCompanyListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 * 22-05-2017 * * Modified Date : 22-05-2017 * * Description : * *
 ********************************************************************************************
...
public class BuilderCompanyListModelItemRenderer implements ListitemRenderer<BuilderCompany>, Serializable {
	...
	@Override
	public void render(Listitem item, BuilderCompany builderCompany, int count) {
