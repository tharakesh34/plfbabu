 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DepartmentListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class DepartmentListCtrl extends GFCBaseListCtrl<Department> {
	...
	private static final Logger logger = LogManager.getLogger(DepartmentListCtrl.class);
	...
	public void onDepartmentItemDoubleClicked(Event event) {
		...
		String whereCond = " where DeptCode=?";

		if (doCheckAuthority(department, whereCond, new Object[] { department.getDeptCode() })) {
	 ...
	 * 
	 * @param department The entity that need to be passed to the dialog.
	 */
