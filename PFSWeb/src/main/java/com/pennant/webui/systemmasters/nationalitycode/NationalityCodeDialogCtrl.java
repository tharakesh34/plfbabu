 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : NationalityCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class NationalityCodeDialogCtrl extends GFCBaseCtrl<NationalityCode> {
	...
	private static final Logger logger = LogManager.getLogger(NationalityCodeDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_NationalityCodeDialog(Event event) {
	 ...
	 * 
	 * @param aNationalityCode NationalityCode
	 */
	 ...
	 * @param aNationalityCode
	 */
	public void doShowDialog(NationalityCode aNationalityCode) {
		logger.debug("Entering");
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_NationalityCodeDialog_NationalityCode.value") + " : "
				+ aNationalityCode.getNationalityCode(), aNationalityCode);
