 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EMailTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class EMailTypeListCtrl extends GFCBaseListCtrl<EMailType> {
	...
	private static final Logger logger = LogManager.getLogger(EMailTypeListCtrl.class);
	 ...
	 * 
	 * @param eMailType The entity that need to be passed to the dialog.
	 */
