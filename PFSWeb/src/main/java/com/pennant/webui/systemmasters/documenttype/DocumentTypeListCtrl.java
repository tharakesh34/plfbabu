 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DocumentTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class DocumentTypeListCtrl extends GFCBaseListCtrl<DocumentType> {
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onDocumentTypeItemDoubleClicked(Event event) {
		logger.debug("Entering");
	 ...
	 * 
	 * @param documentType The entity that need to be passed to the dialog.
	 */
