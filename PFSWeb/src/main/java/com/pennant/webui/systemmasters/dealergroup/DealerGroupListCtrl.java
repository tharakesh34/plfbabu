...
public class DealerGroupListCtrl  extends GFCBaseListCtrl<DealerGroup> {
	...
	public void onCreate$window_DealerGroupList(Event event) {
		...
		registerField("dealerCode", listheader_dealerCode, SortOrder.NONE, dealerCode, sortOperator_dealerCode, Operators.STRING);
		registerField("dealerCategoryId", listheader_dealerCategoryId, SortOrder.NONE, dealerCategoryId, sortOperator_dealerCategoryId,	Operators.STRING);
	...
	private void doShowDialogPage(DealerGroup dealerGroup) {
		...
		try {
			Executions.createComponents("/WEB-INF/pages/DealerGroup/DealerGroupDialog.zul", null,
					arg);
		} catch (Exception e) {
