 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDepartmentDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class GeneralDepartmentDialogCtrl extends GFCBaseCtrl<GeneralDepartment> {
	...
	private static final Logger logger = LogManager.getLogger(GeneralDepartmentDialogCtrl.class);
	...
	public void doWriteBeanToComponents(GeneralDepartment aGeneralDepartment) {
		...
		if (aGeneralDepartment.isNewRecord()
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_GeneralDepartmentDialog_GenDepartment.value") + " : "
				+ aGeneralDepartment.getGenDepartment();

		doDelete(keyReference, aGeneralDepartment);
	...
	public void doSave() throws InterruptedException {
		...
		isNew = aGeneralDepartment.isNewRecord();
		String tranType = "";
	 ...
	 * 
	 */
	protected boolean doProcess(GeneralDepartment aGeneralDepartment, String tranType) {
