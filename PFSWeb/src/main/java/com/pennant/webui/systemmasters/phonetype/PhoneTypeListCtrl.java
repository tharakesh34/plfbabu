 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PhoneTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * * Modified
...
public class PhoneTypeListCtrl extends GFCBaseListCtrl<PhoneType> {
	...
	private static final Logger logger = LogManager.getLogger(PhoneTypeListCtrl.class);
	 ...
	 * 
	 * @param phoneType The entity that need to be passed to the dialog.
	 */
