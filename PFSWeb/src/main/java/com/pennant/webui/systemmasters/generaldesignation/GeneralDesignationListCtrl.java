 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GeneralDesignationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class GeneralDesignationListCtrl extends GFCBaseListCtrl<GeneralDesignation> {
	...
	private static final Logger logger = LogManager.getLogger(GeneralDesignationListCtrl.class);
	...
	public void onGeneralDesignationItemDoubleClicked(Event event) {
		...
		String whereCond = " where GenDesignation=?";

		if (doCheckAuthority(generalDesignation, whereCond, new Object[] { generalDesignation.getGenDesignation() })) {
	 ...
	 * 
	 * @param generalDesignation The entity that need to be passed to the dialog.
	 */
