 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DispatchModeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 18-08-2011
 * * * Modified Date : 18-08-2011 * * Description : * *
 ********************************************************************************************
...
public class DispatchModeListModelItemRenderer implements ListitemRenderer<DispatchMode>, Serializable {
	...
	public void render(Listitem item, DispatchMode dispatchMode, int count) {
		...
		item.setAttribute("id", dispatchMode.getId());
