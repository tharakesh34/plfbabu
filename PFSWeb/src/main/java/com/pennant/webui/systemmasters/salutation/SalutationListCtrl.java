 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SalutationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class SalutationListCtrl extends GFCBaseListCtrl<Salutation> {
	 ...
	 * 
	 * @param salutation The entity that need to be passed to the dialog.
	 */
