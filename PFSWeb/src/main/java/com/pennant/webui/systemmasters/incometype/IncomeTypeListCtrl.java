 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IncomeTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class IncomeTypeListCtrl extends GFCBaseListCtrl<IncomeType> {
	...
	private static final Logger logger = LogManager.getLogger(IncomeTypeListCtrl.class);
	 ...
	 * 
	 * @param incomeType The entity that need to be passed to the dialog.
	 */
