 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RatingTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class RatingTypeListCtrl extends GFCBaseListCtrl<RatingType> {
	...
	private static final Logger logger = LogManager.getLogger(RatingTypeListCtrl.class);
	...
	public void onRatingTypeItemDoubleClicked(Event event) {
		...
		if (doCheckAuthority(aRatingType, whereCond, new Object[] { aRatingType.getRatingType() })) {
	 ...
	 * 
	 * @param aRatingType The entity that need to be passed to the dialog.
	 */
