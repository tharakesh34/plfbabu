 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProductListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-08-2011 * *
...
package com.pennant.webui.bmtmasters.product.model;
...
public class ProductListModelItemRenderer implements ListitemRenderer<Product>, Serializable {
	...
	@Override
	public void render(Listitem item, Product product, int count) {
