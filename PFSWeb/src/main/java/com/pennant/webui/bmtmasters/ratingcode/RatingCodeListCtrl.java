 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RatingCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified
...
public class RatingCodeListCtrl extends GFCBaseListCtrl<RatingCode> {
	...
	private static final Logger logger = LogManager.getLogger(RatingCodeListCtrl.class);
	 ...
	 * 
	 * @param aRatingCode The entity that need to be passed to the dialog.
	 */
