 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScoringTypeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 08-11-2011 * *
...
public class ScoringTypeDialogCtrl extends GFCBaseCtrl<ScoringType> {
	...
	private static final Logger logger = LogManager.getLogger(ScoringTypeDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aScoringType.getScoType(), aScoringType);
