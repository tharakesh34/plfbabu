 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BankBranchListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 17-10-2016 * * Modified
...
public class BankBranchListCtrl extends GFCBaseListCtrl<BankBranch> {
	 ...
	 * 
	 * @param bankBranch The entity that need to be passed to the dialog.
	 */
