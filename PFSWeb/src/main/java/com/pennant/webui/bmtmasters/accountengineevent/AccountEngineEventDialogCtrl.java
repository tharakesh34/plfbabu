 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AccountEngineEventDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-06-2011 * *
...
public class AccountEngineEventDialogCtrl extends GFCBaseCtrl<AccountEngineEvent> {
	...
	private static final Logger logger = LogManager.getLogger(AccountEngineEventDialogCtrl.class);
	 ...
	 * 
	 * @param aAccountEngineEvent AccountEngineEvent
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aAccountEngineEvent.getAEEventCode(), aAccountEngineEvent);
