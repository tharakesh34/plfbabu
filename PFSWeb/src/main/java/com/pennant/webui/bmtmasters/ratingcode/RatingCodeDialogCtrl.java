 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RatingCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified
...
public class RatingCodeDialogCtrl extends GFCBaseCtrl<RatingCode> {
	...
	private static final Logger logger = LogManager.getLogger(RatingCodeDialogCtrl.class);
	...
	public void doWriteBeanToComponents(RatingCode aRatingCode) {
		...
		if (aRatingCode.isNewRecord()
				|| StringUtils.equals(aRatingCode.getRecordType(), PennantConstants.RECORD_TYPE_NEW)) {
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aRatingCode.getRatingType(), aRatingCode);
	 ...
	 * 
	 */
	protected boolean doProcess(RatingCode aRatingCode, String tranType) {
		logger.debug("Entering");
