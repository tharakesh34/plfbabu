...
import com.pennant.webui.vasproduct.vasproductcategory.model.VASProductCategoryListModelItemRenderer;
...
public class VASProductCategoryListCtrl extends GFCBaseListCtrl<VASProductCategory> {
	...
	private void doShowDialogPage(VASProductCategory aVASProductCategory) {
		...
		try {
			Executions.createComponents("/WEB-INF/pages/vasproduct/VASProductCategory/VASProductCategoryDialog.zul",
					null, arg);
		} catch (Exception e) {
