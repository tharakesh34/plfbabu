 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AuthorizationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 20-08-2013 * *
...
public class AuthorizationListCtrl extends GFCBaseListCtrl<Authorization> {
	...
	private static final Logger logger = LogManager.getLogger(AuthorizationListCtrl.class);
	 ...
	 * 
	 * @param authorization The entity that need to be passed to the dialog.
	 */
