 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CourseListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 29-09-2011 * * Modified Date
...
public class CourseListCtrl extends GFCBaseListCtrl<Course> {
	...
	private static final Logger logger = LogManager.getLogger(CourseListCtrl.class);
	 ...
	 * 
	 * @param course The entity that need to be passed to the dialog.
	 */
