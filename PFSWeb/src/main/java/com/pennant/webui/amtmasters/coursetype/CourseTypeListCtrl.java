 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CourseTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 29-09-2011 * * Modified
...
public class CourseTypeListCtrl extends GFCBaseListCtrl<CourseType> {
	...
	private static final Logger logger = LogManager.getLogger(CourseTypeListCtrl.class);
	...
	public void onCourseTypeItemDoubleClicked(Event event) {
		...
		String whereCond = " where CourseTypeCode=?";

		if (doCheckAuthority(courseType, whereCond, new Object[] { courseType.getCourseTypeCode() })) {
	 ...
	 * 
	 * @param courseType The entity that need to be passed to the dialog.
	 */
