 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CourseTypeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 29-09-2011 * * Modified
...
public class CourseTypeDialogCtrl extends GFCBaseCtrl<CourseType> {
	...
	private static final Logger logger = LogManager.getLogger(CourseTypeDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_CourseTypeDialog_CourseTypeCode.value") + " : "
				+ aCourseType.getCourseTypeCode(), aCourseType);
	...
	protected boolean doProcess(CourseType aCourseType, String tranType) {
		logger.debug("Entering");
