...
public class VehicleVersionListCtrl extends GFCBaseListCtrl<VehicleVersion> {
	...
	private static final Logger logger = LogManager.getLogger(VehicleVersionListCtrl.class);
	...
	public void onVehicleVersionItemDoubleClicked(Event event) {
		...
		String whereCond = " where VehicleVersionId= ?";

		if (doCheckAuthority(vehicleVersion, whereCond, new Object[] { vehicleVersion.getVehicleVersionId() })) {
