 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : VASProductTypeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 * 09-01-2017 * * Modified Date : 09-01-2017 * * Description : * *
 ********************************************************************************************
...
public class VASProductTypeListModelItemRenderer implements ListitemRenderer<VASProductType>, Serializable {
	...
	@Override
	public void render(Listitem item, VASProductType vASProductType, int count) {
