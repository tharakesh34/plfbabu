 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : VASProductCategoryListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 09-01-2017 * *
...
public class VASProductCategoryListCtrl extends GFCBaseListCtrl<VASProductCategory> {
	...
	private static final Logger logger = LogManager.getLogger(VASProductCategoryListCtrl.class);
	...
	public void onVASProductCategoryItemDoubleClicked(Event event) {
		...
		String whereCond = " where ProductCtg=?";

		if (doCheckAuthority(vASProductCategory, whereCond, new Object[] { vASProductCategory.getProductCtg() })) {
	 ...
	 * 
	 * @param aVASProductCategory The entity that need to be passed to the dialog.
	 */
