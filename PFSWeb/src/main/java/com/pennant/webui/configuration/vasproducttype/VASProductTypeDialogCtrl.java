 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : VASProductTypeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 09-01-2017 * *
...
public class VASProductTypeDialogCtrl extends GFCBaseCtrl<VASProductType> {
	...
	private static final Logger logger = LogManager.getLogger(VASProductTypeDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_VASProductTypeDialog(Event event) {
	 ...
	 * @param event
	 */
	public void onClose$window_VASProductTypeDialog(Event event) {
		logger.debug("Entering" + event.toString());
		doClose();
		logger.debug("Leaving" + event.toString());
	}
	 ...
	 * 
	 * @param aVASProductType VASProductType
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aVASProductType.getProductType(), aVASProductType);
	...
	private boolean doSaveProcess(AuditHeader auditHeader, String method) {
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			if (retValue == PennantConstants.porcessCONTINUE) {
				...
				if (deleteNotes) {
					deleteNotes(
							getNotes("VASProductType", aVASProductType.getProductType(), aVASProductType.getVersion()),
							true);
				}
			}
