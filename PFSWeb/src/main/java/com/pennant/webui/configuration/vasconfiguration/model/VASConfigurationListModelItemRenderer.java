 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : VASConfigurationListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
...
public class VASConfigurationListModelItemRenderer implements ListitemRenderer<VASConfiguration>, Serializable {
	...
	@Override
	public void render(Listitem item, VASConfiguration vASConfiguration, int count) {
