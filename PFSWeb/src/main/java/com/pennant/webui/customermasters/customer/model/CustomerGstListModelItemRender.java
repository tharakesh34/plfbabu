...
/*
		Listcell lc;
		lc = new Listcell(customerGST.getGstNumber().trim());
		lc.setParent(item);
		lc = new Listcell(customerGST.getf);
		lc.setParent(item);
		lc = new Listcell(customerGST.getCustShrtName());
		lc.setParent(item);
		lc = new Listcell(customerGST.getCustDftBranch());
		lc.setParent(item);
		lc = new Listcell(customerGST.getLovDescCustCtgCodeName());
		lc.setParent(item);
		lc = new Listcell(customerGST.getLovDescCustTypeCodeName());
		lc.setParent(item);
		lc = new Listcell(
