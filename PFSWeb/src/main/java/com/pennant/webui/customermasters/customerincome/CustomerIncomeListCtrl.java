 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerIncomeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * *
...
public class CustomerIncomeListCtrl extends GFCBaseListCtrl<CustomerIncome> {
	 ...
	 * 
	 * @param customerIncome The entity that need to be passed to the dialog.
	 */
