 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerGroupListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class CustomerGroupListCtrl extends GFCBaseListCtrl<CustomerGroup> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerGroupListCtrl.class);
	 ...
	 * 
	 * @param customerGroup The entity that need to be passed to the dialog.
	 */
