 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerAdditionalDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011
...
public class CustomerAdditionalDetailListCtrl extends GFCBaseListCtrl<CustomerAdditionalDetail> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerAdditionalDetailListCtrl.class);
	...
	public void onCustomerAdditionalDetailItemDoubleClicked(Event event) {
		...
		if (item != null) {
			...
			if (doCheckAuthority(customerAdditionalDetail, whereCond,
					new Object[] { customerAdditionalDetail.getCustID() })) {
	 ...
	 * 
	 * @param customerAdditionalDetail The entity that need to be passed to the dialog.
	 */
