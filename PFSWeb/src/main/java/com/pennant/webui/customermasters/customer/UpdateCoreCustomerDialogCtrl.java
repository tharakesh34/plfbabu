...
public class UpdateCoreCustomerDialogCtrl extends GFCBaseCtrl<Customer> {
	 ...
	 */
	public void onFulfill$custCIF(Event event) throws WrongValueException, InterfaceException, SecurityException,
			IllegalArgumentException, NoSuchFieldException, IllegalAccessException, InterfaceException {
		logger.debug("Entering");
	...
	private void doFillCustomerDetails() throws InterfaceException, SecurityException, IllegalArgumentException,
			NoSuchFieldException, IllegalAccessException, InterfaceException {
		logger.debug("Entering");
	...
	public void onClick$btnUpdateCustCIF(Event event) throws InterruptedException {
		...
		if (validate()) {
			...
			try {
				if (this.listBoxUpdateCustomer.getSelectedItems() != null
						&& !this.listBoxUpdateCustomer.getSelectedItems().isEmpty()) {
	...
	private boolean validate() throws InterruptedException {
		...
		if (listBoxNewCustomer.getItems() == null || listBoxNewCustomer.getItems().isEmpty()) {
			if (listBoxUpdateCustomer.getItems() == null || listBoxUpdateCustomer.getItems().isEmpty()) {
				...
				logger.debug("Leaving");
				return false;
			} else if (listBoxUpdateCustomer.getSelectedItems() == null
					|| listBoxUpdateCustomer.getSelectedItems().isEmpty()) {
				...
				&& (listBoxUpdateCustomer.getSelectedItems() == null
						|| listBoxUpdateCustomer.getSelectedItems().isEmpty())) {
	...
	private boolean custFieldMasterCheckValidation() throws InterruptedException {
		...
		List<CustomerDetails> customerDetailsList = getCustomerInterfaceService()
				.validateMasterFieldDetails(customerDetailsListTemp, null);
	...
	public void processCustomerDetails(CustomerDetails core, CustomerDetails pff)
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustShrtName())
				.equals(core.getCustomer().getCustShrtName())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustCoreBank())
				.equals(core.getCustomer().getCustCoreBank())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustFName()).equals(core.getCustomer().getCustFName())) {
			addCustFieldToUpdateList(listGroupCustomer, "CustFName", getFieldLabel("CustFName"),
					core.getCustomer().getCustFName(), pff.getCustomer().getCustFName());
		}
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustFNameLclLng())
				.equals(core.getCustomer().getCustFNameLclLng())) {
			addCustFieldToUpdateList(listGroupCustomer, "CustFNameLclLng", getFieldLabel("CustFNameLclLng"),
					core.getCustomer().getCustFNameLclLng(), pff.getCustomer().getCustFNameLclLng());
		}
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustShrtNameLclLng())
				.equals(core.getCustomer().getCustShrtNameLclLng())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustTypeCode())
				.equals(core.getCustomer().getCustTypeCode())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustDftBranch())
				.equals(core.getCustomer().getCustDftBranch())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustParentCountry())
				.equals(core.getCustomer().getCustParentCountry())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustRiskCountry())
				.equals(core.getCustomer().getCustRiskCountry())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustSalutationCode())
				.equals(core.getCustomer().getCustSalutationCode())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustGenderCode())
				.equals(core.getCustomer().getCustGenderCode())) {
		...
		if (!StringUtils.trimToEmpty(String.valueOf(pff.getCustomer().getCustRO1()))
				.equals(core.getCustomer().getCustRO1())) {
		...
		if (pff.getCustomer().isCustIsMinor() != core.getCustomer().isCustIsMinor()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsMinor", getFieldLabel("CustIsMinor"),
					String.valueOf(core.getCustomer().isCustIsMinor()),
					String.valueOf(pff.getCustomer().isCustIsMinor()));
		}
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustPassportNo())
				.equals(core.getCustomer().getCustPassportNo())) {
		...
		if (pff.getCustomer().getCustPassportExpiry() != null && core.getCustomer().getCustPassportExpiry() != null
				&& pff.getCustomer().getCustPassportExpiry()
						.compareTo(core.getCustomer().getCustPassportExpiry()) != 0) {
		...
		if (pff.getCustomer().isCustIsTradeFinCust() != core.getCustomer().isCustIsTradeFinCust()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsTradeFinCust", getFieldLabel("CustIsTradeFinCust"),
					String.valueOf(core.getCustomer().isCustIsTradeFinCust()),
					String.valueOf(pff.getCustomer().isCustIsTradeFinCust()));
		}
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustNationality())
				.equals(core.getCustomer().getCustNationality())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustMaritalSts())
				.equals(core.getCustomer().getCustMaritalSts())) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustResdCountry())
				.equals(core.getCustomer().getCustResdCountry())) {
		...
		if (pff.getCustomer().getCustFirstBusinessDate()
				.compareTo(core.getCustomer().getCustFirstBusinessDate()) != 0) {
		...
		if (!StringUtils.trimToEmpty(pff.getCustomer().getCustRelation())
				.equals(core.getCustomer().getCustRelation())) {
		...
		if (pff.getCustomer().isCustIsClosed() != core.getCustomer().isCustIsClosed()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsClosed", getFieldLabel("CustIsClosed"),
					String.valueOf(core.getCustomer().isCustIsClosed()),
					String.valueOf(pff.getCustomer().isCustIsClosed()));
		}
		if (pff.getCustomer().isCustIsBlocked() != core.getCustomer().isCustIsBlocked()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsBlocked", getFieldLabel("CustIsBlocked"),
					String.valueOf(core.getCustomer().isCustIsBlocked()),
					String.valueOf(pff.getCustomer().isCustIsBlocked()));
		}
		if (pff.getCustomer().isCustIsActive() != core.getCustomer().isCustIsActive()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsActive", getFieldLabel("CustIsActive"),
					String.valueOf(core.getCustomer().isCustIsActive()),
					String.valueOf(pff.getCustomer().isCustIsActive()));
		}
		if (pff.getCustomer().isCustIsDecease() != core.getCustomer().isCustIsDecease()) {
			addCustFieldToUpdateList(listGroupCustomer, "CustIsDecease", getFieldLabel("CustIsDecease"),
					String.valueOf(core.getCustomer().isCustIsDecease()),
					String.valueOf(pff.getCustomer().isCustIsDecease()));
		}
		if (pff.getCustomer().getCustTotalIncome().compareTo(core.getCustomer().getCustTotalIncome()) != 0) {
			...
			lc = new Listcell(PennantAppUtil
					.formateAmount(core.getCustomer().getCustTotalIncome(), coreCurrency.getCcyEditField()).toString());
			lc.setParent(item);
			lc = new Listcell(PennantAppUtil
					.formateAmount(pff.getCustomer().getCustTotalIncome(), pffCurrency.getCcyEditField()).toString());
			lc.setParent(item);
			...
			for (int count = 1; count <= core.getAddressList().size(); count++) {
				...
				if (valueExistInAddressTypeMaster(coreCustAddrs.getCustAddrType(), addressTypeMasterList)) {
					...
					if (pffCustAddrs != null) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrHNbr())
								.equals(pffCustAddrs.getCustAddrHNbr())) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustFlatNbr())
								.equals(pffCustAddrs.getCustFlatNbr())) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrStreet())
								.equals(pffCustAddrs.getCustAddrStreet())) {
							addChildFieldToUpdateList(listGroupAddress, "CustAddrStreet",
									getFieldLabel("CustAddrStreet"), coreCustAddrs.getCustAddrStreet(),
									pffCustAddrs.getCustAddrStreet());
							createAddressGroup = true;
						}
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrLine1())
								.equals(pffCustAddrs.getCustAddrLine1())) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrLine2())
								.equals(pffCustAddrs.getCustAddrLine2())) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrZIP())
								.equals(pffCustAddrs.getCustAddrZIP())) {
						...
						if (!StringUtils.trimToEmpty(coreCustAddrs.getCustAddrPhone())
								.equals(pffCustAddrs.getCustAddrPhone())) {
						...
						if (!createAddressGroup && this.listBoxUpdateCustomer
								.getFellowIfAny(listGroupAddress + coreCustAddrs.getCustAddrType()) != null) {
							this.listBoxUpdateCustomer
									.getFellowIfAny(listGroupAddress + coreCustAddrs.getCustAddrType()).detach();
						}
					} else {
					...
					masterMissedDetail.setDescription(
							"Customer : " + core.getCustomer().getCustCIF() + " , '" + coreCustAddrs.getCustAddrType()
									+ "' Value Does Not Exist In Master BMTAddressTypes Table ");
	...
	private void processPhoneNumberDetails(CustomerDetails core, CustomerDetails pff) {
		...
		if (core.getCustomerPhoneNumList() != null && !core.getCustomerPhoneNumList().isEmpty()) {
			for (int count = 1; count <= core.getCustomerPhoneNumList().size(); count++) {
				...
				CustomerPhoneNumber pffCustPhoneNum = customerPhoneNumberAlreadyExist(coreCustPhoneNum,
						pff.getCustomerPhoneNumList());

				if (pffCustPhoneNum != null) {

					if (!StringUtils.trimToEmpty(coreCustPhoneNum.getPhoneNumber())
							.equals(pffCustPhoneNum.getPhoneNumber())) {
						Listgroup listgroup = new Listgroup(getGroupLabel(listGroupPhoneNumber) + " : "
								...
								+ pffCustPhoneNum.getPhoneTypeCode());
			...
			for (int count = 1; count <= core.getCustomerEMailList().size(); count++) {
				...
				if (valueExistInEmailTypeMaster(coreCustEmail.getCustEMailTypeCode(), emailTypeMasterList)) {
					...
					if (pffCustEmail != null) {
						...
						if (!StringUtils.trimToEmpty(coreCustEmail.getCustEMail())
								.equals(pffCustEmail.getCustEMail())) {
							...
							Listgroup listgroup = new Listgroup(getGroupLabel(listGroupEmail) + " : "
									...
									+ coreCustEmail.getCustEMailTypeCode());
						...
						addFieldToNewList(listGroupEmail, getFieldLabel("CustEMail"), coreCustEmail.getCustEMail(),
								count);
					}
				} else {
					masterMissedDetail = new EquationMasterMissedDetail();
					...
					masterMissedDetail.setDescription("Customer : " + core.getCustomer().getCustCIF() + " , '"
							+ coreCustEmail.getCustEMailTypeCode()
							+ "' Value Does Not Exist In Master BMTEMailTypes Table ");
					masterValueMissedDetails.add(masterMissedDetail);
				}
			}
		}
			...
			for (int count = 1; count <= core.getRatingsList().size(); count++) {
				...
				if (valueExistInRatingMaster(coreCustRating, ratingTypeMasterList)) {
					...
					if (pffCustRating != null) {
						...
						if (!StringUtils.trimToEmpty(coreCustRating.getCustRatingCode())
								.equals(pffCustRating.getCustRatingCode())
								|| !StringUtils.trimToEmpty(coreCustRating.getCustRating())
										.equals(pffCustRating.getCustRating())) {
							Listgroup listgroup = new Listgroup(getGroupLabel(listGroupRating) + " : "
									...
									+ coreCustRating.getCustRatingType());
						...
						if (!StringUtils.trimToEmpty(coreCustRating.getCustRatingCode())
								.equals(pffCustRating.getCustRatingCode())) {
							addChildFieldToUpdateList(listGroupRating, "CustRatingCode",
						...
						if (!StringUtils.trimToEmpty(coreCustRating.getCustRating())
								.equals(pffCustRating.getCustRating())) {
							addChildFieldToUpdateList(listGroupRating, "CustRating",
									Labels.getLabel("label_CustomerRatingDialog_CustRating.value"),
						...
						addFieldToNewList(listGroupRating,
								Labels.getLabel("label_CustomerRatingDialog_CustRatingType.value"),
					...
					masterMissedDetail.setDescription("Customer : " + core.getCustomer().getCustCIF() + " , '"
							+ coreCustRating.getCustRatingType()
							+ "' Value Does Not Exist In Master BMTRatingTypes Table ");
					masterValueMissedDetails.add(masterMissedDetail);
				}
			}
		}
			...
			for (Listgroup listgroup : this.listBoxUpdateCustomer.getGroups()) {
				...
				if (StringUtils.isNotEmpty(updateQuery)) {
					...
					if (moduleName.contains(listGroupCustomer)) {
						...
						getDailyDownloadInterfaceService().updateObjectDetails(updateQuery,
								coreCustomerDetails.getCustomer());
					} else if (moduleName.contains(listGroupAddress)) {
						updateQuery = "Update  CustomerAddresses  Set " + updateQuery
								+ " Where CustID = :CustID And CustAddrType = :CustAddrType";
						...
						updateQuery = "Update  CustomerPhoneNumbers Set " + updateQuery
								+ " Where PhoneCustID = :PhoneCustID And PhoneTypeCode = :PhoneTypeCode";
						...
						updateQuery = "Update  CustomerEMails  Set " + updateQuery
								+ " Where CustID = :CustID And CustEMailTypeCode = :CustEMailTypeCode";
						...
						updateQuery = "Update  CustomerRatings  Set " + updateQuery
								+ " Where CustID = :CustID And CustRatingType = :CustRatingType";
	...
	private boolean valueExistInRatingMaster(CustomerRating coreCustRating, List<RatingType> ratingTypes) {
		for (RatingType ratingType : ratingTypes) {
			if (StringUtils.trimToEmpty(coreCustRating.getCustRatingType())
					.equalsIgnoreCase(ratingType.getRatingType())) {
				return true;
			}
		}
		return false;
	...
	private CustomerPhoneNumber customerPhoneNumberAlreadyExist(CustomerPhoneNumber customerPhoneNumber,
			List<CustomerPhoneNumber> cPhoneNumbers) {
		for (CustomerPhoneNumber cPhoneNumber : cPhoneNumbers) {
			if (StringUtils.trimToEmpty(customerPhoneNumber.getPhoneTypeCode())
	...
	private CustomerEMail customerEmailAlreadyExist(CustomerEMail customerEMail, List<CustomerEMail> list) {
		for (CustomerEMail cEMail : list) {
			if (StringUtils.trimToEmpty(customerEMail.getCustEMailTypeCode())
	...
	private CustomerRating customerRatingAlreadyExist(CustomerRating customerRating, List<CustomerRating> list) {
		for (CustomerRating cRating : list) {
			if (StringUtils.trimToEmpty(customerRating.getCustRatingType())
					.equalsIgnoreCase(cRating.getCustRatingType())) {
				return cRating;
			}
		}
		return null;
	...
	private void addFieldToNewList(String listGroup, String label, String coreValue, int count) {
		logger.debug("Entering");
		if (this.listBoxNewCustomer.getGroups() != null
				&& !this.listBoxNewCustomer.getGroups().toString().contains(listGroup + count)) {
	...
	@SuppressWarnings("deprecation")
	private void addCustFieldToUpdateList(String listGroup, String fieldID, String label, String coreValue,
			String pffValue) {
		logger.debug("Entering");

		if (this.listBoxUpdateCustomer.getGroups() != null
				&& !this.listBoxUpdateCustomer.getGroups().toString().contains(listGroup)) {
	...
	@SuppressWarnings("deprecation")
	private void addCustFieldToUpdateList(String listGroup, String fieldID, String label, long coreValue,
			long pffValue) {
		logger.debug("Entering");
	...
	private void addChildFieldToUpdateList(String listGroup, String fieldID, String label, String coreValue,
			String pffValue) {
		logger.debug("Entering");
