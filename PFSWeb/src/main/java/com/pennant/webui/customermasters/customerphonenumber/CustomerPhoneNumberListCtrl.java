 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerPhoneNumberListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * *
...
public class CustomerPhoneNumberListCtrl extends GFCBaseListCtrl<CustomerPhoneNumber> {
	 ...
	 * 
	 * @param customerPhoneNumber The entity that need to be passed to the dialog.
	 */
