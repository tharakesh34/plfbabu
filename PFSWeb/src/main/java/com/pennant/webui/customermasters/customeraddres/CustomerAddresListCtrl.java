 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerAddresListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * *
...
public class CustomerAddresListCtrl extends GFCBaseListCtrl<CustomerAddres> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerAddresListCtrl.class);
	...
	public void onCustomerAddresItemDoubleClicked(Event event) {
		...
		if (doCheckAuthority(customerAddres, whereCond, new Object[] { customerAddres.getCustID() })) {
	 ...
	 * 
	 * @param customerAddres The entity that need to be passed to the dialog.
	 */
