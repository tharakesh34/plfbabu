 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CorporateCustomerDetailDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 01-12-2011
...
public class CorporateCustomerDetailDialogCtrl extends GFCBaseCtrl<CorporateCustomerDetail> {
	...
	private static final Logger logger = LogManager.getLogger(CorporateCustomerDetailDialogCtrl.class);
	 ...
	 * 
	 * @param aCorporateCustomerDetail CorporateCustomerDetail
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aCorporateCustomerDetail.getLovDescCustCIF(), aCorporateCustomerDetail);
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			if (StringUtils.isBlank(method)) {
				...
				if (StringUtils.trimToEmpty(method).equalsIgnoreCase(PennantConstants.method_doApprove)) {
					...
					retValue = ErrorControl.showErrorControl(this.window_CorporateCustomerDetailDialog, auditHeader);
					return processCompleted;
				}
			}
