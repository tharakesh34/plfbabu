 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerEMailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * *
...
public class CustomerEMailListCtrl extends GFCBaseListCtrl<CustomerEMail> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerEMailListCtrl.class);
	 ...
	 * 
	 * @param customerEMail The entity that need to be passed to the dialog.
	 */
