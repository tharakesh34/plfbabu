 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class CustomerTypeListCtrl extends GFCBaseListCtrl<CustomerType> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerTypeListCtrl.class);
