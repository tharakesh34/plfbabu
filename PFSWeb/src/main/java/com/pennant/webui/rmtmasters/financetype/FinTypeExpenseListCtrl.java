 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinTypeExpenseListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 20-12-2017 * *
 * Modified Date : 20-12-2017 * * Description : * *
 ********************************************************************************************
...
public class FinTypeExpenseListCtrl extends GFCBaseCtrl<FinTypeExpense> {
	...
	private static final Logger logger = LogManager.getLogger(FinTypeExpenseListCtrl.class);
	...
	public List<FinTypeExpense> onSave() {
		logger.debug("Entering");
