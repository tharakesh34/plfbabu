 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScoringGroupListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-12-2011 * * Modified
...
public class ScoringGroupListCtrl extends GFCBaseListCtrl<ScoringGroup> {
	...
	private static final Logger logger = LogManager.getLogger(ScoringGroupListCtrl.class);
	 ...
	 * 
	 * @param aScoringGroup The entity that need to be passed to the dialog.
	 */
