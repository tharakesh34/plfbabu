 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AccountTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified
...
public class AccountTypeListCtrl extends GFCBaseListCtrl<AccountType> {
	...
	private static final Logger logger = LogManager.getLogger(AccountTypeListCtrl.class);
	 ...
	 * 
	 * @param aAccountType The entity that need to be passed to the dialog.
	 */
