 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : PFSParameterListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-07-2011 * * Modified
...
public class PFSParameterListCtrl extends GFCBaseListCtrl<PFSParameter> {
	...
	private static final Logger logger = LogManager.getLogger(PFSParameterListCtrl.class);
