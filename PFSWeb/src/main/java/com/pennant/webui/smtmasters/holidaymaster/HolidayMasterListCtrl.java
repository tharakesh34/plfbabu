 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : HolidayMasterListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 11-07-2011 * *
...
public class HolidayMasterListCtrl extends GFCBaseListCtrl<HolidayMaster> {
	 ...
	 * 
	 * @param aHolidayMaster The entity that need to be passed to the dialog.
	 */
