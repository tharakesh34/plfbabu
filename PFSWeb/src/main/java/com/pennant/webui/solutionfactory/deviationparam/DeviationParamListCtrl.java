 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DeviationParamListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 22-06-2015 * *
...
public class DeviationParamListCtrl extends GFCBaseListCtrl<DeviationParam> {
	 ...
	 * 
	 * @param deviationParam The entity that need to be passed to the dialog.
	 */
