 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FrequencyListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class FrequencyListCtrl extends GFCBaseListCtrl<Frequency> {
	...
	private static final Logger logger = LogManager.getLogger(FrequencyListCtrl.class);
	 ...
	 * 
	 * @param aFrequency The entity that need to be passed to the dialog.
	 */
