 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LanguageDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-06-2011 * * Modified
 * Date : 27-06-2011 * * Description : * *
 ********************************************************************************************
...
public class LanguageDialogCtrl extends GFCBaseCtrl<Language> {
	...
	private static final Logger logger = LogManager.getLogger(LanguageDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_LanguageDialog_LngCode.value") + " : " + aLanguage.getLngCode();

		doDelete(keyReference, aLanguage);
