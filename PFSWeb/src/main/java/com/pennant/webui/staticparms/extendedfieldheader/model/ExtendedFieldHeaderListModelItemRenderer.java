 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ExtendedFieldHeaderListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
...
public class ExtendedFieldHeaderListModelItemRenderer implements ListitemRenderer<ExtendedFieldHeader>, Serializable {
	...
	@Override
	public void render(Listitem item, ExtendedFieldHeader extendedFieldHeader, int count) {

		Listcell lc;
		lc = new Listcell(PennantApplicationUtil.getLabelDesc(extendedFieldHeader.getModuleName(), this.modulesList));
		lc.setParent(item);
