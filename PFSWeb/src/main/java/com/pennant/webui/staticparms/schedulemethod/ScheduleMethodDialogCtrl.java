 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScheduleMethodDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class ScheduleMethodDialogCtrl extends GFCBaseCtrl<ScheduleMethod> {
	...
	private static final Logger logger = LogManager.getLogger(ScheduleMethodDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_ScheduleMethodDialog(Event event) {
	 ...
	 * 
	 * @param aScheduleMethod ScheduleMethod
	 */
	 ...
	 * @param aScheduleMethod
	 */
	public void doShowDialog(ScheduleMethod aScheduleMethod) {
		logger.debug("Entering");
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_ScheduleMethodDialog_SchdMethod.value") + " : "
				+ aScheduleMethod.getSchdMethod();

		doDelete(keyReference, aScheduleMethod);
