 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : InterestRateBasisCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * *
...
public class InterestRateBasisCodeListCtrl extends GFCBaseListCtrl<InterestRateBasisCode> {
	...
	private static final Logger logger = LogManager.getLogger(InterestRateBasisCodeListCtrl.class);
	...
	public void onInterestRateBasisCodeItemDoubleClicked(Event event) {
		...
		String whereCond = " where IntRateBasisCode= ?";

		if (doCheckAuthority(interestRateBasisCode, whereCond,
				new Object[] { interestRateBasisCode.getIntRateBasisCode() })) {
	 ...
	 * 
	 * @param aInterestRateBasisCode The entity that need to be passed to the dialog.
	 */
