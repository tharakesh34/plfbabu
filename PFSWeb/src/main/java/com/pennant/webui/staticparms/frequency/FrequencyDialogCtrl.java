 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FrequencyDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * * Modified
...
public class FrequencyDialogCtrl extends GFCBaseCtrl<Frequency> {
	...
	private static final Logger logger = LogManager.getLogger(FrequencyDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aFrequency.getFrqCode(), aFrequency);
