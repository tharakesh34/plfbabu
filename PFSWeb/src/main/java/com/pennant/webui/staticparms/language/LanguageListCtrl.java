 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LanguageListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-06-2011 * * Modified
...
public class LanguageListCtrl extends GFCBaseListCtrl<Language> {
	...
	private static final Logger logger = LogManager.getLogger(LanguageListCtrl.class);
	 ...
	 * 
	 * @param aLanguage The entity that need to be passed to the dialog.
	 */
