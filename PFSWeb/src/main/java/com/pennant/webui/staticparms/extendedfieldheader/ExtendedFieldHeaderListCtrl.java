 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ExtendedFieldHeaderListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 28-12-2011 * *
...
public class ExtendedFieldHeaderListCtrl extends GFCBaseListCtrl<ExtendedFieldHeader> {
	...
	private static final Logger logger = LogManager.getLogger(ExtendedFieldHeaderListCtrl.class);
	...
	public void onExtendedFieldHeaderItemDoubleClicked(Event event) {
		...
		String whereCond = " where ModuleId= ?";

		if (doCheckAuthority(extendedFieldHeader, whereCond, new Object[] { extendedFieldHeader.getModuleId() })) {
	 ...
	 * 
	 * @param extendedFieldHeader The entity that need to be passed to the dialog.
	 */
