 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ScheduleMethodListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class ScheduleMethodListCtrl extends GFCBaseListCtrl<ScheduleMethod> {
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onScheduleMethodItemDoubleClicked(Event event) {
		logger.debug("Entering");
	 ...
	 * 
	 * @param aScheduleMethod The entity that need to be passed to the dialog.
	 */
