 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinSuspHoldDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class FinSuspHoldDialogCtrl extends GFCBaseCtrl<FinSuspHold> {
	...
	private static final Logger logger = LogManager.getLogger(FinSuspHoldDialogCtrl.class);
	 ...
	 * 
	 * @param aFinSuspHold FinSuspHold
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(getValidationMsg(), aFinSuspHold);
