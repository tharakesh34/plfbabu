...
public class FinanceWriteoffDialogCtrl extends FinanceBaseCtrl<FinanceMain> {
	...
	protected void doSetFieldProperties() {
		...
		this.writeoffInsAmt.setRoundingMode(RoundingMode.DOWN.ordinal());
		...
		this.label_FinWriteoffDialog_WOInsAmt.setRoundingMode(RoundingMode.DOWN.ordinal());
		...
		this.label_FinWriteoffDialog_UnPaidInsAmt.setRoundingMode(RoundingMode.DOWN.ordinal());
