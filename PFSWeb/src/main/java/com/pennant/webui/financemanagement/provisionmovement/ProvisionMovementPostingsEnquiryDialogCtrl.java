...
public class ProvisionMovementPostingsEnquiryDialogCtrl extends GFCBaseCtrl<ReturnDataSet> {
	...
	private static final Logger logger = LogManager.getLogger(ProvisionMovementPostingsEnquiryDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_ProvisionMovementPostingsEnquiryList(Event event) {
	 ...
	 * @param aProvision
	 */
	public void doShowDialog(ProvisionMovement movement, Provision aProvision) {
		logger.debug("Entering");
	 ...
	 * 
	 * @param aProvisionMovement Provision
	 */
