...
public class ManagerChequeListCtrl extends GFCBaseListCtrl<ManagerCheque> {
	...
	private static final Logger logger = LogManager.getLogger(ManagerChequeListCtrl.class);
			...
			if (item_ValueDate != null) {
				...
				if (searchOpId == -1) {
					...
					if (this.valueDate_two.getValue() != null) {
						this.searchObject.addFilter(new Filter("ValueDate",
								DateUtility.format(this.valueDate_two.getValue(), PennantConstants.DBDateFormat),
