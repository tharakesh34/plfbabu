...
public class ReceiptRealizationListCtrl extends GFCBaseListCtrl<FinReceiptHeader> {
	...
	private transient ReceiptRealizationService realizationProcessService;
	...
	public void onReceiptRealizationItemDoubleClicked(Event event) {
		...
		FinReceiptHeader header = realizationProcessService.getFinReceiptHeaderById(receiptID, "_View");
	...
	public void setReceiptRealizationService(ReceiptRealizationService realizationProcessService) {
		this.realizationProcessService = realizationProcessService;
	}
}