 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : MailTemplateListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-10-2012 * * Modified
...
public class MailTemplateListCtrl extends GFCBaseListCtrl<MailTemplate> {
	...
	private static final Logger logger = LogManager.getLogger(MailTemplateListCtrl.class);
	 ...
	 * 
	 * @param mailTemplate The entity that need to be passed to the dialog.
	 */
