 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ErrorDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2016 * * Modified
...
public class ErrorDetailListCtrl extends GFCBaseListCtrl<ErrorDetail> {
	...
	private static final Logger logger = LogManager.getLogger(ErrorDetailListCtrl.class);
	 ...
	 * 
	 * @param errorDetail The entity that need to be passed to the dialog.
	 */
