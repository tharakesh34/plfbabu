 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  ExcessEnquiryDialogCtrl.java                                                   * 	  
 *                                                                    						*
...
public class ExcessEnquiryDialogCtrl extends GFCBaseCtrl<FinExcessAmount> {
	...
	private static final Logger logger = Logger.getLogger(ExcessEnquiryDialogCtrl.class);
	...
	public void onCreate$window_ExcessEnquiryDialog(ForwardEvent event) throws Exception {
