 ...
 */
public class MudarabaFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = LogManager.getLogger(MudarabaFinanceMainDialogCtrl.class);
	...
	public void onCreate$window_MudarabaFinanceMainDialog(Event event) throws Exception {
		...
		setPageComponents(window_MudarabaFinanceMainDialog);
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_MudarabaFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
