 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  HoldDisbursementListCtrl.java                                                   * 	  
 *                                                                    						*
...
public class HoldDisbursementListCtrl extends GFCBaseListCtrl<HoldDisbursement> {
	...
	private static final Logger logger = LogManager.getLogger(HoldDisbursementListCtrl.class);
	...
	public void onHoldDisbursementItemDoubleClicked(Event event) {
		...
		HoldDisbursement holddisbursement = holdDisbursementService.getHoldDisbursement(finReference);
