 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceEligibilityRuleResultCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-11-2011
...
public class FinancePurposeSelectDialogCtrl extends GFCBaseCtrl<FinanceEligibility> {
	...
	private static final Logger logger = LogManager.getLogger(FinancePurposeSelectDialogCtrl.class);
	...
	public void onCreate$window_FinancePurposeSelectDialog(Event event) {
