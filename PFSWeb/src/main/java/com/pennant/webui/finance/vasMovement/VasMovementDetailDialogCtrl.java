 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  VasMovementDetailDialogCtrl.java                                                   * 	  
 *                                                                    						*
...
public class VasMovementDetailDialogCtrl extends GFCBaseCtrl<VasMovementDetail> {
	...
	private static final Logger logger = Logger.getLogger(VasMovementDetailDialogCtrl.class);
	...
	/**
	 * Deletes a VasMovementDetail object from database.<br>
	 * 
	 * @throws InterruptedException
	 */
	private void doDelete() throws InterruptedException {
		...
		final String msg = Labels.getLabel("message.Question.Are_you_sure_to_delete_this_record") + "\n\n --> "
				+ checkListDetail.getVasReference();
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_VasMovementDetailDialog, auditHeader);
		} catch (Exception exp) {
