 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : GuarantorDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-09-2013 * *
...
public class GuarantorDetailListCtrl extends GFCBaseListCtrl<GuarantorDetail> {
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onGuarantorDetailItemDoubleClicked(Event event) {
	 ...
	 * 
	 * @param aGuarantorDetail The entity that need to be passed to the dialog.
	 */
