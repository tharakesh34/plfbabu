 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceRepayPriorityListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 16-03-2012 * *
...
public class FinanceRepayPriorityListCtrl extends GFCBaseListCtrl<FinanceRepayPriority> {
	...
	private static final Logger logger = LogManager.getLogger(FinanceRepayPriorityListCtrl.class);
	 ...
	 * 
	 * @param aFinanceRepayPriority The entity that need to be passed to the dialog.
	 */
