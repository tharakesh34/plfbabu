 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ExpenseMovementDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class ExpenseMovementDialogCtrl extends GFCBaseCtrl<FinExpenseMovements> {
	...
	public void onCreate$window_ExpenseMovementDialog(ForwardEvent event) {
