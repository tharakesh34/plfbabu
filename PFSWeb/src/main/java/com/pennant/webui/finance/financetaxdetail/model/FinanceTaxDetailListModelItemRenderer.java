 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceTaxDetailListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
 * 17-06-2017 * * Modified Date : 17-06-2017 * * Description : * *
 ********************************************************************************************
...
public class FinanceTaxDetailListModelItemRenderer implements ListitemRenderer<FinanceTaxDetail>, Serializable {
	...
	public void render(Listitem item, FinanceTaxDetail financeTaxDetail, int count) {
		...
		lc.setParent(item);
		item.setAttribute("finID", financeTaxDetail.getFinID());
