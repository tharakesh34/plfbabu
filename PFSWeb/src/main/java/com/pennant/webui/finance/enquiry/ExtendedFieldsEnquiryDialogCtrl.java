...
public class ExtendedFieldsEnquiryDialogCtrl extends GFCBaseCtrl<Object> {
	...
	private static final Logger logger = LogManager.getLogger(ExtendedFieldsEnquiryDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_ExtendedFieldsEnquiryDialog(ForwardEvent event) {
