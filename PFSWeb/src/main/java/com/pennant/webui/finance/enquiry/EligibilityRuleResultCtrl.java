 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : EligibilityRuleResultCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-11-2011 * *
...
public class EligibilityRuleResultCtrl extends GFCBaseListCtrl<EligibilityRule> {
	...
	public void onCreate$window_ElgRuleResult(ForwardEvent event) {
