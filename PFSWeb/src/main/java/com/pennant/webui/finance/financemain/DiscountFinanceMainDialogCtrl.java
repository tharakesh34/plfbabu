 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  DiscountFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
...
public class DiscountFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	...
	private static final Logger logger = Logger.getLogger(DiscountFinanceMainDialogCtrl.class);
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_DiscountFinanceMainDialog(Event event) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void onClose$window_DiscountFinanceMainDialog(Event event) throws Exception {
