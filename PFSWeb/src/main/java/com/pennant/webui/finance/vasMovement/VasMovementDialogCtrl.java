...
public class VasMovementDialogCtrl extends GFCBaseCtrl<VasMovement> {
	...
	private static final Logger logger = Logger.getLogger(VasMovementDialogCtrl.class);
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_VasMovementDialog, auditHeader);
		} catch (Exception exp) {
