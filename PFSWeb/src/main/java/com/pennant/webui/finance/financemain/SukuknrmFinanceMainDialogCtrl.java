 ...
 */
public class SukuknrmFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = LogManager.getLogger(SukuknrmFinanceMainDialogCtrl.class);
	...
	public void onCreate$window_SukuknrmFinanceMainDialog(Event event) throws Exception {
		...
		setPageComponents(window_SukuknrmFinanceMainDialog);
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_SukuknrmFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
