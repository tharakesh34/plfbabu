...
public class MurabahaFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	...
	private final static Logger logger = Logger.getLogger(MurabahaFinanceMainDialogCtrl.class);
	 ...
	 */
	public MurabahaFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_MurabahaFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_MurabahaFinanceMainDialog);
	 ...
	 * @throws Exception
	 */
	public void onClose$window_MurabahaFinanceMainDialog(Event event) throws Exception {
	...
	public void doReject() throws InterruptedException{
		...
		try{
			Executions.createComponents("/WEB-INF/pages/Finance/FinanceMain/FinanceReject.zul",
					window_MurabahaFinanceMainDialog, map);
		} catch (Exception e) {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_MurabahaFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
