 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  RolloverFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
 ...
 */
public class RolloverFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = Logger.getLogger(RolloverFinanceMainDialogCtrl.class);
	 ...
	 */
	protected Window 		window_RolloverFinanceMainDialog; 					// autoWired

	/**
	 * default constructor.<br>
	 */
	public RolloverFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_RolloverFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_RolloverFinanceMainDialog);
		...
		setMainWindow(window_RolloverFinanceMainDialog);
		setProductCode("Rollover");
	 ...
	 * @throws Exception
	 */
	public void onClose$window_RolloverFinanceMainDialog(Event event) throws Exception {
	...
	public void doReject() throws InterruptedException{
		...
		try{
			Executions.createComponents("/WEB-INF/pages/Finance/FinanceMain/FinanceReject.zul",
					window_RolloverFinanceMainDialog, map);
		} catch (Exception e) {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_RolloverFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
