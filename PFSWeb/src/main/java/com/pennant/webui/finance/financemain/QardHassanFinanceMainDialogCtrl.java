 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  QardHassanFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
 ...
 */
public class QardHassanFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = Logger.getLogger(QardHassanFinanceMainDialogCtrl.class);
	 ...
	 */
	protected Window 		window_QardHassanFinanceMainDialog; 					// autoWired

	/**
	 * default constructor.<br>
	 */
	public QardHassanFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_QardHassanFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_QardHassanFinanceMainDialog);
		...
		setMainWindow(window_QardHassanFinanceMainDialog);
		setProductCode("QardHassan");
	 ...
	 * @throws Exception
	 */
	public void onClose$window_QardHassanFinanceMainDialog(Event event) throws Exception {
	...
	public void doReject() throws InterruptedException{
		...
		try{
			Executions.createComponents("/WEB-INF/pages/Finance/FinanceMain/FinanceReject.zul",
					window_QardHassanFinanceMainDialog, map);
		} catch (Exception e) {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_QardHassanFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
