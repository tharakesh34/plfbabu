...
package com.pennant.webui.vasproducttype.vasproducttype;
...
import com.pennant.webui.vasproducttype.vasproducttype.model.VASProductTypeListModelItemRenderer;
...
public class VASProductTypeListCtrl extends GFCBaseListCtrl<VASProductType> {
	...
	private void doShowDialogPage(VASProductType aVASProductType) {
		...
		try {
			Executions.createComponents("/WEB-INF/pages/VASProductType/VASProductType/VASProductTypeDialog.zul", null,
					arg);
		} catch (Exception e) {
