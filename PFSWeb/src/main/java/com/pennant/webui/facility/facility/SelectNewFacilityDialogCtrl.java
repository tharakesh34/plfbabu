...
public class SelectNewFacilityDialogCtrl extends GFCBaseCtrl<Facility> {
	...
	private static final Logger logger = LogManager.getLogger(SelectNewFacilityDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_SelectNewFacilityDialog(Event event) {
