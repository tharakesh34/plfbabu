 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FacilityListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 25-11-2013 * * Modified
...
public class FacilityListCtrl extends GFCBaseListCtrl<Facility> {
	...
	private static final Logger logger = LogManager.getLogger(FacilityListCtrl.class);
	 ...
	 * @param event An event sent to the event handler of the component.
	 */
	public void onClick$button_FacilityList_NewFacility(Event event) {
	 ...
	 * 
	 * @param aFacility The entity that need to be passed to the dialog.
	 */
