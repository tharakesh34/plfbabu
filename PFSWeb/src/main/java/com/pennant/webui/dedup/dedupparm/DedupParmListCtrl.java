 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DedupParmListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 23-08-2011 * * Modified
...
public class DedupParmListCtrl extends GFCBaseListCtrl<DedupParm> {
	...
	private static final Logger logger = LogManager.getLogger(DedupParmListCtrl.class);
	 ...
	 * 
	 * @param dedupParm The entity that need to be passed to the dialog.
	 */
