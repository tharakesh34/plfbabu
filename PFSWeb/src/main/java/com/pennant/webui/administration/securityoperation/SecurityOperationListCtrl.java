 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SecurityOperationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-03-2014 * *
...
public class SecurityOperationListCtrl extends GFCBaseListCtrl<SecurityOperation> {
	...
	private static final Logger logger = LogManager.getLogger(SecurityOperationListCtrl.class);
