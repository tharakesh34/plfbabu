 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SecurityOperationRolesDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-03-2014
...
public class SecurityOperationRolesDialogCtrl extends GFCBaseCtrl<SecurityOperation> {
	...
	private static final Logger logger = LogManager.getLogger(SecurityOperationRolesDialogCtrl.class);
	 ...
	 * 
	 * @param aSecurityUser SecurityOperation
	 */
