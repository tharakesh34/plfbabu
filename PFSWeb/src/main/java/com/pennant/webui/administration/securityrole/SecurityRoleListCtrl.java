 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SecurityRoleListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 27-05-2011 * * Modified
 * Date : 10-08-2011 * * Description : * *
 ********************************************************************************************
...
public class SecurityRoleListCtrl extends GFCBaseListCtrl<SecurityRole> {
	...
	public void onSecurityRoleItemDoubleClicked(Event event) {
		...
		String whereCond = " where RoleID= ?";

		if (doCheckAuthority(aSecurityRole, whereCond, new Object[] { aSecurityRole.getRoleID() })) {
	 ...
	 * 
	 * @param aSecurityRole The entity that need to be passed to the dialog.
	 */
