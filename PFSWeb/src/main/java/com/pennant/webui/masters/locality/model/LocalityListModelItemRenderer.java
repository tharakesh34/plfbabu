 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : LocalityListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 22-05-2017 * *
...
public class LocalityListModelItemRenderer implements ListitemRenderer<Locality>, Serializable {
	...
	@Override
	public void render(Listitem item, Locality locality, int count) {
