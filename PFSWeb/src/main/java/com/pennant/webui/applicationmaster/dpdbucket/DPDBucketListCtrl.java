 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  DPDBucketListCtrl.java                                                   * 	  
 *                                                                    						*
...
public class DPDBucketListCtrl extends GFCBaseListCtrl<DPDBucket> {
	...
	private static final Logger logger = Logger.getLogger(DPDBucketListCtrl.class);
	...
	private void doShowDialogPage(DPDBucket dpdbucket) {
		...
		try {
			Executions.createComponents("/WEB-INF/pages/SystemMaster/DPDBucket/DPDBucketDialog.zul", null, arg);
		} catch (Exception e) {
