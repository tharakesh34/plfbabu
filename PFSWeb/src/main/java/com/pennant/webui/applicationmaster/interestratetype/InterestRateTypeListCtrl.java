 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : InterestRateTypeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * *
...
public class InterestRateTypeListCtrl extends GFCBaseListCtrl<InterestRateType> {
	...
	private static final Logger logger = LogManager.getLogger(InterestRateTypeListCtrl.class);
	 ...
	 * 
	 * @param aInterestRateType The entity that need to be passed to the dialog.
	 */
