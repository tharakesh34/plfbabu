 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceApplicationCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011
...
public class FinanceApplicationCodeDialogCtrl extends GFCBaseCtrl<FinanceApplicationCode> {
	...
	private static final Logger logger = LogManager.getLogger(FinanceApplicationCodeDialogCtrl.class);
	 ...
	 * 
	 * @param aFinanceApplicationCode FinanceApplicationCode
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_FinanceApplicationCodeDialog_FinAppType.value") + " : "
				+ aFinanceApplicationCode.getFinAppType(), aFinanceApplicationCode);
