 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerStatusCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class CustomerStatusCodeDialogCtrl extends GFCBaseCtrl<CustomerStatusCode> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerStatusCodeDialogCtrl.class);
	 ...
	 * 
	 * @param aCustomerStatusCode CustomerStatusCode
	 */
	public void doWriteBeanToComponents(CustomerStatusCode aCustomerStatusCode) {
		...
		if (aCustomerStatusCode.isNewRecord()
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(aCustomerStatusCode.getCustStsCode(), aCustomerStatusCode);
	...
	public void doSave() throws InterruptedException {
		...
		isNew = aCustomerStatusCode.isNewRecord();
		String tranType = "";
	 ...
	 * 
	 */
	protected boolean doProcess(CustomerStatusCode aCustomerStatusCode, String tranType) {
		logger.debug("Entering");
