 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CostOfFundCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class CostOfFundCodeListCtrl extends GFCBaseListCtrl<CostOfFundCode> {
	...
	private static final Logger logger = LogManager.getLogger(CostOfFundCodeListCtrl.class);
	...
	public void onCostOfFundCodeItemDoubleClicked(Event event) {
		...
		String whereCond = " where CofCode=?";
		if (doCheckAuthority(costOfFundCode, whereCond, new Object[] { costOfFundCode.getCofCode() })) {
	 ...
	 * 
	 * @param aCostOfFundCode The entity that need to be passed to the dialog.
	 */
