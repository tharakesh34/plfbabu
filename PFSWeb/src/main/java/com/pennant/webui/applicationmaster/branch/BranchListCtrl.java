 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BranchListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified Date
...
public class BranchListCtrl extends GFCBaseListCtrl<Branch> {
	...
	private static final Logger logger = LogManager.getLogger(BranchListCtrl.class);
	 ...
	 * 
	 * @param aBranch The entity that need to be passed to the dialog.
	 */
