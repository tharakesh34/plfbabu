 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerCategoryListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class CustomerCategoryListCtrl extends GFCBaseListCtrl<CustomerCategory> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerCategoryListCtrl.class);
	...
	public void onCustomerCategoryItemDoubleClicked(Event event) {
		...
		String whereCond = " where CustCtgCode=?";

		if (doCheckAuthority(customerCategory, whereCond, new Object[] { customerCategory.getCustCtgCode() })) {
	 ...
	 * 
	 * @param customerCategory The entity that need to be passed to the dialog.
	 */
