 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ClusterDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-11-2018 * * Modified
...
public class ClusterDialogCtrl extends GFCBaseCtrl<Cluster> {
	 ...
	 * 
	 * @param cluster The entity that need to be render.
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(String.valueOf(aCluster.getId()), aCluster);
