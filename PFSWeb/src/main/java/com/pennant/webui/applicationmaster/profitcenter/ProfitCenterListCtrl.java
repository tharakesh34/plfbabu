 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProfitCenterListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 22-04-2017 * * Modified
...
public class ProfitCenterListCtrl extends GFCBaseListCtrl<ProfitCenter> {
	...
	private static final Logger logger = LogManager.getLogger(ProfitCenterListCtrl.class);
	 ...
	 * 
	 * @param profitcenter The entity that need to be passed to the dialog.
	 */
