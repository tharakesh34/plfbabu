 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustStatusCodeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date :
...
public class CustomerStatusCodeListModelItemRenderer implements ListitemRenderer<CustomerStatusCode>, Serializable {
	...
	@Override
	public void render(Listitem item, CustomerStatusCode customerStatusCode, int count) {
