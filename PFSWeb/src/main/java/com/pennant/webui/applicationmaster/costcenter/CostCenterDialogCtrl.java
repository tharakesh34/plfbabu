 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CostCenterDialogCtrl.java                                                   * 	  
 *                                                                    						*
...
public class CostCenterDialogCtrl extends GFCBaseCtrl<CostCenter>{
	...
	private void doSetValidation() {
		...
		if (!this.costCenterCode.isReadonly()){
			this.costCenterCode.setConstraint(new PTStringValidator(Labels.getLabel("label_CostCenterDialog_CostCenterCode.value"),PennantRegularExpressions.REGEX_UPPER_ALPHANUM_SPACE,true));
		}
	...
	/**
	 * Deletes a CostCenter object from database.<br>
	 * 
