 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CostOfFundListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class CostOfFundListCtrl extends GFCBaseListCtrl<CostOfFund> {
	 ...
	 * 
	 * @param aCostOfFund The entity that need to be passed to the dialog.
	 */
