 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DPDBucketListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-04-2017 *
...
public class DPDBucketListModelItemRenderer implements ListitemRenderer<DPDBucket>, Serializable {
	...
	@Override
	public void render(Listitem item, DPDBucket dPDBucket, int count) {
