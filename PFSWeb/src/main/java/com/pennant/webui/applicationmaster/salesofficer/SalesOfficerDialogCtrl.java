 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SalesOfficerDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class SalesOfficerDialogCtrl extends GFCBaseCtrl<SalesOfficer> {
	...
	private static final Logger logger = LogManager.getLogger(SalesOfficerDialogCtrl.class);
	 ...
	 * 
	 * @param aSalesOfficer SalesOfficer
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		String keyReference = Labels.getLabel("label_SalesOfficerDialog_SalesOffCode.value") + " : "
				+ aSalesOfficer.getSalesOffCode();

		doDelete(keyReference, aSalesOfficer);
