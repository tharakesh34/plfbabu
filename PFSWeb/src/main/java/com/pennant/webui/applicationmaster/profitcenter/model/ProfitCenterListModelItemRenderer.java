 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ProfitCenterListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 22-04-2017
...
public class ProfitCenterListModelItemRenderer implements ListitemRenderer<ProfitCenter>, Serializable {
	...
	@Override
	public void render(Listitem item, ProfitCenter profitCenter, int count) {
