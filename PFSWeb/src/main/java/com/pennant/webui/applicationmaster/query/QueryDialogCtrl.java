 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : QueryDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-07-2013 * * Modified Date
...
public class QueryDialogCtrl extends GFCBaseCtrl<Query> {
	...
	private static final Logger logger = LogManager.getLogger(QueryDialogCtrl.class);
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_QueryDialog_QueryCode.value") + " : " + aQuery.getQueryCode(), aQuery);
