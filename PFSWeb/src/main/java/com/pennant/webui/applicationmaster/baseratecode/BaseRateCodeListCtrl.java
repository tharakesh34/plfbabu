 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BaseRateCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class BaseRateCodeListCtrl extends GFCBaseListCtrl<BaseRateCode> {
	...
	private static final Logger logger = LogManager.getLogger(BaseRateCodeListCtrl.class);
	 ...
	 * 
	 * @param aBaseRateCode The entity that need to be passed to the dialog.
	 */
