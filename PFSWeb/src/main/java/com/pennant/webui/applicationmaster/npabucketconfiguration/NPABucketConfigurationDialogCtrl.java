...
public class NPABucketConfigurationDialogCtrl extends GFCBaseCtrl<NPABucketConfiguration> {
	...
	private static final Logger logger = LogManager.getLogger(NPABucketConfigurationDialogCtrl.class);
	 ...
	 */
	public void onCreate$window_NPABucketConfigurationDialog(Event event) {
