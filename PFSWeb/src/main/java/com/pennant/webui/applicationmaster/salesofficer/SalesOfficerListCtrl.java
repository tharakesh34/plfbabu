 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SalesOfficerListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * * Modified
...
public class SalesOfficerListCtrl extends GFCBaseListCtrl<SalesOfficer> {
	...
	private static final Logger logger = LogManager.getLogger(SalesOfficerListCtrl.class);
	 ...
	 * 
	 * @param aSalesOfficer The entity that need to be passed to the dialog.
	 */
