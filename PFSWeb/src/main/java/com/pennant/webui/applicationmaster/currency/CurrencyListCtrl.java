 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CurrencyListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified
...
public class CurrencyListCtrl extends GFCBaseListCtrl<Currency> {
	...
	private static final Logger logger = LogManager.getLogger(CurrencyListCtrl.class);
	 ...
	 * 
	 * @param aCurrency The entity that need to be passed to the dialog.
	 */
