 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RelationshipOfficerDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class RelationshipOfficerDialogCtrl extends GFCBaseCtrl<RelationshipOfficer> {
	 ...
	 * 
	 * @param aRelationshipOfficer RelationshipOfficer
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_RelationshipOfficerDialog_ROfficerCode.value") + " : "
				+ aRelationshipOfficer.getROfficerCode(), aRelationshipOfficer);
