 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CostCenterListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 22-04-2017 *
...
public class CostCenterListModelItemRenderer implements ListitemRenderer<CostCenter>, Serializable {
	...
	@Override
	public void render(Listitem item, CostCenter costCenter, int count) {
