 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CustomerStatusCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * *
...
public class CustomerStatusCodeListCtrl extends GFCBaseListCtrl<CustomerStatusCode> {
	...
	private static final Logger logger = LogManager.getLogger(CustomerStatusCodeListCtrl.class);
	...
	public void onCreate$window_CustomerStatusCodeList(Event event) {
		...
		setPageComponents(window_CustomerStatusCodeList, borderLayout_CustomerStatusCodeList, listBoxCustomerStatusCode,
				pagingCustomerStatusCodeList);
	 ...
	 * 
	 * @param customerStatusCode The entity that need to be passed to the dialog.
	 */
