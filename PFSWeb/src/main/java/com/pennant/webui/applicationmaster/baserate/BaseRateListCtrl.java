 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : BaseRateListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 03-05-2011 * * Modified
...
public class BaseRateListCtrl extends GFCBaseListCtrl<BaseRate> {
	...
	private static final Logger logger = LogManager.getLogger(BaseRateListCtrl.class);
	 ...
	 * 
	 * @param aBaseRate The entity that need to be passed to the dialog.
	 */
