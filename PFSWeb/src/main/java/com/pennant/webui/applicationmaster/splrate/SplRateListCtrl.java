 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SplRateListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 26-05-2011 * * Modified Date
...
public class SplRateListCtrl extends GFCBaseListCtrl<SplRate> {
	...
	public void onSplRateItemDoubleClicked(Event event) {
		...
		if (doCheckAuthority(splRate, whereCond, new Object[] { splRate.getSRType() })) {
	 ...
	 * 
	 * @param splRate The entity that need to be passed to the dialog.
	 */
