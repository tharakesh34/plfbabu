 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CorpRelationCodeDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class CorpRelationCodeDialogCtrl extends GFCBaseCtrl<CorpRelationCode> {
	...
	private static final Logger logger = LogManager.getLogger(CorpRelationCodeDialogCtrl.class);
	 ...
	 * @param event
	 */
	public void onCreate$window_CorpRelationCodeDialog(Event event) {
	 ...
	 * 
	 * @param aCorpRelationCode CorpRelationCode
	 */
	public void doWriteBeanToComponents(CorpRelationCode aCorpRelationCode) {
		...
		if (aCorpRelationCode.isNewRecord()
	 ...
	 * @param aCorpRelationCode
	 */
	public void doShowDialog(CorpRelationCode aCorpRelationCode) {
		logger.debug("Entering");
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_CorpRelationCodeDialog_CorpRelationCode.value") + " : "
				+ aCorpRelationCode.getCorpRelationCode(), aCorpRelationCode);
	...
	public void doSave() throws InterruptedException {
		...
		isNew = aCorpRelationCode.isNewRecord();
		String tranType = "";
	 ...
	 * 
	 */
	protected boolean doProcess(CorpRelationCode aCorpRelationCode, String tranType) {
		logger.debug("Entering");
