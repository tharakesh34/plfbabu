...
/**
 * This is the controller class for the /WEB-INF/pages/ApplicationMaster/BaseRateCode/baseRateCodeDialog.zul file.
 */
public class BaseRateCodeDialogCtrl extends GFCBaseCtrl<BaseRateCode> {
	...
	private static final Logger logger = LogManager.getLogger(BaseRateCodeDialogCtrl.class);
	 ...
	 * selected BaseRateCode object in a Map.
	 * 
	 * @param event
	 */
	public void onCreate$window_BaseRateCodeDialog(Event event) {
		...
		try {
			...
			if (isWorkFlowEnabled()) {
				...
				getUserWorkspace().allocateRoleAuthorities(getRole(), "BaseRateCodeDialog");
			} else {
			...
			if (arguments.containsKey("baseRateCodeListCtrl")) {
				setBaseRateCodeListCtrl((BaseRateCodeListCtrl) arguments.get("baseRateCodeListCtrl"));
			} else {
	...
	public void doWriteBeanToComponents(BaseRateCode aBaseRateCode) {
		...
		if (aBaseRateCode.isNewRecord() || (aBaseRateCode.getRecordType() != null ? aBaseRateCode.getRecordType() : "")
	...
	public void doWriteComponentsToBean(BaseRateCode aBaseRateCode) {
		...
		try {
			...
			if (!"#".equals(this.bRRepayRvwFrq.getFrqCodeValue())
					&& "#".equals(this.bRRepayRvwFrq.getFrqMonthValue())) {
				throw new WrongValueException(this.bRRepayRvwFrq.getFrqMonthCombobox(),
	 ...
	 * @param aBaseRateCode
	 */
	public void doShowDialog(BaseRateCode aBaseRateCode) {
		logger.debug("Entering");

		// set Read only mode accordingly if the object is new or not.
		if (aBaseRateCode.isNewRecord()) {
	...
	private void doSetValidation() {
		...
		if (!this.bRType.isReadonly()) {
			this.bRType.setConstraint(new PTStringValidator(Labels.getLabel("label_BaseRateCodeDialog_BRType.value"),
					PennantRegularExpressions.REGEX_UPP_BOX_ALPHANUM, true));
		}
		if (!this.bRTypeDesc.isReadonly()) {
			this.bRTypeDesc
					.setConstraint(new PTStringValidator(Labels.getLabel("label_BaseRateCodeDialog_BRTypeDesc.value"),
	...
	public void doSave() throws InterruptedException {
		...
		isNew = aBaseRateCode.isNewRecord();
		String tranType = "";
	 ...
	 * 
	 */
	protected boolean doProcess(BaseRateCode aBaseRateCode, String tranType) {
		logger.debug("Entering");
