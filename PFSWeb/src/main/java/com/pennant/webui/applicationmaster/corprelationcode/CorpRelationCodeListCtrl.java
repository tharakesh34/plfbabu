 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : CorpRelationCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 * *
...
public class CorpRelationCodeListCtrl extends GFCBaseListCtrl<CorpRelationCode> {
	...
	private static final Logger logger = LogManager.getLogger(CorpRelationCodeListCtrl.class);
	 ...
	 * 
	 * @param aCorpRelationCode The entity that need to be passed to the dialog.
	 */
