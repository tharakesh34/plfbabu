 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : SysNotificationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 11-06-2015 * *
...
public class SysNotificationListCtrl extends GFCBaseListCtrl<SysNotification> {
	...
	private static final Logger logger = LogManager.getLogger(SysNotificationListCtrl.class);
	 ...
	 * 
	 * @param sysNotification The entity that need to be passed to the dialog.
	 */
