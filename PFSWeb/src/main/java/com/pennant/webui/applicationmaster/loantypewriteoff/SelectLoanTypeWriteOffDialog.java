...
public class SelectLoanTypeWriteOffDialog extends GFCBaseCtrl<FinTypeWriteOff> {
	 ...
	 */
	protected Window window_SelectLoanTypeWriteOffDialog;
	...
	LoanTypeWriteOffService loanTypeWriteOffService;
	 ...
	 * @param event
	 */
	public void onCreate$window_SelectLoanTypeWriteOffDialog(Event event) {
		logger.debug(Literal.ENTERING);

		// Set the page level components.
		setPageComponents(window_SelectLoanTypeWriteOffDialog);
		...
		this.window_SelectLoanTypeWriteOffDialog.doModal();
	...
	private void doShowDialogPage(FinTypeWriteOff financeType) {
		...
		try {
			...
			this.window_SelectLoanTypeWriteOffDialog.onClose();
		} catch (Exception e) {
