 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : QueryListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 04-07-2013 * * Modified Date :
...
public class QueryListCtrl extends GFCBaseListCtrl<Query> {
	 ...
	 * 
	 * @param query ,isSubQuery The entity that need to be passed to the dialog.
	 */
