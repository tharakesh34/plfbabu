 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RelationshipOfficerListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 12-09-2011 * *
...
public class RelationshipOfficerListCtrl extends GFCBaseListCtrl<RelationshipOfficer> {
	 ...
	 * 
	 * @param aRelationshipOfficer The entity that need to be passed to the dialog.
	 */
