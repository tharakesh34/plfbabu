 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RejectDetailDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * *
...
public class RejectDetailDialogCtrl extends GFCBaseCtrl<RejectDetail> {
	...
	private static final Logger logger = LogManager.getLogger(RejectDetailDialogCtrl.class);
	 ...
	 * 
	 * @param aRejectDetail RejectDetail
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_RejectDetailDialog_RejectCode.value") + " : " + aRejectDetail.getRejectCode(),
				aRejectDetail);
