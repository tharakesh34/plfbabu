 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : IRRCodeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-06-2017 * *
...
public class IRRCodeListModelItemRenderer implements ListitemRenderer<IRRCode>, Serializable {
	...
	@Override
	public void render(Listitem item, IRRCode iRRCode, int count) {
