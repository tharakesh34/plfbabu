 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : AgreementDefinitionListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 23-11-2011 * *
...
public class AgreementDefinitionListCtrl extends GFCBaseListCtrl<AgreementDefinition> {
	...
	private static final Logger logger = LogManager.getLogger(AgreementDefinitionListCtrl.class);
	 ...
	 * 
	 * @param agreementDefinition The entity that need to be passed to the dialog.
	 */
