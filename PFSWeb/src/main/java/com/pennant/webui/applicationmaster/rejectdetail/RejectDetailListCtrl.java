 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : RejectDetailListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 06-05-2011 * * Modified
...
public class RejectDetailListCtrl extends GFCBaseListCtrl<RejectDetail> {
	...
	private static final Logger logger = LogManager.getLogger(RejectDetailListCtrl.class);
	 ...
	 * 
	 * @param aRejectDetail The entity that need to be passed to the dialog.
	 */
