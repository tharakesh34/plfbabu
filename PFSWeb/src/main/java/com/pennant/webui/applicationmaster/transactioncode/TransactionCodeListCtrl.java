 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : TransactionCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 10-11-2011 * *
...
public class TransactionCodeListCtrl extends GFCBaseListCtrl<TransactionCode> {
	...
	private static final Logger logger = LogManager.getLogger(TransactionCodeListCtrl.class);
	 ...
	 * 
	 * @param aTransactionCode The entity that need to be passed to the dialog.
	 */
