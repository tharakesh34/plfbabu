 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : MandateCheckDigitDialogCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 11-12-2017 * *
...
public class MandateCheckDigitDialogCtrl extends GFCBaseCtrl<MandateCheckDigit> {
	...
	private static final Logger logger = LogManager.getLogger(MandateCheckDigitDialogCtrl.class);
	 ...
	 */
	public void onCreate$window_MandateCheckDigitDialog(Event event) {
	 ...
	 * 
	 * @param mandateCheckDigit The entity that need to be render.
	 */
	...
	private void doDelete() throws InterruptedException {
		...
		doDelete(Labels.getLabel("label_CheckDigitValue") + " : " + aMandateCheckDigit.getCheckDigitValue(),
				aMandateCheckDigit);
