...
public class LoanTypeWriteOffDialogCtrl extends GFCBaseCtrl<FinTypeWriteOff> {
	 ...
	 */
	protected Window window_LoanTypeWriteOffDialog;
	...
	private List<FinTypeWriteOff> codeMappingList = new ArrayList<FinTypeWriteOff>();
	...
	public void onCreate$window_LoanTypeWriteOffDialog(Event event) {
		logger.debug(Literal.ENTERING);

		setPageComponents(window_LoanTypeWriteOffDialog);
	...
	private void doCheckRights() {
		logger.debug(Literal.ENTERING);
		this.btnNew_CodeMapping.setVisible(getUserWorkspace().isAllowed("button_LoanTypeWriteOffDialog_btnPSLCode"));
	...
	private void appendAutoWriteOff(FinTypeWriteOff autoWriteOff) {
		...
		writeOffCode.addForward("onFulfill", window_LoanTypeWriteOffDialog, "onChangeWriteOffCode", listitem);
		...
		deleteButton.addForward("onClick", window_LoanTypeWriteOffDialog, "onButtonClick", listitem);
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			if (StringUtils.isBlank(method)) {
				...
				if (StringUtils.trimToEmpty(method).equalsIgnoreCase(PennantConstants.method_doApprove)) {
					...
					retValue = ErrorControl.showErrorControl(this.window_LoanTypeWriteOffDialog, auditHeader);
					return processCompleted;
				}
			}

			auditHeader = ErrorControl.showErrorDetails(this.window_LoanTypeWriteOffDialog, auditHeader);
