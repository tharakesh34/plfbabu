 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : DPDBucketConfigurationListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 21-04-2017 *
...
public class DPDBucketConfigurationListCtrl extends GFCBaseListCtrl<DPDBucketConfiguration> {
	...
	private static final Logger logger = LogManager.getLogger(DPDBucketConfigurationListCtrl.class);
	 ...
	 * 
	 * @param dpdbucketconfiguration The entity that need to be passed to the dialog.
	 */
