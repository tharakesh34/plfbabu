 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : ReasonCodeListModelItemRenderer.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 19-12-2017 *
...
public class ReasonCodeListModelItemRenderer implements ListitemRenderer<ReasonCode>, Serializable {
	...
	@Override
	public void render(Listitem item, ReasonCode reasonCode, int count) {
