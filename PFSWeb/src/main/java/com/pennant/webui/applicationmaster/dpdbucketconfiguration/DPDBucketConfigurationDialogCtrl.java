...
public class DPDBucketConfigurationDialogCtrl extends GFCBaseCtrl<DPDBucketConfiguration> {
	...
	private static final Logger logger = LogManager.getLogger(DPDBucketConfigurationDialogCtrl.class);
	 ...
	 */
	public void onCreate$window_DPDBucketConfigurationDialog(Event event) {
