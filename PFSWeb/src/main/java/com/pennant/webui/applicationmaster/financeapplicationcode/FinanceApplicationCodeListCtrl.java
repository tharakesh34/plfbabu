 ...
 * FILE HEADER *
 ********************************************************************************************
 * * FileName : FinanceApplicationCodeListCtrl.java * * Author : PENNANT TECHONOLOGIES * * Creation Date : 05-05-2011 *
...
public class FinanceApplicationCodeListCtrl extends GFCBaseListCtrl<FinanceApplicationCode> {
	...
	private static final Logger logger = LogManager.getLogger(FinanceApplicationCodeListCtrl.class);
	 ...
	 * 
	 * @param financeApplicationCode The entity that need to be passed to the dialog.
	 */
