 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  EmpStsCodeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class EmpStsCodeListModelItemRenderer implements ListitemRenderer<EmpStsCode>,
		Serializable {
	...
	public void render(Listitem item, EmpStsCode empStsCode, int count) throws Exception {
		...
		lc.setParent(item);
		item.setAttribute("data", empStsCode);
