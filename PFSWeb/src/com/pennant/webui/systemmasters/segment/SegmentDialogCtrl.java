...
public class SegmentDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	private void doSetValidation() {
		...
		if (!this.segmentCode.isReadonly()){
			this.segmentCode.setConstraint(new PTStringValidator(Labels.getLabel("label_SegmentDialog_SegmentCode.value"),PennantRegularExpressions.REGEX_ALPHANUM, true));
		}	
