 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  BlackListReasonCodeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
public class BlackListReasonCodeListModelItemRenderer implements ListitemRenderer<BlackListReasonCode>, Serializable {
	...
	public void render(Listitem item, BlackListReasonCode blackListReasonCode, int count) throws Exception {
		...
		//final BlackListReasonCode blackListReasonCode = (BlackListReasonCode) data;
		Listcell lc;
		...
		lc.setParent(item);
		item.setAttribute("data", blackListReasonCode);
