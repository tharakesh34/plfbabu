 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class NotificationsRuleResultDialogCtrl extends GFCBaseListCtrl<JavaScriptBuilder> implements Serializable {
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window 	window_NotificationsRuleResultDialog; 	// autoWired
	 ...
	 */
	public NotificationsRuleResultDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_NotificationsRuleResultDialog(Event event) throws Exception {
		...
		try {
			...
			this.window_NotificationsRuleResultDialog.doModal();
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" + event.toString());
		PTMessageUtils.showHelpWindow(event, window_NotificationsRuleResultDialog);
		logger.debug("Leaving" + event.toString());
	}
	...
	private void doClose() throws InterruptedException {
		...
		if (close) {
			window_NotificationsRuleResultDialog.onClose();
		}
	...
	public void doSave() throws InterruptedException {
		...
		try {
			...
			this.window_NotificationsRuleResultDialog.onClose();
			throw e;
		}
		this.window_NotificationsRuleResultDialog.onClose();
		logger.debug("Leaving");
	...
	private void createSimulationWindow(String values) throws InterruptedException {
		...
		map.put("notificationsRuleResultDialogCtrl", this);
		...
		if(StringUtils.trimToEmpty(this.formula.getValue()).equals("")){
			...
			if(isSimulated){
				...
				if(errors.size() != 0){
					...
					if (conf==MultiLineMessageBox.YES){
						Events.postEvent("onUser$errors", window_NotificationsRuleResultDialog,errors);
					}else{
						//do Nothing
					}
				}else{
