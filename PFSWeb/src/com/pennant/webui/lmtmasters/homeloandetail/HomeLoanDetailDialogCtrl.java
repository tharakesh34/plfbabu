...
public class HomeLoanDetailDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void doSetFieldProperties() {
		...
		this.homeCostPerFlat.setFormat(PennantApplicationUtil.getAmountFormate(this.ccyFormatter));
		this.homeCostOfLand.setMaxlength(18);
		this.homeCostOfLand.setFormat(PennantApplicationUtil.getAmountFormate(this.ccyFormatter));
		this.homeCostOfConstruction.setMaxlength(18);
		this.homeCostOfConstruction.setFormat(PennantApplicationUtil.getAmountFormate(this.ccyFormatter));
		this.homeDateOfPocession.setFormat(PennantConstants.dateFormat);
		this.homeAreaOfLand.setMaxlength(8);
		this.homeAreaOfLand.setFormat(PennantApplicationUtil.getAmountFormate(2));
		this.homeAreaOfLand.setScale(2);
		this.homeAreaOfFlat.setMaxlength(8);
		this.homeAreaOfFlat.setFormat(PennantApplicationUtil.getAmountFormate(2));
