 ...
 * /WEB-INF/pages/SolutionFactory/FacilityReferenceDetail/FacilityReferenceDetailList.zul file.<br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 * 
 */
public class FacilityReferenceDetailListCtrl extends GFCBaseListCtrl<CAFFacilityType> implements Serializable {
	...
	public void onCreate$window_FacilityReferenceDetailList(Event event) throws Exception {
		...
		ModuleMapping moduleMapping = PennantJavaUtil.getModuleMap("FacilityReferenceDetail");
		boolean wfAvailable=true;
		
		if (moduleMapping.getWorkflowType()!=null){
			workFlowDetails = WorkFlowUtil.getWorkFlowDetails("FacilityReferenceDetail");
		...
		if (!isWorkFlowEnabled() && wfAvailable){
			...
			this.button_FacilityReferenceDetailList_FacilityReferenceDetailSearchDialog.setVisible(false);
			this.button_FacilityReferenceDetailList_PrintList.setVisible(false);
	...
	private void doCheckRights() {
		...
		getUserWorkspace().alocateAuthorities("FacilityReferenceDetailList");
		...
		this.button_FacilityReferenceDetailList_PrintList.setVisible(
				getUserWorkspace().isAllowed("button_FacilityReferenceDetailList_PrintList"));
	...
	public void onFacilityReferenceDetailItemDoubleClicked(Event event) throws Exception {
		...
		if (item != null) {
			...
			if(facilityReference.getLovDescWorkFlowRolesName()==null || facilityReference.getLovDescWorkFlowRolesName().equals("")){
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" + event.toString());
		PTMessageUtils.showHelpWindow(event, window_FacilityReferenceDetailList);
		logger.debug("Leaving" + event.toString());
	}
	...
	public void doSearch(){
		...
		this.searchObj.addTabelName("CAFFacilityTypes");

		// Facility Type  
		if (!StringUtils.trimToEmpty(this.facilityType.getValue()).equals("")) {
		...
		// Facility Type Desc
		if (!StringUtils.trimToEmpty(this.facilityTypeDesc.getValue()).equals("")) {
