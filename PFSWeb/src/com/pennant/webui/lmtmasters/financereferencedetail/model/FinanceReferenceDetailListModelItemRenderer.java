 ...
 * 
 */
public class FinanceReferenceDetailListModelItemRenderer implements ListitemRenderer<FinanceType>, Serializable {
	...
	public void render(Listitem item, FinanceType financeType, int count) throws Exception {
		...
		Listcell lc;
		lc = new Listcell(financeType.getFinType().toUpperCase());
		lc.setParent(item);
