 ...
 * 
 */
public class CustomerLimitListCtrl extends GFCBaseListCtrl<CustomerLimit> implements Serializable {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" + event.toString());
		PTMessageUtils.showHelpWindow(event, window_CustomerLimitList);
		logger.debug("Leaving" + event.toString());
	}
