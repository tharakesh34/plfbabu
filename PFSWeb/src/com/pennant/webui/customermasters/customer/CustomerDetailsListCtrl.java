 ...
 * /WEB-INF/pages/CustomerMasters/Customer/CustomerDetailsList.zul file.<br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 * 
 */
public class CustomerDetailsListCtrl extends GFCBaseListCtrl<Customer> implements Serializable {
	...
	public void onCreate$window_CustomerBasicDetailsList(Event event) throws Exception {
		...
		if (!isWorkFlowEnabled() && wfAvailable) {
			this.button_CustomerDetailsList_NewCustomer.setVisible(false);
			this.button_CustomerDetailsList_CustomerSearchDialog.setVisible(false);
			this.button_CustomerDetailsList_PrintList.setVisible(false);
	...
	public void onCustomerItemDoubleClicked(Event event) throws Exception {
		...
		if (item != null) {
			...
			if (customerDetails == null) {
				...
				if (isWorkFlowEnabled()) {
					boolean userAcces = validateUserAccess(workFlowDetails.getId(), getUserWorkspace().getLoginUserDetails()
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" + event.toString());
		PTMessageUtils.showHelpWindow(event, window_CustomerBasicDetailsList);
		logger.debug("Leaving" + event.toString());
	}
