 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  InterestRateTypeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class InterestRateTypeListModelItemRenderer implements ListitemRenderer<InterestRateType>,
		Serializable {
	...
	public void render(Listitem item, InterestRateType interestRateType, int count) throws Exception {
		...
		lc.setParent(item);
		item.setAttribute("data", interestRateType);
