 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  DashboardDetailListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class DashboardConfigurationListModelItemRenderer implements ListitemRenderer<DashboardConfiguration>, Serializable {

	private static final long serialVersionUID = -2685804825608978299L;
	//Upgraded to ZK-6.5.1.1 Added an additional parameter of type count 	
	@Override
	public void render(Listitem item, DashboardConfiguration dashboardConfig, int count) throws Exception {

		//final DashboardConfiguration dashboardConfig = (DashboardConfiguration) data;
		Listcell lc;
		...
		lc.setParent(item);
		item.setAttribute("data", dashboardConfig);
