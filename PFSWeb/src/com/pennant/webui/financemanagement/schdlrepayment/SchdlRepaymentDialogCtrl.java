 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class SchdlRepaymentDialogCtrl extends GFCBaseCtrl {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" +event.toString());
		PTMessageUtils.showHelpWindow(event, window_SchdlRepaymentDialog);
		logger.debug("Leaving" +event.toString());
	}
	...
	public void onClick$btnSearchFinReference(Event event){
		...
		if (dataObject instanceof String){
			...
			if (details != null) {
				finformetter=details.getLovDescFinFormatter();
		...
		if(!(this.finReference.getValue() == null || this.finReference.getValue().equals(""))){
