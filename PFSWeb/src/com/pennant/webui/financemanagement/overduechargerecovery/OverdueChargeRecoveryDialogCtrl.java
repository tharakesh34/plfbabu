...
public class OverdueChargeRecoveryDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	private void doSetFieldProperties() {
		...
		this.finAmt.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.curFinAmt.setMaxlength(18);
		this.curFinAmt.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.curSchPriDue.setMaxlength(18);
		this.curSchPriDue.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.curSchPftDue.setMaxlength(18);
		this.curSchPftDue.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.totOvrDueChrg.setMaxlength(18);
		this.totOvrDueChrg.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.totOvrDueChrgWaived.setMaxlength(18);
		this.totOvrDueChrgWaived.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.totOvrDueChrgPaid.setMaxlength(18);
		this.totOvrDueChrgPaid.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.totOvrDueChrgBal.setMaxlength(18);
		this.totOvrDueChrgBal.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		...
		this.finODPri.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODPft.setMaxlength(18);
		this.finODPft.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODTot.setMaxlength(18);
		this.finODTot.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		...
		this.finODCPLShare.setFormat(PennantAppUtil.getAmountFormate(2));
		this.finODCCustCtg.setMaxlength(8);
		this.finODCOn.setMaxlength(8);
		this.finODC.setMaxlength(18);
		this.finODC.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODCGraceDays.setMaxlength(10);
		this.finODCMaxWaiver.setMaxlength(5);
		this.finODCMaxWaiver.setFormat(PennantAppUtil.getAmountFormate(2));
		this.finODCPenalty.setMaxlength(18);
		this.finODCPenalty.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODCWaived.setMaxlength(18);
		this.finODCWaived.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODCPLPenalty.setMaxlength(18);
		this.finODCPLPenalty.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODCCPenalty.setMaxlength(18);
		this.finODCCPenalty.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.finODCPaid.setMaxlength(18);
		this.finODCPaid.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
		this.balChrgRecovery.setMaxlength(18);
		this.balChrgRecovery.setFormat(PennantAppUtil.getAmountFormate(getOverdueChargeRecovery().getLovDescFinFormatter()));
