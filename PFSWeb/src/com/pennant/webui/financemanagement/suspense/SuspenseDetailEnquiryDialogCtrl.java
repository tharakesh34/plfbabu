 ...
 * 
 */
public class SuspenseDetailEnquiryDialogCtrl extends GFCBaseListCtrl<FinanceSuspDetails> implements Serializable {
	...
	public void onCreate$window_SuspenseEnquiryDialog(ForwardEvent event) throws Exception {
		...
		if (args.containsKey("suspHead")) {
			this.setSuspHead((FinanceSuspHead) args.get("suspHead"));
		} 
	...
	public void doShowDialog(FinanceSuspHead aSuspHead) throws InterruptedException {
		...
		try {
			...
			if(tabPanel_dialogWindow != null){
				...
				setDialog(this.window_SuspenseEnquiryDialog);
			}
	...
	public void doWriteBeanToComponents(FinanceSuspHead aSuspHead) {
		...
		if(aSuspHead != null){
			...
			doFillPostingslistbox(aSuspHead.getSuspPostingsList(), aSuspHead.getLovDescFinFormatter());
		}
		logger.debug("Leaving");
	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException {
		...
		try {
			if(tabPanel_dialogWindow == null){
				closeDialog(this.window_SuspenseEnquiryDialog, "SuspenseEnquiry");
			}
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" + event.toString());
		PTMessageUtils.showHelpWindow(event, window_SuspenseEnquiryDialog);
		logger.debug("Leaving" + event.toString());
	}
