...
public class SuspenseSearchCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onCreate$window_SuspenseSearch(Event event) throws Exception {
		...
		if (args.containsKey("suspenseListCtrl")) {
			this.suspenseCtrl = (SuspenseListCtrl) args.get("suspenseListCtrl");
		} else {
		...
		if (args.containsKey("searchObject")) {
			searchObj = (JdbcSearchObject<FinanceSuspHead>) args.get("searchObject");
			...
			rmvFilter.add(filter);
			    ...
			    } else if (filter.getProperty().equals("finSuspAmt")) {
			    ...
			    } else if (filter.getProperty().equals("finCurSuspAmt")) {
			    ...
			    } else if (filter.getProperty().equals("finIsInSusp")) {
			    ...
			    } else if (filter.getProperty().equals("manualSusp")) {
	...
	private void doClose() {
		...
		this.window_SuspenseSearch.onClose();
