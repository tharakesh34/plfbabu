 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class BulkDefermentChangeCtrl extends GFCBaseListCtrl<BulkDefermentChange> implements Serializable{

	private static final long serialVersionUID = 966281186831332116L;
	private final static Logger logger = Logger.getLogger(BulkDefermentChangeCtrl.class);
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering" +event.toString());
		PTMessageUtils.showHelpWindow(event, window_BulkDefferment);
		logger.debug("Leaving" +event.toString());
	}
