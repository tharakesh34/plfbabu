 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  FinanceTypeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
package com.pennant.webui.rmtmasters.commodityFinanceType.model;
 ...
 * 
 */
public class CommodityFinanceTypeListModelItemRenderer implements ListitemRenderer<FinanceType>,
Serializable {
	...
	public void render(Listitem item, FinanceType financeType, int count) throws Exception {
		...
		lc.setParent(item);
		lc = new Listcell(
				(financeType.getLovDescFinCcyName() != null) ? (financeType
						.getFinCcy() + "-" + financeType.getLovDescFinCcyName())
						: "");
		lc.setParent(item);
		lc = new Listcell(
				financeType.getLovDescFinDaysCalTypeName() != null ? financeType
						.getFinDaysCalType()
						+ "-"
						+ financeType.getLovDescFinDaysCalTypeName() : "");
		lc.setParent(item);
		lc = new Listcell(
				(financeType.getLovDescFinAcTypeName() != null) ? (financeType
						.getFinAcType() + "-" + financeType
						.getLovDescFinAcTypeName()) : "");
		lc.setParent(item);
		...
		"onDoubleClick=onCommodityFinanceTypeItemDoubleClicked");
	}
}