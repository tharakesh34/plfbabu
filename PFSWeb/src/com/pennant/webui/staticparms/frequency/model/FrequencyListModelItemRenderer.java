 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  FrequencyListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class FrequencyListModelItemRenderer implements ListitemRenderer<Frequency>,
		Serializable {
	...
	public void render(Listitem item, Frequency frequency, int count) throws Exception {
		...
		//final Frequency frequency = (Frequency) data;
		Listcell lc;
		...
		lc.setParent(item);
		item.setAttribute("data", frequency);
