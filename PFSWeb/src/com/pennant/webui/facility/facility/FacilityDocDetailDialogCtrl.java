...
public class FacilityDocDetailDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long	          serialVersionUID	      = -6959194080451993569L;
	private final static Logger	          logger	              = Logger.getLogger(FacilityDocDetailDialogCtrl.class);
	...
	public void onCreate$window_FinDocumentDetailDialog(Event event) throws Exception {
		...
		if (args.containsKey("DocumentDetailDialogCtrl")) {
			...
			setFacilityDocumentDetailDialogCtrl((FacilityDocumentDetailDialogCtrl) args.get("DocumentDetailDialogCtrl"));
			setNewDocument(true);
