 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class FacilityCustomerRatingDialogCtrl extends GFCBaseCtrl implements Serializable {
	private static final long serialVersionUID = -6959194080451993569L;
	private final static Logger logger = Logger.getLogger(FacilityCustomerRatingDialogCtrl.class);
	/*
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	public void onCreate$window_CustomerRatingDialog(Event event) throws Exception {
		...
		if (args.containsKey("roleCode")) {
			...
			getUserWorkspace().alocateRoleAuthorities(userRole, "CustomerRatingDialog");
		}
		if (args.containsKey("customerDialogCtrl")) {
			setCustomerDialogCtrl((FacilityDialogCtrl) args.get("customerDialogCtrl"));
		}
		doCheckRights();
	...
	private void doCheckRights() {
		logger.debug("Entering");
		getUserWorkspace().alocateAuthorities("CustomerRatingDialog",userRole);
	...
	public void closeWindow() throws InterruptedException {
		logger.debug("Entering");
		closePopUpWindow(this.window_CustomerRatingDialog,"CustomerRatingDialog");
