 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  MudarabaFinanceMainDialogCtrl.java                                                   * 	  
 *                                                                    						*
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class MudarabaWIFFinanceMainDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = 6004939933729664895L;
	private final static Logger logger = Logger.getLogger(MudarabaWIFFinanceMainDialogCtrl.class);
	...
	protected Label 		label_MudarabaFinanceMainDialog_FinRepayPftOnFrq;
	 ...
	 */
	public MudarabaWIFFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_MudarabaFinanceMainDialog(Event event) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void onClose$window_MudarabaFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering " + event.toString());
		doClose();
		logger.debug("Leaving " + event.toString());
	}
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		PTMessageUtils.showHelpWindow(event, window_MudarabaFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException, IllegalAccessException, InvocationTargetException {
		...
		try {
			...
			closeDialog(this.window_MudarabaFinanceMainDialog,"financeMain");
		}
		logger.debug("Leaving " + event.toString());
	}
	...
	public void doWriteBeanToComponents(FinanceDetail aFinanceDetail, boolean onLoadProcess) throws ParseException, InterruptedException, AccountNotFoundException, IllegalAccessException, InvocationTargetException {
		...
		if (aFinanceDetail.getFinScheduleData().getFinanceType().isFinDepreciationReq()) {
			...
			this.label_MudarabaFinanceMainDialog_DepriFrq.setVisible(true);
			...
			this.label_MudarabaFinanceMainDialog_DepriFrq.setVisible(false);
		...
		if (getFinanceDetail().getFinScheduleData().getFinanceType().isFinIsAlwFrqDifferment()) {
			...
			this.label_MudarabaFinanceMainDialog_FrqDef.setVisible(false);
		}
	...
	public void doWriteComponentsToBean(FinScheduleData aFinanceSchData) throws InterruptedException, IllegalAccessException, InvocationTargetException {
		...
		try {
			...
			if(this.finCcy.getValue().equals("")) {
				wve.add(new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinCcy.value") })));
			} else {
		...
		try {
			if (getComboboxValue(this.cbScheduleMethod).equals("#")) {
				throw new WrongValueException(this.cbScheduleMethod, Labels.getLabel("STATIC_INVALID",
						new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_ScheduleMethod.value") }));
			}
		...
		try {
			if (getComboboxValue(this.cbProfitDaysBasis).equals("#")) {
				throw new WrongValueException(this.cbProfitDaysBasis, Labels.getLabel("STATIC_INVALID",
						new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_ProfitDaysBasis.value") }));
			}
		...
		try {
			if (!this.defferments.isReadonly() && this.defferments.intValue() != 0 && 
				...
				throw new WrongValueException(this.defferments, Labels.getLabel("FIELD_IS_LESSER",
						new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_Defferments.value"),
		...
		try {
			if (!this.frqDefferments.isReadonly() && this.frqDefferments.intValue() != 0 && 
				...
				throw new WrongValueException(this.frqDefferments,Labels.getLabel("FIELD_IS_LESSER",
						new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FrqDefferments.value"),
			...
			try {
				if(getComboboxValue(this.grcRateBasis).equals("#")) {
					throw new WrongValueException(this.grcRateBasis, Labels.getLabel("STATIC_INVALID",
							new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_GrcRateBasis.value") }));
				}
				...
				if (this.gracePftRate.getValue() != null && !this.gracePftRate.isDisabled()) {
					if ((this.gracePftRate.getValue().intValue() > 0) && 
						...
						throw new WrongValueException(this.gracePftRate, Labels.getLabel("EITHER_OR",
								new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_GraceBaseRate.value"),
								Labels.getLabel("label_MudarabaFinanceMainDialog_GracePftRate.value") }));
					}
			...
			try {
				if (this.allowGrcRepay.isChecked() && getComboboxValue(this.cbGrcSchdMthd).equals("#")) {
					throw new WrongValueException(this.cbGrcSchdMthd, Labels.getLabel("STATIC_INVALID",
							new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_GrcSchdMthd.value") }));
				}
		...
		try {
			...
			if (!recSave && this.graceTerms_Two.intValue() == 0 && this.gracePeriodEndDate_two.getValue() == null) {
				throw new WrongValueException(this.graceTerms, Labels.getLabel("EITHER_OR",
						new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_GracePeriodEndDate.value"),
						Labels.getLabel("label_MudarabaFinanceMainDialog_GraceTerms.value") }));
				...
				if(this.finStartDate.getValue().compareTo(this.gracePeriodEndDate.getValue()) > 0){
					...
					throw new WrongValueException(this.gracePeriodEndDate, Labels.getLabel("NUMBER_MINVALUE_EQ",
							new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_GracePeriodEndDate.value"), 
							Labels.getLabel("label_MudarabaFinanceMainDialog_FinStartDate.value")}));
				}
			}
		} catch (WrongValueException we) {
			wve.add(we);
			...
			if (this.repayProfitRate.getValue() != null && !this.repayProfitRate.isDisabled()) {
				if ((this.repayProfitRate.getValue().intValue() > 0)
					...
					throw new WrongValueException(this.repayProfitRate, Labels.getLabel("EITHER_OR",
							new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_RepayBaseRate.value"),
							Labels.getLabel("label_MudarabaFinanceMainDialog_ProfitRate.value") }));
				}
		...
		try {
			...
			if (this.numberOfTerms.intValue() != 0 && this.maturityDate_two.getValue() == null) {
				if (this.numberOfTerms.intValue() < 0) {
					this.numberOfTerms.setConstraint("NO NEGATIVE:" + Labels.getLabel("CONST_NO_EMPTY_NEGATIVE_ZERO",
							new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NumberOfTerms.value") }));
				}
			...
			if (!recSave && this.numberOfTerms_two.intValue() == 0 && this.maturityDate_two.getValue() == null) {
				throw new WrongValueException(this.numberOfTerms, Labels.getLabel("EITHER_OR",
						new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_MaturityDate.value"),
						Labels.getLabel("label_MudarabaFinanceMainDialog_NumberOfTerms.value") }));
			...
			if (recSave) {
				...
				if (downPayment.compareTo(this.finAmount.getValue()) > 0) {
					throw new WrongValueException(this.downPayBank, Labels.getLabel("MAND_FIELD_MIN",
							new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_DownPayment.value"),
				...
				if (downPayment.compareTo(reqDwnPay) == -1) {
					throw new WrongValueException(this.downPayBank, Labels.getLabel("PERC_MIN",
							new String[] {Labels.getLabel("label_MudarabaFinanceMainDialog_DownPayBS.value"),
		...
		try {
			...
			if(getFinanceDetail().getFinScheduleData().getFinanceType().getFinMinTerm() == 1 && 
				...
				if(!getFinanceDetail().getFinScheduleData().getFinanceType().isFinRepayPftOnFrq()){
					this.label_MudarabaFinanceMainDialog_FinRepayPftOnFrq.setVisible(false);
					this.rpyPftFrqRow.setVisible(false);
					this.hbox_finRepayPftOnFrq.setVisible(false);
				}else{
					this.label_MudarabaFinanceMainDialog_FinRepayPftOnFrq.setVisible(true);
					this.rpyPftFrqRow.setVisible(true);
	...
	private void doSetValidation() {
		...
		if (!this.finReference.isReadonly() && 
			...
			this.finReference.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinReference.value") }));
		}

		if (!this.finAmount.isDisabled()) {
			this.finAmount.setConstraint(new AmountValidator(18,0,
					Labels.getLabel("label_MudarabaFinanceMainDialog_FinAmount.value"), false));
		}
		...
		if (this.gb_gracePeriodDetails.isVisible()) {
			...
			if (!this.grcMargin.isDisabled()) {
				this.grcMargin.setConstraint(new RateValidator(13, 9, 
						Labels.getLabel("label_MudarabaFinanceMainDialog_GraceMargin.value"), true));
			}

			if(this.allowGrace.isChecked()){
				this.grcEffectiveRate.setConstraint(new RateValidator(13, 9,
						Labels.getLabel("label_MudarabaFinanceMainDialog_GracePftRate.value"), true));
			}
			...
			if (!this.nextGrcPftDate.isDisabled() && 
				...
				this.nextGrcPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextGrcPftDate.value") }));
			}
			...
			if (!this.nextGrcPftRvwDate.isDisabled() && 
				...
				this.nextGrcPftRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextGrcPftRvwDate.value") }));
			}
		}
		...
		if (!this.nextRepayDate.isDisabled() && 
			...
			this.nextRepayDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayDate.value") }));
		}
		...
		if (!this.nextRepayPftDate.isDisabled() && 
			...
			this.nextRepayPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayPftDate.value") }));
		}
		...
		if (!this.nextRepayRvwDate.isDisabled() && 
			...
			this.nextRepayRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayRvwDate.value") }));
		}
		...
		if (!this.nextRepayCpzDate.isDisabled() && 
			...
			this.nextRepayCpzDate_two.setConstraint("NO EMPTY:"+ Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayCpzDate.value") }));
		}

		this.repayEffectiveRate.setConstraint(new RateValidator(13, 9,
				Labels.getLabel("label_MudarabaFinanceMainDialog_ProfitRate.value"), true));

		if (!this.repayMargin.isDisabled()) {
			this.repayMargin.setConstraint(new RateValidator(13, 9, 
					Labels.getLabel("label_MudarabaFinanceMainDialog_RepayMargin.value"), true));
		}
	...
	private void doSetLOVValidation() {
		...
		this.lovDescFinTypeName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY", 
				new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinType.value") }));

		this.lovDescFinCcyName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY", 
				new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinCcy.value") }));
		...
		if(this.allowGrcInd.isChecked() && !this.btnSearchGrcIndBaseRate.isDisabled()){
			this.lovDescGrcIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_MudarabaFinanceMainDialog_FinGrcIndBaseRate.value")}));			
		}
		...
		if(this.allowRpyInd.isChecked() && !this.btnSearchRpyIndBaseRate.isDisabled()){
			this.lovDescRpyIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_MudarabaFinanceMainDialog_FinRpyIndBaseRate.value")}));			
		}
		logger.debug("Leaving ");
	}
		...
		if (isWorkFlowEnabled()) {
			...
			while (!"".equals(serviceTasks)) {
				...
				if (StringUtils.trimToEmpty(method).contains(PennantConstants.method_doDedup)) {
					...
					tFinanceDetail = FetchDedupDetails.getLoanDedup(getRole(),aFinanceDetail, this.window_MudarabaFinanceMainDialog);
			...
			while (retValue == PennantConstants.porcessOVERIDE) {
				...
				if (StringUtils.trimToEmpty(method).equalsIgnoreCase("")) {
					...
					if (StringUtils.trimToEmpty(method).equalsIgnoreCase(PennantConstants.method_doApprove)) {
						...
						retValue = ErrorControl.showErrorControl(this.window_MudarabaFinanceMainDialog, auditHeader);
						return processCompleted;
					}
				}

				auditHeader = ErrorControl.showErrorDetails(this.window_MudarabaFinanceMainDialog, auditHeader);
	...
	public void onClick$btnSearchFinType(Event event) {
		...
		Object dataObject = ExtendedSearchListBox.show(this.window_MudarabaFinanceMainDialog, "FinanceType");
	...
	public void onChange$lovDescFinCcyName(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			finCcy.setValue("");
			throw new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinCcy.value") }));
		}
	...
	public void onClick$btnSearchFinCcy(Event event) {
		...
		this.lovDescFinCcyName.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_MudarabaFinanceMainDialog, "Currency");
		if (dataObject instanceof String) {
	...
	public void onClick$btnSearchGraceBaseRate(Event event) throws InterruptedException {
		...
		this.grcEffectiveRate.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_MudarabaFinanceMainDialog, "BaseRateCode");
	...
	public void onClick$btnSearchGraceSpecialRate(Event event) throws InterruptedException {
		...
		this.grcEffectiveRate.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_MudarabaFinanceMainDialog, "SplRateCode");
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			if (!this.finReference.isReadonly() && this.finReference.getValue() != null) {
				if (getFinanceDetailService().isFinReferenceExits(this.finReference.getValue(), "_View", false)) {
					...
					errorList.add(new ErrorDetails("finReference","E0006",new String[] {
							Labels.getLabel("label_MudarabaFinanceMainDialog_FinReference.value"),this.finReference.getValue().toString() },new String[] {}));
				}
			}
			...
			if (getFinanceDetail().getFinScheduleData().getFinanceMain().isAllowGrcPeriod()) {
				...
				if (!validateFrquency(this.cbGracePftFrqCode, this.gracePftFrq, this.nextGrcPftDate_two)) {
					...
					errorList.add(new ErrorDetails("nextGrcPftDate_two", "W0004", new String[] {
							Labels.getLabel("label_MudarabaFinanceMainDialog_NextGrcPftDate.value"), Labels.getLabel("label_MudarabaFinanceMainDialog_GracePftFrq.value"),
				...
				if (!validateFrquency(this.cbGracePftRvwFrqCode, this.gracePftRvwFrq, this.nextGrcPftRvwDate_two)) {
					errorList.add(new ErrorDetails("nextGrcPftRvwDate_two", "W0004", new String[] {
							Labels.getLabel("label_MudarabaFinanceMainDialog_NextGrcPftRvwDate.value"),
							Labels.getLabel("label_MudarabaFinanceMainDialog_GracePftRvwFrq.value"), Labels.getLabel("finGracePeriodDetails") }, 
				...
				if (!validateFrquency(this.cbGraceCpzFrqCode, this.graceCpzFrq, this.nextGrcCpzDate_two)) {
					errorList.add(new ErrorDetails("nextGrcCpzDate_two","W0004", new String[] {
							Labels.getLabel("label_MudarabaFinanceMainDialog_NextGrcCpzDate.value"),
							Labels.getLabel("label_MudarabaFinanceMainDialog_GraceCpzFrq.value"), Labels.getLabel("finGracePeriodDetails") },
			...
			if (!validateFrquency(this.cbRepayFrqCode, this.repayFrq, this.nextRepayDate_two)) {
				errorList.add(new ErrorDetails("nextRepayDate_two", "W0004", new String[] {
						Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayDate.value"),
						Labels.getLabel("label_MudarabaFinanceMainDialog_RepayFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayPftFrqCode, this.repayPftFrq, this.nextRepayPftDate_two)) {
				errorList.add(new ErrorDetails("nextRepayPftDate_two","W0004", new String[] {
						Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayPftDate.value"), 
						Labels.getLabel("label_MudarabaFinanceMainDialog_RepayPftFrq.value"), Labels.getLabel("WIFinRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayRvwFrqCode, this.repayRvwFrq, this.nextRepayRvwDate_two)) {
				errorList.add(new ErrorDetails("nextRepayRvwDate_two", "W0004", new String[] {
						Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayRvwDate.value"),
						Labels.getLabel("label_MudarabaFinanceMainDialog_RepayRvwFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayCpzFrqCode, this.repayCpzFrq, this.nextRepayCpzDate_two)) {
				errorList.add(new ErrorDetails("nextRepayCpzDate_two", "W0004", new String[] {
						Labels.getLabel("label_MudarabaFinanceMainDialog_NextRepayCpzDate.value"),
						Labels.getLabel("label_MudarabaFinanceMainDialog_RepayCpzFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!this.numberOfTerms.isReadonly() && this.numberOfTerms.intValue() != 0 && !singleTermFinance) {
				if (this.numberOfTerms.intValue() >= 1 && this.maturityDate.getValue() != null) {
					errorList.add(new ErrorDetails("numberOfTerms","E0011", new String[] {
							Labels.getLabel("label_MudarabaFinanceMainDialog_NumberOfTerms.value"),
							Labels.getLabel("label_MudarabaFinanceMainDialog_MaturityDate.value") }, new String[] {}));
				}
			}
			...
			auditHeader = ErrorControl.showErrorDetails(window_MudarabaFinanceMainDialog, auditHeader);
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_MudarabaFinanceMainDialog, auditHeader);
		} catch (Exception exp) {
			logger.error(exp);
		}
	}
