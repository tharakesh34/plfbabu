 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class MurabahaWIFFinanceMainDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = 6004939933729664895L;
	private final static Logger logger = Logger.getLogger(MurabahaWIFFinanceMainDialogCtrl.class);
	 ...
	 */
	public MurabahaWIFFinanceMainDialogCtrl() {
		super();
	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException, IllegalAccessException, InvocationTargetException {
		...
		try {
			...
			closeDialog(this.window_MurabahaFinanceMainDialog,"financeMain");
		}
		logger.debug("Leaving " + event.toString());
	}
	...
	private boolean doValidation(AuditHeader auditHeader) throws InterruptedException {
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			auditHeader = ErrorControl.showErrorDetails(window_MurabahaFinanceMainDialog, auditHeader);
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_MurabahaFinanceMainDialog, auditHeader);
		} catch (Exception exp) {
			logger.error(exp);
		}
	}
