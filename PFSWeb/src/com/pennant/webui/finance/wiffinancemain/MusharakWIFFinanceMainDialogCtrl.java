 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  MusharakFinanceMainDialogCtrl.java                                                   * 	  
 *                                                                    						*
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */
public class MusharakWIFFinanceMainDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = 6004939933729664895L;
	private final static Logger logger = Logger.getLogger(MusharakWIFFinanceMainDialogCtrl.class);
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window 		window_MusharakFinanceMainDialog; 				// autoWired
	 ...
	 */
	public MusharakWIFFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_MusharakFinanceMainDialog(Event event) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void onClose$window_MusharakFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering " + event.toString());
		doClose();
		logger.debug("Leaving " + event.toString());
	}
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		PTMessageUtils.showHelpWindow(event, window_MusharakFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException, IllegalAccessException, InvocationTargetException {
		...
		try {
			...
			closeDialog(this.window_MusharakFinanceMainDialog,"financeMain");
		}
		logger.debug("Leaving " + event.toString());
	}
	...
	public void doWriteBeanToComponents(FinanceDetail aFinanceDetail, boolean onLoadProcess) throws ParseException, InterruptedException, AccountNotFoundException, IllegalAccessException, InvocationTargetException {
		...
		if (aFinanceDetail.getFinScheduleData().getFinanceType().isFinDepreciationReq()) {
			...
			this.label_MusharakFinanceMainDialog_DepriFrq.setVisible(true);
			...
			this.label_MusharakFinanceMainDialog_DepriFrq.setVisible(false);
		...
		if (getFinanceDetail().getFinScheduleData().getFinanceType().isFinIsAlwFrqDifferment()) {
			...
			this.label_MusharakFinanceMainDialog_FrqDef.setVisible(false);
		}
	...
	public void doWriteComponentsToBean(FinScheduleData aFinanceSchData) throws InterruptedException, IllegalAccessException, InvocationTargetException {
		...
		try {
			...
			if(this.finCcy.getValue().equals("")) {
				wve.add(new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_FinCcy.value") })));
			} else {
		...
		try {
			if (getComboboxValue(this.cbScheduleMethod).equals("#")) {
				throw new WrongValueException(this.cbScheduleMethod, Labels.getLabel("STATIC_INVALID",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_ScheduleMethod.value") }));
			}
		...
		try {
			if (getComboboxValue(this.cbProfitDaysBasis).equals("#")) {
				throw new WrongValueException(this.cbProfitDaysBasis, Labels.getLabel("STATIC_INVALID",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_ProfitDaysBasis.value") }));
			}
		...
		try {
			if (!this.defferments.isReadonly() && this.defferments.intValue() != 0 && 
				...
				throw new WrongValueException(this.defferments, Labels.getLabel("FIELD_IS_LESSER",
						new String[] {Labels.getLabel("label_MusharakFinanceMainDialog_Defferments.value"),
		...
		try {
			if (!this.frqDefferments.isReadonly() && this.frqDefferments.intValue() != 0 && 
				...
				throw new WrongValueException(this.frqDefferments,Labels.getLabel("FIELD_IS_LESSER",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_FrqDefferments.value"),
			...
			try {
				if(getComboboxValue(this.grcRateBasis).equals("#")) {
					throw new WrongValueException(this.grcRateBasis, Labels.getLabel("STATIC_INVALID",
							new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_GrcRateBasis.value") }));
				}
				...
				if (this.gracePftRate.getValue() != null && !this.gracePftRate.isDisabled()) {
					if ((this.gracePftRate.getValue().intValue() > 0) && 
						...
						throw new WrongValueException(this.gracePftRate, Labels.getLabel("EITHER_OR",
								...
								Labels.getLabel("label_MusharakFinanceMainDialog_GracePftRate.value") }));
					}
			...
			try {
				if (this.allowGrcRepay.isChecked() && getComboboxValue(this.cbGrcSchdMthd).equals("#")) {
					throw new WrongValueException(this.cbGrcSchdMthd, Labels.getLabel("STATIC_INVALID",
							new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_GrcSchdMthd.value") }));
				}
			...
			if (this.repayProfitRate.getValue() != null && !this.repayProfitRate.isDisabled()) {
				if ((this.repayProfitRate.getValue().intValue() > 0)
					...
					throw new WrongValueException(this.repayProfitRate, Labels.getLabel("EITHER_OR",
							...
							Labels.getLabel("label_MusharakFinanceMainDialog_ProfitRate.value") }));
				}
		...
		try {
			...
			if (this.numberOfTerms.intValue() != 0 && this.maturityDate_two.getValue() == null) {
				if (this.numberOfTerms.intValue() < 0) {
					this.numberOfTerms.setConstraint("NO NEGATIVE:" + Labels.getLabel("CONST_NO_EMPTY_NEGATIVE_ZERO",
							new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NumberOfTerms.value") }));
				}
			...
			if (!recSave && this.numberOfTerms_two.intValue() == 0 && this.maturityDate_two.getValue() == null) {
				throw new WrongValueException(this.numberOfTerms, Labels.getLabel("EITHER_OR",
						new String[] {Labels.getLabel("label_MusharakFinanceMainDialog_MaturityDate.value"),
						Labels.getLabel("label_MusharakFinanceMainDialog_NumberOfTerms.value") }));
		...
		try {
			...
			if (recSave) {
			...
			} else if (!this.downPayBank.isDisabled()) {
				...
				if (downPayment.compareTo(this.finAmount.getValue()) > 0) {
					throw new WrongValueException(this.downPayBank, Labels.getLabel("MAND_FIELD_MIN",
							new String[] {Labels.getLabel("label_MusharakFinanceMainDialog_DownPayment.value"),
				...
				if (downPayment.compareTo(reqDwnPay) == -1) {
					throw new WrongValueException(this.downPayBank, Labels.getLabel("PERC_MIN",
							new String[] {Labels.getLabel("label_MusharakFinanceMainDialog_DownPayBS.value"),
		...
		if(buildEvent) {
			...
			if (getFeeDetailDialogCtrl() != null) {
				try {
					aFinanceSchData = getFeeDetailDialogCtrl().doExecuteFeeCharges(true, true,
		...
		try {
			...
			if(getFinanceDetail().getFinScheduleData().getFinanceType().getFinMinTerm() == 1 && 
				...
				if(!getFinanceDetail().getFinScheduleData().getFinanceType().isFinRepayPftOnFrq()){
					this.label_MusharakFinanceMainDialog_FinRepayPftOnFrq.setVisible(false);
					this.rpyPftFrqRow.setVisible(false);
					this.hbox_finRepayPftOnFrq.setVisible(false);
				}else{
					this.label_MusharakFinanceMainDialog_FinRepayPftOnFrq.setVisible(true);
					this.rpyPftFrqRow.setVisible(true);
			...
			// during user action.
			doStoreInitValues();
			setDialog(this.window_MusharakFinanceMainDialog);
	...
	private void doSetValidation() {
		...
		if (!this.finReference.isReadonly() && 
			...
			this.finReference.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_FinReference.value") }));
		}

		if (!this.finAmount.isDisabled()) {
			this.finAmount.setConstraint(new AmountValidator(18,0,
					Labels.getLabel("label_MusharakFinanceMainDialog_FinAmount.value"), false));
		}
		...
		if(!this.frqDefferments.isDisabled()){
			this.frqDefferments.setConstraint(new PTNumberValidator(Labels.getLabel("label_MusharakFinanceMainDialog_FrqDefferments.value"), false, false));
		}
		...
		if (this.gb_gracePeriodDetails.isVisible()) {
			...
			if (!this.graceTerms.isReadonly()) {
				this.graceTerms_Two.setConstraint("NO NEGATIVE:" + Labels.getLabel("CONST_NO_EMPTY_NEGATIVE_ZERO",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_GraceTerms.value") }));
			}
			
			if (!this.grcMargin.isDisabled()) {
				this.grcMargin.setConstraint(new RateValidator(13, 9, 
						Labels.getLabel("label_MusharakFinanceMainDialog_GraceMargin.value"), true));
			}

			if(this.allowGrace.isChecked()){
				this.grcEffectiveRate.setConstraint(new RateValidator(13, 9,
						Labels.getLabel("label_MusharakFinanceMainDialog_GracePftRate.value"), true));
			}
			...
			if (!this.nextGrcPftDate.isDisabled() && 
				...
				this.nextGrcPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextGrcPftDate.value") }));
			}
			...
			if (!this.nextGrcPftRvwDate.isDisabled() && 
				...
				this.nextGrcPftRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextGrcPftRvwDate.value") }));
			}
		}
		...
		if (!this.nextRepayDate.isDisabled() && 
			...
			this.nextRepayDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayDate.value") }));
		}
		...
		if (!this.nextRepayPftDate.isDisabled() && 
			...
			this.nextRepayPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayPftDate.value") }));
		}
		...
		if (!this.nextRepayRvwDate.isDisabled() && 
			...
			this.nextRepayRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayRvwDate.value") }));
		}
		...
		if (!this.nextRepayCpzDate.isDisabled() && 
			...
			this.nextRepayCpzDate_two.setConstraint("NO EMPTY:"+ Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayCpzDate.value") }));
		}

		this.repayEffectiveRate.setConstraint(new RateValidator(13, 9,
				Labels.getLabel("label_MusharakFinanceMainDialog_ProfitRate.value"), true));

		if (!this.repayMargin.isDisabled()) {
			this.repayMargin.setConstraint(new RateValidator(13, 9, 
					Labels.getLabel("label_MusharakFinanceMainDialog_RepayMargin.value"), true));
		}
	...
	private void doSetLOVValidation() {
		...
		if(this.allowGrcInd.isChecked() && !this.btnSearchGrcIndBaseRate.isDisabled()){
			this.lovDescGrcIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_MusharakFinanceMainDialog_FinGrcIndBaseRate.value")}));			
		}
		...
		if(this.allowRpyInd.isChecked() && !this.btnSearchRpyIndBaseRate.isDisabled()){
			this.lovDescRpyIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_MusharakFinanceMainDialog_FinRpyIndBaseRate.value")}));			
		}
		logger.debug("Leaving ");
	}
		...
		if (isWorkFlowEnabled()) {
			...
			while (!"".equals(serviceTasks)) {
				...
				if (StringUtils.trimToEmpty(method).contains(PennantConstants.method_doDedup)) {
					...
					tFinanceDetail = FetchDedupDetails.getLoanDedup(getRole(),aFinanceDetail, this.window_MusharakFinanceMainDialog);
			...
			while (retValue == PennantConstants.porcessOVERIDE) {
				...
				if (StringUtils.trimToEmpty(method).equalsIgnoreCase("")) {
					...
					if (StringUtils.trimToEmpty(method).equalsIgnoreCase(PennantConstants.method_doApprove)) {
						...
						retValue = ErrorControl.showErrorControl(this.window_MusharakFinanceMainDialog, auditHeader);
						return processCompleted;
					}
				}

				auditHeader = ErrorControl.showErrorDetails(this.window_MusharakFinanceMainDialog, auditHeader);
	...
	public void onClick$btnSearchFinType(Event event) {
		...
		Object dataObject = ExtendedSearchListBox.show(this.window_MusharakFinanceMainDialog, "FinanceType");
	...
	public void onChange$lovDescFinCcyName(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			finCcy.setValue("");
			throw new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_MusharakFinanceMainDialog_FinCcy.value") }));
		}
	...
	public void onClick$btnSearchFinCcy(Event event) {
		...
		this.lovDescFinCcyName.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_MusharakFinanceMainDialog, "Currency");
		if (dataObject instanceof String) {
	...
	private void doStoreDefaultValues() {
		...
		} else if(this.graceTerms.intValue() == 0 && 
				(this.gracePeriodEndDate.getValue() != null || this.gracePeriodEndDate_two.getValue() != null)){
		...
		while (retValue == PennantConstants.porcessOVERIDE) {
			...
			if (!this.finReference.isReadonly() && this.finReference.getValue() != null) {
				if (getFinanceDetailService().isFinReferenceExits(this.finReference.getValue(), "_View", false)) {
					...
					errorList.add(new ErrorDetails("finReference","E0006",new String[] {
							Labels.getLabel("label_MusharakFinanceMainDialog_FinReference.value"),this.finReference.getValue().toString() },new String[] {}));
				}
			}
			...
			if (getFinanceDetail().getFinScheduleData().getFinanceMain().isAllowGrcPeriod()) {
				...
				if (!validateFrquency(this.cbGracePftFrqCode, this.gracePftFrq, this.nextGrcPftDate_two)) {
					...
					errorList.add(new ErrorDetails("nextGrcPftDate_two", "W0004", new String[] {
							Labels.getLabel("label_MusharakFinanceMainDialog_NextGrcPftDate.value"), Labels.getLabel("label_MusharakFinanceMainDialog_GracePftFrq.value"),
				...
				if (!validateFrquency(this.cbGracePftRvwFrqCode, this.gracePftRvwFrq, this.nextGrcPftRvwDate_two)) {
					errorList.add(new ErrorDetails("nextGrcPftRvwDate_two", "W0004", new String[] {
							Labels.getLabel("label_MusharakFinanceMainDialog_NextGrcPftRvwDate.value"),
							Labels.getLabel("label_MusharakFinanceMainDialog_GracePftRvwFrq.value"), Labels.getLabel("finGracePeriodDetails") }, 
				...
				if (!validateFrquency(this.cbGraceCpzFrqCode, this.graceCpzFrq, this.nextGrcCpzDate_two)) {
					errorList.add(new ErrorDetails("nextGrcCpzDate_two","W0004", new String[] {
							Labels.getLabel("label_MusharakFinanceMainDialog_NextGrcCpzDate.value"),
							Labels.getLabel("label_MusharakFinanceMainDialog_GraceCpzFrq.value"), Labels.getLabel("finGracePeriodDetails") },
			...
			if (!validateFrquency(this.cbRepayFrqCode, this.repayFrq, this.nextRepayDate_two)) {
				errorList.add(new ErrorDetails("nextRepayDate_two", "W0004", new String[] {
						Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayDate.value"),
						Labels.getLabel("label_MusharakFinanceMainDialog_RepayFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayPftFrqCode, this.repayPftFrq, this.nextRepayPftDate_two)) {
				errorList.add(new ErrorDetails("nextRepayPftDate_two","W0004", new String[] {
						Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayPftDate.value"), 
						Labels.getLabel("label_MusharakFinanceMainDialog_RepayPftFrq.value"), Labels.getLabel("WIFinRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayRvwFrqCode, this.repayRvwFrq, this.nextRepayRvwDate_two)) {
				errorList.add(new ErrorDetails("nextRepayRvwDate_two", "W0004", new String[] {
						Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayRvwDate.value"),
						Labels.getLabel("label_MusharakFinanceMainDialog_RepayRvwFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!validateFrquency(this.cbRepayCpzFrqCode, this.repayCpzFrq, this.nextRepayCpzDate_two)) {
				errorList.add(new ErrorDetails("nextRepayCpzDate_two", "W0004", new String[] {
						Labels.getLabel("label_MusharakFinanceMainDialog_NextRepayCpzDate.value"),
						Labels.getLabel("label_MusharakFinanceMainDialog_RepayCpzFrq.value"), Labels.getLabel("finRepaymentDetails") },
			...
			if (!this.numberOfTerms.isReadonly() && this.numberOfTerms.intValue() != 0 && !singleTermFinance) {
				if (this.numberOfTerms.intValue() >= 1 && this.maturityDate.getValue() != null) {
					errorList.add(new ErrorDetails("numberOfTerms","E0011", new String[] {
							Labels.getLabel("label_MusharakFinanceMainDialog_NumberOfTerms.value"),
							Labels.getLabel("label_MusharakFinanceMainDialog_MaturityDate.value") }, new String[] {}));
				}
			}
			...
			auditHeader = ErrorControl.showErrorDetails(window_MusharakFinanceMainDialog, auditHeader);
	...
	private void showMessage(Exception e) {
		...
		try {
			...
			ErrorControl.showErrorControl(this.window_MusharakFinanceMainDialog, auditHeader);
		} catch (Exception exp) {
			logger.error(exp);
		}
	}
