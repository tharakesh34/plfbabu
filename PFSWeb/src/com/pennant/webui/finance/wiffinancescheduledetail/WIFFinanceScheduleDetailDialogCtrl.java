   ...
   protected Textbox splRate; // autowired
	...
	private void doSetFieldProperties() {
		...
		this.schSeq.setMaxlength(10);
	  	...
	  	this.balanceForPftCal.setFormat(PennantAppUtil.getAmountFormate(0));
		...
		this.splRate.setMaxlength(8);
	  	...
	  	this.actRate.setFormat(PennantAppUtil.getAmountFormate(9));
	  	this.actRate.setRoundingMode(BigDecimal.ROUND_DOWN);
	  	this.actRate.setScale(9);
	  	this.adjRate.setMaxlength(13);
	  	this.adjRate.setFormat(PennantAppUtil.getAmountFormate(9));
		...
		this.noOfDays.setMaxlength(10);
	  	...
	  	this.downPaymentAmount.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.cpzAmount.setFormat(PennantAppUtil.getAmountFormate(0));
	  	this.cpzAmount.setRoundingMode(BigDecimal.ROUND_DOWN);
	  	this.cpzAmount.setScale(0);
	  	this.diffProfitSchd.setMaxlength(18);
	  	this.diffProfitSchd.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.dIffPrincipalSchd.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.closingBalance.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.profitFraction.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.prvRepayAmount.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.deffProfitBal.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.diffPrincipalBal.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.schdPriPaid.setFormat(PennantAppUtil.getAmountFormate(0));
