...
public class SukukFinanceMainDialogCtrl extends FinanceBaseCtrl implements Serializable {
	...
	protected Label 		label_SukukFinanceMainDialog_FrqDef;	// autoWired
	...
	public void onCreate$window_SukukFinanceMainDialog(Event event) throws Exception {
		...
		setLabel_FinanceMainDialog_FrqDef(label_SukukFinanceMainDialog_FrqDef);
	...
	private void doSetValidation() {
		...
		if(!this.frqDefferments.isReadonly()){
			this.frqDefferments.setConstraint(new PTNumberValidator(Labels.getLabel("label_SukukFinanceMainDialog_FrqDefferments.value"), false, false));
		}
		
		if(!this.stepPolicy.isReadonly() && this.stepFinance.isChecked() && !this.alwManualSteps.isChecked()){
			this.stepPolicy.setConstraint(new PTStringValidator( Labels.getLabel("label_SukukFinanceMainDialog_StepPolicy.value"), null, true));
		}
	...
	private void doSetLOVValidation() {
		...
		if (!this.finPurpose.isReadonly()) {
			this.finPurpose.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukukFinanceMainDialog_FinPurpose.value") }));
		}
		...
		if(!this.btnSearchGraceBaseRate.isDisabled()) {
			this.lovDescGraceBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukukFinanceMainDialog_GraceBaseRate.value") }));
		}
		...
		if(!this.btnSearchRepayBaseRate.isDisabled()) {
			this.lovDescRepayBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukukFinanceMainDialog_RepayBaseRate.value") }));
		}
...
*/
	...
	public void onClick$btnSearchGraceSpecialRate(Event event) throws InterruptedException {
		...
		this.grcEffectiveRate.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_SukukFinanceMainDialog, "SplRateCode");
