...
public class SukuknrmFinanceMainDialogCtrl extends FinanceBaseCtrl implements Serializable {
	...
	private void doSetValidation() {
		...
		if (!this.finReference.isReadonly() && 
			...
			this.finReference.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinReference.value") }));
		}
		...
		if (this.gb_gracePeriodDetails.isVisible()) {
			...
			if (!this.graceTerms.isReadonly()) {
				this.graceTerms.setConstraint("NO NEGATIVE:" + Labels.getLabel("CONST_NO_EMPTY_NEGATIVE_ZERO",
						new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_GraceTerms.value") }));
			}
			...
			if (!this.nextGrcPftDate.isReadonly() && 
				...
				this.nextGrcPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextGrcPftDate.value") }));
			}
			...
			if (!this.nextGrcPftRvwDate.isReadonly() && 
				...
				this.nextGrcPftRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
						new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextGrcPftRvwDate.value") }));
			}
		}
		...
		if (!this.nextRepayDate.isReadonly() && 
			...
			this.nextRepayDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextRepayDate.value") }));
		}
		...
		if (!this.nextRepayPftDate.isReadonly() && 
			...
			this.nextRepayPftDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextRepayPftDate.value") }));
		}
		...
		if (!this.nextRepayRvwDate.isReadonly() && 
			...
			this.nextRepayRvwDate_two.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextRepayRvwDate.value") }));
		}
		...
		if (!this.nextRepayCpzDate.isReadonly() && 
			...
			this.nextRepayCpzDate_two.setConstraint("NO EMPTY:"+ Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_NextRepayCpzDate.value") }));
		}
		...
		if(financeType.getFinMinTerm() == 1 &&
			...
			this.maturityDate_two.setConstraint("NO EMPTY:"+ Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_MaturityDate.value") }));
		}
	...
	private void doSetLOVValidation() {
		...
		this.lovDescFinTypeName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY", 
				new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinType.value") }));

		this.lovDescFinCcyName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY", 
				new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinCcy.value") }));

		if (!this.finBranch.isReadonly()) {
			this.finBranch.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinBranch.value") }));
		}
		...
		if (!recSave && StringUtils.trimToEmpty(this.disbAcctId.getSclass()).equals("mandatory")) {
			this.disbAcctId.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_DisbAcctId.value") }));
		}
		...
		if (!recSave && this.repayAcctId.getSclass().equals("mandatory")) {
			this.repayAcctId.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_RepayAcctId.value") }));
		}
		...
		if (!recSave && this.downPayAccount.getSclass().equals("mandatory")) {
			this.downPayAccount.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_DownPayAccount.value") }));
		}
		...
		if (!this.btnSearchCommitmentRef.isDisabled() && 
			...
			this.lovDescCommitmentRefName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_CommitRef.value") }));
		}

		if (!this.finPurpose.isReadonly()) {
			this.finPurpose.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinPurpose.value") }));
		}
		...
		if(!this.btnSearchGraceBaseRate.isDisabled()) {
			this.lovDescGraceBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_GraceBaseRate.value") }));
		}
		...
		if(this.allowGrcInd.isChecked() && !this.btnSearchGrcIndBaseRate.isDisabled()){
			this.lovDescGrcIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_SukuknrmFinanceMainDialog_FinGrcIndBaseRate.value")}));			
		}
		...
		if(!this.btnSearchRepayBaseRate.isDisabled()) {
			this.lovDescRepayBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_RepayBaseRate.value") }));
		}
		...
		if(this.allowRpyInd.isChecked() && !this.btnSearchRpyIndBaseRate.isDisabled()){
			this.lovDescRpyIndBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[]{Labels.getLabel("label_SukuknrmFinanceMainDialog_FinRpyIndBaseRate.value")}));			
		}
		logger.debug("Leaving ");
	}
	...
	public void onChange$lovDescFinCcyName(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			finCcy.setValue("");
			throw new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_FinCcy.value") }));
		}
...
//		filters[1] = new Filter("cmtCcy", this.finCcy.getValue(), Filter.OP_EQUAL);
	...
	public void onClick$btnSearchGraceSpecialRate(Event event) throws InterruptedException {
		...
		this.grcEffectiveRate.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_SukuknrmFinanceMainDialog, "SplRateCode");
	...
	public void onChange$lovDescCustCIF(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			this.repayAcctId.setCustCIF("");
			this.downPayAccount.setCustCIF("");
			throw new WrongValueException(this.lovDescCustCIF, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_SukuknrmFinanceMainDialog_CustID.value") }));
		}
