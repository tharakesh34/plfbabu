...
public class MudarabaFinanceMainDialogCtrl extends FinanceBaseCtrl implements Serializable {
	...
	private void doSetLOVValidation() {
		...
		if (!this.finBranch.isReadonly()) {
			this.finBranch.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinBranch.value") }));
		}
		...
		if (!this.finPurpose.isReadonly()) {
			this.finPurpose.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_FinPurpose.value") }));
		}
	...
	public void onChange$lovDescCustCIF(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			this.repayAcctId.setCustCIF("");
			this.downPayAccount.setCustCIF("");
			throw new WrongValueException(this.lovDescCustCIF, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_MudarabaFinanceMainDialog_CustID.value") }));
		}
