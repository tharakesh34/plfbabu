...
public class TawarruqFinanceMainDialogCtrl extends FinanceBaseCtrl implements Serializable {
	...
	protected Label 		label_TawarruqFinanceMainDialog_FrqDef;		// autoWired
	...
	private void doSetValidation() {
		...
		if(!this.frqDefferments.isDisabled()){
			this.frqDefferments.setConstraint(new PTNumberValidator(Labels.getLabel("label_TawarruqFinanceMainDialog_FrqDefferments.value"), false, false));
		}
	...
	private void doSetLOVValidation() {
		...
		this.lovDescFinCcyName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY", 
				new String[] { Labels.getLabel("label_TawarruqFinanceMainDialog_FinCcy.value") }));
		...
		if(!this.btnSearchGraceBaseRate.isDisabled()) {
			this.lovDescGraceBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_TawarruqFinanceMainDialog_GraceBaseRate.value") }));
		}
		...
		if(!this.btnSearchRepayBaseRate.isDisabled()) {
			this.lovDescRepayBaseRateName.setConstraint("NO EMPTY:" + Labels.getLabel("FIELD_NO_EMPTY",
					new String[] { Labels.getLabel("label_TawarruqFinanceMainDialog_RepayBaseRate.value") }));
		}
	...
	public void onChange$lovDescFinCcyName(Event event) throws InterruptedException {
		...
		if (customer != null) {
			...
			finCcy.setValue("");
			throw new WrongValueException(this.lovDescFinCcyName, Labels.getLabel("FIELD_NO_INVALID", new String[] { Labels.getLabel("label_TawarruqFinanceMainDialog_FinCcy.value") }));
		}
	...
	public void onClick$btnSearchGraceSpecialRate(Event event) throws InterruptedException {
		...
		this.grcEffectiveRate.setConstraint("");
		Object dataObject = ExtendedSearchListBox.show(this.window_TawarruqFinanceMainDialog, "SplRateCode");
