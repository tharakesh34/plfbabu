...
public class FinanceDisbursementDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	private void doSetValidation() {
		...
		if (!this.finReference.isReadonly()){
			this.finReference.setConstraint(new PTStringValidator(Labels.getLabel("label_FinanceDisbursementDialog_FinReference.value"),null,true));
		}	
		if (!this.disbDate.isDisabled()){
			this.disbDate.setConstraint(new PTDateValidator(Labels.getLabel("label_FinanceDisbursementDialog_DisbDate.value"),true));
		}
		...
		if (!this.disbDesc.isReadonly()){
			this.disbDesc.setConstraint(new PTStringValidator(Labels.getLabel("label_FinanceDisbursementDialog_DisbDesc.value"),null,true));
		}	
		...
		if (!this.disbActDate.isDisabled()){
			this.disbActDate.setConstraint(new PTDateValidator(Labels.getLabel("label_FinanceDisbursementDialog_DisbActDate.value"),true));
		}
		if (!this.disbRemarks.isReadonly()){
			this.disbRemarks.setConstraint(new PTStringValidator(Labels.getLabel("label_FinanceDisbursementDialog_DisbRemarks.value"),null,true));
		}	
	logger.debug("Leaving");
	}
