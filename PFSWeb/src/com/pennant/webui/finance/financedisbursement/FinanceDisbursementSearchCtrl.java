 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  FinanceDisbursementSearchCtrl.java                                                   * 	  
 *                                                                    						*
...
public class FinanceDisbursementSearchCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = 1L;
	private final static Logger logger = Logger.getLogger(FinanceDisbursementSearchCtrl.class);
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window window_FinanceDisbursementSearch; // autowired
	...
	protected Label label_FinanceDisbursementSearch_RecordStatus; // autowired
	protected Label label_FinanceDisbursementSearch_RecordType; // autowired
	protected Label label_FinanceDisbursementSearchResult; // autowired

	// not auto wired vars
	private transient FinanceDisbursementListCtrl financeDisbursementCtrl; // overhanded per param
	private transient FinanceDisbursementService financeDisbursementService;
	private transient WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("FinanceDisbursement");
	
	/**
	 * constructor
	 */
	public FinanceDisbursementSearchCtrl() {
		super();
	}
	...
	public void onCreate$window_FinanceDisbursementSearch(Event event) throws Exception {
		...
		if (args.containsKey("financeDisbursementCtrl")) {
			this.financeDisbursementCtrl = (FinanceDisbursementListCtrl) args.get("financeDisbursementCtrl");
		} else {
			this.financeDisbursementCtrl = null;
		}
		...
		this.sortOperator_disbDate.setModel(new ListModelList<SearchOperators>(new SearchOperators().getStringOperators()));
		this.sortOperator_disbDate.setItemRenderer(new SearchOperatorListModelItemRenderer());
	
		this.sortOperator_disbSeq.setModel(new ListModelList<SearchOperators>(new SearchOperators().getStringOperators()));
		this.sortOperator_disbSeq.setItemRenderer(new SearchOperatorListModelItemRenderer());
	
		this.sortOperator_disbDesc.setModel(new ListModelList<SearchOperators>(new SearchOperators().getStringOperators()));
		...
		this.sortOperator_disbActDate.setModel(new ListModelList<SearchOperators>(new SearchOperators().getStringOperators()));
		this.sortOperator_disbActDate.setItemRenderer(new SearchOperatorListModelItemRenderer());
	
		this.sortOperator_disbDisbursed.setModel(new ListModelList<SearchOperators>(new SearchOperators().getBooleanOperators()));
		this.sortOperator_disbDisbursed.setItemRenderer(new SearchOperatorListModelItemRenderer());
	
		this.sortOperator_disbIsActive.setModel(new ListModelList<SearchOperators>(new SearchOperators().getBooleanOperators()));
		this.sortOperator_disbIsActive.setItemRenderer(new SearchOperatorListModelItemRenderer());
	
		this.sortOperator_disbRemarks.setModel(new ListModelList<SearchOperators>(new SearchOperators().getStringOperators()));
		...
		if (isWorkFlowEnabled()){
			...
			this.label_FinanceDisbursementSearch_RecordStatus.setVisible(false);
			this.label_FinanceDisbursementSearch_RecordType.setVisible(false);
		}
		...
		showFinanceDisbursementSeekDialog();
	}
	...
	private void doClose() {
		this.window_FinanceDisbursementSearch.onClose();
	}

	/**
	 * Opens the SearchDialog window modal.
	 */
	private void showFinanceDisbursementSeekDialog() throws InterruptedException {

		try {
			// open the dialog in modal mode
			this.window_FinanceDisbursementSearch.doModal();
	...
	public void doSearch() {
		...
		if (isWorkFlowEnabled()){
			so.addTabelName("FinDisbursementDetails_View");
			so.addFilterIn("nextRoleCode", getUserWorkspace().getUserRoles(),isFirstTask());	
		}else{
			so.addTabelName("FinDisbursementDetails_AView");
		}
		...
		this.financeDisbursementCtrl.setSearchObj(so);

		final Listbox listBox = this.financeDisbursementCtrl.listBoxFinanceDisbursement;
		final Paging paging = this.financeDisbursementCtrl.pagingFinanceDisbursementList;
		...
		this.label_FinanceDisbursementSearchResult.setValue(Labels.getLabel("label_FinanceDisbursementSearchResult.value") + " "
