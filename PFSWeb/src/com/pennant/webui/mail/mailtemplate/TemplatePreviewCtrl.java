...
public class TemplatePreviewCtrl  extends GFCBaseCtrl implements Serializable {
	...
	public void onCreate$window_TemplatePreview(Event event) throws Exception {
		...
		if (args.containsKey("fieldsMap")) {
			fieldsMap = (HashMap<String, String>) args.get("fieldsMap");
		}
		if (args.containsKey("mailContent")) {
			mailContent = (String) args.get("mailContent");
		}
		...
		// READ OVERHANDED parameters !
		if (args.containsKey("mailTemplateDialogCtrl")) {
			this.mailTemplateDialogCtrl = (MailTemplateDialogCtrl) args
