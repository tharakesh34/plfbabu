 ...
 * /WEB-INF/pages/Administration/SecurityUsers/SecurityRoleSearchDialog.zul file. <br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */

public class SecurityRoleSearchCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onCreate$window_SecurityRoleSearch(Event event) throws Exception {
		...
		if (args.containsKey("securityRoleCtrl")) {
			object  =(Object)args.get("securityRoleCtrl");
			listBox = (Listbox)args.get("listBoxSecurityRole");
			paging  = (Paging)args.get("pagingSecurityRoleList");
		...
		if (args.containsKey("searchObject")) {
			final JdbcSearchObject<SecurityRole> searchObj = (JdbcSearchObject<SecurityRole>) args.get("searchObject");
			...
			for (final Filter filter : ft) {
				...
				if (filter.getProperty().equals("roleID")) {
				...
				} else if (filter.getProperty().equals("roleApp")) {
	...
	private void doClose() {
		...
		this.window_SecurityRoleSearch.onClose();
		logger.debug("Leaving ");
	}
