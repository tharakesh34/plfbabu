...
public class FinanceCampaignDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	private void doSetFieldProperties() {
		...
		this.fCSplRate.setMaxlength(8);
	  	...
	  	this.fCIntRate.setFormat(PennantAppUtil.getAmountFormate(9));
		...
		this.fCGrcSplRate.setMaxlength(8);
	  	...
	  	this.fCGrcIntRate.setFormat(PennantAppUtil.getAmountFormate(9));
		...
		this.fCRepayMethod.setMaxlength(8);
	  	...
	  	this.fCMaxDifferment.setFormat(PennantAppUtil.getAmountFormate(0));
	  	...
	  	this.fCMaxFrqDifferment.setFormat(PennantAppUtil.getAmountFormate(0));
		...
		this.fCGrcRvwRateApplFor.setMaxlength(8);
	  	...
	  	this.fCMinDownPayAmount.setFormat(PennantAppUtil.getAmountFormate(2));
