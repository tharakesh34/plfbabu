...
public class ButtonStatusCtrl implements Serializable  {
	 ...
	 *            (Close Button)
	 */
	public ButtonStatusCtrl(UserWorkspace userWorkspace, String rightPrefix, boolean withCloseBtn, Button btnNew, Button btnEdit, Button btnDelete, Button btnSave, Button btnCancel, Button btnClose,Button btnNotes) {
		super();
...
//		buttons.get(ButtonEnum.New).setSclass(sclass);
		buttons.get(ButtonEnum.New).setLabel("New");

//		buttons.get(ButtonEnum.Edit).setSclass(sclass);
		buttons.get(ButtonEnum.Edit).setLabel("Edit");
		
//		buttons.get(ButtonEnum.Save).setSclass(sclass);
		buttons.get(ButtonEnum.Save).setLabel("Save");
		
//		buttons.get(ButtonEnum.Delete).setSclass(sclass);
		buttons.get(ButtonEnum.Delete).setLabel("Delete");
		
//		buttons.get(ButtonEnum.Cancel).setSclass(sclass);
		buttons.get(ButtonEnum.Cancel).setLabel("Cancel");
		
//		buttons.get(ButtonEnum.Close).setSclass(sclass);
		buttons.get(ButtonEnum.Close).setLabel("Close");
		
//		buttons.get(ButtonEnum.Notes).setSclass(sclass);
		buttons.get(ButtonEnum.Notes).setLabel("Notes");
		
		
//		setImage(ButtonEnum.New, imagePath + "addnew.png");
...
//		setImage(ButtonEnum.Notes, imagePath + "btn_notes.gif");
	}
