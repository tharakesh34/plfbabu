...
public class PennantRegularExpressions {
	...
	public static final String	NM_NAME_REGEX						= "[a-zA-Z.\\s]*";																											//TODO
	...
	public static final String REGEX_QUERY_CODE="REGEX_QUERY_CODE";
	...
	private static Map<String, String> regexMapper = new HashMap<String, String>() {
...

		{
			...
			put(REGEX_ALPHANUM_SPACE_SPL_COMMAHIPHEN, "^[A-Za-z0-9]+[A-Za-z0-9.\\>\\<\\!\\,\\-\\@\\$\\%\\&\\#\\*\\(\\)\\[\\]\\{\\}\\s]*");
			...
			put(REGEX_ACCOUNT, "[0-9]{13}");
			put(REGEX_CR, "^[1-9]+[1-9\\-\\/]{8,10}");
			put(REGEX_ZIP, "[0-9]{3,6}");
			put(REGEX_QUERY_CODE, "^[A-Za-z0-9]+[A-Za-z0-9.\\-\\s\\_\\/]*");
		}
	};
