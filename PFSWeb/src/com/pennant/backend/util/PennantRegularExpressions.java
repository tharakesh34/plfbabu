...
public class PennantRegularExpressions {
	...
	public static final String REGEX_DOOR_BUILDING="REGEX_DOOR_BUILDING";
	public static final String REGEX_ADDRESS="REGEX_ADDRESS";
	public static final String REGEX_IDCODES="REGEX_IDCODES";
	...
	private static Map<String, String> regexMapper = new HashMap<String, String>() {
...

		{
			...
			put(REGEX_IDCODES, "(^[A-Za-z\\/\\-]+[A-Za-z\\/\\s\\-]*|^[0-9\\/]+[0-9\\/\\-\\s*]*|^[a-zA-Z0-9\\/\\-]+[a-zA-Z0-9\\/\\-\\s*]*)");
