 ...
 * 
 */
@XmlType(propOrder = { "ParticularId", "Remarks", "finReference", "particulars" })
@XmlAccessorType(XmlAccessType.NONE)
public class RecommendationNotes extends AbstractWorkflowEntity {
	...
	public RecommendationNotes(long id) {
		super();
		this.setId(id);
	}
	...
	public RecommendationNotes getBefImage() {
		return befImage;
	}
