...
public class AgreementDetail {
	...
	/** If it is a retail customer it use to store current Customer
	 *  Date of Birth or if it is a corporate or an SME customer
	 *  then it will be either date of incorporation or Date of Birth. 	*/
