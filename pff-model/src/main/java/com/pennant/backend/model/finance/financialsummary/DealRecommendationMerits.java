...
public class DealRecommendationMerits extends AbstractWorkflowEntity {
	...
	public DealRecommendationMerits() {
		super();
	}

	public DealRecommendationMerits(long id) {
		super();
		this.setId(id);
	}
	...
	public DealRecommendationMerits getBefImage() {
		return befImage;
	}

	public void setBefImage(DealRecommendationMerits befImage) {
