...
public class FinanceMain extends AbstractWorkflowEntity {
	...
	public String toString() {
		return "FinanceMain [finReference=" + finReference + ", linkedFinRef=" + linkedFinRef + ", investmentRef="
				+ investmentRef + ", finType=" + finType + ", lovDescFinTypeName=" + lovDescFinTypeName
				+ ", promotionCode=" + promotionCode + ", finCcy=" + finCcy + ", profitDaysBasis=" + profitDaysBasis
				+ ", custID=" + custID + ", lovDescCustCIF=" + lovDescCustCIF + ", lovDescCustShrtName="
				+ lovDescCustShrtName + ", finBranch=" + finBranch + ", lovDescFinBranchName=" + lovDescFinBranchName
				+ ", finBranchProvinceCode=" + finBranchProvinceCode + ", finStartDate=" + finStartDate
				+ ", finContractDate=" + finContractDate + ", finAmount=" + finAmount + ", disbAccountId="
				+ disbAccountId + ", repayAccountId=" + repayAccountId + ", finCancelAc=" + finCancelAc
				+ ", finWriteoffAc=" + finWriteoffAc + ", minDownPayPerc=" + minDownPayPerc + ", downPayment="
				+ downPayment + ", advanceEMI=" + advanceEMI + ", downPayBank=" + downPayBank + ", downPaySupl="
				+ downPaySupl + ", downPayAccount=" + downPayAccount + ", defferments=" + defferments
				+ ", planDeferCount=" + planDeferCount + ", finPurpose=" + finPurpose + ", lovDescFinPurposeName="
				+ lovDescFinPurposeName + ", allowGrcPeriod=" + allowGrcPeriod + ", finRepayMethod=" + finRepayMethod
				+ ", finCommitmentRef=" + finCommitmentRef + ", lovDescCommitmentRefName=" + lovDescCommitmentRefName
				+ ", depreciationFrq=" + depreciationFrq + ", finIsActive=" + finIsActive + ", finRemarks=" + finRemarks
				+ ", initiateUser=" + initiateUser + ", initiateDate=" + initiateDate + ", mMAId=" + mMAId
				+ ", agreeName=" + agreeName + ", finIsAlwMD=" + finIsAlwMD + ", accountsOfficer=" + accountsOfficer
				+ ", dsaCode=" + dsaCode + ", dsaName=" + dsaName + ", dsaCodeDesc=" + dsaCodeDesc
				+ ", lovDescAccountsOfficer=" + lovDescAccountsOfficer + ", lovDescSourceCity=" + lovDescSourceCity
				+ ", lovDescMobileNumber=" + lovDescMobileNumber + ", lovDescFinProduct=" + lovDescFinProduct
				+ ", lovDescCustCRCPR=" + lovDescCustCRCPR + ", lovDescCustPassportNo=" + lovDescCustPassportNo
				+ ", lovDescCustDOB=" + lovDescCustDOB + ", lovDescRequestStage=" + lovDescRequestStage
				+ ", lovDescQueuePriority=" + lovDescQueuePriority + ", lovDescMMAReference=" + lovDescMMAReference
				+ ", tDSApplicable=" + tDSApplicable + ", droplineFrq=" + droplineFrq + ", firstDroplineDate="
				+ firstDroplineDate + ", pftServicingODLimit=" + pftServicingODLimit + ", chequeOrDDAvailable="
				+ chequeOrDDAvailable + ", neftAvailable=" + neftAvailable + ", approved=" + approved
				+ ", securityDeposit=" + securityDeposit + ", deductFeeDisb=" + deductFeeDisb + ", deductInsDisb="
				+ deductInsDisb + ", stepFinance=" + stepFinance + ", stepType=" + stepType + ", stepPolicy="
				+ stepPolicy + ", lovDescStepPolicyName=" + lovDescStepPolicyName + ", alwManualSteps=" + alwManualSteps
				+ ", noOfSteps=" + noOfSteps + ", shariaApprovalReq=" + shariaApprovalReq + ", shariaStatus="
				+ shariaStatus + ", rejectStatus=" + rejectStatus + ", rejectReason=" + rejectReason
				+ ", isPaymentToBank=" + isPaymentToBank + ", isPayToDevSelCust=" + isPayToDevSelCust
				+ ", scheduleChange=" + scheduleChange + ", adjOrgBal=" + adjOrgBal + ", remBalForAdj=" + remBalForAdj
				+ ", devFinCalReq=" + devFinCalReq + ", resetNxtRpyInstReq=" + resetNxtRpyInstReq + ", resetOrgBal="
				+ resetOrgBal + ", lovDescEntityCode=" + lovDescEntityCode + ", deviationApproval=" + deviationApproval
				+ ", finPreApprovedRef=" + finPreApprovedRef + ", preApprovalFinance=" + preApprovalFinance
				+ ", preApprovalExpired=" + preApprovalExpired + ", applicationNo=" + applicationNo
				+ ", swiftBranchCode=" + swiftBranchCode + ", finBranchContact=" + finBranchContact
				+ ", allowDrawingPower=" + allowDrawingPower + ", allowRevolving=" + allowRevolving + ", graceTerms="
				+ graceTerms + ", grcPeriodEndDate=" + grcPeriodEndDate + ", grcRateBasis=" + grcRateBasis
				+ ", grcPftRate=" + grcPftRate + ", graceBaseRate=" + graceBaseRate + ", graceSpecialRate="
				+ graceSpecialRate + ", grcMargin=" + grcMargin + ", grcProfitDaysBasis=" + grcProfitDaysBasis
				+ ", grcPftFrq=" + grcPftFrq + ", nextGrcPftDate=" + nextGrcPftDate + ", allowGrcPftRvw="
				+ allowGrcPftRvw + ", grcPftRvwFrq=" + grcPftRvwFrq + ", nextGrcPftRvwDate=" + nextGrcPftRvwDate
				+ ", allowGrcCpz=" + allowGrcCpz + ", grcCpzFrq=" + grcCpzFrq + ", nextGrcCpzDate=" + nextGrcCpzDate
				+ ", allowGrcRepay=" + allowGrcRepay + ", grcSchdMthd=" + grcSchdMthd + ", grcMinRate=" + grcMinRate
				+ ", grcMaxRate=" + grcMaxRate + ", grcMaxAmount=" + grcMaxAmount + ", grcFrqEditable=" + grcFrqEditable
				+ ", grcAdvBaseRate=" + grcAdvBaseRate + ", grcAdvMargin=" + grcAdvMargin + ", grcAdvPftRate="
				+ grcAdvPftRate + ", numberOfTerms=" + numberOfTerms + ", NOInst=" + NOInst + ", reqRepayAmount="
				+ reqRepayAmount + ", repayRateBasis=" + repayRateBasis + ", repayProfitRate=" + repayProfitRate
				+ ", repayBaseRate=" + repayBaseRate + ", repayBaseRateVal=" + repayBaseRateVal + ", repaySpecialRate="
				+ repaySpecialRate + ", repayMargin=" + repayMargin + ", scheduleMethod=" + scheduleMethod
				+ ", repayPftFrq=" + repayPftFrq + ", nextRepayPftDate=" + nextRepayPftDate + ", allowRepayRvw="
				+ allowRepayRvw + ", repayRvwFrq=" + repayRvwFrq + ", nextRepayRvwDate=" + nextRepayRvwDate
				+ ", allowRepayCpz=" + allowRepayCpz + ", repayCpzFrq=" + repayCpzFrq + ", nextRepayCpzDate="
				+ nextRepayCpzDate + ", repayFrq=" + repayFrq + ", nextRepayDate=" + nextRepayDate + ", maturityDate="
				+ maturityDate + ", finRepayPftOnFrq=" + finRepayPftOnFrq + ", rpyMinRate=" + rpyMinRate
				+ ", rpyMaxRate=" + rpyMaxRate + ", rpyAdvBaseRate=" + rpyAdvBaseRate + ", rpyAdvMargin=" + rpyAdvMargin
				+ ", rpyAdvPftRate=" + rpyAdvPftRate + ", supplementRent=" + supplementRent + ", increasedCost="
				+ increasedCost + ", curSuplRent=" + curSuplRent + ", curIncrCost=" + curIncrCost + ", frqEditable="
				+ frqEditable + ", rolloverFrq=" + rolloverFrq + ", nextRolloverDate=" + nextRolloverDate
				+ ", calRoundingMode=" + calRoundingMode + ", roundingTarget=" + roundingTarget + ", alwMultiDisb="
				+ alwMultiDisb + ", postingId=" + postingId + ", alwBPI=" + alwBPI + ", bpiTreatment=" + bpiTreatment
				+ ", bpiPftDaysBasis=" + bpiPftDaysBasis + ", planEMIHAlw=" + planEMIHAlw + ", planEMIHMethod="
				+ planEMIHMethod + ", planEMIHMaxPerYear=" + planEMIHMaxPerYear + ", planEMIHMax=" + planEMIHMax
				+ ", planEMIHLockPeriod=" + planEMIHLockPeriod + ", planEMICpz=" + planEMICpz
				+ ", unPlanEMIHLockPeriod=" + unPlanEMIHLockPeriod + ", unPlanEMICpz=" + unPlanEMICpz + ", reAgeCpz="
				+ reAgeCpz + ", maxUnplannedEmi=" + maxUnplannedEmi + ", maxReAgeHolidays=" + maxReAgeHolidays
				+ ", feeChargeAmt=" + feeChargeAmt + ", insuranceAmt=" + insuranceAmt + ", curDisbursementAmt="
				+ curDisbursementAmt + ", anualizedPercRate=" + anualizedPercRate + ", effectiveRateOfReturn="
				+ effectiveRateOfReturn + ", cpzAtGraceEnd=" + cpzAtGraceEnd + ", totalGracePft=" + totalGracePft
				+ ", totalGraceCpz=" + totalGraceCpz + ", totalGrossGrcPft=" + totalGrossGrcPft + ", totalProfit="
				+ totalProfit + ", totalCpz=" + totalCpz + ", totalGrossPft=" + totalGrossPft + ", totalRepayAmt="
				+ totalRepayAmt + ", calculateRepay=" + calculateRepay + ", equalRepay=" + equalRepay + ", calGrcTerms="
				+ calGrcTerms + ", calGrcEndDate=" + calGrcEndDate + ", calTerms=" + calTerms + ", calMaturity="
				+ calMaturity + ", firstRepay=" + firstRepay + ", lastRepay=" + lastRepay + ", finRepaymentAmount="
				+ finRepaymentAmount + ", eventFromDate=" + eventFromDate + ", eventToDate=" + eventToDate
				+ ", recalFromDate=" + recalFromDate + ", recalToDate=" + recalToDate + ", recalType=" + recalType
				+ ", recalSchdMethod=" + recalSchdMethod + ", desiredProfit=" + desiredProfit + ", rvwRateApplFor="
				+ rvwRateApplFor + ", lovDescAdjClosingBal=" + lovDescAdjClosingBal + ", totalPriAmt=" + totalPriAmt
				+ ", schPriDue=" + schPriDue + ", schPftDue=" + schPftDue + ", schCalOnRvw=" + schCalOnRvw
				+ ", pastduePftCalMthd=" + pastduePftCalMthd + ", droppingMethod=" + droppingMethod + ", rateChgAnyDay="
				+ rateChgAnyDay + ", pastduePftMargin=" + pastduePftMargin + ", pftCpzFromReset=" + pftCpzFromReset
				+ ", allowedDefRpyChange=" + allowedDefRpyChange + ", availedDefRpyChange=" + availedDefRpyChange
				+ ", allowedDefFrqChange=" + allowedDefFrqChange + ", availedDefFrqChange=" + availedDefFrqChange
				+ ", lastRepayDate=" + lastRepayDate + ", lastRepayPftDate=" + lastRepayPftDate + ", lastRepayRvwDate="
				+ lastRepayRvwDate + ", lastRepayCpzDate=" + lastRepayCpzDate + ", pftIntact=" + pftIntact
				+ ", adjTerms=" + adjTerms + ", isAdjustClosingBal=" + isAdjustClosingBal + ", finAssetValue="
				+ finAssetValue + ", finCurrAssetValue=" + finCurrAssetValue + ", nextDepDate=" + nextDepDate
				+ ", lastDepDate=" + lastDepDate + ", finSourceID=" + finSourceID + ", rcdMaintainSts=" + rcdMaintainSts
				+ ", lovDescFinScheduleOn=" + lovDescFinScheduleOn + ", closingStatus=" + closingStatus
				+ ", finApprovedDate=" + finApprovedDate + ", lovDescTenorName=" + lovDescTenorName
				+ ", migratedFinance=" + migratedFinance + ", scheduleMaintained=" + scheduleMaintained
				+ ", scheduleRegenerated=" + scheduleRegenerated + ", manualSchedule=" + manualSchedule
				+ ", takeOverFinance=" + takeOverFinance + ", finStatus=" + finStatus + ", finStsReason=" + finStsReason
				+ ", custDSR=" + custDSR + ", curFinAmount=" + curFinAmount + ", financingAmount=" + financingAmount
				+ ", bpiAmount=" + bpiAmount + ", lovDescFinancingAmount=" + lovDescFinancingAmount
				+ ", lovDescIsSchdGenerated=" + lovDescIsSchdGenerated + ", lovDescProductCodeName="
				+ lovDescProductCodeName + ", availCommitAmount=" + availCommitAmount + ", jointCustId=" + jointCustId
				+ ", lovDescJointCustCIF=" + lovDescJointCustCIF + ", lovDescJointCustShrtName="
				+ lovDescJointCustShrtName + ", jointAccount=" + jointAccount + ", finAccount=" + finAccount
				+ ", finCustPftAccount=" + finCustPftAccount + ", lovDescAccruedTillLBD=" + lovDescAccruedTillLBD
				+ ", custStsDescription=" + custStsDescription + ", dedupFound=" + dedupFound + ", skipDedup="
				+ skipDedup + ", proceedDedup=" + proceedDedup + ", blacklisted=" + blacklisted + ", blacklistOverride="
				+ blacklistOverride + ", limitValid=" + limitValid + ", overrideLimit=" + overrideLimit + ", amount="
				+ amount + ", exception=" + exception + ", amountBD=" + amountBD + ", amountUSD=" + amountUSD
				+ ", maturity=" + maturity + ", fundsAvailConfirmed=" + fundsAvailConfirmed + ", policeCaseFound="
				+ policeCaseFound + ", policeCaseOverride=" + policeCaseOverride + ", chequeFound=" + chequeFound
				+ ", chequeOverride=" + chequeOverride + ", score=" + score + ", smecustomer=" + smecustomer
				+ ", cadrequired=" + cadrequired + ", feeExists=" + feeExists + ", receiptMode=" + receiptMode
				+ ", receiptModeStatus=" + receiptModeStatus + ", receiptPurpose=" + receiptPurpose + ", waivedAmt="
				+ waivedAmt + ", lovDescCustCoreBank=" + lovDescCustCoreBank + ", lovDescCustFName=" + lovDescCustFName
				+ ", lovDescCustLName=" + lovDescCustLName + ", lovDescSalutationName=" + lovDescSalutationName
				+ ", lovDescCustCtgCode=" + lovDescCustCtgCode + ", newRecord=" + newRecord + ", befImage=" + befImage
				+ ", userDetails=" + userDetails + ", nextUserId=" + nextUserId + ", nextUsrName=" + nextUsrName
				+ ", priority=" + priority + ", lovDescAssignMthd=" + lovDescAssignMthd + ", lovDescBaseRoleCodeMap="
				+ lovDescBaseRoleCodeMap + ", lovDescFirstTaskOwner=" + lovDescFirstTaskOwner + ", bankName=" + bankName
				+ ", bankNameDesc=" + bankNameDesc + ", iban=" + iban + ", accountType=" + accountType
				+ ", ddaReferenceNo=" + ddaReferenceNo + ", pftForSelectedPeriod=" + pftForSelectedPeriod
				+ ", miscAmount=" + miscAmount + ", indexMisc=" + indexMisc + ", compareToExpected=" + compareToExpected
				+ ", compareExpectedResult=" + compareExpectedResult + ", compareExpectIndex=" + compareExpectIndex
				+ ", compareWith=" + compareWith + ", protectSchdPft=" + protectSchdPft + ", schdIndex=" + schdIndex
				+ ", indexStart=" + indexStart + ", indexEnd=" + indexEnd + ", newMaturityIndex=" + newMaturityIndex
				+ ", reqMaturity=" + reqMaturity + ", procMethod=" + procMethod + ", ifscCode=" + ifscCode
				+ ", reqTerms=" + reqTerms + ", increaseTerms=" + increaseTerms + ", lovDescFinDivision="
				+ lovDescFinDivision + ", lovValue=" + lovValue + ", feeAccountId=" + feeAccountId + ", finLimitRef="
				+ finLimitRef + ", lovDescLimitRefName=" + lovDescLimitRefName + ", productCategory=" + productCategory
				+ ", mandateID=" + mandateID + ", refundAmount=" + refundAmount + ", errorDetails=" + errorDetails
				+ ", lovDescNextUsersRolesMap=" + lovDescNextUsersRolesMap + ", secondaryAccount=" + secondaryAccount
				+ ", salesDepartment=" + salesDepartment + ", salesDepartmentDesc=" + salesDepartmentDesc + ", dmaCode="
				+ dmaCode + ", dmaCodeDesc=" + dmaCodeDesc + ", dmaName=" + dmaName + ", referralId=" + referralId
				+ ", referralIdDesc=" + referralIdDesc + ", employeeName=" + employeeName + ", employeeNameDesc="
				+ employeeNameDesc + ", quickDisb=" + quickDisb + ", wifReference=" + wifReference
				+ ", availedUnPlanEmi=" + availedUnPlanEmi + ", availedReAgeH=" + availedReAgeH + ", workFlowType="
				+ workFlowType + ", nextRoleCodeDesc=" + nextRoleCodeDesc + ", secUsrFullName=" + secUsrFullName
				+ ", validateMain=" + validateMain + ", firstDisbDate=" + firstDisbDate + ", lastDisbDate="
				+ lastDisbDate + ", dueBucket=" + dueBucket + ", reAgeBucket=" + reAgeBucket + ", finCategory="
				+ finCategory + ", stage=" + stage + ", status=" + status + ", recalFee=" + recalFee + ", recalTerms="
				+ recalTerms + ", bpiResetReq=" + bpiResetReq + ", modifyBpi=" + modifyBpi + ", rcu=" + rcu
				+ ", dedupMatch=" + dedupMatch + ", hunterGo=" + hunterGo + ", bureau=" + bureau + ", recalCGSTFee="
				+ recalCGSTFee + ", recalIGSTFee=" + recalIGSTFee + ", recalSGSTFee=" + recalSGSTFee + ", recalUGSTFee="
				+ recalUGSTFee + ", eligibilityMethod=" + eligibilityMethod + ", lovEligibilityMethod="
				+ lovEligibilityMethod + ", lovDescEligibilityMethod=" + lovDescEligibilityMethod + ", collateralType="
				+ collateralType + ", marketValue=" + marketValue + ", guidedValue=" + guidedValue + ", totalExposure="
				+ totalExposure + ", samplingRequired=" + samplingRequired + ", legalRequired=" + legalRequired
				+ ", depositProcess=" + depositProcess + ", connector=" + connector + ", connectorCode=" + connectorCode
				+ ", connectorDesc=" + connectorDesc + ", vanReq=" + vanReq + ", vanCode=" + vanCode
				+ ", fixedRateTenor=" + fixedRateTenor + ", fixedTenorRate=" + fixedTenorRate + ", fixedTenorEndDate="
				+ fixedTenorEndDate + ", processAttributes=" + processAttributes + ", higherDeviationApprover="
				+ higherDeviationApprover + ", attributes=" + attributes + ", repayAmount=" + repayAmount
				+ ", entityCode=" + entityCode + ", entityDesc=" + entityDesc + ", businessVertical=" + businessVertical
				+ ", businessVerticalCode=" + businessVerticalCode + ", businessVerticalDesc=" + businessVerticalDesc
				+ ", grcAdvType=" + grcAdvType + ", grcAdvTerms=" + grcAdvTerms + ", advType=" + advType + ", advTerms="
				+ advTerms + ", advStage=" + advStage + ", alwFlexi=" + alwFlexi + ", flexiAmount=" + flexiAmount
				+ ", chgDropLineSchd=" + chgDropLineSchd + ", assignmentId=" + assignmentId + ", promotionSeqId="
				+ promotionSeqId + ", loanCategory=" + loanCategory + ", allowSubvention=" + allowSubvention
				+ ", glSubHeadCodes=" + glSubHeadCodes + ", closedDate=" + closedDate + ", recalIdx=" + recalIdx
				+ ", alwStrtPrdHday=" + alwStrtPrdHday + ", maxStrtPrdHdays=" + maxStrtPrdHdays + ", strtPrdHdays="
				+ strtPrdHdays + ", strtprdCpzMethod=" + strtprdCpzMethod + ", oldFinReference=" + oldFinReference
				+ ", coreBankId=" + coreBankId + ", tdsPercentage=" + tdsPercentage + ", tdsStartDate=" + tdsStartDate
				+ ", tdsEndDate=" + tdsEndDate + ", tdsLimitAmt=" + tdsLimitAmt + ", intTdsAdjusted=" + intTdsAdjusted
				+ ", extReference=" + extReference + ", serviceName=" + serviceName + ", sanBsdSchdle=" + sanBsdSchdle
				+ ", applySanctionCheck=" + applySanctionCheck + ", svAmount=" + svAmount + ", cbAmount=" + cbAmount
				+ ", bRRpyRvwFrq=" + bRRpyRvwFrq + ", baseRateReq=" + baseRateReq + ", totalFinAmount=" + totalFinAmount
