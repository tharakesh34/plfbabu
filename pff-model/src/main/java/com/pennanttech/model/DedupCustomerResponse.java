...
public class DedupCustomerResponse {
	...
	public void setDedupCustomerDetails(List<DedupCustomerDetail> dedupCustomerDetails) {
		this.dedupCustomerDetails = dedupCustomerDetails;
	}

	@Override
	public String toString() {
		return "DedupCustomerResponse [response=" + response + ", errorCode=" + errorCode + ", errorDesc=" + errorDesc
