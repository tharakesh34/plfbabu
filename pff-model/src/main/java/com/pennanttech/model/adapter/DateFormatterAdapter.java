 ...
 * 
 * This file is part of Pennant CXF Webservices Application Framework. All components/modules/functions/classes/logic in
 * this software, unless otherwise stated, the property of Pennant Technologies.
 * 
 ...
 ********************************************************************************************
 */
package com.pennanttech.model.adapter;
...
public class DateFormatterAdapter extends XmlAdapter<String, Date> {
	...
	@Override
	public Date unmarshal(final String dateAsString) throws ParseException {
