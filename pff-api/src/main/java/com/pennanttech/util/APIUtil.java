 ...
 *//**
	 ...
	 */
/*
 * public static WSReturnStatus getSuccessStatus() { WSReturnStatus status = new WSReturnStatus();
 * status.setReturnCode(APIConstants.RES_SUCCESS_CODE); status.setReturnText(APIConstants.RES_SUCCESS_DESC); return
 * status; }
 * 
 *//**
	 ...
	 */
/*
 * public static WSReturnStatus getFailedStatus() { WSReturnStatus status = new WSReturnStatus();
 * status.setReturnCode(APIConstants.RES_FAILED_CODE); status.setReturnText(APIConstants.RES_FAILED_DESC); return
 * status; }
 * 
 *//**
