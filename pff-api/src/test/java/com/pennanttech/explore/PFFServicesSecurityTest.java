 ...
 * 
 * 1. PFF application should be running in tomcat at http://localhost:8080/pff-api for running this test. 2. Acadamic
 * services should be running in tomcat.
 * 
 * This has test to authenticate with userid and password in the request header. This has test to authenticate with
 * Token generated by server after validating the userid/password. This has test to authenticate with the Token assigned
 * to the server which is sending the request.
 */
