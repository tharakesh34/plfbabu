 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  FinanceRepayPriorityListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
public class FinanceRepayPriorityListModelItemRenderer implements ListitemRenderer<FinanceRepayPriority>, Serializable {
	...
	public void render(Listitem item, FinanceRepayPriority financeRepayPriority, int count) throws Exception {
		...
		//final FinanceRepayPriority financeRepayPriority = (FinanceRepayPriority) data;
		Listcell lc;
		...
		lc.setParent(item);
		item.setAttribute("data", financeRepayPriority);
