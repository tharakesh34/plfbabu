 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  DocumentTypeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class DocumentTypeListModelItemRenderer implements ListitemRenderer<DocumentType>,
		Serializable {
	...
	public void render(Listitem item, DocumentType documentType, int count) throws Exception {
		...
		lc.setParent(item);
		lc = new Listcell();
		final Checkbox cbDocIsMandatory = new Checkbox();
		cbDocIsMandatory.setDisabled(true);
		cbDocIsMandatory.setChecked(documentType.isDocIsMandatory());
		lc.appendChild(cbDocIsMandatory);
		lc.setParent(item);
		lc = new Listcell();
		...
		lc.setParent(item);
		item.setAttribute("data", documentType);
