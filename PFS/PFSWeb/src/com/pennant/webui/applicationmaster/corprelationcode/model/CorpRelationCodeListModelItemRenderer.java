 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CorpRelationCodeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
 ...
 * 
 */
public class CorpRelationCodeListModelItemRenderer implements ListitemRenderer<CorpRelationCode>,
		Serializable {
	...
	public void render(Listitem item, CorpRelationCode corpRelationCode, int count) throws Exception {
		...
		lc.setParent(item);
		item.setAttribute("data", corpRelationCode);
