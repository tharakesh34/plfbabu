 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  RelationshipOfficerListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
public class RelationshipOfficerListModelItemRenderer implements ListitemRenderer<RelationshipOfficer>, Serializable {
	...
	public void render(Listitem item, RelationshipOfficer relationshipOfficer, int count) throws Exception {
		...
		lc.setParent(item);
	  	lc = new Listcell(relationshipOfficer.getROfficerDeptCode()+"-"+relationshipOfficer.getLovDescROfficerDeptCodeName());
		lc.setParent(item);
		lc = new Listcell();
		...
		lc.setParent(item);
		item.setAttribute("data", relationshipOfficer);
