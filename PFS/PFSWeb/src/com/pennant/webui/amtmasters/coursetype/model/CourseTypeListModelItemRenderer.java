 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CourseTypeListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
public class CourseTypeListModelItemRenderer implements ListitemRenderer<CourseType>, Serializable {
	...
	@Override
	public void render(Listitem item, CourseType courseType, int count) throws Exception {

		//final CourseType courseType = (CourseType) data;
		Listcell lc;
		...
		lc.setParent(item);
		item.setAttribute("data", courseType);
