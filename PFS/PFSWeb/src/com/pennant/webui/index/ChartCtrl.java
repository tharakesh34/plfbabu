 ...
 * /WEB-INF/pages/BMTMasters/Nationality/chart.zul file. <br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 */

public class ChartCtrl extends GFCBaseCtrl implements Serializable {
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window window_chart;     // autoWired
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_chart(Event event) throws Exception {
		...
		if (args.containsKey("chartDetail")) {
			this.chartDetail = (ChartDetail) args.get("chartDetail");

		}
		if (args.containsKey("dashboardConfigurationDialogCtrl")) {
			this.dashboardConfigurationDialogCtrl = (DashboardConfigurationDialogCtrl)args.get("dashboardConfigurationDialogCtrl");
		...
		if(this.chartDetail!=null){
			...
			this.dashboardConfigurationDialogCtrl.window_DashboardConfigurationDialog.appendChild(this.window_chart);
		}
		setDialog(this.window_chart);
	...
	public void doShowChart(ChartDetail chartDetail){
		...
		if(this.chartDetail!=null){
			...
			divFrame.appendChild(chartUtil.getHtmlContent(chartDetail));
		}
		logger.debug("Leaving ");
