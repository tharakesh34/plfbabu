...
public class RateDetail implements Serializable {
	...
	public RateDetail(String baseRateCode, String splRateCode, Date valueDate) {
		this.baseRateCode = baseRateCode;
		this.splRateCode = splRateCode;
		this.valueDate = valueDate;
	}

	public RateDetail(String baseRateCode, String splRateCode, BigDecimal margin, Date valueDate) {
		super();
		this.baseRateCode = baseRateCode;
		this.splRateCode = splRateCode;
		this.valueDate = valueDate;
