 ...
 *
 */
public class ScoringType implements java.io.Serializable {
	...
	public ScoringType() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("ScoringType");
	}
	...
	public boolean equals(ScoringType scoringType) {
		return getId() == scoringType.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ScoringType) {
			ScoringType scoringType = (ScoringType) obj;
			return equals(scoringType);
		}
		return false;
	}
}
