 ...
 * 
 */
public class InterestRateBasisCode implements java.io.Serializable {

	private static final long serialVersionUID = 3132970492211301519L;
	
	private String intRateBasisCode = null;
	...
	public InterestRateBasisCode() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("InterestRateBasisCode");
	}
	...
	public boolean equals(InterestRateBasisCode interestRateBasisCode) {
		return getId() == interestRateBasisCode.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof InterestRateBasisCode) {
			InterestRateBasisCode interestRateBasisCode = (InterestRateBasisCode) obj;
			return equals(interestRateBasisCode);
		}
		return false;
	}
}
