 ...
 *
 */
public class InterestRateType implements java.io.Serializable {

	private static final long serialVersionUID = -4364815634437557784L;
	private String intRateTypeCode = null;
	...
	public InterestRateType() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("InterestRateType");
	}
	...
	public boolean equals(InterestRateType interestRateType) {
		return getId() == interestRateType.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof InterestRateType) {
			InterestRateType interestRateType = (InterestRateType) obj;
			return equals(interestRateType);
		}
		return false;
	}
}
