...
public class TransactionCode implements java.io.Serializable {
	...
	public TransactionCode() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("TransactionCode");
	}
	...
	public boolean equals(TransactionCode transactionCode) {
		return getId() == transactionCode.getId();
	}
