 ...
 *
 */
public class ExpenseType implements java.io.Serializable, Entity {
	...
	public ExpenseType() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("ExpenseType");
	}
	...
	public boolean equals(ExpenseType expenseType) {
		return getId() == expenseType.getId();
	}
