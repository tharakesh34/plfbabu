 ...
 * 
 */
public class PRelationCode implements java.io.Serializable {
	
	private static final long serialVersionUID = -6112299060860374205L;
	
	private String pRelationCode = null;
	...
	public PRelationCode() {
		this.workflowId = WorkFlowUtil.getWorkFlowID("PRelationCode");
	}
	...
	public boolean equals(PRelationCode pRelationCode) {
		return getId() == pRelationCode.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof PRelationCode) {
			PRelationCode pRelationCode = (PRelationCode) obj;
			return equals(pRelationCode);
		}
		return false;
	}
}
