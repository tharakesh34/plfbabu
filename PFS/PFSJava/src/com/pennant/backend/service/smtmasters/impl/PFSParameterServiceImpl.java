 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  PFSParameterServiceImpl.java                                                   * 	  
 *                                                                    						*
...
public class PFSParameterServiceImpl extends GenericService<PFSParameter> implements PFSParameterService {
	...
	public PFSParameter getPFSParameter() {
		return getPFSParameterDAO().getPFSParameter();
	}

	@Override
	public PFSParameter getNewPFSParameter() {
		return getPFSParameterDAO().getNewPFSParameter();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (pFSParameter.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(pFSParameter.getSysParmCode()));
	 ...
	 */
	@Override
	public PFSParameter refresh(PFSParameter pFSParameter) {
		logger.debug("Entering ");
		getPFSParameterDAO().refresh(pFSParameter);
		getPFSParameterDAO().initialize(pFSParameter);
		logger.debug("Leaving ");
		return pFSParameter;
	}
	...
	public AuditHeader doReject(AuditHeader auditHeader) {
		logger.debug("Entering ");
		PFSParameter pFSParameter = (PFSParameter) auditHeader.getModelData();
