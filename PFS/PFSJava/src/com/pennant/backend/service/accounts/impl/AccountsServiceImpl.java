...
public class AccountsServiceImpl extends GenericService<Accounts> implements AccountsService {
	 ...
	 */
	@Override
	public Accounts refresh(Accounts accounts) {
		logger.debug("Entering");
		getAccountsDAO().refresh(accounts);
		getAccountsDAO().initialize(accounts);
		logger.debug("Leaving");
		return accounts;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !accounts.isWorkflow()){
