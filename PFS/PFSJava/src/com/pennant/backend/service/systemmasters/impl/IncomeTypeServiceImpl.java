...
public class IncomeTypeServiceImpl extends GenericService<IncomeType> implements
	...
	public IncomeType getIncomeType() {
		return getIncomeTypeDAO().getIncomeType();
	}

	public IncomeType getNewIncomeType() {
		return getIncomeTypeDAO().getNewIncomeType();
	}
	 ...
	 */
	@Override
	public IncomeType refresh(IncomeType incomeType) {
		logger.debug("Entering");
		getIncomeTypeDAO().refresh(incomeType);
		getIncomeTypeDAO().initialize(incomeType);
		logger.debug("Leaving");
		return incomeType;
	}
