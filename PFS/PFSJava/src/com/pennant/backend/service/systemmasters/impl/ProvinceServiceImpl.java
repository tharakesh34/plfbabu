...
public class ProvinceServiceImpl extends GenericService<Province> implements ProvinceService {
	...
	public Province getProvince() {
		return getProvinceDAO().getProvince();
	}
	public Province getNewProvince() {
		return getProvinceDAO().getNewProvince();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (province.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(province.getCPCountry()) 
	 ...
	 */
	@Override
	public Province refresh(Province province) {
		logger.debug("Entering");
		getProvinceDAO().refresh(province);
		getProvinceDAO().initialize(province);
		logger.debug("Leaving");
		return province;
	}
