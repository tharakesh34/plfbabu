...
public class GeneralDepartmentServiceImpl extends GenericService<GeneralDepartment> implements GeneralDepartmentService {
	...
	public GeneralDepartment getGeneralDepartment() {
		return getGeneralDepartmentDAO().getGeneralDepartment();
	}
	@Override
	public GeneralDepartment getNewGeneralDepartment() {
		return getGeneralDepartmentDAO().getNewGeneralDepartment();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (generalDepartment.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(generalDepartment
					.getGenDepartment()));
		} else {
	 ...
	 */
	@Override
	public GeneralDepartment refresh(GeneralDepartment generalDepartment) {
		logger.debug("Entering");
		getGeneralDepartmentDAO().refresh(generalDepartment);
		getGeneralDepartmentDAO().initialize(generalDepartment);
		logger.debug("Leaving");
		return generalDepartment;
	}
