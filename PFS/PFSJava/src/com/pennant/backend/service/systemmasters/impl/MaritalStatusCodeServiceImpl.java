...
public class MaritalStatusCodeServiceImpl extends GenericService<MaritalStatusCode> implements MaritalStatusCodeService {
	...
	public MaritalStatusCode getMaritalStatusCode() {
		return getMaritalStatusCodeDAO().getMaritalStatusCode();
	}

	public MaritalStatusCode getNewMaritalStatusCode() {
		return getMaritalStatusCodeDAO().getNewMaritalStatusCode();
	}
	 ...
	 */
	@Override
	public MaritalStatusCode refresh(MaritalStatusCode maritalStatusCode) {
		logger.debug("Entering");
		getMaritalStatusCodeDAO().refresh(maritalStatusCode);
		getMaritalStatusCodeDAO().initialize(maritalStatusCode);
		logger.debug("Leaving");
		return maritalStatusCode;
	}
