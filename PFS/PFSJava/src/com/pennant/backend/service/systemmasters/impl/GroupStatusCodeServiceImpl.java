...
public class GroupStatusCodeServiceImpl extends GenericService<GroupStatusCode>
	...
	public GroupStatusCode getGroupStatusCode() {
		return getGroupStatusCodeDAO().getGroupStatusCode();
	}

	public GroupStatusCode getNewGroupStatusCode() {
		return getGroupStatusCodeDAO().getNewGroupStatusCode();
	}
	 ...
	 */
	@Override
	public GroupStatusCode refresh(GroupStatusCode groupStatusCode) {
		logger.debug("Entering");
		getGroupStatusCodeDAO().refresh(groupStatusCode);
		getGroupStatusCodeDAO().initialize(groupStatusCode);
		logger.debug("Leaving");
		return groupStatusCode;
	}
