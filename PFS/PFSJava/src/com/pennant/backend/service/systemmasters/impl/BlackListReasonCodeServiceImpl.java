...
public class BlackListReasonCodeServiceImpl extends
	...
	public BlackListReasonCode getBlackListReasonCode() {
		return getBlackListReasonCodeDAO().getBlackListReasonCode();
	}

	public BlackListReasonCode getNewBlackListReasonCode() {
		return getBlackListReasonCodeDAO().getNewBlackListReasonCode();
	}
	 ...
	 */
	@Override
	public BlackListReasonCode refresh(
			BlackListReasonCode blackListReasonCode) {
		logger.debug("Entering");
		getBlackListReasonCodeDAO().refresh(blackListReasonCode);
		getBlackListReasonCodeDAO().initialize(blackListReasonCode);
		logger.debug("Leaving");
		return blackListReasonCode;
	}
