...
public class CustomerPRelationServiceImpl extends GenericService<CustomerPRelation> implements CustomerPRelationService {
	...
	public CustomerPRelation getCustomerPRelation() {
		return getCustomerPRelationDAO().getCustomerPRelation();
	}
	public CustomerPRelation getNewCustomerPRelation() {
		return getCustomerPRelationDAO().getNewCustomerPRelation();
	}
	 ...
	 */
	@Override
	public CustomerPRelation refresh(CustomerPRelation customerPRelation) {
		logger.debug("Entering");
		getCustomerPRelationDAO().refresh(customerPRelation);
		getCustomerPRelationDAO().initialize(customerPRelation);
		logger.debug("Leaving");
		return customerPRelation;
	}
