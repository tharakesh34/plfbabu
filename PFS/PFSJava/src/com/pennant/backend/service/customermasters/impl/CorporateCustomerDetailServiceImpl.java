...
implements CorporateCustomerDetailService {
	...
	public CorporateCustomerDetail getCorporateCustomerDetail() {
		return getCorporateCustomerDetailDAO().getCorporateCustomerDetail();
	}

	@Override
	public CorporateCustomerDetail getNewCorporateCustomerDetail() {
		return getCorporateCustomerDetailDAO().getNewCorporateCustomerDetail();
	}
	 ...
	 */
	@Override
	public CorporateCustomerDetail refresh(CorporateCustomerDetail corporateCustomerDetail) {
		logger.debug("Entering");
		getCorporateCustomerDetailDAO().refresh(corporateCustomerDetail);
		getCorporateCustomerDetailDAO().initialize(corporateCustomerDetail);
		logger.debug("Leaving");
		return corporateCustomerDetail;
	}
