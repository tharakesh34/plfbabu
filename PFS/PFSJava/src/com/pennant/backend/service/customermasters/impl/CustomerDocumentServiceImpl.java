...
public class CustomerDocumentServiceImpl extends GenericService<CustomerDocument> 
	...
	public CustomerDocument getCustomerDocument() {
		return getCustomerDocumentDAO().getCustomerDocument();
	}

	@Override
	public CustomerDocument getNewCustomerDocument() {
		return getCustomerDocumentDAO().getNewCustomerDocument();
	}
	 ...
	 */
	@Override
	public CustomerDocument getCustomerDocumentById(long id, String docType) {
		return getCustomerDocumentDAO().getCustomerDocumentById(id, docType, "_View");
	}
	 ...
	 */
	@Override
	public CustomerDocument refresh(CustomerDocument customerDocument) {
		logger.debug("Entering");
		getCustomerDocumentDAO().refresh(customerDocument);
		getCustomerDocumentDAO().initialize(customerDocument);
		logger.debug("Leaving");
		return customerDocument;
	}
