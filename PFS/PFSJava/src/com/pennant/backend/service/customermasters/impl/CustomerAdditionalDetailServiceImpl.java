 ...
 * 
 */
public class CustomerAdditionalDetailServiceImpl extends 
			GenericService<CustomerAdditionalDetail> implements CustomerAdditionalDetailService {
	...
	public CustomerAdditionalDetail getCustomerAdditionalDetail() {
		return getCustomerAdditionalDetailDAO().getCustomerAdditionalDetail();
	}
	@Override
	public CustomerAdditionalDetail getNewCustomerAdditionalDetail() {
		return getCustomerAdditionalDetailDAO().getNewCustomerAdditionalDetail();
	}
	 ...
	 */
	@Override
	public CustomerAdditionalDetail refresh(CustomerAdditionalDetail customerAdditionalDetail) {
		logger.debug("Entering ");
		getCustomerAdditionalDetailDAO().refresh(customerAdditionalDetail);
		getCustomerAdditionalDetailDAO().initialize(customerAdditionalDetail);
		logger.debug("Leaving ");
		return customerAdditionalDetail;
	}
