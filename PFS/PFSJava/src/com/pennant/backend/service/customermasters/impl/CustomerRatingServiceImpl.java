...
public class CustomerRatingServiceImpl extends GenericService<CustomerRating> implements CustomerRatingService {
	...
	public CustomerRating getCustomerRating() {
		return getCustomerRatingDAO().getCustomerRating();
	}
	public CustomerRating getNewCustomerRating() {
		return getCustomerRatingDAO().getNewCustomerRating();
	}
	 ...
	 */
	@Override
	public CustomerRating refresh(CustomerRating customerRating) {
		logger.debug("Entering");
		getCustomerRatingDAO().refresh(customerRating);
		getCustomerRatingDAO().initialize(customerRating);
		logger.debug("Leaving");
		return customerRating;
	}
