...
public class CustomerBalanceSheetServiceImpl extends GenericService<CustomerBalanceSheet> 
	...
	private final static Logger logger = Logger.getLogger(CustomerBalanceSheetServiceImpl.class);
	...
	public CustomerBalanceSheet getCustomerBalanceSheet() {
		return getCustomerBalanceSheetDAO().getCustomerBalanceSheet();
	}
	
	@Override
	public CustomerBalanceSheet getNewCustomerBalanceSheet() {
		return getCustomerBalanceSheetDAO().getNewCustomerBalanceSheet();
	}
	 ...
	 * @param CustomerBalanceSheet (customerBalanceSheet)
 	 * @return customerBalanceSheet
	 */
	@Override
	public CustomerBalanceSheet refresh(CustomerBalanceSheet customerBalanceSheet) {
		logger.debug("Entering");
		getCustomerBalanceSheetDAO().refresh(customerBalanceSheet);
		getCustomerBalanceSheetDAO().initialize(customerBalanceSheet);
		logger.debug("Leaving");
		return customerBalanceSheet;
	}
