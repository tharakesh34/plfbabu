...
public class RelationshipOfficerServiceImpl extends	GenericService<RelationshipOfficer> implements
	...
	public RelationshipOfficer getRelationshipOfficer() {
		return getRelationshipOfficerDAO().getRelationshipOfficer();
	}

	@Override
	public RelationshipOfficer getNewRelationshipOfficer() {
		return getRelationshipOfficerDAO().getNewRelationshipOfficer();
	}
	 ...
	 */
	@Override
	public RelationshipOfficer refresh(RelationshipOfficer relationshipOfficer) {
		logger.debug("Entering");
		getRelationshipOfficerDAO().refresh(relationshipOfficer);
		getRelationshipOfficerDAO().initialize(relationshipOfficer);
		logger.debug("Leaving");
		return relationshipOfficer;
	}
