...
public class CustomerCategoryServiceImpl extends
	...
	public CustomerCategory getCustomerCategory() {
		return getCustomerCategoryDAO().getCustomerCategory();
	}

	public CustomerCategory getNewCustomerCategory() {
		return getCustomerCategoryDAO().getNewCustomerCategory();
	}
	 ...
	 */
	@Override
	public CustomerCategory refresh(CustomerCategory customerCategory) {
		logger.debug("Entering");
		getCustomerCategoryDAO().refresh(customerCategory);
		getCustomerCategoryDAO().initialize(customerCategory);
		logger.debug("Leaving");
		return customerCategory;
	}
