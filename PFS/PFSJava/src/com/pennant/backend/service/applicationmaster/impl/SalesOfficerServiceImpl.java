...
public class SalesOfficerServiceImpl extends GenericService<SalesOfficer>
	...
	public SalesOfficer getSalesOfficer() {
		return getSalesOfficerDAO().getSalesOfficer();
	}
	@Override
	public SalesOfficer getNewSalesOfficer() {
		return getSalesOfficerDAO().getNewSalesOfficer();
	}
	 ...
	 */
	@Override
	public SalesOfficer refresh(SalesOfficer salesOfficer) {
		logger.debug("Entering");
		getSalesOfficerDAO().refresh(salesOfficer);
		getSalesOfficerDAO().initialize(salesOfficer);
		logger.debug("Leaving");
		return salesOfficer;
	}
