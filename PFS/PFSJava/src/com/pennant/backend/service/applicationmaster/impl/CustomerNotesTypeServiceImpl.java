...
public class CustomerNotesTypeServiceImpl extends
	...
	private static Logger logger = Logger
			.getLogger(CustomerNotesTypeServiceImpl.class);
	...
	public CustomerNotesType getCustomerNotesType() {
		return getCustomerNotesTypeDAO().getCustomerNotesType();
	}

	public CustomerNotesType getNewCustomerNotesType() {
		return getCustomerNotesTypeDAO().getNewCustomerNotesType();
	}
	 ...
	 */
	@Override
	public CustomerNotesType refresh(CustomerNotesType customerNotesType) {
		logger.debug("Entering");
		getCustomerNotesTypeDAO().refresh(customerNotesType);
		getCustomerNotesTypeDAO().initialize(customerNotesType);
		logger.debug("Leaving");
		return customerNotesType;
	}
