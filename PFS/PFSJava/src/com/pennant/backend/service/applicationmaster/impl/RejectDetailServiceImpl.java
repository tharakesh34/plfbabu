...
public class RejectDetailServiceImpl extends GenericService<RejectDetail> implements RejectDetailService {
	...
	public RejectDetail getRejectDetail() {
		return getRejectDetailDAO().getRejectDetail();
	}

	public RejectDetail getNewRejectDetail() {
		return getRejectDetailDAO().getNewRejectDetail();
	}
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (rejectDetail.isNew()) {
			...
			auditHeader.setAuditReference(String.valueOf(rejectDetail.getRejectCode()));
		} else {
	 ...
	 */
	@Override
	public RejectDetail refresh(RejectDetail rejectDetail) {
		logger.debug("Entering");
		getRejectDetailDAO().refresh(rejectDetail);
		getRejectDetailDAO().initialize(rejectDetail);
		logger.debug("Leaving");
		return rejectDetail;
	}
