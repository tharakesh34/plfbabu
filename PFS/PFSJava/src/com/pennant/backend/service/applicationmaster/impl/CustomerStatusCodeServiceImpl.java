 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  CustomerStatusCodeServiceImpl.java                                   * 	  
 *                                                                    						*
...
public class CustomerStatusCodeServiceImpl extends GenericService<CustomerStatusCode>
	...
	public CustomerStatusCode getCustomerStatusCode() {
		return getCustomerStatusCodeDAO().getCustomerStatusCode();
	}

	public CustomerStatusCode getNewCustomerStatusCode() {
		return getCustomerStatusCodeDAO().getNewCustomerStatusCode();
	}
	 ...
	 */
	@Override
	public CustomerStatusCode refresh(CustomerStatusCode customerStatusCode) {
		logger.debug("Entering");
		getCustomerStatusCodeDAO().refresh(customerStatusCode);
		getCustomerStatusCodeDAO().initialize(customerStatusCode);
		logger.debug("Leaving");
		return customerStatusCode;
	}
