		...
		if(list!=null && list.size()>0){
			...
			for (int i = 0; i < list.size(); i++) {
					...
					try{
						...
						if(activeStatistics ==null || activeStatistics.size()==0){
							...
							if(auditStatistics.getNextRoleCode().equals("")){ 
								...
								System.out.println(prevStatistics.getRoleCode()+"--"+auditStatistics.getNextRoleCode());
						...
						logger.error("Error occured in Module:"+statistics.getModuleName()+"AuditID :"+statistics.getAuditId());
						throw e;
					}
				}
