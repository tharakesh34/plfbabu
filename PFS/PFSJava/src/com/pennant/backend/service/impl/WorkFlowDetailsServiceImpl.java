...
public class WorkFlowDetailsServiceImpl extends GenericService<WorkFlowDetails> implements WorkFlowDetailsService {
	...
	public WorkFlowDetails getNewWorkFlowDetails() {
		return getWorkFlowDetailsDAO().getNewWorkFlowDetails();
	}
	
	public WorkFlowDetails getWorkFlowDetails() {
		return getWorkFlowDetailsDAO().getWorkFlowDetails();
	}
	...
	public WorkFlowDetails refresh(WorkFlowDetails workFlowDetails) {
		getWorkFlowDetailsDAO().refresh(workFlowDetails);
		getWorkFlowDetailsDAO().initialize(workFlowDetails);
	...
	public AuditHeader saveOrUpdate(AuditHeader auditHeader) {
		...
		if (workFlowDetails.isNew()){
			...
			WorkFlowDetails flowDetails=getWorkFlowDetailsDAO().getWorkFlowDetails();
