...
public class WIFFinanceScheduleDetailServiceImpl extends GenericService<FinanceScheduleDetail> implements WIFFinanceScheduleDetailService {
	private final static Logger logger = Logger.getLogger(WIFFinanceScheduleDetailServiceImpl.class);
	...
	public FinanceScheduleDetail getWIFFinanceScheduleDetail() {
		return getWIFFinanceScheduleDetailDAO().getWIFFinanceScheduleDetail();
	}
	/**
	...
	public FinanceScheduleDetail getNewWIFFinanceScheduleDetail() {
		return getWIFFinanceScheduleDetailDAO().getNewWIFFinanceScheduleDetail();
	}
	 ...
	 */
	@Override
	public FinanceScheduleDetail refresh(FinanceScheduleDetail wIFFinanceScheduleDetail) {
		logger.debug("Entering");
		getWIFFinanceScheduleDetailDAO().refresh(wIFFinanceScheduleDetail);
		getWIFFinanceScheduleDetailDAO().initialize(wIFFinanceScheduleDetail);
		logger.debug("Leaving");
		return wIFFinanceScheduleDetail;
	}
	 ...
	 * 		a)  DELETE	Delete the record from the main table by using getWIFFinanceScheduleDetailDAO().delete with parameters wIFFinanceScheduleDetail,""
	 * 		b)  NEW		Add new record in to main table by using getWIFFinanceScheduleDetailDAO().save with parameters wIFFinanceScheduleDetail,""
	 * 		c)  EDIT	Update record in the main table by using getWIFFinanceScheduleDetailDAO().update with parameters wIFFinanceScheduleDetail,""
	 * 3)	Delete the record from the workFlow table by using getWIFFinanceScheduleDetailDAO().delete with parameters wIFFinanceScheduleDetail,"_Temp"
	...
	public AuditHeader doApprove(AuditHeader auditHeader) {
		...
		BeanUtils.copyProperties((FinanceScheduleDetail) auditHeader.getAuditDetail().getModelData(), wIFFinanceScheduleDetail);
	 ...
	 */
		...
		private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
			...
			FinanceScheduleDetail old_WIFFinanceScheduleDetail= wIFFinanceScheduleDetail.getBefImage();
			...
			if(StringUtils.trimToEmpty(method).equals("doApprove") || !wIFFinanceScheduleDetail.isWorkflow()){
