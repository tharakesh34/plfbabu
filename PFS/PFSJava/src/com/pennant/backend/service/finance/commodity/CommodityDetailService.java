...
public interface CommodityDetailService {
	...
	CommodityDetail getCommodityDetailById(CommodityDetail commodityDetail);
	CommodityDetail getApprovedCommodityDetailById(CommodityDetail commodityDetail);
	CommodityDetail refresh(CommodityDetail commodityDetail);
