 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  OwnerShipTypeService.java                                                   * 	  
 *                                                                    						*
...
public interface OwnerShipTypeService {
	...
	OwnerShipType getOwnerShipTypeById(long id);
	OwnerShipType getApprovedOwnerShipTypeById(long id);
	OwnerShipType refresh(OwnerShipType ownerShipType);
