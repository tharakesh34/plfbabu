...
public class CourseServiceImpl extends GenericService<Course> implements CourseService {
	...
	private final static Logger logger = Logger.getLogger(CourseServiceImpl.class);
	...
	public Course getCourse() {
		return getCourseDAO().getCourse();
	}
	public Course getNewCourse() {
		return getCourseDAO().getNewCourse();
	}
	 ...
	 */
	@Override
	public Course refresh(Course course) {
		logger.debug("Entering");
		getCourseDAO().refresh(course);
		getCourseDAO().initialize(course);
		logger.debug("Leaving");
		return course;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !course.isWorkflow()){
