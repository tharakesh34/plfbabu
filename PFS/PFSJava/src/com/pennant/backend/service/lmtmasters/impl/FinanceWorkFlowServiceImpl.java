...
public class FinanceWorkFlowServiceImpl extends GenericService<FinanceWorkFlow> implements FinanceWorkFlowService {
	...
	public FinanceWorkFlow getNewFinanceWorkFlow() {
		return getFinanceWorkFlowDAO().getNewFinanceWorkFlow();
	}
	 ...
	 */
	@Override
	public FinanceWorkFlow getFinanceWorkFlowById(String id) {
		return getFinanceWorkFlowDAO().getFinanceWorkFlowById(id,"_View");
	}
	...
	public FinanceWorkFlow getApprovedFinanceWorkFlowById(String id) {
		return getFinanceWorkFlowDAO().getFinanceWorkFlowById(id,"_AView");
	}
	 ...
	 */
	@Override
	public FinanceWorkFlow refresh(FinanceWorkFlow financeWorkFlow) {
		logger.debug("Entering");
		getFinanceWorkFlowDAO().refresh(financeWorkFlow);
		getFinanceWorkFlowDAO().initialize(financeWorkFlow);
		logger.debug("Leaving");
		return financeWorkFlow;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !financeWorkFlow.isWorkflow()){
