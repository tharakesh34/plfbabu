...
public class ScoringTypeServiceImpl extends GenericService<ScoringType> implements ScoringTypeService {
	 ...
	 */
	@Override
	public ScoringType refresh(ScoringType scoringType) {
		logger.debug("Entering");
		getScoringTypeDAO().refresh(scoringType);
		getScoringTypeDAO().initialize(scoringType);
		logger.debug("Leaving");
		return scoringType;
	}
	...
	private AuditDetail validation(AuditDetail auditDetail,String usrLanguage,String method){
		...
		if(StringUtils.trimToEmpty(method).equals("doApprove") || !scoringType.isWorkflow()){
