...
public class FinContributorDetailDAOImpl extends BasisNextidDaoImpl<FinContributorDetail> implements FinContributorDetailDAO {
	...
	/**
	 * This method set the Work Flow id based on the module name and return the new FinContributorDetail 
	 * @return FinContributorDetail
	 */
	@Override
	public FinContributorDetail getFinContributorDetail() {
		logger.debug("Entering");
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("FinContributorDetail");
		FinContributorDetail contributorDetail= new FinContributorDetail();
		if (workFlowDetails!=null){
			contributorDetail.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getFinContributorDetail() and set the
	 * new record flag as true and return FinContributorDetail()
	 * 
	 * @return FinContributorDetail
	 */
	@Override
	 ...
	 * @param FinContributorDetail (contributorDetail)
	 * @return FinContributorDetail
	 */
	@Override
	public void initialize(FinContributorDetail contributorDetail) {
		super.initialize(contributorDetail);
	}
	 ...
	 */
	@Override
	public void refresh(FinContributorDetail contributorDetail) {
	...
	public long save(FinContributorDetail contributorDetail,String type) {
		...
		if(contributorDetail.getContributorBaseNo() == 0 || contributorDetail.getContributorBaseNo()==Long.MIN_VALUE){
			contributorDetail.setContributorBaseNo(getNextidviewDAO().getNextId("Seq"+PennantJavaUtil.getTabelMap("FinContributorDetail")));	
		}
