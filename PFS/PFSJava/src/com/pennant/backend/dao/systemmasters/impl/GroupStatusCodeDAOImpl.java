...
public class GroupStatusCodeDAOImpl extends BasisCodeDAO<GroupStatusCode> implements GroupStatusCodeDAO {
	...
	public GroupStatusCode getGroupStatusCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("GroupStatusCode");
		GroupStatusCode groupStatusCode = new GroupStatusCode();
		if (workFlowDetails != null) {
			groupStatusCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getGroupStatusCode() and set the
	 * new record flag as true and return GroupStatusCode()
	 * 
	 * @return GroupStatusCode
	 */
	...
	public void initialize(GroupStatusCode groupStatusCode) {
		super.initialize(groupStatusCode);
	}
	 ...
	 */
	@Override
	public void refresh(GroupStatusCode groupStatusCode) {
