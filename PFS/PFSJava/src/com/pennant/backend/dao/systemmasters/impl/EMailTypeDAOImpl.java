...
public class EMailTypeDAOImpl extends BasisCodeDAO<EMailType> implements EMailTypeDAO {
	...
	public EMailType getEMailType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("EMailType");
		EMailType eMailType = new EMailType();
		if (workFlowDetails != null) {
			eMailType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getEMailType() and set the new
	 * record flag as true and return EMailType()
	 * 
	 * @return EMailType
	 */
	@Override
	 ...
	 */
	@Override
	public void refresh(EMailType eMailType) {
