...
public class BlackListReasonCodeDAOImpl extends BasisCodeDAO<BlackListReasonCode> implements BlackListReasonCodeDAO {
	...
	public BlackListReasonCode getBlackListReasonCode() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("BlackListReasonCode");
		BlackListReasonCode blackListReasonCode = new BlackListReasonCode();
		if (workFlowDetails != null) {
			blackListReasonCode.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getBlackListReasonCode() and set
	 * the new record flag as true and return BlackListReasonCode()
	 * 
	 * @return BlackListReasonCode
	 */
	@Override
	...
	public void initialize(BlackListReasonCode blackListReasonCode) {
		super.initialize(blackListReasonCode);
	}
	 ...
	 */
	@Override
	public void refresh(BlackListReasonCode blackListReasonCode) {
