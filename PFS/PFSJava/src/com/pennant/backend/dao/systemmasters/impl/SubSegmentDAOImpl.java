...
public class SubSegmentDAOImpl extends BasisCodeDAO<SubSegment> implements SubSegmentDAO {
	...
	public SubSegment getSubSegment() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("SubSegment");
		SubSegment subSegment = new SubSegment();
		if (workFlowDetails != null) {
			subSegment.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getSubSegment() and set the new
	 * record flag as true and return SubSegment()
	 * 
	 * @return SubSegment
	 */
	@Override
	...
	public SubSegment getSubSegmentById(final String id, String subSegmentCode,String type) {
		...
		selectSql.append(" Where SegmentCode =:SegmentCode and SubSegmentCode=:SubSegmentCode");
	 ...
	 */
	@Override
	public void refresh(SubSegment subSegment) {
	...
	public void update(SubSegment subSegment, String type) {
		...
		updateSql.append(" Where SegmentCode =:SegmentCode and SubSegmentCode = :SubSegmentCode");
