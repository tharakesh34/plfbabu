...
public class DocumentTypeDAOImpl extends BasisCodeDAO<DocumentType> implements DocumentTypeDAO {
	...
	public DocumentType getDocumentType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("DocumentType");
		DocumentType documentType = new DocumentType();
		if (workFlowDetails != null) {
			documentType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getDocumentType() and set the new
	 * record flag as true and return DocumentType()
	 * 
	 * @return DocumentType
	 */
	@Override
	public DocumentType getNewDocumentType() {
		...
		logger.debug("Leaving getNewDocumentType()");
		return documentType;
	}
