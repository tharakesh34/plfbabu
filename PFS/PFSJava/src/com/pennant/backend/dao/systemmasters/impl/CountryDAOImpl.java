...
public class CountryDAOImpl extends BasisCodeDAO<Country> implements CountryDAO {
	...
	public Country getCountry() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("Country");
		Country country = new Country();
		if (workFlowDetails != null) {
			country.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getCountry() and set the new
	 * record flag as true and return Country()
	 * 
	 * @return Country
	 */
	@Override
	...
	public Country getCountryById(final String id, String type) {
		...
		selectSql.append("SELECT CountryCode, CountryDesc, CountryParentLimit, CountryResidenceLimit,CountryRiskLimit, CountryIsActive," );
	...
	public String save(Country country, String type) {
		...
		insertSql.append(" CountryRiskLimit, CountryIsActive,");
	...
	public void update(Country country, String type) {
		...
		updateSql.append(" CountryIsActive = :CountryIsActive,");
