...
public class CustomerNotesTypeDAOImpl extends BasisCodeDAO<CustomerNotesType> implements CustomerNotesTypeDAO {
	...
	public CustomerNotesType getCustomerNotesType() {
		...
		WorkFlowDetails workFlowDetails = WorkFlowUtil.getWorkFlowDetails("CustomerNotesType");
		CustomerNotesType customerNotesType = new CustomerNotesType();
		if (workFlowDetails != null) {
			customerNotesType.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getCustomerNotesType() and set the
	 * new record flag as true and return CustomerNotesType()
	 * 
	 * @return CustomerNotesType
	 */
	@Override
	...
	public CustomerNotesType getCustomerNotesTypeById(final String id, String type) {
		...
		if(type.contains("View")){
			selectSql.append(" lovDescCustNotesTypeArchiveFrqName,");
		}
	...
	public void initialize(CustomerNotesType customerNotesType) {
		super.initialize(customerNotesType);
	}
	 ...
	 */
	@Override
	public void refresh(CustomerNotesType customerNotesType) {
