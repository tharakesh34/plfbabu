...
public class CorporateCustomerDetailDAOImpl extends BasisNextidDaoImpl<CorporateCustomerDetail> 
	...
	public CorporateCustomerDetail getCorporateCustomerDetail() {
		...
		WorkFlowDetails workFlowDetails=WorkFlowUtil.getWorkFlowDetails("CorporateCustomerDetail");
		CorporateCustomerDetail corporateCustomerDetail= new CorporateCustomerDetail();
		if (workFlowDetails!=null){
			corporateCustomerDetail.setWorkflowId(workFlowDetails.getWorkFlowId());
		}
	...
	/**
	 * This method get the module from method getCorporateCustomerDetail() and
	 * set the new record flag as true and return CorporateCustomerDetail()
	 * 
	 * @return CorporateCustomerDetail
	 */
	@Override
	 ...
	 * @param CorporateCustomerDetail (corporateCustomerDetail)
 	 * @return CorporateCustomerDetail
	 */
	@Override
	public void initialize(CorporateCustomerDetail corporateCustomerDetail) {
		super.initialize(corporateCustomerDetail);
	}
	 ...
	 */
	@Override
	public void refresh(CorporateCustomerDetail corporateCustomerDetail) {
	...
	public void delete(CorporateCustomerDetail corporateCustomerDetail,String type) {
		...
		try{
			...
			if (recordCount <= 0) {
				ErrorDetails errorDetails= getError("41003",corporateCustomerDetail.getId() ,
						corporateCustomerDetail.getUserDetails().getUsrLanguage());
				throw new DataAccessException(errorDetails.getError()) {};
			}
		}catch(DataAccessException e){
			logger.error(e);
			ErrorDetails errorDetails= getError("41006",corporateCustomerDetail.getId() ,
					corporateCustomerDetail.getUserDetails().getUsrLanguage());
			throw new DataAccessException(errorDetails.getError()) {};
		}
		logger.debug("Leaving");
	...
	public void update(CorporateCustomerDetail corporateCustomerDetail,String type) {
		...
		if (recordCount <= 0) {
			...
			ErrorDetails errorDetails= getError("41004",corporateCustomerDetail.getId() ,
					corporateCustomerDetail.getUserDetails().getUsrLanguage());
			throw new DataAccessException(errorDetails.getError()) {};
		}
		logger.debug("Leaving");
