...
public class UserImpl extends User implements Serializable, com.pennant.policy.User {
	...
	public UserImpl(SecurityUser user, Collection<GrantedAuthority> grantedAuthorities,List<SecurityRole> securityRole) throws IllegalArgumentException {

		super(user.getUsrLogin(), user.getUsrPwd(), user.isUsrEnabled(), user.isAccountNonExpired(), user.isCredentialsNonExpired(), user.isAccountNonLocked(), grantedAuthorities);
