...
public class AbstractPresentmentProcess extends AbstractInterface implements PresentmentProcess {
	private static final Logger	logger	= Logger.getLogger(AbstractPresentmentProcess.class);

	@Autowired(required = false)
	private PresentmentResponse	presentmentResponse;
	...
	public void setPresentmentResponse(PresentmentResponse presentmentResponse) {
		this.presentmentResponse = presentmentResponse;
	}
