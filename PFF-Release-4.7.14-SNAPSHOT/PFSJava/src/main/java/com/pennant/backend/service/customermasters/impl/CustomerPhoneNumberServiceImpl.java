 ...
 * 
 */
public class CustomerPhoneNumberServiceImpl extends GenericService<CustomerPhoneNumber> implements
	...
	/**
	 * getApprovedCustomerPhoneNumberById fetch the details by using
	 * CustomerPhoneNumberDAO's getApprovedCustomerPhoneNumberById method . with
	 * parameter custID. it fetches the approved records from the
	 * CustomerPhoneNumbers.
	 * 
	 * @param custID
	 *           
