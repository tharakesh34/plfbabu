...
public interface LimitGroupDAO {
	...
	LimitGroup getLimitGroupById(String id, String type);

	void update(LimitGroup limitGroup, String type);

	void delete(LimitGroup limitGroup, String type);

	String save(LimitGroup limitGroup, String type);
}