...
public class InterfaceCoreCustomer implements Serializable {
	...
	private String monthlyOutageVolume;
	private String monthlyIncomeVolume;
	private String maximumSingleDeposit;
	private String maximumSingleWithdrawal;
	...
	public String getMonthlyOutageVolume() {
	...
	public void setMonthlyIncomeVolume(String monthlyIncomeVolume) {
		this.monthlyIncomeVolume = monthlyIncomeVolume;
	}

	public String getMaximumSingleDeposit() {
		return maximumSingleDeposit;
	}

	public void setMaximumSingleDeposit(String maximumSingleDeposit) {
		this.maximumSingleDeposit = maximumSingleDeposit;
	}

	public String getMaximumSingleWithdrawal() {
		return maximumSingleWithdrawal;
	}

	public void setMaximumSingleWithdrawal(String maximumSingleWithdrawal) {
