...
public class ReportConfigurationDialogCtrl extends GFCBaseCtrl<ReportConfiguration> {
	...
	public void onCreate$window_ReportConfigurationDialog(Event event) throws Exception {
		...
		try {
			...
			if (arguments.containsKey("reportConfigurationListCtrl")) {
				setReportConfigurationListCtrl((ReportConfigurationListCtrl) arguments.get("reportConfigurationListCtrl"));
			} else {
	...
	private void doDelete() throws InterruptedException {
		...
		final String msg = Labels.getLabel("message.Question.Are_you_sure_to_delete_this_record") + "\n\n --> " +
				Labels.getLabel("label_ReportConfigurationDialog_ReportName.value")+" : "+aReportConfiguration.getReportName();
