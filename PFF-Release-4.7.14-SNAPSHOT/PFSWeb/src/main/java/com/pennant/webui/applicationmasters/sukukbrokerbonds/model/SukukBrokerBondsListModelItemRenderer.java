 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  SukukBrokerBondsListModelItemRenderer.java                                                   * 	  
 *                                                                    						*
...
package com.pennant.webui.applicationmasters.sukukbrokerbonds.model;
 ...
 * 
 */
public class SukukBrokerBondsListModelItemRenderer implements ListitemRenderer<SukukBrokerBonds>, Serializable {
	...
	public void render(Listitem item, SukukBrokerBonds sukukBrokerBonds, int count) throws Exception {
		...
		lc.setParent(item);
		item.setAttribute("data", sukukBrokerBonds);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onSukukBrokerBondsItemDoubleClicked");
	}
}