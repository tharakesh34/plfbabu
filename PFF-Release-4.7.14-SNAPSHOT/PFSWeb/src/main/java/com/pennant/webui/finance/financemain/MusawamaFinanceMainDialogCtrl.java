 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  MusawamaFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
 ...
 */
public class MusawamaFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	private static final long serialVersionUID = 6004939933729664895L;
	private static final Logger logger = Logger.getLogger(MusawamaFinanceMainDialogCtrl.class);
	 ...
	 */
	protected Window 		window_MusawamaFinanceMainDialog; 					// autoWired

	/**
	 * default constructor.<br>
	 */
	public MusawamaFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_MusawamaFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_MusawamaFinanceMainDialog);
		...
		setMainWindow(window_MusawamaFinanceMainDialog);
		setProductCode("Musawama");
	 ...
	 * @throws Exception
	 */
	public void onClose$window_MusawamaFinanceMainDialog(Event event) throws Exception {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_MusawamaFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
