 ...
 ********************************************************************************************
 *																							*
 * FileName    		:  StructuredMurabahaFinanceMainDialogCtrl.java                                   * 	  
 *                                                                    						*
...
public class StructuredMurabahaFinanceMainDialogCtrl extends FinanceMainBaseCtrl {
	 ...
	 */
	protected Window 		window_StructuredMurabahaFinanceMainDialog; 					// autoWired
	
	/**
	 * default constructor.<br>
	 */
	public StructuredMurabahaFinanceMainDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$window_StructuredMurabahaFinanceMainDialog(Event event) throws Exception {
		logger.debug("Entering");

		// Set the page level components.
		setPageComponents(window_StructuredMurabahaFinanceMainDialog);
		...
		setMainWindow(window_StructuredMurabahaFinanceMainDialog);
		setProductCode("StructuredMurabaha");
		...
		Events.echoEvent("onPostWinCreation", this.window_StructuredMurabahaFinanceMainDialog, null);
	 ...
	 * @throws Exception
	 */
	public void onClose$window_StructuredMurabahaFinanceMainDialog(Event event) throws Exception {
	...
	public void onClick$btnHelp(Event event) throws InterruptedException {
		logger.debug("Entering " + event.toString());
		MessageUtil.showHelpWindow(event, window_StructuredMurabahaFinanceMainDialog);
		logger.debug("Leaving " + event.toString());
	}
