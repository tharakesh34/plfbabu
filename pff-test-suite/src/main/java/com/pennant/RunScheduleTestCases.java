	...
	public static void main(String[] args) {
		try {
			...
			if (SN01_RR_EQUAL_REQ.RunTestCase()) {
				System.out.println("Result for : SN01_RR_EQUAL_REQ : success");
			} else {
				System.err.println("Result for : SN01_RR_EQUAL_REQ : failed");
			}
			if (SN01_RR_EQUAL.RunTestCase()) {
				System.out.println("Result for : SN01_RR_EQUAL  : success");
			} else {
				System.err.println("Result for : SN01_RR_EQUAL : failed");
			}
