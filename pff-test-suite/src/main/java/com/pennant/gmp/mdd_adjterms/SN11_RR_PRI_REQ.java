...
public class SN11_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(3430143);
	private static BigDecimal expectedTotPft = new BigDecimal(16703224);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN11_RR_PRI_REQ.class.getName()
				+ ".xls";
