...
public class SN11_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(6036822);
	private static BigDecimal expectedTotPft = new BigDecimal(16490967);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN11_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
