...
public class SN11_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2904757);
	private static BigDecimal expectedTotPft = new BigDecimal(16827838);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN11_RR_EQUAL_REQ.class.getName() + ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			// Add Disbursement with adjust terms
