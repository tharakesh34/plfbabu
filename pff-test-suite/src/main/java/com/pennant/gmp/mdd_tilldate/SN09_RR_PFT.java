...
public class SN09_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(155881097);
	private static BigDecimal expectedTotPft = new BigDecimal(20516921);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN09_RR_PFT.class.getName()
				+ ".xls";
