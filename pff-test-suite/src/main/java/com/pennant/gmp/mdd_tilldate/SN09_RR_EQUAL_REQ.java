package com.pennant.gmp.mdd_tilldate;
...
public class SN09_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(18203243);
	private static BigDecimal expectedTotPft = new BigDecimal(15243877);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN09_RR_EQUAL_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			Amount = new BigDecimal(13000000);
			...
			sh2.getFinanceMain().setRecalToDate(DateUtility.getDate("31/12/2012"));
			schdMethod = CalculationConstants.EQUAL;
			sh2 = ScheduleCalculator.changeRepay(sh2, Amount, schdMethod);
