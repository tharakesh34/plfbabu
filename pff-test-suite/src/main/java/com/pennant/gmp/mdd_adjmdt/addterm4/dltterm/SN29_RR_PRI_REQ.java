...
public class SN29_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(12310301);
	private static BigDecimal expectedTotPft = new BigDecimal(16633382);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN29_RR_PRI_REQ.class.getName()
				+ ".xls";
