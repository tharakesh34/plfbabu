...
public class SN18_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(1852502);
	private static BigDecimal expectedTotPft = new BigDecimal(16503469);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN18_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
