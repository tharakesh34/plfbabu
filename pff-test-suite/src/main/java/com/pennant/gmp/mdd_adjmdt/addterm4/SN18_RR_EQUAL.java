...
public class SN18_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2809431);
	private static BigDecimal expectedTotPft = new BigDecimal(16819612);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN18_RR_EQUAL.class.getName() + ".xls";
