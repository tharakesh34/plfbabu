...
public class SN29_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(12360664);
	private static BigDecimal expectedTotPft = new BigDecimal(16637377);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN29_RR_PRI.class.getName() + ".xls";
