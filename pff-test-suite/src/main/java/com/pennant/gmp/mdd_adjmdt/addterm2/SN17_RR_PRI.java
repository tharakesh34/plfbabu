...
public class SN17_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7935490);
	private static BigDecimal expectedTotPft = new BigDecimal(16685271);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN17_RR_PRI.class.getName() + ".xls";
