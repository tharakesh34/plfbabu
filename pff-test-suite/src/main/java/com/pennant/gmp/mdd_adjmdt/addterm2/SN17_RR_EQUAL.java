...
public class SN17_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7293821);
	private static BigDecimal expectedTotPft = new BigDecimal(16800652);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN17_RR_EQUAL.class.getName()
				+ ".xls";
