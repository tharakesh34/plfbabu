...
public class SN18_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(110723288);
	private static BigDecimal expectedTotPft = new BigDecimal(26891093);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN18_RR_PFT.class.getName() + ".xls";
