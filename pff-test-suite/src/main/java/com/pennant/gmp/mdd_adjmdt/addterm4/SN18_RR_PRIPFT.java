...
public class SN18_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(1677982);
	private static BigDecimal expectedTotPft = new BigDecimal(16487982);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN18_RR_PRIPFT.class.getName()
				+ ".xls";
