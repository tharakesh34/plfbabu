...
public class SN17_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(110675068);
	private static BigDecimal expectedTotPft = new BigDecimal(25420408);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN17_RR_PFT.class.getName() + ".xls";
