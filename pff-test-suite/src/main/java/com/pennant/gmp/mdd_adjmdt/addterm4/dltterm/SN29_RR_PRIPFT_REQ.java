...
public class SN29_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(10229032);
	private static BigDecimal expectedTotPft = new BigDecimal(16454145);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN29_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
