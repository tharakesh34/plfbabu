...
public class SN29_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(110747397);
	private static BigDecimal expectedTotPft = new BigDecimal(24745340);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN29_RR_PFT.class.getName() + ".xls";
