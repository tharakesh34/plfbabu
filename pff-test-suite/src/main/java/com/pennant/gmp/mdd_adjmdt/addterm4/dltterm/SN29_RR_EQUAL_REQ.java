...
public class SN29_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(11840108);
	private static BigDecimal expectedTotPft = new BigDecimal(16763189);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN29_RR_EQUAL_REQ.class.getName()
				+ ".xls";
