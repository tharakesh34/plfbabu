package com.pennant.gmp.mdd_adjmdt.addterm4;
...
public class SN18_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(153945);
	private static BigDecimal expectedTotPft = new BigDecimal(16707904);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN18_RR_PRI.class.getName() + ".xls";
