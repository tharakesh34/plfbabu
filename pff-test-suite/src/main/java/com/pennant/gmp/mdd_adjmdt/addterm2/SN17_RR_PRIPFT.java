...
public class SN17_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5869124);
	private static BigDecimal expectedTotPft = new BigDecimal(16476658);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN17_RR_PRIPFT.class.getName()
				+ ".xls";
