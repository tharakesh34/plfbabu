package com.pennant.gmp.mdd_adjmdt.addterm4.dltterm;
...
public class SN29_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(10067937);
	private static BigDecimal expectedTotPft = new BigDecimal(16440859);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN29_RR_PRIPFT.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh2 = ScheduleCalculator.addTerm(sh2, 4, schdMethod);
					
			//Delete Terms from 28th Feb14
			sh2.getFinanceMain().setEventFromDate(
					DateUtility.getDate("28/02/2014"));
			sh2 = ScheduleCalculator.deleteTerm(sh2);
