...
public class SN12_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(9036900);
	private static BigDecimal expectedTotPft = new BigDecimal(14471561);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN12_RR_EQUAL.class.getName() + ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setFinReference("I AM ORIGINAL");
			...
			financeDetail.getFinScheduleData().setFinReference("I AM ORIGINAL");
