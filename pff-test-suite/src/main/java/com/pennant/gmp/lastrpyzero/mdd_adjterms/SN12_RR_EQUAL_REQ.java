...
public class SN12_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(9117011);
	private static BigDecimal expectedTotPft = new BigDecimal(14477972);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN12_RR_EQUAL_REQ.class.getName() + ".xls";
