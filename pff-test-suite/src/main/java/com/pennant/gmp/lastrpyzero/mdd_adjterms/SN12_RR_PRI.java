...
public class SN12_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(9608876);
	private static BigDecimal expectedTotPft = new BigDecimal(14377333);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN12_RR_PRI.class.getName() + ".xls";
