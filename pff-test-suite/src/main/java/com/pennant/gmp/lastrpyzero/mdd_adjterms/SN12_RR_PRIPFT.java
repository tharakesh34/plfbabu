package com.pennant.gmp.lastrpyzero.mdd_adjterms;
...
public class SN12_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8389947);
	private static BigDecimal expectedTotPft = new BigDecimal(14286847);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc() + SN12_RR_PRIPFT.class.getName() + ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			String schdMethod = CalculationConstants.PRI_PFT;
			...
			// FinanceDetail orgSchedule = new FinanceDetail();
			// orgSchedule = ScheduleCalculator.addDisbursement(sh2, Amount,
			// tillDate);
			...
			// System.err.println("Service Returned Error");
			// }
