...
public class SN10_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(6523129);
	private static BigDecimal expectedTotPft = new BigDecimal(21421394);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN10_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(2500000));
			...
			// Change Repayment to 64500 till maturity date
			Amount = new BigDecimal(6450000);
			sh2.getFinanceMain().setEventFromDate(
