package com.pennant.gmp.mdd_tillmdt.chdrat_curprd;
...
public class SN10_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7919883);
	private static BigDecimal expectedTotPft = new BigDecimal(21550310);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN10_RR_PRI_REQ.class.getName()
				+ ".xls";
