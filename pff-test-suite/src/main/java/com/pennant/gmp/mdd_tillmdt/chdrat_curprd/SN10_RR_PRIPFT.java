...
public class SN10_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(6495041);
	private static BigDecimal expectedTotPft = new BigDecimal(21419161);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN10_RR_PRIPFT.class.getName()
				+ ".xls";
