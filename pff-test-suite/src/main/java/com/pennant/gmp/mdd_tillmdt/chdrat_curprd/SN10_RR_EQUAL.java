...
public class SN10_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(6972487);
	private static BigDecimal expectedTotPft = new BigDecimal(21751463);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN10_RR_EQUAL.class.getName()
				+ ".xls";
