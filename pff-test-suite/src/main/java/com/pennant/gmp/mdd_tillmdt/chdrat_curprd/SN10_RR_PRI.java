...
public class SN10_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7904676);
	private static BigDecimal expectedTotPft = new BigDecimal(21549150);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN10_RR_PRI.class.getName() + ".xls";
