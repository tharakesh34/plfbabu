...
public class SN10_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7533146);
	private static BigDecimal expectedTotPft = new BigDecimal(21794748);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN10_RR_EQUAL_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			// Change Repay amount to 69500.00 till maturity
			Amount = new BigDecimal(6950000);
			sh2.getFinanceMain().setEventFromDate(
