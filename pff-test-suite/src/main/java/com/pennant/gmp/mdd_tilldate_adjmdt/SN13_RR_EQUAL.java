...
public class SN13_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(16627105);
	private static BigDecimal expectedTotPft = new BigDecimal(17583578);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN13_RR_EQUAL.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh2.getFinanceMain().setRecalType(
					CalculationConstants.RPYCHG_TILLDATE);
			sh2.getFinanceMain().setRecalToDate(DateUtility.getDate("31/032/2012"));
