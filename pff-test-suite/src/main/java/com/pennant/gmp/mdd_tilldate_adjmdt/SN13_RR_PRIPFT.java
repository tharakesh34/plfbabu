...
public class SN13_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(14661796);
	private static BigDecimal expectedTotPft = new BigDecimal(17270180);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN13_RR_PRIPFT.class.getName()
				+ ".xls";
