...
public class SN13_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(17220156);
	private static BigDecimal expectedTotPft = new BigDecimal(17453756);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN13_RR_PRI.class.getName() + ".xls";
