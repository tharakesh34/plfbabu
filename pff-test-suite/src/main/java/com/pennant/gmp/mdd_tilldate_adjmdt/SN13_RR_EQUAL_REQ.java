package com.pennant.gmp.mdd_tilldate_adjmdt;
...
public class SN13_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(16732199);
	private static BigDecimal expectedTotPft = new BigDecimal(17591681);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN13_RR_EQUAL_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(4650000));
			...
			// Add Disbursement with recalculation adjust to maturity date
			...
			sh2.getFinanceMain().setRecalToDate(DateUtility.getDate("31/03/2012"));
