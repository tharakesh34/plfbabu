...
public class SN13_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(17168378);
	private static BigDecimal expectedTotPft = new BigDecimal(17449821);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN13_RR_PRI_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(4625000));
