...
public class SN06_FR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(15023507);
	...
	private static String getFile() {
		return getFileLoc() + SN06_FR_EQUAL_REQ.class.getName()
				+ ".xls";
