...
public class SN05_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(11779978);
	private static BigDecimal expectedTotPft = new BigDecimal(9779978);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN05_RR_EQUAL_REQ.class.getName()
				+ ".xls";
