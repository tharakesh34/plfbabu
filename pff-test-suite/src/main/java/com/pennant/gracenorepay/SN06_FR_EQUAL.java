...
public class SN06_FR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8585295);
	...
	private static String getFile() {
		return getFileLoc() + SN06_FR_EQUAL.class.getName()
				+ ".xls";
