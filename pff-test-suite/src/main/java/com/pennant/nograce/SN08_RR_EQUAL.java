...
public class SN08_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4456499);
	private static BigDecimal expectedTotPft = new BigDecimal(6955723);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN08_RR_EQUAL.class.getName()
				+ ".xls";
