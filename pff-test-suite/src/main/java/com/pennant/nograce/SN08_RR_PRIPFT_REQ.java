...
public class SN08_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8054356);
	private static BigDecimal expectedTotPft = new BigDecimal(7106356);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN08_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setNextRepayDate(DateUtility.getDate("31/01/2011"));
			sh.setRepayPftFrq("M0031");
			sh.setNextRepayPftDate(DateUtility.getDate("31/01/2011"));
			sh.setAllowRepayRvw(true);
			sh.setRepayRvwFrq("Q0331");
			sh.setNextRepayRvwDate(DateUtility.getDate("31/03/2011"));
			sh.setAllowRepayCpz(true);
			sh.setRepayCpzFrq("H0631");
			sh.setNextRepayCpzDate(DateUtility.getDate("30/06/2011"));
			sh.setMaturityDate(DateUtility.getDate("31/12/2012"));
			//sh.setCpzAtGraceEnd(true);
			sh.setDownPayment(BigDecimal.ZERO);
			sh.setReqRepayAmount(new BigDecimal(4000000));
			...
			sh.setGrcPeriodEndDate(DateUtility.getDate("01/01/2011"));
			...
			tillDate = DateUtility.getDate("31/12/2012");
			String schdMethod = CalculationConstants.NOPAY;
			sh2 = ScheduleCalculator.changeRepay(sh2, Amount, tillDate,
					schdMethod);
