...
public class SN08_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5740815);
	private static BigDecimal expectedTotPft = new BigDecimal(6940815);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN08_RR_PRI_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(4400000));
			...
			sh2 = ScheduleCalculator.changeRepay(sh2, Amount, tillDate, schdMethod);
