...
public class SN08_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(100679452);
	private static BigDecimal expectedTotPft = new BigDecimal(13883562);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN08_RR_PFT.class.getName()
				+ ".xls";
