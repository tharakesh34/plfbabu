...
public class SN08_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5855750);
	private static BigDecimal expectedTotPft = new BigDecimal(7055750);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN08_RR_EQUAL_REQ.class.getName()
				+ ".xls";
