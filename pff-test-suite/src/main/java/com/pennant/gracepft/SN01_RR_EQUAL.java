...
public class SN01_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7799907);
	private static BigDecimal expectedTotPft = new BigDecimal(9323748);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN01_RR_EQUAL.class.getName()
				+ ".xls";
