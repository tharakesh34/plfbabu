...
public class SN02_FR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8770341);
	...
	private static String getFile() {
		return getFileLoc() + SN02_FR_EQUAL_REQ.class.getName()
				+ ".xls";
