...
public class SN01_RR_EQUAL_REQ extends TestingUtil {
	...
	private static BigDecimal expectedResult = new BigDecimal(11229990);
	private static BigDecimal expectedTotPft = new BigDecimal(9454854);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN01_RR_EQUAL_REQ.class.getName()
				+ ".xls";
