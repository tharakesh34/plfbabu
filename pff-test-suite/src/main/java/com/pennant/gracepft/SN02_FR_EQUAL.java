...
public class SN02_FR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8064196);
	...
	private static String getFile() {
		return getFileLoc() + SN02_FR_EQUAL.class.getName()
				+ ".xls";
