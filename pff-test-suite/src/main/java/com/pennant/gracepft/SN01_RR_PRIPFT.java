...
public class SN01_RR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7550959);
	private static BigDecimal expectedTotPft = new BigDecimal(9285771);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN01_RR_PRIPFT.class.getName()
				+ ".xls";
