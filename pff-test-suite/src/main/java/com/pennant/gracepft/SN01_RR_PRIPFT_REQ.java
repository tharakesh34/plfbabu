...
public class SN01_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(13088329);
	private static BigDecimal expectedTotPft = new BigDecimal(9499733);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN01_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
