...
public class SN02_FR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(11466271);
	...
	private static String getFile() {
		return getFileLoc() + SN02_FR_PRI.class.getName()
				+ ".xls";
