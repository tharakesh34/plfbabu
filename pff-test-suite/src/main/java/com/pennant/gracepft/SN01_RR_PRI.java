...
public class SN01_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8774247);
	private static BigDecimal expectedTotPft = new BigDecimal(9295889);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN01_RR_PRI.class.getName()
				+ ".xls";
