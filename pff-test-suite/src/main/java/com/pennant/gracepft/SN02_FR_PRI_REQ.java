...
public class SN02_FR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(14397276);
	private static BigDecimal expectedTotPft = new BigDecimal(12622140);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN02_FR_PRI_REQ.class.getName()
				+ ".xls";
