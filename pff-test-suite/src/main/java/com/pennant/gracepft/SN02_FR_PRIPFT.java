...
public class SN02_FR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8111507);
	...
	private static String getFile() {
		return getFileLoc() + SN02_FR_PRIPFT.class.getName()
				+ ".xls";
