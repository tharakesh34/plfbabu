...
public class SN04_FR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(12207200);
	...
	private static String getFile() {
		return getFileLoc() + SN04_FR_PRI.class.getName()
				+ ".xls";
