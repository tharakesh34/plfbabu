...
public class SN03_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(11706743);
	private static BigDecimal expectedTotPft = new BigDecimal(9706743);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN03_RR_PRI_REQ.class.getName()
				+ ".xls";
