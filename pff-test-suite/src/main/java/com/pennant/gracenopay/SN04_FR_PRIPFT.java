...
public class SN04_FR_PRIPFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8635656);
	...
	private static String getFile() {
		return getFileLoc() + SN04_FR_PRIPFT.class.getName()
				+ ".xls";
