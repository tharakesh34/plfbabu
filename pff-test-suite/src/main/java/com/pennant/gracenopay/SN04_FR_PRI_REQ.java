...
public class SN04_FR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(15158643);
	private static BigDecimal expectedTotPft = new BigDecimal(13158643);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN04_FR_PRI_REQ.class.getName()
				+ ".xls";
