package com.pennant.gracenopay;
...
public class SN04_FR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8466696);
	...
	private static String getFile() {
		return getFileLoc() + SN04_FR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setGrcRateBasis("F");
			sh.setRepayRateBasis("F");
