...
public class SN16_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5018850);
	private static BigDecimal expectedTotPft = new BigDecimal(14956861);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN16_RR_EQUAL.class.getName()
				+ ".xls";
