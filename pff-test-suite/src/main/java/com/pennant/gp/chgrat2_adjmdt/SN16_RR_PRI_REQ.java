...
public class SN16_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5617584);
	private static BigDecimal expectedTotPft = new BigDecimal(14846045);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN16_RR_PRI_REQ.class.getName()
				+ ".xls";
