...
public class SN16_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5102387);
	private static BigDecimal expectedTotPft = new BigDecimal(14963348);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN16_RR_EQUAL_REQ.class.getName()
				+ ".xls";
