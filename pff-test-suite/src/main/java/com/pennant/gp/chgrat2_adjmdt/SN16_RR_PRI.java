...
public class SN16_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5603439);
	private static BigDecimal expectedTotPft = new BigDecimal(14844964);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN16_RR_PRI.class.getName() + ".xls";
