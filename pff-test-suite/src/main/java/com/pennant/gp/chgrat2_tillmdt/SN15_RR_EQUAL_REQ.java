...
public class SN15_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4523230);
	private static BigDecimal expectedTotPft = new BigDecimal(14918389);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN15_RR_EQUAL_REQ.class.getName()
				+ ".xls";
