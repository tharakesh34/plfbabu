package com.pennant.gp.chgrat2_tillmdt;
...
public class SN15_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4194969);
	private static BigDecimal expectedTotPft = new BigDecimal(14705224);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN15_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(4165000));
