...
public class SN15_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5127238);
	private static BigDecimal expectedTotPft = new BigDecimal(14808523);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN15_RR_PRI.class.getName() + ".xls";
