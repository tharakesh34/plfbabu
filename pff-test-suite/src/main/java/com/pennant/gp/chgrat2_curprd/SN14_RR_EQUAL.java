...
public class SN14_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4503352);
	private static BigDecimal expectedTotPft = new BigDecimal(14891159);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN14_RR_EQUAL.class.getName()
				+ ".xls";
