...
public class SN14_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5105416);
	private static BigDecimal expectedTotPft = new BigDecimal(14782391);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN14_RR_PRI.class.getName() + ".xls";
