...
public class SN14_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4233571);
	private static BigDecimal expectedTotPft = new BigDecimal(14708296);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN14_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
