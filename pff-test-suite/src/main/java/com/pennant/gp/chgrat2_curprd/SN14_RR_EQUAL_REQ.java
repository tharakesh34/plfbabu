...
public class SN14_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(4586838);
	private static BigDecimal expectedTotPft = new BigDecimal(14897637);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;

	private static String getFile() {
		return getFileLoc()
				+ SN14_RR_EQUAL_REQ.class.getName()
				+ ".xls";
