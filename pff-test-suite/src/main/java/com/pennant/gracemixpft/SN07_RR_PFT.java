...
public class SN07_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(104052310);
	private static BigDecimal expectedTotPft = new BigDecimal(14187615);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN07_RR_PFT.class.getName()
				+ ".xls";
