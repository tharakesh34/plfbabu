...
public class SN07_RR_EQUAL_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(19901133);
	private static BigDecimal expectedTotPft = new BigDecimal(10964036);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN07_RR_EQUAL_REQ.class.getName()
				+ ".xls";
