...
public class SN07_RR_PRI extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(10075770);
	private static BigDecimal expectedTotPft = new BigDecimal(10513731);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN07_RR_PRI.class.getName()
				+ ".xls";
