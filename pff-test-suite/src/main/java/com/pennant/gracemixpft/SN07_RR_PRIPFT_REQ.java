...
public class SN07_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(15454393);
	private static BigDecimal expectedTotPft = new BigDecimal(10764220);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN07_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
