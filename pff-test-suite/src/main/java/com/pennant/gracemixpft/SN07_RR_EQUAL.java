package com.pennant.gracemixpft;
...
public class SN07_RR_EQUAL extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(8956900);
	private static BigDecimal expectedTotPft = new BigDecimal(10545725);
	private static BigDecimal resultedTotPft = BigDecimal.ZERO;


	private static String getFile() {
		return getFileLoc() + SN07_RR_EQUAL.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh2.getFinanceMain().setRecalFromDate(DateUtility.getDate("31/12/2012"));
