...
public class SN21_RR_EQUAL extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(830389);
...
/*	private static BigDecimal resultDefPft = BigDecimal.ZERO;
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_EQUAL.class.getName() + ".xls";
