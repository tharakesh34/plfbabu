...
public class SN21_RR_PRI extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(820693);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_PRI.class.getName() + ".xls";
