package com.pennant.gnp.adddefer_tillmdt;
...
public class SN21_RR_PRIPFT extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(847317);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_PRIPFT.class.getName()
				+ ".xls";
		...
		try {
			...
			for (int i = 0; i < sh2.getFinanceScheduleDetails().size(); i++) {
				...
				if (i == (sdSize - 1)
						...
						&& sd.getDefPrincipalSchd().equals(expectedDefPri)
						&& sd.getDefProfitSchd().equals(expectedDefPft)
