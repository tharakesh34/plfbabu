...
public class SN21_RR_PFT extends TestingUtil {
	...
	private static BigDecimal expectedDefPft = new BigDecimal(53292);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_PFT.class.getName() + ".xls";
