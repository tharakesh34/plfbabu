...
public class SN21_RR_PRI_REQ extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(820000);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_PRI_REQ.class.getName() + ".xls";
