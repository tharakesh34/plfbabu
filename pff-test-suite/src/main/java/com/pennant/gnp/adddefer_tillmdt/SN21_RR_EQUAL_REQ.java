...
public class SN21_RR_EQUAL_REQ extends TestingUtil {
	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(51810014);
	private static BigDecimal expectedTotPft = new BigDecimal(11310014);
	private static BigDecimal expectedDefPri = new BigDecimal(450000);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_EQUAL_REQ.class.getName() + ".xls";
