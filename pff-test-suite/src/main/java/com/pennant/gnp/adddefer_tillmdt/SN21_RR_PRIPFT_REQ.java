...
public class SN21_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(46630367);
	private static BigDecimal expectedTotPft = new BigDecimal(11097845);
	private static BigDecimal expectedDefPri = new BigDecimal(500791);
	...
	private static String getFile() {
		return getFileLoc() + SN21_RR_PRIPFT_REQ.class.getName() + ".xls";
