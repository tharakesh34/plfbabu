...
public class ASN19_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(7868778);
	private static BigDecimal expectedTotPft = new BigDecimal(9600109);
	private static BigDecimal expectedDefPri = new BigDecimal(8000000);
	private static BigDecimal expectedDefPft = new BigDecimal(488400);
	...
	private static String getFile() {
		return getFileLoc() + ASN19_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
