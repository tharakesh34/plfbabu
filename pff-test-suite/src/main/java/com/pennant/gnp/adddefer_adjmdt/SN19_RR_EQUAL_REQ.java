package com.pennant.gnp.adddefer_adjmdt;
...
public class SN19_RR_EQUAL_REQ extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(7810101);
	private static BigDecimal expectedDefPft = new BigDecimal(489899);
	...
	private static String getFile() {
		return getFileLoc() + SN19_RR_EQUAL_REQ.class.getName()
				+ ".xls";
