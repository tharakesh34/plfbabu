package com.pennant.gnp.adddefer_addterm.addterm2_aftmdt;
...
public class SN23_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5890880);
	private static BigDecimal expectedTotPft = new BigDecimal(9889278);
	...
	private static String getFile() {
		return getFileLoc() + SN23_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh2 = ScheduleCalculator.addTerm(sh2, 2, CalculationConstants.ADDTERM_AFTMDT);
