...
public class SN23_RR_EQUAL_REQ extends TestingUtil {
	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2645703);
	private static BigDecimal expectedTotPft = new BigDecimal(10145703);
	...
	private static String getFile() {
		return getFileLoc() + SN23_RR_EQUAL_REQ.class.getName() + ".xls";
