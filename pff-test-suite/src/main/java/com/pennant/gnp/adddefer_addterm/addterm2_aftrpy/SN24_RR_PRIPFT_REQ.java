package com.pennant.gnp.adddefer_addterm.addterm2_aftrpy;
...
public class SN24_RR_PRIPFT_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(5855189);
	private static BigDecimal expectedTotPft = new BigDecimal(9853587);
	private static BigDecimal expectedDefPri = new BigDecimal(7500000);
	private static BigDecimal expectedDefPft = new BigDecimal(491180);
	...
	private static String getFile() {
		return getFileLoc() + SN24_RR_PRIPFT_REQ.class.getName()
				+ ".xls";
	...
	public static boolean RunTestCase() {
		try {
			...
			sh.setReqRepayAmount(new BigDecimal(7500000));
			...
			sh2 = ScheduleCalculator.addTerm(sh2, 2, CalculationConstants.ADDTERM_AFTRPY);
