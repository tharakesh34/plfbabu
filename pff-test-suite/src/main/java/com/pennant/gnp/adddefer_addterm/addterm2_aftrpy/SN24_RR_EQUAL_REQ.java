...
public class SN24_RR_EQUAL_REQ extends TestingUtil {
	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2582237);
	private static BigDecimal expectedTotPft = new BigDecimal(10082237);
	private static BigDecimal expectedDefPri = new BigDecimal(7005652);
	private static BigDecimal expectedDefPft = new BigDecimal(494348);
	...
	private static String getFile() {
		return getFileLoc() + SN24_RR_EQUAL_REQ.class.getName() + ".xls";
		...
		try {
			...
			for (int i = 0; i < sh2.getFinanceScheduleDetails().size(); i++) {
				...
				if (i == (sdSize - 1) && resultedTotPft.equals(expectedTotPft)
					...
					if (sh2.getFinanceScheduleDetails().get(sdSize - 1)
