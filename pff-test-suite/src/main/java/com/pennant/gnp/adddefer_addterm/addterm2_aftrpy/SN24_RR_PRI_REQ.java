...
public class SN24_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2504773);
	private static BigDecimal expectedTotPft = new BigDecimal(10004773);
	...
	private static String getFile() {
		return getFileLoc() + SN24_RR_PRI_REQ.class.getName() + ".xls";
