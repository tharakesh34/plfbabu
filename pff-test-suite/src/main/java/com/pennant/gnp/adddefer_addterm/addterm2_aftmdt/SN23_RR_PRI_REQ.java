...
public class SN23_RR_PRI_REQ extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(2567260);
	private static BigDecimal expectedTotPft = new BigDecimal(10067260);
	...
	private static String getFile() {
		return getFileLoc() + SN23_RR_PRI_REQ.class.getName() + ".xls";
