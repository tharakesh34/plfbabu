...
public class SN22_RR_PRI extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(8206930);
	...
	private static String getFile() {
		return getFileLoc() + SN22_RR_PRI.class.getName()
				+ ".xls";
