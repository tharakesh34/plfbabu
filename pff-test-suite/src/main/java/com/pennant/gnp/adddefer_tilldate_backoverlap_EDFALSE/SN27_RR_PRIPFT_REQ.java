...
public class SN27_RR_PRIPFT_REQ extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(16000000);
	private static BigDecimal expectedDefPft = new BigDecimal(1058044);
	...
	private static String getFile() {
		return getFileLoc() + SN27_RR_PRIPFT_REQ.class.getName() + ".xls";
