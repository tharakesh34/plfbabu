package com.pennant.gnp.adddefer_tilldate_backoverlap_EDFALSE;
...
public class SN27_RR_PFT extends TestingUtil {
	...
	private static Date defPayStartDate = DateUtility.getDate("29/02/2012");
	private static Date defPayEndDate = DateUtility.getDate("31/05/2012");

	private static String getFile() {
		return getFileLoc() + SN27_RR_PFT.class.getName() + ".xls";
