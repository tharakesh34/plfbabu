...
public class SN27_RR_EQUAL extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(15548331);
	private static BigDecimal expectedDefPft = new BigDecimal(1059521);
	...
	private static String getFile() {
		return getFileLoc() + SN27_RR_EQUAL.class.getName() + ".xls";
