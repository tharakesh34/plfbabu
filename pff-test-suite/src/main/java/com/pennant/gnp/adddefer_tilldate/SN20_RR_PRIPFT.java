package com.pennant.gnp.adddefer_tilldate;
...
public class SN20_RR_PRIPFT extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(7984640);
	private static BigDecimal expectedDefPft = new BigDecimal(488485);
	...
	private static boolean isDefStarted = false;
	private static int defAdjTerms = 0;


	private static String getFile() {
		return getFileLoc() + SN20_RR_PRIPFT.class.getName()
				+ ".xls";
