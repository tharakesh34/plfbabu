...
public class SN28_RR_PFT extends TestingUtil {

	private static boolean isSuccess = false;
	private static BigDecimal expectedResult = new BigDecimal(96466696);
	private static BigDecimal expectedTotPft = new BigDecimal(13023507);
	private static BigDecimal expectedDefPri = BigDecimal.ZERO;
	private static BigDecimal expectedDefPft = new BigDecimal(1102537);
	...
	private static String getFile() {
		return getFileLoc() + SN28_RR_PFT.class.getName() + ".xls";
