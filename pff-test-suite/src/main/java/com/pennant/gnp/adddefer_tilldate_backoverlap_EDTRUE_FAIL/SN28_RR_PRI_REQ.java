...
public class SN28_RR_PRI_REQ extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(16400000);
	...
	private static String getFile() {
		return getFileLoc() + SN28_RR_PRI_REQ.class.getName() + ".xls";
