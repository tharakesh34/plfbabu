...
public class SN28_RR_PRI extends TestingUtil {
	...
	private static BigDecimal expectedDefPri = new BigDecimal(16413860);
	...
	private static String getFile() {
		return getFileLoc() + SN28_RR_PRI.class.getName() + ".xls";
