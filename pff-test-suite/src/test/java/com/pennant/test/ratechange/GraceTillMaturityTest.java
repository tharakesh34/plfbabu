	...
	public Object[][] dataset() {
		return new Object[][] {
				new Object[] { "RR_GRCPFT_MRCTM_EQUAL_REQ",
						...
						BigDecimal.valueOf(4513108),
						BigDecimal.valueOf(15644708),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_EQUAL", BigDecimal.ZERO,
						CalculationConstants.EQUAL, true, true,
						BigDecimal.valueOf(4513108),
						BigDecimal.valueOf(15644708),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_PFT", BigDecimal.ZERO,
						CalculationConstants.PFT, true, true,
						BigDecimal.valueOf(100624246),
						BigDecimal.valueOf(22548630),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_PRI_REQ",
						BigDecimal.valueOf(4500000), CalculationConstants.PRI,
						false, false, BigDecimal.valueOf(5066797),
						BigDecimal.valueOf(15536687),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_PRI", BigDecimal.ZERO,
						CalculationConstants.PRI, true, true,
						BigDecimal.valueOf(5066797),
						BigDecimal.valueOf(15536687),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_PRIPFT_REQ",
						BigDecimal.valueOf(4200000),
						CalculationConstants.PRI_PFT, false, false,
						BigDecimal.valueOf(4192669),
						BigDecimal.valueOf(15436158),
						CalculationConstants.RPYCHG_TILLMDT },
				new Object[] { "RR_GRCPFT_MRCTM_PRIPFT", BigDecimal.ZERO,
