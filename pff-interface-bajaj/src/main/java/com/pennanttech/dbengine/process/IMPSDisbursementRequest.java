...
public class IMPSDisbursementRequest extends DatabaseDataEngine {
	private static final Logger	logger	= Logger.getLogger(IMPSDisbursementRequest.class);

	private String				paymentIds;

	public IMPSDisbursementRequest(DataSource dataSource, String database) {
	...
	protected void processData() {
		...
		parmMap.addValue("DISBURSEMENT_ID", Arrays.asList(paymentIds.split(",")));
