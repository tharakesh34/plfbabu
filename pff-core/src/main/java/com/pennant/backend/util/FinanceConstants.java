...
public class FinanceConstants {
	...
	/*
	 * public static final String REPAYMTH_AUTO = "CASA"; public static final String REPAYMTH_MANUAL = "MANUAL"; public
	 * static final String REPAYMTH_NACH = "NACH"; public static final String REPAYMTH_PDC = "PDC"; public static final
	 * String REPAYMTH_UDC = "UDC";
	 */
