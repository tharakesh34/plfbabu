...
public class PennantConstants {
	...
	public static final String FEE_REFUND_APPROVAL_FAILED = "0";
	public static final String FEE_REFUND_APPROVAL_SUCCESS = "1";
	public static final String FEE_REFUND_APPROVAL_HOLD = "2";
	public static final String FEE_REFUND_APPROVAL_DOWNLOADED = "3";
}
