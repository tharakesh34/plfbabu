...
//			rpyHierarchyTypes.add(new ValueLabel(RepayConstants.REPAY_HIERARCHY_IPFCS, Labels.getLabel("label_REPAY_HIERARCHY_IPFCS")));
	...
	public static ArrayList<ValueLabel> getEnquiryTypes() {
		...
		if(enquiryTypes == null){
			...
			//Module to display Loan extended details where label will be replaced with tab heading
			enquiryTypes.add(new ValueLabel("LOANEXTDET", "")); 
...
//			templateForList.add(new ValueLabel(NotificationConstants.TEMPLATE_FOR_LIMIT, Labels.getLabel("label_MailTemplateDialog_LimitNotification")));
	...
	public static ArrayList<ValueLabel> getFeeCalculatedOnList() {
		if (feeCalculatedOn == null) {
			...
			feeCalculatedOn.add(new ValueLabel(PennantConstants.FEE_CALCULATEDON_OUTSTANDPRINCIFUTURE, Labels.getLabel("Fee_CalculatedOn_OutStandingPrincipalFuture")));
	...
	public static List<Property> getManualAdvisePropertyTypes(){
		if(manualAdvisePropertyTypes == null){
			...
			manualAdvisePropertyTypes.add(new Property(FinanceConstants.MANUAL_ADVISE_RECEIVABLE, Labels.getLabel("label_ManualAdvise_Receivable")));
			manualAdvisePropertyTypes.add(new Property(FinanceConstants.MANUAL_ADVISE_PAYABLE, Labels.getLabel("label_ManualAdvise_Payable")));
		}
   ...
   public static ArrayList<ValueLabel> getMandateStatusTypeList() {
	...
	public static ArrayList<ValueLabel> getFinanceClosingStatusList() {
		if (financeClosingStatusList == null) {
			...
			financeClosingStatusList.add(new ValueLabel("E", Labels.getLabel("label_FinanceClosingStatus_EarlySettlement")));
