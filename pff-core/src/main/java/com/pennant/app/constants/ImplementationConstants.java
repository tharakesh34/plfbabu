...
public class ImplementationConstants {
	...
	static {
		...
		ONLINE_IRL_CHECK = FeatureExtension.getValueAsBoolean("ONLINE_IRL_CHECK", false);
		ALLOW_MULTIPLE_EMPLOYMENTS = FeatureExtension.getValueAsBoolean("ALLOW_MULTIPLE_EMPLOYMENTS", true);
		...
		// ALLOW_INSURANCE = getValueAsBoolean("ALLOW_INSURANCE", false);
