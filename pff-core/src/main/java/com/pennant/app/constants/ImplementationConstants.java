...
public class ImplementationConstants {
	...
	public static final boolean LIMIT_INTERNAL = true; // Limit Module Exists or
														// not
	...
	// AHB Implementation for Core Customer creation which includes reserve CIF
	// and Create CIF
	public static final boolean VALIDATE_CORE_CUST_UPDATE = false;
	public static final boolean ALLOW_COVENANT_TYPES = true; // Covenants
																// Allowed or
																// not
	public static final boolean COLLATERAL_INTERNAL = true; // Which Collateral
															// We are using
															// Internal or Third
															// Party Collaterals
	public static final boolean ALLOW_VAS = true; // VAS required or not F =
													// Administration/Insurance/Other
													// Fees C = Past due Penalty
													// I = Profit P = Principal
	public static final String REPAY_HIERARCHY_METHOD = "FCIP";

	public static final String REPAY_INTEREST_HIERARCHY = "LI"; // L = Late pay
																// Profit I =
																// Profit
	...
	public static final boolean ADD_FEEINFTV_ONCALC = true; // Fee Amount Ad to
															// Net Finance
															// Amount in Display

	public static final boolean ALLOW_FIN_SALARY_PAYMENT = true; // Salaried
																	// Payment
																	// Recording
	public static final boolean ALLOW_SPECIALRATE = false; // Special Rate
															// Allowed or Not in
															// Referential Rate
															// Component
	public static final boolean ACCOUNTS_APPLICABLE = false; // Application
																// Level
																// Accounting
																// Component
																// Allowed or
																// not
	public static final boolean ALLOW_MANUAL_SCHEDULE = false; // Manual
																// Schedule
																// Allowed or
																// not
	public static final boolean ALLOW_INDICATIVE_RATE = false; // Allow
																// Indicative
																// Rate
	public static final boolean CAPTURE_APPLICATION_NUMBER = true; // Allow
																	// Separate
																	// Application
																	// Number in
																	// finance
																	// // main
	public static final boolean ALLOW_PLANNED_EMIHOLIDAY = true; // Allow
																	// Planned
																	// EMI
																	// holidays
	public static final boolean ALLOW_UNPLANNED_EMIHOLIDAY = true; // Allow
																	// UnPlanned
																	// EMI
																	// holidays
	public static final boolean ALLOW_REAGE = true; // Allow UnPlanned EMI
													// holidays

	public static final boolean ALLOW_DOWNPAY_SUPPORTPGM = false; // Allow
																	// DownPay
																	// Support
																	// Program
	public static final boolean ALLOW_BPI_TREATMENT = true; // Allow Broken
															// Period Interest
	public static final boolean INTERESTON_PASTDUE_PRINCIPAL = true; // Allow
																		// Interest
																		// on
																		// Past
																		// Due
																		// Principal
	public static final boolean ALLOW_PLANNED_DEFERMENTS = false; // Allow
																	// Planned
																	// Deferments
	public static final boolean ALLOW_PRICINGPOLICY = false; // Allow pricing
																// policy
	public static final boolean ALLOW_CREDITBUREAU = false; // Allow Credit
															// Bureau
	public static final boolean ALLOW_BUNDLEDPRODUCT = false; // Allow Bundled
																// Product
	public static final boolean ALLOW_COMMITMENT = false; // Allow Commitment
															// Details
	public static final boolean ALLOW_PFTUNCHG = false; // Allow Profit
														// Unchanged
	public static final boolean COLLATERAL_DELINK_AUTO = false; // Allow Auto
																// Collateral
																// DelinkProcess
	...
	public static final boolean ALLOW_DEPRECIATION = false; // DEPRECIATION
															// Required or Not
	...
	public static final boolean ALLOW_INSURANCE = false; // Insurance Required
															// or Not
	public static final boolean ALLOW_RIA = false; // RIA Required or Not
	public static final boolean ALLOW_ADDDBSF = false; // Add Disbursement
														// future date Required
														// or Not
	public static final boolean UPFRONT_ADJUST_PAYABLEADVISE = false; // Excess
																		// upfront
																		// fees
																		// paid
																		// by
																		...
																		// Payable
																		// Advise/Excess.
	public static final boolean CO_APP_ENQ_SAME_AS_CUST_ENQ = true; // Inquiry
																	// menu in
																	// the
																	// co-applicant
																	// should
	...
	public static final boolean ALLOW_AUTO_DISBURSEMENTS = false; // Allow Auto
																	// Disbursements
																	// which
																	// will be
																	// called
	...
	public static final boolean ALLOW_COSTOFFUNDS = true; // Cost Of Funds For
															// Loan Type.
	public static final boolean ALLOW_IRRCODES = true; // IRR Codes For Loan
														// Type.
	public static final boolean ALLOW_FEES_RECALCULATE = true; // Fees
																// Recalculate
																// always
	public static final boolean ALLOW_PAID_FEE_SCHEDULE_METHOD = false; // Fee
																		// Schedule
																		// Methods
																		// for
																		// Paid
	...
	public static final boolean PPPERCENT_VALIDATION_REQ = false; // validation
																	// based on
																	// partial
																	// payment
																	// percent
	...
	// Auto Cancellation of Loans after "N" Days Allowed.ONLY FOR FGROUP IT
	// SHOULD BE TRUE
	public static final boolean ALW_LOAN_AUTO_CANCEL = false;

	// Capitalizing on Lock Period of Schedule Profit Balance
	// 1. TRUE : Default Capitalize Balance amount when Applicable
	// Capitalization
	// 2. FALSE : Check Schedule is on Lock Period or not, if not Capitalize
	// amount will reset
	...
	// If True, credit amounts will be shown with "-" sign in Trial balance.
	// Bajaj it is True
	public static final boolean NEGATE_SIGN_TB = false;

	// The below variable is set to show the Reporting manager list,Branch
	// Details tab if set false
	...
	// If Due Basis creation , means LPP created as fixed amount and same should
	// be accrued on creation date then PARAMTER = "D"
	// If Accrual Basis Creation, means LPP is calculated on daily basis then
