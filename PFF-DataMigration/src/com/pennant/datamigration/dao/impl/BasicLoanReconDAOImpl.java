...
public class BasicLoanReconDAOImpl implements BasicLoanReconDAO {
	...
	// Spring Named JDBC Template
		...
		public List<FinanceType> getDMFinTypes(String type) {
			...
			List<FinanceType> finTypeList = this.namedParameterJdbcTemplate.query(selectSql.toString(), source, typeRowMapper);
		...
		public SourceReport getSourceReportDetails(String lnno) {
			...
			try {
				esr = this.namedParameterJdbcTemplate.queryForObject(selectSql.toString(), beanParameters,
						typeRowMapper);
