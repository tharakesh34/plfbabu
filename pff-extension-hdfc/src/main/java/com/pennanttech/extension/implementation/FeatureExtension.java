...
public class FeatureExtension implements IFeatureExtension {
	...
	private void mandateExtensaions() {
		...
		mandateExtensions.put("MANDATE_SPLIT_COUNT", 3000);
		...
		mandateExtensions.put("ALLOW_LIEN_MARKING", true);
		mandateExtensions.put("ALLOW_HOLD_MARKING", true);
	}
	...
	private void dpdExtensions() {
		...
		dpdExtensions.put("DPD_STRING_CALCULATION_ON", 0);
	}
