...
public class RPMSExtractionTasklet implements Tasklet {

	private static Logger logger = LogManager.getLogger(RPMSExtractionTasklet.class);
	private EODExtractionsHook extExtractionHook;

	public RPMSExtractionTasklet() {
		super();
	}
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		if (extExtractionHook != null) {
			extExtractionHook.processRPMSExtraction();
		}
