		...
		if("Y".equals(alwAutoProv)){
			...
			try {
				...
				while (resultSet.next()) {
					...
					getProvisionCalculationUtil().processProvCalculations(provision, dateValueDate, false, false, financeType.isAllowRIAInvestment(),false);
				...
				while (resultSet.next()) {
					...
					//Call Method for Provision Calculation
					getProvisionCalculationUtil().processProvCalculations(provision, dateValueDate, true, false ,financeType.isAllowRIAInvestment(),false);
