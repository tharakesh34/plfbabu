...
public class BaselOneExtractionTasklet implements Tasklet {
	private static Logger logger = LogManager.getLogger(BaselOneExtractionTasklet.class);
	private EODExtractionsHook extExtractionHook;

	public BaselOneExtractionTasklet() {
		super();
	}
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		if (extExtractionHook != null) {
			extExtractionHook.processBaselOneExtraction();
		}
