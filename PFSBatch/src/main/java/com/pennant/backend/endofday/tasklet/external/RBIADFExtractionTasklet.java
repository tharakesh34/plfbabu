...
public class RBIADFExtractionTasklet implements Tasklet {

	private static Logger logger = LogManager.getLogger(RBIADFExtractionTasklet.class);
	private EODExtractionsHook extExtractionHook;

	public RBIADFExtractionTasklet() {
		super();
	}
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		if (extExtractionHook != null) {
			extExtractionHook.processExtRBIADFExtraction();
		}
