...
public class RefreshRateChanges  implements Tasklet {
	...
	public RepeatStatus execute(StepContribution arg0, ChunkContext context) throws Exception {
		...
		logger.debug("START: Refresh Rate Changes for Value Date: " + dateValueDate);
		...
		logger.debug("COMPLETE: Refresh Rate Changes for Value Date: " + dateValueDate);
	...
	private StringBuffer prepareSelectQuery(StringBuffer selQuery) {
		...
		selQuery.append(" AND br.LastMdfDate = '"+dateValueDate+"' " );
		...
		selQuery.append(" AND sr.LastMdfDate = '"+dateValueDate+"' " ); 
		selQuery.append(" UNION " );
		selQuery.append(" SELECT fm.FinReference AS FinReference " );
