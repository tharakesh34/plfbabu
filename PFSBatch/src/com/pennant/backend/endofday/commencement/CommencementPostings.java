 ...
 ********************************************************************************************
 */
package com.pennant.backend.endofday.commencement;
...
public class CommencementPostings implements Tasklet {
	...
	public RepeatStatus execute(StepContribution arg0, ChunkContext context) throws Exception {
		...
		try {
			...
			while (resultSet.next()) {
				...
				DataSet dataSet = AEAmounts.createDataSet(financeMain, "GRACEEND", financeMain.getGrcPeriodEndDate(), financeMain.getGrcPeriodEndDate());
				...
				if(returnList!=null && !returnList.isEmpty()) {
					if((Boolean)returnList .get(0)) {
						...
						if(returnList.get(4) != null && !StringUtils.trimToEmpty((String)returnList.get(4)).equals("")){
	...
	private String getCountQuery() {
		...
		selQuery.append(" FROM FinanceMain AS T1 " );
		selQuery.append(" INNER JOIN FinPftDetails AS T2 ON T1.FinReference = T2.FinReference " );
		selQuery.append(" INNER JOIN RMTFinanceTypes AS T3 ON T2.FinType = T3.FinType AND T3.FinAEGraceEnd != 0 " );
	...
	private String prepareSelectQuery() {
		...
		selQuery.append(" T2.TdPftAmortizedSusp, T2.AmzTillLBD  FROM FinanceMain AS T1 " );
		selQuery.append(" INNER JOIN FinPftDetails AS T2 ON T1.FinReference = T2.FinReference " );
		selQuery.append(" INNER JOIN RMTFinanceTypes AS T3 ON T2.FinType = T3.FinType AND T3.FinAEGraceEnd != 0 " );
		selQuery.append(" WHERE  T1.FinIsActive = '1' And T1.GrcPeriodEndDate = ? ");
		return selQuery.toString();
